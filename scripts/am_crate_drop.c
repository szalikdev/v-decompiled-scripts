...
void main() // Position - 0x0 (0)
{
	...
	while (true)
	{
		...
		if (_SHOULD_NETWORK_SCRIPT_TERMINATE() || func_424(4))
			func_435();
		...
		if (!NETWORK::NETWORK_DOES_NETWORK_ID_EXIST(iLocal_96.f_2.f_68[iParam0 /*104*/].f_5[i /*18*/]))
		{
			if (func_41(iLocal_96.f_2.f_68[iParam0 /*104*/].f_5[i /*18*/].f_1))
			{
				if (func_21(iLocal_96.f_2.f_68[iParam0 /*104*/].f_5[i /*18*/].f_2, 1086324736, 1065353216, 1065353216, 1084227584, true, true, true, 1123024896, false, -1, true, 0, false, 0, false, false))
				{
					...
					{
						PED::SET_PED_RELATIONSHIP_GROUP_HASH(NETWORK::NET_TO_PED(iLocal_96.f_2.f_68[iParam0 /*104*/].f_5[i /*18*/]), Global_1837343);
	...
	for (i = 0; i < 32; i = i + 1)
	{
		...
		if (_NETWORK_IS_PLAYER_VALID(player, true, true))
		{
			if (!func_24(player, 0) && NETWORK::NETWORK_ARE_PLAYERS_IN_SAME_TUTORIAL_SESSION(PLAYER::PLAYER_ID(), player))
			{
				...
				{
					if (func_23(player) || !bParam10 && !Global_2658291[player /*468*/].f_274)
					{
						num = iParam6;
...
Vector3 func_28(Player plParam0) // Position - 0x11C7 (4551)
{
	...
	if (func_33() && Global_1845250[player /*880*/].f_862 && !func_32(Global_1845250[player /*880*/].f_863))
...
BOOL func_58(int iParam0) // Position - 0x23F1 (9201)
{
	...
	{
		MISC::SET_BIT(&(Global_2699859.f_10), 0);
	
		if (!NETWORK::NETWORK_DOES_NETWORK_ID_EXIST(iLocal_96.f_2.f_1[iParam0 /*66*/].f_1))
		{
			MISC::SET_BIT(&(Global_2699859.f_10), 1);
	...
	switch (uLocal_286[NETWORK::PARTICIPANT_ID_TO_INT() /*4*/].f_3)
	{
		case 0:
			if (iLocal_96.f_180 > 0)
			{
				for (i = 0; i < 1; i = i + 1)
				{
					Global_2733002.f_238[i /*3*/] = { iLocal_96.f_2.f_68[i /*104*/].f_1 };
				}
			
				if (func_63() && func_61() && func_55())
				{
					if (!IS_BIT_SET(iLocal_96.f_2.f_1[0 /*66*/].f_65, 1) && func_396(31, false, false) && func_395(60000) && !func_394())
						if (!IS_BIT_SET(iLocal_96.f_1, 11))
		...
		case 1:
			...
			for (j = 0; j < iLocal_96.f_2; j = j + 1)
			{
				...
				if (NETWORK::NETWORK_DOES_NETWORK_ID_EXIST(iLocal_96.f_2.f_1[j /*66*/].f_1) && NETWORK::NETWORK_DOES_NETWORK_ID_EXIST(iLocal_96.f_181[j /*2*/]) || IS_BIT_SET(iLocal_96.f_1, 11))
				{
					func_203(j);
					func_202(j);
					func_196(j, iLocal_96.f_2.f_68[j /*104*/].f_101);
				}
...
void func_89(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4) // Position - 0x6DB3 (28083)
{
	if (Global_2673271.f_1762.f_703.f_16 != _INVALID_PLAYER_INDEX())
		if (IS_BIT_SET(Global_2658291[Global_2673271.f_1762.f_703.f_16 /*468*/].f_429, 0) && func_90())
			iParam0 = 23;
...
void func_107(int iParam0, float fParam1) // Position - 0x7191 (29073)
{
	if (!IS_BIT_SET(iLocal_415, 13))
	{
		if (_NETWORK_IS_PLAYER_VALID(PLAYER::PLAYER_ID(), true, true))
		{
			func_125(iLocal_96.f_2.f_68[iParam0 /*104*/].f_1, fParam1, 0, 0, 1, 0);
			func_109(iLocal_96.f_2.f_68[iParam0 /*104*/].f_1, (200f / 4f) * 2f, 0, 1);
			func_108(iLocal_96.f_2.f_68[iParam0 /*104*/].f_1, 1, 0);
...
void func_128(int iParam0) // Position - 0x77BA (30650)
{
	...
	for (i = 0; i < iLocal_96.f_2.f_68[iParam0 /*104*/].f_96; i = i + 1)
	{
		func_185(iLocal_96.f_2.f_68[iParam0 /*104*/].f_5[i /*18*/], &uLocal_421[iParam0 /*33*/][i /*8*/], -1082130432, false, false, false, 0, -1, INVALID, true, false, false, true, false);
		func_129(iParam0, i);
	}
	...
	if (NETWORK::NETWORK_DOES_NETWORK_ID_EXIST(iLocal_96.f_2.f_68[iParam0 /*104*/].f_5[iParam1 /*18*/]))
	{
		if (!IS_BIT_SET(uLocal_455[iParam0], 0 + iParam1))
		{
			if (ENTITY::IS_ENTITY_DEAD(NETWORK::NET_TO_PED(iLocal_96.f_2.f_68[iParam0 /*104*/].f_5[iParam1 /*18*/]), false))
			{
				...
				{
					func_130(0, NETWORK::NET_TO_PED(iLocal_96.f_2.f_68[iParam0 /*104*/].f_5[iParam1 /*18*/]), "XPT_KAIE" /*~g~+~1~ ~a~:~s~ Killed Hostile*/, joaat("XPTYPE_ACTION"), joaat("XPCATEGORY_ACTION_KILLS"), BUILTIN::ROUND(50f * Global_262145.f_3926), 1, -1, 0, false, 0);
...
int func_131(int iParam0, Object obParam1, char* sParam2, Hash hParam3, Hash hParam4, int iParam5, int iParam6, int iParam7, char* sParam8, BOOL bParam9, int iParam10) // Position - 0x792A (31018)
{
	...
	if (NETWORK::NETWORK_IS_ACTIVITY_SESSION() && IS_BIT_SET(Global_4718592.f_40, 19) || func_141(*Global_4718592.f_192777, true))
		return num;
...
void func_137(var uParam0, var uParam1, var uParam2, int iParam3, int iParam4, char* sParam5, int iParam6) // Position - 0x7AEF (31471)
{
	...
	if (iParam3 != 0)
	{
		...
		if (num != -1)
		{
			...
			Global_2673271.f_1158[num /*30*/].f_4 = func_140(Global_2673271.f_1158[num /*30*/], &Global_1574479, &Global_1574480);
			...
			Global_2673271.f_1158[num /*30*/].f_9 = func_139();
			Global_2673271.f_1158[num /*30*/].f_10 = func_138();
...
void func_151(int iParam0, Hash hParam1, int iParam2) // Position - 0x80BB (32955)
{
	if (func_175())
	{
		...
		if (func_161(PLAYER::PLAYER_ID()))
		{
			...
			Global_1845250[PLAYER::PLAYER_ID() /*880*/].f_198.f_6 = func_158(iParam0, true);
		}
...
BOOL func_168(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x8E64 (36452)
{
	...
	for (i = 0; i <= 31; i = i + 1)
	{
		...
		if (!_NETWORK_IS_PLAYER_VALID(player, true, true) || func_24(player, 0) || IS_BIT_SET(Global_2658291[player /*468*/].f_203, 2) || func_169(player))
		{
		}
...
void func_185(int iParam0, Blip* pblParam1, int iParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, const char* sParam6, int iParam7, eBlipSprite ebsParam8, BOOL bParam9, BOOL bParam10, BOOL bParam11, BOOL bParam12, BOOL bParam13) // Position - 0x936D (37741)
{
	if (NETWORK::NETWORK_DOES_NETWORK_ID_EXIST(iParam0))
	{
		...
		if (bParam3)
			func_187(NETWORK::NET_TO_PED(iParam0), pblParam1, 1, Global_2673271, bParam4, bParam5, iParam2, sParam6, iParam7, ebsParam8, bParam9, bParam10, bParam11, bParam12, bParam13);
		else
			func_187(NETWORK::NET_TO_PED(iParam0), pblParam1, -1, Global_2673271, bParam4, bParam5, iParam2, sParam6, iParam7, ebsParam8, bParam9, bParam10, bParam11, bParam12, bParam13);
	}
...
{
	if (!NETWORK::NETWORK_DOES_NETWORK_ID_EXIST(iLocal_96.f_2.f_1[iParam0 /*66*/].f_1) && iLocal_96.f_2.f_1[iParam0 /*66*/].f_64 == -1 && func_193())
		func_190(iParam0);
...
BOOL func_195() // Position - 0x9858 (39000)
{
	...
	if (IS_BIT_SET(Global_1882572[player /*315*/].f_17, 0) && Global_1882572[player /*315*/].f_27 == 2)
		return true;
					...
					if (func_45(iLocal_96.f_2.f_1[iParam0 /*66*/].f_1) && func_45(iLocal_96.f_2.f_1[iParam0 /*66*/].f_2))
					{
						if (!IS_BIT_SET(iLocal_96.f_2.f_1[iParam0 /*66*/].f_65, 2) && !IS_BIT_SET(uLocal_286[NETWORK::PARTICIPANT_ID_TO_INT() /*4*/].f_1, 0 + iParam0))
						{
							...
							if (IS_BIT_SET(iLocal_96.f_2.f_1[iParam0 /*66*/].f_65, 13) && ENTITY::IS_ENTITY_STATIC(object) && num == 1)
							{
								...
								func_200(&(iLocal_96.f_2.f_1[iParam0 /*66*/].f_2));
...
void func_197(int iParam0) // Position - 0xA08C (41100)
{
	if (iLocal_96.f_2.f_1[iParam0 /*66*/].f_64 != -1)
		if (func_45(iLocal_96.f_2.f_1[iParam0 /*66*/].f_1))
			func_200(&(iLocal_96.f_2.f_1[iParam0 /*66*/].f_1));
...
BOOL func_198(int iParam0) // Position - 0xA0C7 (41159)
{
	...
	else if (!ENTITY::IS_ENTITY_IN_AIR(NETWORK::NET_TO_OBJ(iLocal_96.f_2.f_1[iParam0 /*66*/].f_1)) || ENTITY::IS_ENTITY_IN_WATER(NETWORK::NET_TO_OBJ(iLocal_96.f_2.f_1[iParam0 /*66*/].f_1)) || func_199(iParam0))
	{
		return true;
	}
...
{
	if (func_193() && !ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(NETWORK::NET_TO_OBJ(iLocal_96.f_2.f_1[iParam0 /*66*/].f_1)))
	{
...
void func_211(int iParam0) // Position - 0xA8F0 (43248)
{
	...
	if (NETWORK::NETWORK_DOES_NETWORK_ID_EXIST(iLocal_96.f_2.f_1[iParam0 /*66*/].f_1))
		func_130(0, NETWORK::NET_TO_OBJ(iLocal_96.f_2.f_1[iParam0 /*66*/].f_1), "XPT_MEDIUMT", joaat("XPTYPE_COLLECT"), joaat("XPCATEGORY_COLLECT_CRATE_DROP"), num, 1, -1, 0, false, 0);
	else
	...
	{
		case 0:
			amount = func_380(iLocal_96.f_2.f_1[iParam0 /*66*/].f_32, 1);
		...
		case 8:
			...
			{
				case 0:
					func_224("ACD_TCONT_CXWA" /*Crate Contents:~n~ + $~1~~n~ + ~1~RP~n~ + ~a~~n~ + Body Armor*/, func_293(iLocal_96.f_2.f_1[iParam0 /*66*/].f_33, false), amount, num);
					break;
			
				case 1:
					func_219("ACD_TCONT_CXWAC" /*Crate Contents:~n~ + $~1~~n~ + ~1~RP~n~ + ~a~~n~ + Body Armor~n~ + ~a~*/, func_293(iLocal_96.f_2.f_1[iParam0 /*66*/].f_33, false), &unk5, amount, num);
					break;
...
int func_225(int iParam0, int iParam1, var uParam2) // Position - 0xB208 (45576)
{
	...
	else if (iParam0 != -1 && iParam0 != 10 || !flag && iParam1 != -1 && iParam1 != -99 && func_227(func_289(), iParam0, iParam1) && !MISC::IS_STRING_NULL_OR_EMPTY(&(unk14.f_8)) && IS_BIT_SET(unk14.f_6, 6))
	{
...
{
	Global_80063[1 /*14*/] = { func_239(hParam0, iParam1, iParam2, -1) };
	return IS_BIT_SET(Global_80063[1 /*14*/].f_6, 1);
}
...
int func_233() // Position - 0x15701 (87809)
{
	int outValue;
	int outValue2;
	Hash statHash;
...
int func_234() // Position - 0x157B7 (87991)
{
	int outValue;
	int outValue2;
	Hash statHash;
...
BOOL _IS_EXCLUSIVE_CONTENT_UNLOCKED() // Position - 0x158F0 (88304)
{
	int profileSetting;
...
int func_236() // Position - 0x159A8 (88488)
{
	return 1;
}

int func_237() // Position - 0x159B1 (88497)
{
	return 1;
}

void func_238(char* sParam0, int iParam1, Ped pedParam2, char* sParam3, char* sParam4, char* sParam5, char* sParam6, int iParam7, int iParam8, int iParam9) // Position - 0x159BA (88506)
{
	var unk;
...
struct<14> func_239(Hash hParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0x15C70 (89200)
{
	func_288();
...
void func_240(int iParam0, int iParam1, Hash hParam2) // Position - 0x15CB1 (89265)
{
	switch (iParam0)
	{
		case 2:
...
void func_241(int iParam0) // Position - 0x15DBD (89533)
{
	BOOL flag;
	int num;
	var unk;
	...
	func_242(&Global_80063[0 /*14*/], num6, iParam0, &unk, num2, num3, num, flag, num4, num5, false);
	return;
}

void func_242(int iParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, BOOL bParam7, int iParam8, int iParam9, BOOL bParam10) // Position - 0x15F78 (89976)
{
	int num;
	int num2;
	...
	*iParam0 = iParam9;
	...
	else
	{
		...
		if (iParam1 == 11 || iParam1 == 4 || iParam1 == 6 || iParam1 == 1 || iParam1 == 14 || iParam1 == 2 || iParam1 == 8 || iParam1 == 9 || iParam1 == 10 || iParam1 == 7 || iParam1 == 12)
		{
			...
			num = func_162(func_245(iParam1, iParam0->f_2), Global_80060);
		
			if (IS_BIT_SET(num, iParam0->f_1))
				MISC::SET_BIT(&(iParam0->f_6), 1);
		
			num = func_162(func_244(iParam1, iParam0->f_2), Global_80060);
			...
			{
				num = func_162(num2, Global_80060);
...
BOOL func_243(int iParam0, int iParam1, var uParam2) // Position - 0x1631A (90906)
{
	*uParam2 = 979;
...
int func_244(int iParam0, int iParam1) // Position - 0x1671F (91935)
{
	switch (iParam1)
	{
		case 0:
...
int func_245(int iParam0, int iParam1) // Position - 0x16B1A (92954)
{
	switch (iParam1)
	{
		case 0:
...
BOOL func_246(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x16F15 (93973)
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
BOOL func_247(Hash hParam0, int iParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x17DB8 (97720)
{
	int num;
	int num2;
	int num3;
...
BOOL func_248(Hash hParam0, int iParam1, var uParam2, var uParam3, BOOL bParam4, BOOL bParam5) // Position - 0x17DF6 (97782)
{
...
BOOL func_249(int iParam0) // Position - 0x1AA93 (109203)
{
	return Global_44869 == iParam0;
}

int func_250(int iParam0) // Position - 0x1AAA1 (109217)
{
	switch (iParam0)
	{
		case -1:
...
void func_251(int iParam0, Hash hParam1) // Position - 0x1AB75 (109429)
{
	int num;
...
void func_252(int iParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0x1AB95 (109461)
{
	int num;
	int num2;
	Hash outfit;
	...
	if (iParam0 == 12)
	{
		...
		if (outfitIndex >= 0)
		{
			...
			if (num3 > outfitIndex)
			{
				...
				func_242(&Global_80063[0 /*14*/], iParam0, iParam1, &(outfit.f_7), 0, 0, outfit.f_2, false, -1, 2, true);
				return;
			}
		}
	}
	...
	{
		func_242(&Global_80063[0 /*14*/], iParam0, iParam1, "NO_LABEL", 0, 0, 0, true, -1, 2, true);
	}
	else if (iParam0 == 14)
	{
		...
		if (componentId >= 0)
		{
			...
			if (num5 > componentId)
			{
				...
				func_242(&Global_80063[0 /*14*/], iParam0, iParam1, &(outProp.f_9), outProp.f_3, outProp.f_4, outProp.f_5, EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(outProp.f_1, joaat("OUTFIT_ONLY"), 0), num4, 2, outProp.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (hParam3 != -1 && Global_80261)
		{
			...
			func_242(&Global_80063[0 /*14*/], iParam0, iParam1, &(outComponent.f_9), outComponent.f_3, outComponent.f_4, outComponent.f_5, EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(outComponent.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, outComponent.f_1 != 0);
			return;
		}
...
void func_253(int iParam0, Hash hParam1) // Position - 0x1AE1C (110108)
{
	BOOL flag;
	int num;
	var unk;
...
void func_254(int iParam0, Hash hParam1) // Position - 0x1AF1F (110367)
{
	BOOL flag;
	int num;
	var unk;
...
void func_255(int iParam0, Hash hParam1) // Position - 0x1B1FE (111102)
{
	BOOL flag;
	int value;
	var unk;
	...
	{
		func_242(&Global_80063[0 /*14*/], num5, iParam0, &unk, num, num2, value, flag, num3, num4, false);
	}

	return;
}

void func_256(int iParam0, Hash hParam1) // Position - 0x1DFD4 (122836)
{
	BOOL flag;
	int num;
	var unk;
...
void func_257(int iParam0, Hash hParam1) // Position - 0x1E0D9 (123097)
{
	BOOL flag;
	int value;
	var unk;
...
void func_258(int iParam0, Hash hParam1) // Position - 0x1E8B5 (125109)
{
	BOOL flag;
	int value;
	var unk;
...
void func_259(int iParam0, Hash hParam1) // Position - 0x1EB9A (125850)
{
	BOOL flag;
	int value;
	var unk;
...
void func_260(int iParam0, Hash hParam1) // Position - 0x201C2 (131522)
{
	BOOL flag;
	int value;
	var unk;
...
void func_261(int iParam0, Hash hParam1) // Position - 0x21821 (137249)
{
	BOOL flag;
	int num;
	var unk;
...
void func_262(int iParam0, Hash hParam1) // Position - 0x2197C (137596)
{
	BOOL flag;
	int num;
	var unk;
...
void func_263(int iParam0, Hash hParam1) // Position - 0x21BFC (138236)
{
	BOOL flag;
	int value;
	var unk;
...
BOOL func_264(int iParam0, int iParam1) // Position - 0x22F9E (143262)
{
	int num;
	int num2;
...
int func_265(int iParam0) // Position - 0x22FCD (143309)
{
	return iParam0 % 32;
}

int func_266(int iParam0, int iParam1) // Position - 0x22FDA (143322)
{
	int num;

	num = func_162(func_267(iParam0), iParam1);
	return num;
}

int func_267(int iParam0) // Position - 0x22FF2 (143346)
{
	int num;
	int num2;
...
int func_268() // Position - 0x2336D (144237)
{
	return Global_33776;
}

int func_269(int iParam0) // Position - 0x23378 (144248)
{
	return iParam0 / 32;
}

void func_270(int iParam0, Hash hParam1) // Position - 0x23385 (144261)
{
	BOOL flag;
	int value;
	var unk;
...
void func_271(int iParam0, Hash hParam1) // Position - 0x24B4B (150347)
{
	BOOL flag;
	int value;
	var unk;
...
void func_272(int iParam0, int iParam1, Hash hParam2) // Position - 0x25A1C (154140)
{
	switch (iParam0)
	{
		case 2:
...
void func_273(int iParam0) // Position - 0x25B28 (154408)
{
	BOOL flag;
	int num;
	var unk;
...
void func_274(int iParam0, Hash hParam1) // Position - 0x25CF2 (154866)
{
	int num;
...
void func_275(int iParam0, Hash hParam1) // Position - 0x25D12 (154898)
{
	BOOL flag;
	int num;
	var unk;
...
void func_276(int iParam0, Hash hParam1) // Position - 0x25E15 (155157)
{
	BOOL flag;
	int num;
	var unk;
...
void func_277(int iParam0, Hash hParam1) // Position - 0x260C6 (155846)
{
	BOOL flag;
	int value;
	var unk;
...
void func_278(int iParam0, Hash hParam1) // Position - 0x28E87 (167559)
{
	BOOL flag;
	int num;
	var unk;
...
void func_279(int iParam0, Hash hParam1) // Position - 0x28FA8 (167848)
{
	BOOL flag;
	int value;
	var unk;
...
void func_281(int iParam0, Hash hParam1) // Position - 0x29B57 (170839)
{
	BOOL flag;
	int value;
	var unk;
...
void func_282(int iParam0, Hash hParam1) // Position - 0x2B194 (176532)
{
	BOOL flag;
	int value;
	var unk;
...
void func_283(int iParam0, Hash hParam1) // Position - 0x2C7C8 (182216)
{
	BOOL flag;
	int num;
	var unk;
...
void func_284(int iParam0, Hash hParam1) // Position - 0x2C91F (182559)
{
	BOOL flag;
	int num;
	var unk;
...
void func_285(int iParam0, Hash hParam1) // Position - 0x2CC3B (183355)
{
	BOOL flag;
	int value;
	var unk;
...
void func_286(int iParam0, Hash hParam1) // Position - 0x2F12C (192812)
{
	BOOL flag;
	int value;
	var unk;
...
void func_287(int iParam0, Hash hParam1) // Position - 0x306B8 (198328)
{
	BOOL flag;
	int value;
	var unk;
...
void func_288() // Position - 0x31572 (202098)
{
...
Hash func_289() // Position - 0x315EB (202219)
{
	return ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID());
}

BOOL func_290(int iParam0, int iParam1) // Position - 0x315FB (202235)
{
	var unk;
	var unk14;
	int num;
...
void func_291() // Position - 0x316D7 (202455)
{
	int num;
	int playerMaxArmour;
	int pedArmour;
...
int func_292(char* sParam0, char* sParam1, int iParam2) // Position - 0x31730 (202544)
{
	int num;
...
char* func_293(Hash hParam0, BOOL bParam1) // Position - 0x3176B (202603)
{
	var unk;
...
char* func_294(var uParam0) // Position - 0x32770 (206704)
{
	return uParam0;
}

int func_295(Hash hParam0, Any* panParam1) // Position - 0x3277A (206714)
{
	int i;
	int numDlcWeapons;
...
BOOL func_296(var uParam0, var uParam1) // Position - 0x327B5 (206773)
{
	BOOL flag;
...
BOOL func_297(var uParam0, int iParam1, int iParam2) // Position - 0x3297C (207228)
{
	int num;
	int num2;
...
int func_298(var uParam0) // Position - 0x329B0 (207280)
{
	return func_299(uParam0);
}

int func_299(int iParam0) // Position - 0x329BE (207294)
{
	switch (iParam0)
	{
		case joaat("WEAPON_UNARMED"):
...
int func_300(var uParam0, int iParam1) // Position - 0x3300E (208910)
{
	int num;

	num = func_162(func_301(uParam0), iParam1);
	return num;
}

int func_301(var uParam0) // Position - 0x33026 (208934)
{
	int num;
	int num2;
...
BOOL func_302() // Position - 0x330F0 (209136)
{
	return Global_1575069;
}

void func_303(int iParam0, int iParam1) // Position - 0x330FC (209148)
{
	if (iParam1 > 0)
	{
...
int func_305(char* sParam0, int iParam1, int iParam2) // Position - 0x33170 (209264)
{
	int num;
...
void func_306(var uParam0, var uParam1, var uParam2, int iParam3) // Position - 0x331AC (209324)
{
...
int func_308(var uParam0, int iParam1, Hash hParam2, Hash hParam3, Hash hParam4, int iParam5, int iParam6, int iParam7) // Position - 0x33B82 (211842)
{
	BOOL flag;
	BOOL flag2;
	int i;
...
void func_309(int iParam0, Hash hParam1, int iParam2, int iParam3, int iParam4) // Position - 0x33D2F (212271)
{
	switch (hParam1)
	{
		case joaat("SERVICE_SPEND_BETTING"):
...
void func_310(int iParam0) // Position - 0x33D67 (212327)
{
	BOOL flag;
...
void func_311(Hash hParam0) // Position - 0x33DBB (212411)
{
	hParam0->f_65 = 0;
...
void func_312(var uParam0) // Position - 0x33EC2 (212674)
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
BOOL func_313(int iParam0) // Position - 0x33F0A (212746)
{
...
void func_314(int iParam0, Hash hParam1) // Position - 0x33F35 (212789)
{
...
int func_315(int iParam0, int iParam1, Hash hParam2, Hash hParam3, Hash hParam4, int iParam5, BOOL bParam6, int iParam7, int iParam8, int iParam9, BOOL bParam10) // Position - 0x33F49 (212809)
{
	int i;
...
int func_317(Player plParam0) // Position - 0x3410B (213259)
{
	int address;
...
BOOL _NETSHOPPING_SHOULD_USE_TRANSACTION_SYSTEM() // Position - 0x34126 (213286)
{
...
void func_319(var uParam0, int iParam1) // Position - 0x3413D (213309)
{
	int num;
...
void func_320(Player plParam0, int iParam1, int iParam2) // Position - 0x341DD (213469)
{
	Hash eventData;
...
void func_321(var uParam0, var uParam1) // Position - 0x34235 (213557)
{
...
var func_322(Player plParam0) // Position - 0x3424F (213583)
{
	return Global_1892653[plParam0 /*615*/].f_517;
}

void func_323(int iParam0) // Position - 0x34263 (213603)
{
	int num;
	int offset;
...
int func_324(char* sParam0, Player plParam1, int iParam2, eHudColour ehcParam3, BOOL bParam4, BOOL bParam5) // Position - 0x3428C (213644)
{
	int num;
	var unk;
...
const char* func_325(char* sParam0) // Position - 0x34324 (213796)
{
	var unk;
...
const char* func_326(var uParam0) // Position - 0x34348 (213832)
{
	return uParam0;
}

eHudColour func_327(Player plParam0, int iParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x34352 (213842)
{
	int playerTeam;
	Ped ped;
	...
	if (func_368(PLAYER::PLAYER_ID()) || func_367() && func_366() && !IS_BIT_SET(Global_2733002.f_3788, 31) && !bParam4)
	{
		ped = func_365();
...
eHudColour func_328(BOOL bParam0, int iParam1, BOOL bParam2) // Position - 0x3453D (214333)
{
	return func_329(PLAYER::PLAYER_ID(), bParam0, iParam1, bParam2);
}

int func_329(Player plParam0, BOOL bParam1, int iParam2, BOOL bParam3) // Position - 0x34553 (214355)
{
	int playerTeam;
...
int func_330(int iParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0x34670 (214640)
{
	int num;

	num = func_332(iParam0, iParam1, iParam3);

	if (func_331(*Global_4718592.f_132500, true, true))
		if (num == 1)
			num = 0;
...
BOOL func_331(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x34789 (214921)
{
	int i;
	...
	if (bParam2)
		if (func_141(*Global_4718592.f_192777, false))
			return true;
...
int func_332(int iParam0, int iParam1, int iParam2) // Position - 0x347F5 (215029)
{
	int i;
	int num;
...
int func_333(BOOL bParam0) // Position - 0x3483D (215101)
{
	if (bParam0)
		return 118;
...
int func_334(int iParam0, int iParam1) // Position - 0x34854 (215124)
{
	if (iParam0 == -1)
...
BOOL func_335() // Position - 0x348A2 (215202)
{
	if (func_336())
		return true;
...
BOOL func_336() // Position - 0x348C1 (215233)
{
	return IS_BIT_SET(*Global_4718592.f_185514, 12);
}

BOOL func_337() // Position - 0x348D6 (215254)
{
	if (NETWORK::NETWORK_IS_ACTIVITY_SESSION())
...
BOOL func_338() // Position - 0x3491D (215325)
{
...
BOOL func_339(int iParam0) // Position - 0x3493A (215354)
{
	return iParam0 == 94;
}

eHudColour func_340(Player plParam0, Player plParam1, int iParam2, BOOL bParam3, BOOL bParam4) // Position - 0x34947 (215367)
{
	int playerTeam;
	BOOL flag;
	Player player;
	...
	if (!flag)
	{
		if (playerTeam != -1)
		{
			...
			if (func_342(plParam1, plParam0, playerTeam, 0) && !IS_BIT_SET(Global_4718592.f_16, 18) || func_167(PLAYER::GET_PLAYER_TEAM(plParam1), PLAYER::GET_PLAYER_TEAM(plParam0), 0, -1) && IS_BIT_SET(Global_4718592.f_16, 23) && !IS_BIT_SET(Global_4718592.f_16, 18))
				return func_333(true);
...
int func_341(BOOL bParam0) // Position - 0x34ADF (215775)
{
	if (bParam0)
		return 119;
...
BOOL func_342(Player plParam0, Player plParam1, int iParam2, int iParam3) // Position - 0x34AF6 (215798)
{
	if (iParam2 == -2)
	{
		if (iParam3 == 0)
...
int func_343(int iParam0) // Position - 0x34B6E (215918)
{
	int num;
...
var func_344(int iParam0) // Position - 0x34C31 (216113)
{
	return Global_2649159.f_818.f_44[iParam0 /*2*/].f_1;
}

int func_345(Player plParam0) // Position - 0x34C48 (216136)
{
	if (func_27(plParam0))
		if (func_346(plParam0, true))
			return Global_2649159.f_818.f_11[func_37(plParam0)];

	return -1;
}

BOOL func_346(Player plParam0, BOOL bParam1) // Position - 0x34C78 (216184)
{
	if (!func_27(plParam0))
		return false;
	...
	return func_27(Global_1892653[plParam0 /*615*/].f_10);
}

BOOL func_347(Player plParam0) // Position - 0x34CB0 (216240)
{
	if (func_27(plParam0))
		if (func_27(Global_1892653[plParam0 /*615*/].f_10))
			return Global_1892653[plParam0 /*615*/].f_10 == plParam0;

	return false;
}

BOOL func_348() // Position - 0x34CE5 (216293)
{
...
BOOL func_349() // Position - 0x34D61 (216417)
{
	return func_350(*Global_4718592.f_132500);
}

BOOL func_350(int iParam0) // Position - 0x34D77 (216439)
{
	int i;
...
int func_351(int iParam0) // Position - 0x34DAB (216491)
{
	if (iParam0 != -1)
...
BOOL func_352() // Position - 0x34DCA (216522)
{
	return func_353(*Global_4718592.f_132500);
}

BOOL func_353(int iParam0) // Position - 0x34DE0 (216544)
{
	int i;
...
int func_354(int iParam0) // Position - 0x34E14 (216596)
{
	if (iParam0 != -1)
...
BOOL func_355() // Position - 0x34E33 (216627)
{
	return func_356(*Global_4718592.f_132500);
}

BOOL func_356(int iParam0) // Position - 0x34E49 (216649)
{
	int i;
...
BOOL func_357() // Position - 0x34E82 (216706)
{
	return func_358(*Global_4718592.f_132500);
}

BOOL func_358(int iParam0) // Position - 0x34E98 (216728)
{
	int i;
...
BOOL func_359() // Position - 0x34ED2 (216786)
{
	return Global_2685150.f_24;
}

BOOL func_360() // Position - 0x34EE0 (216800)
{
	return Global_2685150.f_21;
}

BOOL func_361() // Position - 0x34EEE (216814)
{
	return Global_2685150.f_18;
}

BOOL func_362() // Position - 0x34EFC (216828)
{
	return Global_2685150.f_17;
}

eHudColour func_363(int iParam0, Player plParam1, BOOL bParam2) // Position - 0x34F0A (216842)
{
	int num;
	int num2;
	int num3;
...
int func_364(int iParam0) // Position - 0x3508A (217226)
{
	int num;
...
Ped func_365() // Position - 0x3515F (217439)
{
	return Global_2621446.f_2;
}

BOOL func_366() // Position - 0x3516D (217453)
{
	return IS_BIT_SET(Global_2621446, 4);
}

BOOL func_367() // Position - 0x3517B (217467)
{
	return IS_BIT_SET(Global_1845250[PLAYER::PLAYER_ID() /*880*/].f_36.f_18, 14);
}

BOOL func_368(Player plParam0) // Position - 0x35195 (217493)
{
...
BOOL func_369() // Position - 0x351D4 (217556)
{
	return IS_BIT_SET(Global_2621446, 3);
}

void func_370(var uParam0, BOOL bParam1) // Position - 0x351E2 (217570)
{
	int num;
	int num2;
...
int func_371(BOOL bParam0) // Position - 0x35214 (217620)
{
	if (bParam0)
...
int func_372() // Position - 0x3523A (217658)
{
	return Global_262145.f_12931;
}

Player _GET_BOSS_OF_LOCAL_PLAYER() // Position - 0x35249 (217673)
{
	return Global_1892653[PLAYER::PLAYER_ID() /*615*/].f_10;
}

BOOL func_374(BOOL bParam0) // Position - 0x3525E (217694)
{
	return func_375(PLAYER::PLAYER_ID(), bParam0);
}

BOOL func_375(Player plParam0, BOOL bParam1) // Position - 0x35270 (217712)
{
	return func_376(plParam0, bParam1, 1);
}

int func_376(Player plParam0, BOOL bParam1, int iParam2) // Position - 0x35281 (217729)
{
	Player player;
	...
	if (func_27(player) && Global_1892653[player /*615*/].f_10.f_433 == iParam2)
		return 1;

	return 0;
}

BOOL func_377(Player plParam0, int iParam1) // Position - 0x352DD (217821)
{
	if (func_27(plParam0))
		if (func_27(Global_1892653[plParam0 /*615*/].f_10))
...
BOOL func_378(BOOL bParam0) // Position - 0x3532C (217900)
{
	return func_346(PLAYER::PLAYER_ID(), bParam0);
}

BOOL func_379() // Position - 0x3533E (217918)
{
	return func_347(PLAYER::PLAYER_ID());
}

int func_380(int iParam0, int iParam1) // Position - 0x3534E (217934)
{
	float value;
...
void func_381(int iParam0) // Position - 0x3538F (217999)
{
	Global_2673271.f_1761 = iParam0;
	return;
}

void func_382(Hash hParam0, int iParam1, int iParam2) // Position - 0x353A0 (218016)
{
	int ammo;
	int ammo2;
	int num;
...
void func_383(Ped pedParam0, int iParam1) // Position - 0x35401 (218113)
{
	var unk;
	int i;
	int num;
	...
	if (iParam1 > 0)
	{
		...
		if (num != -1)
		{
			Global_2673271.f_1158[num /*30*/] = { unk };
			Global_2673271.f_1158[num /*30*/].f_6 = 1;
			Global_2673271.f_1158[num /*30*/].f_4 = func_140(Global_2673271.f_1158[num /*30*/], &Global_1574479, &Global_1574480);
			Global_2673271.f_1158[num /*30*/].f_7 = NETWORK::GET_NETWORK_TIME();
			Global_2673271.f_1158[num /*30*/].f_3 = iParam1;
			Global_2673271.f_1158[num /*30*/].f_8 = 1;
			Global_2673271.f_1158[num /*30*/].f_9 = func_139();
			Global_2673271.f_1158[num /*30*/].f_10 = func_138();
			Global_1945444 = 1;
...
Hash func_384(Ped pedParam0) // Position - 0x3551D (218397)
{
	var weaponHash;
...
void func_385() // Position - 0x35531 (218417)
{
	return;
}

void func_386() // Position - 0x35539 (218425)
{
	if (_NETWORK_IS_PLAYER_VALID(PLAYER::PLAYER_ID(), true, true))
	{
		if (!IS_BIT_SET(Global_2733002.f_206.f_1, 0))
		{
			if (!HUD::IS_HELP_MESSAGE_BEING_DISPLAYED() && !func_391() && !func_390() && !func_389() && func_396(31, false, false) && !func_420(PLAYER::PLAYER_ID()) && !_IS_FMMC_ACTIVE())
			{
				if (func_395(60000))
				{
					if (!func_192())
					...
					MISC::SET_BIT(&(Global_2733002.f_206.f_1), 0);
				}
				else
				{
					MISC::SET_BIT(&(Global_2733002.f_206.f_1), 0);
...
void _DISPLAY_HELP_TEXT(char* text, int iParam1) // Position - 0x355E0 (218592)
{
...
void func_392() // Position - 0x3564D (218701)
{
	...
	for (i = 0; i < 2; i = i + 1)
	{
		...
		if (num > 0)
			Global_2733002.f_206.f_25[num /*3*/] = { Global_2733002.f_206.f_25[num - 1 /*3*/] };
		else
			Global_2733002.f_206.f_25[num /*3*/] = { func_77(iLocal_96.f_2.f_68[0 /*104*/]) };
	}

	return;
}

int _THEFEED_SHOW_MESSAGE(char* sParam0, BOOL bParam1) // Position - 0x356AF (218799)
{
	int num;
	int num2;
...
BOOL func_394() // Position - 0x356E7 (218855)
{
	return Global_1575090;
}

BOOL func_395(int iParam0) // Position - 0x356F3 (218867)
{
	return MISC::ABSI(NETWORK::GET_TIME_DIFFERENCE(Global_2645098, NETWORK::GET_NETWORK_TIME())) > iParam0;
}

BOOL func_396(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x3570E (218894)
{
	int num;
	int num2;
...
BOOL func_397() // Position - 0x35884 (219268)
{
	int num;
...
BOOL func_398() // Position - 0x358E1 (219361)
{
	return Global_1575078;
}

BOOL func_399() // Position - 0x358ED (219373)
{
	return Global_1575080;
}

BOOL func_400(Player plParam0, int iParam1) // Position - 0x358F9 (219385)
{
	if (!func_404())
		return false;
	...
	return func_401(&(Global_1845250[plParam0 /*880*/].f_821), func_402(iParam1));
}

BOOL func_401(var uParam0, int iParam1) // Position - 0x35939 (219449)
{
	int num;
	int num2;
	int num3;
...
int func_402(int iParam0) // Position - 0x3595C (219484)
{
	switch (iParam0)
	{
		case 86:
...
BOOL func_403() // Position - 0x35B48 (219976)
{
	return IS_BIT_SET(Global_1845250[PLAYER::PLAYER_ID() /*880*/].f_144, 3);
}

BOOL func_404() // Position - 0x35B5F (219999)
{
	if (!func_405())
		return false;
...
BOOL func_405() // Position - 0x35B74 (220020)
{
	if (Global_1574612)
		return true;
...
BOOL func_406(int iParam0, int iParam1) // Position - 0x35BA4 (220068)
{
	Hash statHash;
	int outValue;
...
Hash func_407(int iParam0, int iParam1) // Position - 0x35BC8 (220104)
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(2, iParam0, func_157(iParam1));
}

void func_408() // Position - 0x35BDD (220125)
{
	...
	if (iLocal_96.f_177 != numReservedMissionVehicles)
		if (iLocal_96.f_177 < numReservedMissionVehicles || func_416(iLocal_96.f_177, false, true))
	...
	if (iLocal_96.f_178 != numReservedMissionVehicles)
		if (iLocal_96.f_178 < numReservedMissionVehicles || func_415(iLocal_96.f_178, false, true))
	...
	if (iLocal_96.f_179 != numReservedMissionVehicles)
		if (iLocal_96.f_179 < numReservedMissionVehicles || func_409(iLocal_96.f_179, false, true))
...
BOOL func_409(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x35CA2 (220322)
{
	return func_410(2, iParam0, true, bParam1, bParam2);
}

BOOL func_410(int iParam0, int iParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x35CB6 (220342)
{
	int num;
	int num2;
	...
	if (bParam2 && !bParam3 && iParam1 <= func_414(iParam0) - func_413(iParam0, false))
	{
		return 1;
	}
	else
	{
		...
		{
			if (bParam2)
				num = iParam1 - func_413(iParam0, false);
			else
				num = iParam1;
		
			num2 = func_414(iParam0) - func_412(iParam0);
		}
		else
		{
			if (bParam2)
			...
			num2 = func_414(iParam0) - func_413(iParam0, true);
		}
	
		if (!bParam4 && Global_1845250[PLAYER::PLAYER_ID() /*880*/] != 3)
			num2 = num2 - func_411(iParam0);
...
int func_411(int iParam0) // Position - 0x35D7C (220540)
{
	switch (iParam0)
	{
		case 0:
...
int func_412(int iParam0) // Position - 0x35DB6 (220598)
{
	switch (iParam0)
	{
		case 0:
...
int func_413(int iParam0, BOOL bParam1) // Position - 0x35DFC (220668)
{
	Player player;
...
int func_414(int iParam0) // Position - 0x35E99 (220825)
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_415(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x35ED9 (220889)
{
	return func_410(0, iParam0, true, bParam1, bParam2);
}

BOOL func_416(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x35EED (220909)
{
	return func_410(1, iParam0, true, bParam1, bParam2);
}

int func_417() // Position - 0x35F01 (220929)
{
	return iLocal_96;
}

int func_418(int iParam0) // Position - 0x35F0B (220939)
{
	return uLocal_286[iParam0 /*4*/];
}

void func_419() // Position - 0x35F1A (220954)
{
	Global_2699859 = iLocal_96;
	Global_2699859.f_1 = iLocal_96.f_180;
	Global_2699859.f_2 = iLocal_96.f_2.f_1[0 /*66*/].f_64;
	Global_2699859.f_3 = IS_BIT_SET(iLocal_96.f_2.f_1[0 /*66*/].f_65, 0);
	Global_2699859.f_4 = IS_BIT_SET(iLocal_96.f_2.f_1[0 /*66*/].f_65, 1);
	Global_2699859.f_5 = IS_BIT_SET(iLocal_96.f_2.f_1[0 /*66*/].f_65, 13);
	Global_2699859.f_6 = IS_BIT_SET(iLocal_96.f_2.f_1[0 /*66*/].f_65, 3);
	Global_2699859.f_7 = IS_BIT_SET(iLocal_96.f_2.f_1[0 /*66*/].f_65, 5);
	Global_2699859.f_8 = IS_BIT_SET(iLocal_96.f_1, 11);
	Global_2699859.f_9 = uLocal_286[NETWORK::PARTICIPANT_ID_TO_INT() /*4*/].f_3;
	return;
}

BOOL func_420(Player plParam0) // Position - 0x35FC1 (221121)
{
	return func_421(plParam0);
}

BOOL func_421(Player plParam0) // Position - 0x35FCF (221135)
{
	return IS_BIT_SET(Global_1845250[plParam0 /*880*/].f_11.f_1, 0);
}

BOOL func_422(Player plParam0) // Position - 0x35FE6 (221158)
{
	switch (func_423(plParam0))
	{
		case 20:
		case 21:
		case 24:
...
int func_423(Player plParam0) // Position - 0x36052 (221266)
{
	return Global_1845250[plParam0 /*880*/].f_185;
}

BOOL func_424(int iParam0) // Position - 0x36065 (221285)
{
	return !func_425(iParam0);
}

BOOL func_425(int iParam0) // Position - 0x36074 (221300)
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_426(int iParam0) // Position - 0x363A8 (222120)
{
	int i;
...
BOOL _SHOULD_NETWORK_SCRIPT_TERMINATE() // Position - 0x363EB (222187)
{
...
Hash _GET_CURRENT_SESSION_TYPE_SCRIPT_HASH() // Position - 0x3646F (222319)
{
	switch (func_124())
	{
		case 0:
...
Hash func_429() // Position - 0x364A2 (222370)
{
...
BOOL func_430() // Position - 0x364C6 (222406)
{
	return Global_2685150.f_700;
}

BOOL _DOES_EVENT_OF_TYPE_EXIST(int iParam0) // Position - 0x364D5 (222421)
{
...
BOOL func_432() // Position - 0x364EC (222444)
{
	return Global_2696964;
}

BOOL func_433() // Position - 0x364F8 (222456)
{
	return Global_2685150.f_695;
}

void func_434() // Position - 0x36507 (222471)
{
	BUILTIN::WAIT(0);
	return;
}

void func_435() // Position - 0x36514 (222484)
{
	int i;
	...
	if (bLocal_477)
		func_438(0f, 0f, 0f, func_439(31), true);
...
void func_436() // Position - 0x3665A (222810)
{
	SCRIPT::TERMINATE_THIS_THREAD();
	return;
}

BOOL _IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(char* message) // Position - 0x36666 (222822)
{
	HUD::BEGIN_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(message);
	return HUD::END_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(0);
}

void func_438(float fParam0, float fParam1, float fParam2, char* sParam3, BOOL bParam4) // Position - 0x36679 (222841)
{
	int i;
	...
	if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam3))
	{
		for (i = 0; i < 16; i = i + 1)
		{
			...
			{
				if (bParam4 || func_201(Global_2733002.f_3157[i /*26*/].f_1, fParam0, false))
				{
...
char* func_439(int iParam0) // Position - 0x36719 (223001)
{
	iParam0 == iParam0;
	return "";
}

void func_440(int iParam0, BOOL bParam1) // Position - 0x3672B (223019)
{
	if (bParam1)
...
void func_441(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18, var uParam19, var uParam20) // Position - 0x36788 (223112)
{
	func_446(32, uParam0);
	func_445(0, -1, false);
...
void func_442() // Position - 0x36812 (223250)
{
	int i;
	int endRange;
	int randomIntInRange;
	...
	if (Global_262145.f_66 >= 0 && Global_262145.f_66 < 32)
	{
		...
		switch (randomIntInRange)
		{
			...
			case 1:
				iLocal_96.f_2.f_68[0 /*104*/] = Global_262145.f_7207;
				break;
		
			case 2:
				iLocal_96.f_2.f_68[0 /*104*/] = Global_262145.f_7208;
				break;
		
			case 3:
				iLocal_96.f_2.f_68[0 /*104*/] = Global_262145.f_7209;
				break;
		
			case 4:
				iLocal_96.f_2.f_68[0 /*104*/] = Global_262145.f_7210;
				break;
		}
		...
		if (endRange > 1)
		{
			for (i = 0; i < 2; i = i + 1)
			{
				if (func_443(Global_2733002.f_206.f_25[i /*3*/], func_77(iLocal_96.f_2.f_68[0 /*104*/]), 50f, false))
				{
...
BOOL func_443(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, BOOL bParam7) // Position - 0x36B14 (224020)
{
	if (fParam6 < 0f)
		fParam6 = 0f;
...
BOOL _NETWORK_WAIT_FOR_HOST_BROADCAST_DATA() // Position - 0x36B8F (224143)
{
	int num;
...
int func_445(int iParam0, int iParam1, BOOL bParam2) // Position - 0x36BE8 (224232)
{
	int i;
...
void func_446(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18, var uParam19, var uParam20, var uParam21) // Position - 0x36CFE (224510)
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		func_436();
...
BOOL _NETWORK_IS_PLAYER_VALID(Player player, BOOL bIsPlaying, BOOL bUnk) // Position - 0x36D1D (224541)
{
	Player player;
