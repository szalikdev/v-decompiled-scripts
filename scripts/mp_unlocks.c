...
int func_1(var uParam0) // Position - 0x18B (395)
{
	...
	func_70(0, iLocal_169, false, true);
	func_69(1);
	num = 0;
	...
	switch (iLocal_169)
	{
		case 0:
			for (i = 0; i < 19; i = i + 1)
			{
				...
				func_47(&num, hash, hash2, func_50(num));
			}
			break;
...
BOOL func_8(int iParam0, int iParam1, int iParam2) // Position - 0x147D (5245)
{
	...
	hash = func_12(iParam0, iParam1);
	action = func_10(iParam0);
	return IS_BIT_SET(hash, func_9(action));
}
...
Hash func_12(int iParam0, int iParam1) // Position - 0x1B1C (6940)
{
	Hash hash;

	hash = func_13(func_17(iParam0), iParam1);
	return hash;
}

Hash func_13(int iParam0, int iParam1) // Position - 0x1B34 (6964)
{
	Hash statHash;
	int outValue;
...
BOOL func_29(Player plParam0, int iParam1) // Position - 0x1F46 (8006)
{
	...
	return func_30(&(Global_1845225[plParam0 /*874*/].f_815), func_31(iParam1));
}
...
void func_37(var uParam0, int iParam1, BOOL bParam2) // Position - 0x222A (8746)
{
	...
	if (!bParam2)
	{
		func_38(1, *uParam0, iLocal_164, *uParam0, "", iParam1);
		*uParam0 = *uParam0 + 1;
	}

	str = "PAUSEUNLRANK" /*RANK ~1~*/;
	func_38(1, *uParam0, iLocal_164, *uParam0, str, iParam1);
	*uParam0 = *uParam0 + 1;
	return;
}
...
void func_47(var uParam0, Hash hParam1, Hash hParam2, BOOL bParam3) // Position - 0x26FF (9983)
{
	var unk;
	...
	if (!bParam3)
		func_49(1, *uParam0, iLocal_164, *uParam0, &unk, "PM_UGEN_NUM" /*~1~/~1~*/, hParam1, hParam2);
	else
		func_48(1, *uParam0, iLocal_164, *uParam0, &unk, "NUMBR" /*~1~*/, hParam1);

	*uParam0 = *uParam0 + 1;
	return;
}

void func_48(int iParam0, int iParam1, int iParam2, int iParam3, char* sParam4, char* sParam5, Hash hParam6) // Position - 0x2753 (10067)
{
	if (GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD_ON_FRONTEND("SET_DATA_SLOT"))
	{
		GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(iParam0);
...
void func_49(int iParam0, int iParam1, int iParam2, int iParam3, char* sParam4, char* sParam5, Hash hParam6, Hash hParam7) // Position - 0x27A7 (10151)
{
	if (GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD_ON_FRONTEND("SET_DATA_SLOT"))
	{
		GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(iParam0);
		...
		GRAPHICS::BEGIN_TEXT_COMMAND_SCALEFORM_STRING(sParam5);
		HUD::ADD_TEXT_COMPONENT_INTEGER(hParam6);
		HUD::ADD_TEXT_COMPONENT_INTEGER(hParam7);
		GRAPHICS::END_TEXT_COMMAND_SCALEFORM_STRING();
		GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
	}
...
Hash func_54(int iParam0) // Position - 0x29E5 (10725)
{
	Hash hash;
...
Hash func_55() // Position - 0x2BDE (11230)
{
	int num;
...
Hash func_57() // Position - 0x2C82 (11394)
{
	int num;
...
Hash func_58() // Position - 0x2C9D (11421)
{
	int num;
...
Hash func_59() // Position - 0x2CB8 (11448)
{
	int num;
...
Hash func_60() // Position - 0x2CD3 (11475)
{
	int num;
...
Hash func_61() // Position - 0x2CF0 (11504)
{
	int num;
...
int func_62(Hash hParam0, BOOL bParam1) // Position - 0x2D2B (11563)
{
	bParam1;
	return func_63(hParam0, 0);
}

int func_63(Hash hParam0, int iParam1) // Position - 0x2D3F (11583)
{
	int i;
	int value;
	int value2;
	...
	for (i = 0; i <= 100; i = i + 1)
	{
		...
		if (func_64(num) == hParam0)
		{
			value = num;
			value2 = num;
		}
		else if (func_64(num) < hParam0)
		{
			if (value2 == num)
				value2 = value2 + 1;
			else
...
Hash func_64(int iParam0) // Position - 0x2DFA (11770)
{
	int num;
	int num2;
...
Hash func_65(Player plParam0, BOOL bParam1) // Position - 0x333E (13118)
{
	bParam1;
	return func_66(plParam0);
}

Hash func_66(Player plParam0) // Position - 0x3351 (13137)
{
...
BOOL func_67(Player plParam0) // Position - 0x33A8 (13224)
{
	if (!func_68(plParam0))
		return false;
...
BOOL func_68(Player plParam0) // Position - 0x33C7 (13255)
{
	Player player;
...
void func_69(int iParam0) // Position - 0x33E9 (13289)
{
...
void func_70(int iParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0x3406 (13318)
{
	if (iParam1 == -1)
		return;
...
void func_71() // Position - 0x343E (13374)
{
	var lastItemMenuId;
	...
	func_69(0);
	iLocal_169 = 0;
	func_73(0, 0, iLocal_163, 0, true, "PM_UL_D0" /*General*/, false, 0, false);
	func_73(0, 1, iLocal_163, 1, true, "PM_UL_D1" /*Progress*/, false, 0, false);
	func_73(0, 2, iLocal_163, 2, true, "PM_UL_D2" /*Content*/, false, 0, false);
	func_2(0);
	func_72(2);
	func_72(3);
	func_72(4);
...
void func_72(int iParam0) // Position - 0x34CA (13514)
{
	func_3(iParam0, false);
	return;
}

void func_73(int iParam0, int iParam1, int iParam2, int iParam3, BOOL bParam4, char* sParam5, BOOL bParam6, int iParam7, BOOL bParam8) // Position - 0x34D9 (13529)
{
	if (GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD_ON_FRONTEND("SET_DATA_SLOT"))
	{
		GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(iParam0);
...
BOOL func_74() // Position - 0x3553 (13651)
{
	int i;
...
BOOL func_75(eControlAction ecaParam0) // Position - 0x35FA (13818)
{
	eControlAction action;
	int num;
	int offset;
	...
	if (PAD::IS_CONTROL_JUST_RELEASED(FRONTEND_CONTROL, ecaParam0) || PAD::IS_DISABLED_CONTROL_JUST_RELEASED(FRONTEND_CONTROL, ecaParam0) || func_76(ecaParam0, &(Global_1673846.f_1060), 1))
	{
...
BOOL func_76(eControlAction ecaParam0, var uParam1, int iParam2) // Position - 0x368E (13966)
{
	int num;
	int num2;
	int num3;
...
void func_77() // Position - 0x37F1 (14321)
{
	int controlValue;
	...
	if (!PAD::IS_USING_KEYBOARD_AND_MOUSE(FRONTEND_CONTROL))
	{
		...
		if (controlValue > 180)
		{
			if (func_79(&uLocal_166, iLocal_168, false))
			{
				if (bLocal_170)
				{
...
void _STOPWATCH_DESTROY(var uParam0) // Position - 0x38AE (14510)
{
	uParam0->f_1 = 0;
	return;
}

BOOL func_79(var uParam0, int iParam1, BOOL bParam2) // Position - 0x38BB (14523)
{
	if (iParam1 == -1)
		return true;
...
void func_80(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0x3919 (14617)
{
	if (uParam0->f_1 == 0)
	{
...
BOOL func_81() // Position - 0x395E (14686)
{
	return MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION();
}

BOOL func_82() // Position - 0x3974 (14708)
{
