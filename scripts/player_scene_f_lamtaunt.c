...
void func_86(eCharacter echParam0, char* sParam1, BOOL bParam2, int iParam3) // Position - 0x37F7 (14327)
{
	eCharacter character;
...
int func_87(Player plParam0) // Position - 0x3892 (14482)
{
...
int func_109(int iParam0) // Position - 0x4A12 (18962)
{
	switch (iParam0)
	{
		case 0:
