...
BOOL func_57(var uParam0) // Position - 0x1EBD (7869)
{
	...
	for (i = 0; i < 10; i = i + 1)
	{
		if (ENTITY::DOES_ENTITY_EXIST(sizeAndPeds[i]) && !PED::IS_PED_INJURED(sizeAndPeds[i]) && ENTITY::IS_ENTITY_VISIBLE(sizeAndPeds[i]) && func_63(sizeAndPeds[i], &uParam0->[uParam0->f_141.f_2 /*14*/]) || BUILTIN::VDIST2(ENTITY::GET_ENTITY_COORDS(sizeAndPeds[i], false), (uParam0->[uParam0->f_141.f_2 /*14*/].f_1 + uParam0->[uParam0->f_141.f_2 /*14*/].f_1.f_3) / { 2f, 2f, 2f }) < 1f)
			return true;
	}
...
void func_85(int iParam0, var uParam1, int iParam2, int iParam3) // Position - 0x24B6 (9398)
{
	var unk;
	float num;
...
Vector3 func_86() // Position - 0x2531 (9521)
{
	return 0.5f, -0.5f, 2f;
}

Vector3 func_87(float fParam0, var uParam1, var uParam2, float fParam3) // Position - 0x2544 (9540)
{
	float num;
	float num2;
	float num3;
...
Vector3 func_88() // Position - 0x2588 (9608)
{
	return -0.5f, -0.5f, 0f;
}

void func_89(int iParam0, var uParam1, var uParam2) // Position - 0x259B (9627)
{
	if (func_12())
	{
		switch (iParam0)
...
void func_90() // Position - 0x283B (10299)
{
	return;
}

int func_91(int iParam0, int iParam1, BOOL bParam2) // Position - 0x2843 (10307)
{
	int i;
...
BOOL func_92(BOOL bParam0) // Position - 0x2959 (10585)
{
	bParam0;
