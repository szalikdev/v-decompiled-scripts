...
void func_3(Hash hParam0, int iParam1) // Position - 0xA38 (2616)
{
	func_9(hParam0, iParam1);
	func_8(hParam0, iParam1);
	func_7(hParam0, iParam1);
	func_6(hParam0, iParam1);
	func_5(hParam0, iParam1);
	func_4(hParam0, iParam1);
	return;
}

void func_4(Hash hParam0, int iParam1) // Position - 0xA70 (2672)
{
	var arrayName;

	TEXT_LABEL_ASSIGN_STRING(&arrayName, "g_SaveData_DATE_ScriptSaves", 32);
	TEXT_LABEL_APPEND_INT(&arrayName, iParam1, 32);
	MISC::START_SAVE_ARRAY_WITH_SIZE(&(hParam0->f_5544.f_19), 8, &arrayName);
	MISC::START_SAVE_STRUCT_WITH_SIZE(&hParam0->f_5544.f_19[0 /*7*/], 7, "TEMPSTAT_DATE");
	MISC::REGISTER_INT_TO_SAVE(&hParam0->f_5544.f_19[0 /*7*/], "TEMPSTAT_DATE.year");
	MISC::REGISTER_INT_TO_SAVE(&(hParam0->f_5544.f_19[0 /*7*/].f_1), "TEMPSTAT_DATE.month");
	MISC::REGISTER_INT_TO_SAVE(&(hParam0->f_5544.f_19[0 /*7*/].f_2), "TEMPSTAT_DATE.day");
	MISC::REGISTER_INT_TO_SAVE(&(hParam0->f_5544.f_19[0 /*7*/].f_3), "TEMPSTAT_DATE.hour");
	MISC::REGISTER_INT_TO_SAVE(&(hParam0->f_5544.f_19[0 /*7*/].f_4), "TEMPSTAT_DATE.minute");
	MISC::REGISTER_INT_TO_SAVE(&(hParam0->f_5544.f_19[0 /*7*/].f_5), "TEMPSTAT_DATE.seconds");
	MISC::REGISTER_INT_TO_SAVE(&(hParam0->f_5544.f_19[0 /*7*/].f_6), "TEMPSTAT_DATE.Milliseconds");
	MISC::STOP_SAVE_STRUCT();
	MISC::STOP_SAVE_ARRAY();
	return;
}

void func_5(Hash hParam0, int iParam1) // Position - 0xB3A (2874)
{
	var arrayName;

	TEXT_LABEL_ASSIGN_STRING(&arrayName, "g_SaveData_VECTOR_ScriptSaves", 32);
	TEXT_LABEL_APPEND_INT(&arrayName, iParam1, 32);
	MISC::START_SAVE_ARRAY_WITH_SIZE(&(hParam0->f_5544.f_15), 4, &arrayName);
	MISC::START_SAVE_STRUCT_WITH_SIZE(&hParam0->f_5544.f_15[0 /*3*/], 3, "TEMPSTAT_VEC");
	MISC::REGISTER_FLOAT_TO_SAVE(&hParam0->f_5544.f_15[0 /*3*/], "TEMPSTAT_VEC.x");
	MISC::REGISTER_FLOAT_TO_SAVE(&(hParam0->f_5544.f_15[0 /*3*/].f_1), "TEMPSTAT_VEC.y");
	MISC::REGISTER_FLOAT_TO_SAVE(&(hParam0->f_5544.f_15[0 /*3*/].f_2), "TEMPSTAT_VEC.z");
	MISC::STOP_SAVE_STRUCT();
	MISC::STOP_SAVE_ARRAY();
	return;
}

void func_6(Hash hParam0, int iParam1) // Position - 0xBB3 (2995)
{
	var arrayName;

	TEXT_LABEL_ASSIGN_STRING(&arrayName, "g_SaveData_STRING_ScriptSaves", 32);
	TEXT_LABEL_APPEND_INT(&arrayName, iParam1, 32);
	MISC::START_SAVE_ARRAY_WITH_SIZE(&(hParam0->f_5544.f_6), 9, &arrayName);
	MISC::REGISTER_TEXT_LABEL_31_TO_SAVE(&hParam0->f_5544.f_6[0 /*8*/], "TEMPSTAT_LABEL");
	MISC::STOP_SAVE_ARRAY();
	return;
}

void func_7(Hash hParam0, int iParam1) // Position - 0xBEE (3054)
{
	var arrayName;

	TEXT_LABEL_ASSIGN_STRING(&arrayName, "g_SaveData_BOOL_ScriptSaves", 32);
	TEXT_LABEL_APPEND_INT(&arrayName, iParam1, 32);
	MISC::START_SAVE_ARRAY_WITH_SIZE(&(hParam0->f_5544.f_4), 2, &arrayName);
	MISC::REGISTER_BOOL_TO_SAVE(&hParam0->f_5544.f_4[0], "TEMPSTAT_BOOL");
	MISC::STOP_SAVE_ARRAY();
	return;
}

void func_8(Hash hParam0, int iParam1) // Position - 0xC28 (3112)
{
	var arrayName;

	TEXT_LABEL_ASSIGN_STRING(&arrayName, "g_SaveData_FLOAT_ScriptSaves", 32);
	TEXT_LABEL_APPEND_INT(&arrayName, iParam1, 32);
	MISC::START_SAVE_ARRAY_WITH_SIZE(&(hParam0->f_5544.f_2), 2, &arrayName);
	MISC::REGISTER_FLOAT_TO_SAVE(&hParam0->f_5544.f_2[0], "TEMPSTAT_FLOAT");
	MISC::STOP_SAVE_ARRAY();
	return;
}

void func_9(Hash hParam0, int iParam1) // Position - 0xC62 (3170)
{
	var arrayName;

	TEXT_LABEL_ASSIGN_STRING(&arrayName, "g_SaveData_INT_ScriptSaves", 32);
	TEXT_LABEL_APPEND_INT(&arrayName, iParam1, 32);
	MISC::START_SAVE_ARRAY_WITH_SIZE(&(hParam0->f_5544), 2, &arrayName);
	MISC::REGISTER_INT_TO_SAVE(&hParam0->f_5544[0], "TEMPSTAT_INT1");
	MISC::STOP_SAVE_ARRAY();
	return;
}

void func_10(Hash hParam0, int iParam1) // Position - 0xC98 (3224)
{
	var structName;
	int i;
	var arrayName;
	...
	MISC::START_SAVE_STRUCT_WITH_SIZE(&(hParam0->f_5394), 150, &structName);
	MISC::REGISTER_INT_TO_SAVE(&(hParam0->f_5394), "MPATM_CARET_");
	i = 0;
	TEXT_LABEL_ASSIGN_STRING(&arrayName, "MPATMLOGVAL", 16);
	MISC::START_SAVE_ARRAY_WITH_SIZE(&(hParam0->f_5394.f_1), 17, &arrayName);

	for (i = 0; i < 16; i = i + 1)
	{
		name = { arrayName };
		TEXT_LABEL_APPEND_INT(&name, i, 16);
		MISC::REGISTER_INT_TO_SAVE(&hParam0->f_5394.f_1[i], &name);
	}

	MISC::STOP_SAVE_ARRAY();
	TEXT_LABEL_ASSIGN_STRING(&arrayName, "MPATMLOGSCRS", 16);
	MISC::START_SAVE_ARRAY_WITH_SIZE(&(hParam0->f_5394.f_18), 97, &arrayName);

	for (i = 0; i < 16; i = i + 1)
	{
		name2 = { arrayName };
		TEXT_LABEL_APPEND_INT(&name2, i, 16);
		MISC::REGISTER_TEXT_LABEL_23_TO_SAVE(&hParam0->f_5394.f_18[i /*6*/], &name2);
	}

	MISC::STOP_SAVE_ARRAY();
	TEXT_LABEL_ASSIGN_STRING(&arrayName, "MPATMLOGACT", 16);
	MISC::START_SAVE_ARRAY_WITH_SIZE(&(hParam0->f_5394.f_115), 17, &arrayName);

	for (i = 0; i < 16; i = i + 1)
	{
		name3 = { arrayName };
		TEXT_LABEL_APPEND_INT(&name3, i, 16);
		MISC::REGISTER_ENUM_TO_SAVE(&hParam0->f_5394.f_115[i], &name3);
	}

	MISC::STOP_SAVE_ARRAY();
	TEXT_LABEL_ASSIGN_STRING(&arrayName, "MPATMLOGDAT", 16);
	MISC::START_SAVE_ARRAY_WITH_SIZE(&(hParam0->f_5394.f_132), 17, &arrayName);

	for (i = 0; i < 16; i = i + 1)
	{
		name4 = { arrayName };
		TEXT_LABEL_APPEND_INT(&name4, i, 16);
		MISC::REGISTER_INT_TO_SAVE(&hParam0->f_5394.f_132[i], &name4);
	}

	MISC::STOP_SAVE_ARRAY();
	MISC::REGISTER_BOOL_TO_SAVE(&(hParam0->f_5394.f_149), "mpAnyVecBought");
	MISC::STOP_SAVE_STRUCT();
	return;
}

void func_11(Hash hParam0, int iParam1) // Position - 0xE12 (3602)
{
	var structName;
	var name;
	int i;
	...
	TEXT_LABEL_APPEND_INT(&structName, iParam1, 24);
	MISC::START_SAVE_STRUCT_WITH_SIZE(&(hParam0->f_5153), 241, &structName);
	MISC::REGISTER_INT64_TO_SAVE(&(hParam0->f_5153), "BOUNTY_GAMERH64_1");
	MISC::REGISTER_INT64_TO_SAVE(&(hParam0->f_5153.f_1), "BOUNTY_GAMERH64_2");
	MISC::REGISTER_INT64_TO_SAVE(&(hParam0->f_5153.f_2), "BOUNTY_GAMERH64_3");
	MISC::REGISTER_INT64_TO_SAVE(&(hParam0->f_5153.f_3), "BOUNTY_GAMERH64_4");
	MISC::REGISTER_INT64_TO_SAVE(&(hParam0->f_5153.f_4), "BOUNTY_GAMERH64_5");
	MISC::REGISTER_INT64_TO_SAVE(&(hParam0->f_5153.f_5), "BOUNTY_GAMERH64_6");
	MISC::REGISTER_INT64_TO_SAVE(&(hParam0->f_5153.f_6), "BOUNTY_GAMERH64_7");
	MISC::REGISTER_INT64_TO_SAVE(&(hParam0->f_5153.f_7), "BOUNTY_GAMERH64_8");
	MISC::REGISTER_INT64_TO_SAVE(&(hParam0->f_5153.f_8), "BOUNTY_GAMERH64_9");
	MISC::REGISTER_INT64_TO_SAVE(&(hParam0->f_5153.f_9), "BOUNTY_GAMERH64_10");
	MISC::REGISTER_INT64_TO_SAVE(&(hParam0->f_5153.f_10), "BOUNTY_GAMERH64_11");
	MISC::REGISTER_INT64_TO_SAVE(&(hParam0->f_5153.f_11), "BOUNTY_GAMERH64_12");
	MISC::REGISTER_INT64_TO_SAVE(&(hParam0->f_5153.f_12), "BOUNTY_GAMERH64_13");
	MISC::REGISTER_INT_TO_SAVE(&(hParam0->f_5153.f_13), "BOUNTY_TIME");
	MISC::REGISTER_INT_TO_SAVE(&(hParam0->f_5153.f_14), "BOUNTY_VALUE");
	TEXT_LABEL_APPEND_STRING(&structName, "_GH", 24);
	MISC::START_SAVE_ARRAY_WITH_SIZE(&(hParam0->f_5153.f_15), 209, &structName);
	...
	for (i = 0; i < 16; i = i + 1)
	{
		...
		MISC::REGISTER_INT64_TO_SAVE(&hParam0->f_5153.f_15[i /*13*/], &name);
		TEXT_LABEL_COPY(&name, { structName }, 8);
		TEXT_LABEL_APPEND_STRING(&name, "64_", 32);
		TEXT_LABEL_APPEND_INT(&name, i, 32);
		TEXT_LABEL_APPEND_STRING(&name, "_2", 32);
		MISC::REGISTER_INT64_TO_SAVE(&(hParam0->f_5153.f_15[i /*13*/].f_1), &name);
		TEXT_LABEL_COPY(&name, { structName }, 8);
		TEXT_LABEL_APPEND_STRING(&name, "64_", 32);
		TEXT_LABEL_APPEND_INT(&name, i, 32);
		TEXT_LABEL_APPEND_STRING(&name, "_3", 32);
		MISC::REGISTER_INT64_TO_SAVE(&(hParam0->f_5153.f_15[i /*13*/].f_2), &name);
		TEXT_LABEL_COPY(&name, { structName }, 8);
		TEXT_LABEL_APPEND_STRING(&name, "64_", 32);
		TEXT_LABEL_APPEND_INT(&name, i, 32);
		TEXT_LABEL_APPEND_STRING(&name, "_4", 32);
		MISC::REGISTER_INT64_TO_SAVE(&(hParam0->f_5153.f_15[i /*13*/].f_3), &name);
		TEXT_LABEL_COPY(&name, { structName }, 8);
		TEXT_LABEL_APPEND_STRING(&name, "64_", 32);
		TEXT_LABEL_APPEND_INT(&name, i, 32);
		TEXT_LABEL_APPEND_STRING(&name, "_5", 32);
		MISC::REGISTER_INT64_TO_SAVE(&(hParam0->f_5153.f_15[i /*13*/].f_4), &name);
		TEXT_LABEL_COPY(&name, { structName }, 8);
		TEXT_LABEL_APPEND_STRING(&name, "64_", 32);
		TEXT_LABEL_APPEND_INT(&name, i, 32);
		TEXT_LABEL_APPEND_STRING(&name, "_6", 32);
		MISC::REGISTER_INT64_TO_SAVE(&(hParam0->f_5153.f_15[i /*13*/].f_5), &name);
		TEXT_LABEL_COPY(&name, { structName }, 8);
		TEXT_LABEL_APPEND_STRING(&name, "64_", 32);
		TEXT_LABEL_APPEND_INT(&name, i, 32);
		TEXT_LABEL_APPEND_STRING(&name, "_7", 32);
		MISC::REGISTER_INT64_TO_SAVE(&(hParam0->f_5153.f_15[i /*13*/].f_6), &name);
		TEXT_LABEL_COPY(&name, { structName }, 8);
		TEXT_LABEL_APPEND_STRING(&name, "64_", 32);
		TEXT_LABEL_APPEND_INT(&name, i, 32);
		TEXT_LABEL_APPEND_STRING(&name, "_8", 32);
		MISC::REGISTER_INT64_TO_SAVE(&(hParam0->f_5153.f_15[i /*13*/].f_7), &name);
		TEXT_LABEL_COPY(&name, { structName }, 8);
		TEXT_LABEL_APPEND_STRING(&name, "64_", 32);
		TEXT_LABEL_APPEND_INT(&name, i, 32);
		TEXT_LABEL_APPEND_STRING(&name, "_9", 32);
		MISC::REGISTER_INT64_TO_SAVE(&(hParam0->f_5153.f_15[i /*13*/].f_8), &name);
		TEXT_LABEL_COPY(&name, { structName }, 8);
		TEXT_LABEL_APPEND_STRING(&name, "64_", 32);
		TEXT_LABEL_APPEND_INT(&name, i, 32);
		TEXT_LABEL_APPEND_STRING(&name, "_10", 32);
		MISC::REGISTER_INT64_TO_SAVE(&(hParam0->f_5153.f_15[i /*13*/].f_9), &name);
		TEXT_LABEL_COPY(&name, { structName }, 8);
		TEXT_LABEL_APPEND_STRING(&name, "64_", 32);
		TEXT_LABEL_APPEND_INT(&name, i, 32);
		TEXT_LABEL_APPEND_STRING(&name, "_11", 32);
		MISC::REGISTER_INT64_TO_SAVE(&(hParam0->f_5153.f_15[i /*13*/].f_10), &name);
		TEXT_LABEL_COPY(&name, { structName }, 8);
		TEXT_LABEL_APPEND_STRING(&name, "64_", 32);
		TEXT_LABEL_APPEND_INT(&name, i, 32);
		TEXT_LABEL_APPEND_STRING(&name, "_12", 32);
		MISC::REGISTER_INT64_TO_SAVE(&(hParam0->f_5153.f_15[i /*13*/].f_11), &name);
		TEXT_LABEL_COPY(&name, { structName }, 8);
		TEXT_LABEL_APPEND_STRING(&name, "64_", 32);
		TEXT_LABEL_APPEND_INT(&name, i, 32);
		TEXT_LABEL_APPEND_STRING(&name, "_13", 32);
		MISC::REGISTER_INT64_TO_SAVE(&(hParam0->f_5153.f_15[i /*13*/].f_12), &name);
	}
	...
	MISC::START_SAVE_ARRAY_WITH_SIZE(&(hParam0->f_5153.f_224), 17, &structName);

	for (i = 0; i < 16; i = i + 1)
	{
		TEXT_LABEL_COPY(&name, { structName }, 8);
		TEXT_LABEL_APPEND_INT(&name, i, 32);
		MISC::REGISTER_INT_TO_SAVE(&hParam0->f_5153.f_224[i], &name);
	}
...
void func_14(Hash hParam0, int iParam1) // Position - 0x23F8 (9208)
{
	func_15(&(hParam0->f_593), iParam1);
	return;
}
...
void func_17(Hash hParam0, int iParam1) // Position - 0x277C (10108)
{
	var unk;

	TEXT_LABEL_ASSIGN_STRING(&unk, "MP_PROPERTY_SAVED", 24);
	TEXT_LABEL_APPEND_INT(&unk, iParam1, 24);
	func_18(&(hParam0->f_7), &unk);
	return;
}
...
void func_19(Hash hParam0, int iParam1) // Position - 0x2B2C (11052)
{
	var unk;
...
void func_20(Hash hParam0, const char* sParam1) // Position - 0x2B4A (11082)
{
	int i;
	var name;

	MISC::START_SAVE_STRUCT_WITH_SIZE(hParam0, 7, sParam1);
	MISC::REGISTER_INT_TO_SAVE(hParam0, "BAV_Timestamp");
	MISC::START_SAVE_ARRAY_WITH_SIZE(&(hParam0->f_1), 6, "B_A_V_BS_ID");

	for (i = 0; i < 5; i = i + 1)
	{
		TEXT_LABEL_ASSIGN_STRING(&name, "B_A_V_BS_ID", 16);
		TEXT_LABEL_APPEND_INT(&name, i, 16);
		MISC::REGISTER_INT_TO_SAVE(&hParam0->f_1[i], &name);
	}
...
void func_23() // Position - 0x2C1C (11292)
{
	...
	if (outValue >= 0 && outValue2 >= 0 && outValue3 >= 0)
		Global_114344.f_668.f_1316 = Global_114344.f_668.f_1316 - outValue;
...
void func_24() // Position - 0x2C7B (11387)
{
	...
	for (i = 0; i < 3; i = i + 1)
	{
		...
		{
			if (IS_BIT_SET(Global_114344.f_25186[j], i))
			{
				MISC::CLEAR_BIT(&Global_114344.f_25186[j], i);
				num = j + (198 - 171) + 1;
				MISC::SET_BIT(&Global_114344.f_25186[num], i);
			}
		}
	}
...
void func_29(int iParam0, int iParam1) // Position - 0x2E8A (11914)
{
	...
	unk = { Global_114344.f_10198[iParam0 /*12*/] };
	num = Global_114344.f_10198[iParam0 /*12*/].f_4;
	flag = Global_114344.f_10198[iParam0 /*12*/].f_5;
	num2 = Global_114344.f_10198[iParam0 /*12*/].f_6;
	unk5 = Global_114344.f_10198[iParam0 /*12*/].f_7;
	unk6 = Global_114344.f_10198[iParam0 /*12*/].f_8;
	unk7 = Global_114344.f_10198[iParam0 /*12*/].f_9;
	unk8 = Global_114344.f_10198[iParam0 /*12*/].f_10;
	unk9 = Global_114344.f_10198[iParam0 /*12*/].f_11;
	...
	Global_114344.f_10198[iParam1 /*12*/] = { unk };
	Global_114344.f_10198[iParam1 /*12*/].f_4 = num;
	Global_114344.f_10198[iParam1 /*12*/].f_5 = flag;
	Global_114344.f_10198[iParam1 /*12*/].f_6 = num2;
	Global_114344.f_10198[iParam1 /*12*/].f_7 = unk5;
	Global_114344.f_10198[iParam1 /*12*/].f_8 = unk6;
	Global_114344.f_10198[iParam1 /*12*/].f_9 = unk7;
	Global_114344.f_10198[iParam1 /*12*/].f_10 = unk8;
	Global_114344.f_10198[iParam1 /*12*/].f_11 = unk9;
	return;
}
...
void func_30() // Position - 0x308E (12430)
{
	...
	for (i = 0; i < 16; i = i + 1)
	{
		if (!func_31(Global_114344.f_24908[i /*4*/]))
			if (Global_114344.f_24908[i /*4*/] != _CHAR_NULL)
				Global_114344.f_24908[i /*4*/] = _CHAR_NULL;
	}
...
int func_74() // Position - 0x22D64 (142692)
{
	int outValue;
	int outValue2;
	Hash statHash;
...
int _IS_EXCLUSIVE_CONTENT_UNLOCKED() // Position - 0x22E9D (143005)
{
	int profileSetting;
...
BOOL _NETSHOPPING_SHOULD_USE_TRANSACTION_SYSTEM() // Position - 0x22F55 (143189)
{
...
void func_77() // Position - 0x22F6C (143212)
{
	int i;
	BOOL flag;
	int address;
...
BOOL func_78(int iParam0) // Position - 0x22FF2 (143346)
{
	switch (iParam0)
	{
		case 8:
...
BOOL func_79(int iParam0, int iParam1) // Position - 0x23015 (143381)
{
	switch (iParam0)
	{
		case 12:
...
Hash func_80(int iParam0) // Position - 0x23051 (143441)
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_81() // Position - 0x23125 (143653)
{
...
void func_82(int iParam0) // Position - 0x2315A (143706)
{
	int i;
