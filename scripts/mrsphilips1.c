...
BOOL func_32(Ped pedParam0, int iParam1, Hash hParam2) // Position - 0x1537 (5431)
{
	Hash entityModel;
	int i;
	var unk;
...
int func_35(Ped pedParam0, int iParam1, Hash hParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0x17D0 (6096)
{
	int i;
	int j;
	int k;
...
void func_36(Hash hParam0, int iParam1, Hash hParam2) // Position - 0x1FE1 (8161)
{
	Hash hash;
	int num;
...
BOOL func_37(Hash hParam0, int iParam1, Hash hParam2) // Position - 0x206B (8299)
{
	if (hParam0 == joaat("Player_Zero"))
		if (iParam1 == 4)
...
BOOL func_38(Hash hParam0, int iParam1, Hash hParam2) // Position - 0x2149 (8521)
{
	Global_79527[1 /*14*/] = { func_85(hParam0, iParam1, hParam2, -1) };
	return IS_BIT_SET(Global_79527[1 /*14*/].f_6, 2);
}

BOOL func_39(Hash hParam0, Hash hParam1, int iParam2, Hash hParam3, var uParam4, int iParam5) // Position - 0x2171 (8561)
{
	var unk;
	int i;
...
BOOL func_40(Hash hParam0, int iParam1, Hash hParam2) // Position - 0x2775 (10101)
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
Hash func_41(Ped pedParam0, int iParam1, ePedComponentType epctParam2) // Position - 0x280E (10254)
{
	Hash i;
	Hash j;
...
int func_42(Hash hParam0, int iParam1, Hash hParam2, var uParam3) // Position - 0x28AF (10415)
{
	int num;
...
Hash func_43(Ped pedParam0, Hash hParam1, int iParam2, Hash hParam3, int iParam4, int iParam5) // Position - 0x2BB6 (11190)
{
	Hash hash;
	Hash hash2;
	Hash hash3;
...
BOOL func_44(int iParam0, Hash hParam1, Hash hParam2, Hash hParam3, var uParam4) // Position - 0x3769 (14185)
{
	int num;
...
Hash func_45(Hash hParam0, Hash hParam1, Hash hParam2, int iParam3) // Position - 0x3A4D (14925)
{
	int num;
...
Hash func_46(Hash hParam0, int iParam1, int iParam2, int iParam3) // Position - 0x3D14 (15636)
{
	Hash i;
	Hash hash;
...
BOOL func_47(Ped pedParam0, int iParam1, Hash hParam2, Hash hParam3) // Position - 0x3D4B (15691)
{
	Hash hash;
...
BOOL func_48(Hash hParam0, Hash hParam1, var uParam2) // Position - 0x3D74 (15732)
{
	*uParam2 = -99;
...
int func_49(Hash hParam0, int iParam1, Hash hParam2, var uParam3) // Position - 0x403F (16447)
{
	int num;
...
Hash func_50(Hash hParam0, Hash hParam1, Hash hParam2) // Position - 0x42C9 (17097)
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
void func_51(Ped pedParam0, ePedComponentType epctParam1, Hash hParam2, Hash hParam3) // Position - 0x4420 (17440)
{
	Hash hash;
...
BOOL func_52(Hash hParam0, int iParam1, Hash hParam2, Hash hParam3) // Position - 0x44BA (17594)
{
	switch (hParam0)
	{
...
Hash func_53(Hash hParam0, Hash hParam1, int iParam2, int iParam3) // Position - 0x4588 (17800)
{
	var outProp;
	int componentId;
	int num;
...
Hash func_56(Ped pedParam0, Hash hParam1, Hash hParam2, ePedComponentType epctParam3) // Position - 0x4AAA (19114)
{
	Hash entityModel;
...
BOOL func_61(Hash hParam0, int iParam1, Hash hParam2, Hash hParam3) // Position - 0x4E84 (20100)
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
BOOL func_62(Hash hParam0, int iParam1, Hash hParam2, Hash hParam3) // Position - 0x5101 (20737)
{
	if (hParam0 == joaat("Player_Zero"))
	{
		if (iParam1 == 6)
...
BOOL func_63(Hash hParam0, int iParam1, Hash hParam2, Hash hParam3) // Position - 0x5526 (21798)
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
Hash func_64(Ped pedParam0, ePedComponentType epctParam1) // Position - 0x5819 (22553)
{
	int pedPropIndex;
...
Hash func_65(Ped pedParam0, int iParam1) // Position - 0x5860 (22624)
{
...
BOOL func_150(Ped pedParam0, int iParam1, Hash hParam2) // Position - 0x1FA46 (129606)
{
	Hash entityModel;
	Hash hash;
	int i;
	...
	if (Global_79999 != 6)
	{
		...
		else
		{
			...
			if (value < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				text = { func_241(Global_80000, Global_80002, iParam10) };
				y == -0.014f;
...
int func_276() // Position - 0x28D76 (167286)
{
	...
	num = func_277(&(Global_101893.f_3), false);
	num2 = 0;
