	...
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && MISC::GET_GAME_TIMER() - iLocal_55 > 2000 || NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && NETWORK::IS_TIME_MORE_THAN(NETWORK::GET_NETWORK_TIME(), NETWORK::GET_TIME_OFFSET(iLocal_56, 2000)) || bLocal_58)
	{
		...
		for (j = 0; j < num3; j = j + 1)
		{
			...
			if (func_59(echLocal_57, num2, outValue, &value))
			{
				...
				{
					if (Global_114344.f_2367.f_539.f_2387[echLocal_57] == 0)
						flag2 = false;
				...
				if (value > func_55(echLocal_57, num2, -1))
				{
					...
					hash2 = value;
					hash3 = hash2 - (hash2 % func_53(echLocal_57, num2));
				
					if (hash2 % func_53(echLocal_57, num2) >= 0)
						hash3 = hash3 + func_53(echLocal_57, num2);
				
					if (hash2 >= hash3)
						hash2 = hash3;
					else
						hash2 = hash3 - func_53(echLocal_57, num2);
...
{
	if (func_50(plParam0))
		if (func_50(Global_1888737[plParam0 /*611*/].f_10))
...
Hash func_55(eCharacter echParam0, int iParam1, int iParam2) // Position - 0x1533 (5427)
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		if (func_56(14))
			return 100;
...
void func_57(int iParam0, Hash hParam1, int iParam2, BOOL bParam3) // Position - 0x1787 (6023)
{
	Hash statName;
...
BOOL func_59(eCharacter echParam0, int iParam1, Hash hParam2, var uParam3) // Position - 0x17CA (6090)
{
...
Hash func_60(eCharacter echParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0x17EC (6124)
{
	float value;
	float outValue;
	Hash hash;
	...
	if (iParam1 != 0)
	{
		hash2 = func_55(echParam0, iParam1, iParam3);
		value = value + (float)hash2;
	...
	hash = BUILTIN::FLOOR(value);
	hash = func_72(hash, 0, 100);
	return hash;
}

Hash func_61(eCharacter echParam0, int iParam1, int iParam2) // Position - 0x250F (9487)
{
	switch (echParam0)
	{
		case CHAR_MICHAEL:
...
Hash func_72(Hash hParam0, int iParam1, int iParam2) // Position - 0x27C8 (10184)
{
	if (hParam0 > iParam2)
		return iParam2;
...
Hash func_73(int iParam0, int iParam1) // Position - 0x27ED (10221)
{
	Hash statHash;
	int outValue;
...
void func_93() // Position - 0x3628 (13864)
{
	...
	if (bLocal_60)
	{
		...
		HUD::ADD_TEXT_COMPONENT_INTEGER(hLocal_64);
		HUD::END_TEXT_COMMAND_THEFEED_POST_STATS(func_95(iLocal_62), func_94(iLocal_62), bLocal_63, hLocal_64 - bLocal_63, false, pedheadshotTxdString, pedheadshotTxdString);
		bLocal_81 = true;
