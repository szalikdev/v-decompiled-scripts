			...
			if (func_6(num, &animName, &unk36, &any))
				if (func_4(num, &animDict, &unk67, &unk83, &unk99, &unk100))
					if (!ENTITY::IS_ENTITY_PLAYING_ANIM(*pobParam0, &animDict, &animName, 2))
						ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(*pobParam0, Global_99198, &animName, &animDict, 1000f, -8f, any, 1148846080);
...
void func_17(Ped pedParam0, Cam caParam1, int iParam2, int iParam3, int iParam4) // Position - 0x2671 (9841)
{
	...
	if (!func_34(pedParam0))
	{
		...
		if (num3 == -1)
		{
			...
			if (!(num4 == -1))
				Global_45376[num4 /*5*/].f_4 = Global_45376[num4 /*5*/].f_4 + iParam2;
		}
	}
	else
	{
		...
		if (num5 == -1)
		{
			...
			if (!(num6 == -1))
				Global_45376[num6 /*5*/].f_4 = Global_45376[num6 /*5*/].f_4 + iParam2;
		}
		...
		{
			Global_45557 = Global_45557 + num2;
			func_24(pedParam0, num2);
		}
	}

	Global_45563 = 0.25f;
	TEXT_LABEL_ASSIGN_STRING(&Global_45564, func_23(iParam3), 16);
...
void func_19(int iParam0, int iParam1, int iParam2, Ped pedParam3, int iParam4, int iParam5) // Position - 0x27FF (10239)
{
	...
	Global_45457[num /*6*/].f_3 = pedParam3;
...
void func_24(Ped pedParam0, int iParam1) // Position - 0x2946 (10566)
{
	...
	if (num == -1)
	{
		...
		if (!(num2 == -1))
		{
			Global_45345[num2 /*6*/].f_3 = Global_45345[num2 /*6*/].f_3 + iParam1;
			Global_45345[num2 /*6*/].f_2 = Global_45345[num2 /*6*/].f_2 + iParam1;
		}
...
void func_29(int iParam0, int iParam1, float fParam2, float fParam3, Cam caParam4, BOOL bParam5) // Position - 0x2A7D (10877)
{
	...
	Global_45557 = gameTimer + iParam0;
...
int func_36(Ped pedParam0) // Position - 0x2D5A (11610)
{
	...
	return Global_45376[num2 /*5*/].f_4;
}
...
void func_43() // Position - 0x302F (12335)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (_GET_CHARACTER_MODEL(Global_114344.f_2367.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_44(character) && !func_48(14) || Global_113292)
			{
	...
	switch (iParam0)
	{
		...
		case 5:
			*uParam1 = Global_114344.f_2367.f_539.f_2310[0];
			TEXT_LABEL_ASSIGN_STRING(sParam2, func_65(Global_114344.f_2367.f_539.f_2314[0]), 32);
			return true;
	
		case 6:
			*uParam1 = Global_114344.f_2367.f_539.f_2310[1];
			TEXT_LABEL_ASSIGN_STRING(sParam2, func_65(Global_114344.f_2367.f_539.f_2314[1]), 32);
			return true;
	
		case 7:
			*uParam1 = Global_114344.f_2367.f_539.f_2310[2];
			TEXT_LABEL_ASSIGN_STRING(sParam2, func_65(Global_114344.f_2367.f_539.f_2314[2]), 32);
			return true;
