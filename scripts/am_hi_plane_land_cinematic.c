...
void func_299() // Position - 0x354B5 (218293)
{
	...
	func_300(&uLocal_120, 3967.4226f, -4685.0845f, 11.7691f, -1.6326f, 0.4627f, -70.7491f, "HS4_NIMB_LSA_ISD_REPEAT", 1, 1, 3, 0);
	return;
}

void func_300(var uParam0, float fParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6, char* sParam7, int iParam8, int iParam9, int iParam10, int iParam11) // Position - 0x354FF (218367)
{
...
void func_301(var uParam0, char* sParam1, int iParam2, int iParam3, int iParam4) // Position - 0x3552F (218415)
{
	uParam0->f_1 = sParam1;
	uParam0->f_2 = iParam3;
...
void func_302(var uParam0, int iParam1, char* sParam2) // Position - 0x3555C (218460)
{
