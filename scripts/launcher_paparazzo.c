	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (num != -1)
		{
			if (Global_113991[num /*10*/].f_9 != -1)
			{
				...
				func_295(&(Global_113991[num /*10*/].f_9));
			}
		}
...
Vector3 func_97(ePedComponentType epctParam0, int iParam1) // Position - 0x89A9 (35241)
{
	switch (iParam1)
	{
		case 0:
...
int func_98() // Position - 0x8B39 (35641)
{
	return func_99(PLAYER::PLAYER_ID());
}

int func_99(Player plParam0) // Position - 0x8B49 (35657)
{
	return MISC::GET_BITS_IN_RANGE(Global_2658291[plParam0 /*468*/].f_325.f_3, 28, 31);
}

BOOL func_100(int iParam0) // Position - 0x8B66 (35686)
{
	return func_74(iParam0, 0, false);
}

int func_101(int iParam0) // Position - 0x8B76 (35702)
{
	switch (iParam0)
	{
		case -1:
...
BOOL func_102() // Position - 0x8EE0 (36576)
{
	return Global_102481.f_417 > 0;
}

var func_103() // Position - 0x8EF1 (36593)
{
	var unk;
...
void func_104(var uParam0, int iParam1) // Position - 0x8F37 (36663)
{
	if (iParam1 <= 0)
		return;
...
void func_105(var uParam0, int iParam1) // Position - 0x8FBD (36797)
{
...
void func_106(var uParam0, int iParam1) // Position - 0x8FF0 (36848)
{
	int num;
	int num2;
...
int func_107(int iParam0, int iParam1) // Position - 0x9041 (36929)
{
	if (iParam1 < 0)
		iParam1 = 0;
...
int func_108(int iParam0) // Position - 0x90E3 (37091)
{
	return (BUILTIN::SHIFT_RIGHT(iParam0, 26) & 31 * IS_BIT_SET(iParam0, 31) ? -1 : 1) + 2011;
}

var func_109(BOOL bParam0, var uParam1, var uParam2) // Position - 0x9105 (37125)
{
	if (bParam0)
		return uParam1;
...
int func_110(int iParam0) // Position - 0x911C (37148)
{
	return iParam0 & 15;
}

void func_111(var uParam0, int iParam1) // Position - 0x9129 (37161)
{
...
void func_112(var uParam0, int iParam1) // Position - 0x9163 (37219)
{
...
void func_113(var uParam0, int iParam1) // Position - 0x919E (37278)
{
	if (iParam1 < 0 || iParam1 >= 60)
		return;
...
eCharacter _GET_CURRENT_PLAYER_CHARACTER_0() // Position - 0x91DA (37338)
{
	func_58();
	return Global_114904.f_2370.f_539.f_4321;
}

void func_115(int iParam0) // Position - 0x91F3 (37363)
{
	int num;
	var textLabel;
...
BOOL func_116() // Position - 0x9256 (37462)
{
	return MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION();
}

BOOL func_117() // Position - 0x926C (37484)
{
	return MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION();
}

void func_118(char* sParam0, Any anParam1, int iParam2) // Position - 0x9282 (37506)
{
...
BOOL func_119(BOOL bParam0) // Position - 0x92C4 (37572)
{
...
struct<2> func_120(int iParam0) // Position - 0x92EC (37612)
{
	var unk;
...
void func_121(int iParam0, var uParam1) // Position - 0x9739 (38713)
{
	switch (iParam0)
	{
		case 0:
...
int func_123(int iParam0) // Position - 0xAA11 (43537)
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_124(Any* panParam0) // Position - 0xAD57 (44375)
{
	int threadId;
...
void func_125(int iParam0) // Position - 0xADFC (44540)
{
	var name;
...
void func_126(int iParam0) // Position - 0xAE97 (44695)
{
	if (iParam0 < 63)
	{
		func_127();
...
void func_127() // Position - 0xAEBD (44733)
{
	Global_80535 != 6;
...
void func_128(Ped pedParam0) // Position - 0xAEF5 (44789)
{
	int num;
	int num2;
	int num3;
...
void func_129(int iParam0) // Position - 0xAF4E (44878)
{
...
int func_130(Ped pedParam0) // Position - 0xAFD1 (45009)
{
	int i;
...
void func_131(int iParam0, int iParam1, int iParam2) // Position - 0xB002 (45058)
{
	func_132(iParam0, iParam1, iParam2, 0, 0, 1);
	return;
}

void func_132(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xB017 (45079)
{
	int num;
...
int func_133() // Position - 0xB099 (45209)
{
	int i;
...
BOOL func_134(int iParam0, int iParam1, int iParam2) // Position - 0xB0CA (45258)
{
...
int func_135(int iParam0, int iParam1, int iParam2) // Position - 0xB0E5 (45285)
{
	int i;
...
int func_136(Ped pedParam0) // Position - 0xB131 (45361)
{
	int i;
...
BOOL func_137(Vehicle veParam0) // Position - 0xB17A (45434)
{
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(Ped pedParam0) // Position - 0xB19A (45466)
{
	if (ENTITY::DOES_ENTITY_EXIST(pedParam0))
...
BOOL func_139(int iParam0) // Position - 0xB1BB (45499)
{
	switch (iParam0)
	{
		case 5:
...
void func_140() // Position - 0xB20E (45582)
{
...
BOOL func_141(int iParam0) // Position - 0xB28B (45707)
{
	switch (iParam0)
	{
		case 5:
...
void func_142(Any* panParam0, BOOL bParam1, BOOL bParam2) // Position - 0xB2DE (45790)
{
	int i;
...
BOOL func_143(int iParam0) // Position - 0xB3D4 (46036)
{
	switch (iParam0)
	{
		case 5:
...
void func_144(BOOL bParam0) // Position - 0xB43F (46143)
{
	Player playerIndex;
...
void func_145(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB47E (46206)
{
	if (bParam0)
	{
...
BOOL func_146() // Position - 0xB5CD (46541)
{
	return IS_BIT_SET(Global_1845250[PLAYER::PLAYER_ID() /*880*/].f_36.f_18, 14);
}

BOOL func_147(Player plParam0, int iParam1) // Position - 0xB5E7 (46567)
{
	BOOL flag;
...
int func_148(int iParam0, BOOL bParam1) // Position - 0xB640 (46656)
{
	int num;
	int num2;
...
BOOL func_149(Player plParam0) // Position - 0xB681 (46721)
{
	Player player;
...
BOOL func_150(Player plParam0) // Position - 0xB6A3 (46755)
{
...
BOOL func_151() // Position - 0xB6E2 (46818)
{
	return IS_BIT_SET(Global_2621446, 3);
}

int func_152(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0xB6F0 (46832)
{
	int num;
...
BOOL func_153() // Position - 0xB723 (46883)
{
...
void func_154(int iParam0) // Position - 0xB74A (46922)
{
	if (iParam0 == 1)
...
BOOL func_155(const char* sParam0) // Position - 0xB76D (46957)
{
...
void func_156() // Position - 0xB7AA (47018)
{
	Global_21849 = 0;
	func_157();
	return;
...
void func_157() // Position - 0xB7BA (47034)
{
...
BOOL func_158() // Position - 0xB811 (47121)
{
...
void func_159() // Position - 0xB833 (47155)
{
	func_165(0);
	func_164();
	func_160();
...
void func_160() // Position - 0xB848 (47176)
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
...
BOOL func_161(Vehicle veParam0, float fParam1, int iParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB8A0 (47264)
{
...
void func_162(Vehicle veParam0) // Position - 0xB8F7 (47351)
{
	if (!ENTITY::IS_ENTITY_DEAD(veParam0, false))
...
void func_163(BOOL bParam0, BOOL bParam1) // Position - 0xB923 (47395)
{
...
void func_164() // Position - 0xBA74 (47732)
{
...
void func_165(int iParam0) // Position - 0xBAC5 (47813)
{
	if (func_170())
		return;
...
void func_166(int iParam0) // Position - 0xBAF8 (47864)
{
	if (func_170())
		return;
...
void func_167(BOOL bParam0, BOOL bParam1) // Position - 0xBB82 (48002)
{
	if (bParam0)
	{
		if (func_169(0))
...
BOOL func_168() // Position - 0xBBF6 (48118)
{
	return IS_BIT_SET(Global_1964145, 5);
}

BOOL func_169(int iParam0) // Position - 0xBC04 (48132)
{
	if (iParam0 == 1)
...
BOOL func_170() // Position - 0xBC5B (48219)
{
	return IS_BIT_SET(Global_1964145, 19);
}

BOOL func_171(int iParam0) // Position - 0xBC6A (48234)
{
...
BOOL func_172(int iParam0) // Position - 0xBCAB (48299)
{
	int num;
...
void func_173(int iParam0) // Position - 0xBCF0 (48368)
{
...
int func_174(int iParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4) // Position - 0xBD22 (48418)
{
	int i;
...
void func_175(int iParam0, int iParam1) // Position - 0xBE59 (48729)
{
	int i;
...
BOOL _CAN_ENTER_FREEROAM_STATE(int iParam0) // Position - 0xBEA8 (48808)
{
	return func_177(iParam0, Global_44869);
}

BOOL func_177(int iParam0, int iParam1) // Position - 0xBEB9 (48825)
{
	if (iParam1 == 15)
		return 1;
...
void func_201(var uParam0, const char* sParam1, var uParam2, var uParam3, var uParam4) // Position - 0xD83B (55355)
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
...
void func_202(int iParam0, BOOL bParam1) // Position - 0xD92C (55596)
{
	if (iParam0 == -1)
		return;
...
int func_203(int iParam0) // Position - 0xD968 (55656)
{
	if (Global_80276 == iParam0)
		if (Global_80277 == -1)
...
void func_204(var uParam0, int iParam1) // Position - 0xD9A1 (55713)
{
	BOOL flag;
	int i;
...
float func_205(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0xDA3F (55871)
{
...
BOOL func_206() // Position - 0xDA79 (55929)
{
	return Global_99713;
}

void func_207(var uParam0) // Position - 0xDA85 (55941)
{
	CUTSCENE::STOP_CUTSCENE(false);
	CUTSCENE::REMOVE_CUTSCENE();
	func_208(uParam0);
...
void func_208(var uParam0) // Position - 0xDA9C (55964)
{
	BOOL flag;
	int num;
	int i;
...
void func_209(int iParam0) // Position - 0xDB84 (56196)
{
	if (iParam0 == -1)
		iParam0 = func_179();
...
int func_210(var uParam0, var uParam1, var uParam2, var uParam3, char* sParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, int iParam9) // Position - 0xDBAC (56236)
{
	var unk;
...
void _CONVERSATION_ADD_LINE_NO_SUBTITLE(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xDC34 (56372)
{
...
void func_212(var uParam0, eCharacter echParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xDC6F (56431)
{
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, Ped pedParam2, char* sParam3, int iParam4, int iParam5) // Position - 0xDCC5 (56517)
{
...
BOOL func_214(Any* panParam0, BOOL bParam1) // Position - 0xDD60 (56672)
{
	var unk;
	...
	if (func_251(*panParam0) || func_249(*panParam0) || Global_80526 == true)
		return true;
...
void func_215(Ped pedParam0, var uParam1, int iParam2) // Position - 0xDFD0 (57296)
{
	int taskSequenceId;
	int taskSequenceId2;
...
BOOL func_216(int iParam0) // Position - 0xE328 (58152)
{
...
BOOL func_217(var uParam0) // Position - 0xE348 (58184)
{
...
BOOL func_218(var uParam0) // Position - 0xE360 (58208)
{
...
void func_219(var uParam0) // Position - 0xE385 (58245)
{
	int i;
	int taskSequenceId;
...
void func_220(Object* pobParam0) // Position - 0xE689 (59017)
{
...
void func_221(var uParam0) // Position - 0xE6B4 (59060)
{
	int i;
...
BOOL CHECK_VEHICLES_OK(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0xE734 (59188)
{
	int i;
	int num;
	Vehicle playersLastVehicle;
...
BOOL func_223(Ped pedParam0, Vehicle veParam1) // Position - 0xE8F2 (59634)
{
...
BOOL func_224(var uParam0, BOOL bParam1, int iParam2) // Position - 0xE922 (59682)
{
	int i;
	int num;
...
BOOL func_225(int iParam0) // Position - 0xEBDE (60382)
{
...
BOOL func_226(Vehicle veParam0, int iParam1) // Position - 0xEC12 (60434)
{
	float xSize;
...
BOOL func_227(Vehicle veParam0, int iParam1) // Position - 0xEC88 (60552)
{
	return func_228(veParam0, PLAYER::PLAYER_PED_ID(), iParam1, 1, 250, 7);
}

BOOL func_228(Vehicle veParam0, Ped pedParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xECA0 (60576)
{
	BOOL flag;
	var pedBoneCoords;
	int num;
...
BOOL func_229(var uParam0, Vector3 vParam1, var uParam2, var uParam3, Ped pedParam4, var uParam5, Vehicle veParam6, int iParam7) // Position - 0xED61 (60769)
{
	var hit;
	var endCoords;
	var surfaceNormal;
...
Vector3 func_230(Ped pedParam0, int iParam1) // Position - 0xEE8D (61069)
{
...
int func_231() // Position - 0xEF52 (61266)
{
	int i;
...
BOOL func_232(Vehicle veParam0, Ped pedParam1, int iParam2, int iParam3) // Position - 0xEF9C (61340)
{
	var unk;
...
float func_233(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) // Position - 0xF02D (61485)
{
	return (fParam0 * uParam3) + (fParam0.f_1 * uParam3.f_1) + (fParam0.f_2 * uParam3.f_2);
}

Vector3 func_234(float fParam0, var uParam1, var uParam2) // Position - 0xF04E (61518)
{
	float num;
	float num2;
...
void func_235(var uParam0) // Position - 0xF08D (61581)
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_236(Vehicle veParam0, Ped pedParam1) // Position - 0xF0A8 (61608)
{
	int i;
...
BOOL func_237(Vehicle veParam0) // Position - 0xF0E7 (61671)
{
...
BOOL func_238(Vehicle veParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0xF10F (61711)
{
	float radius;
	float num;
	int weaponHash;
...
BOOL func_239(Vehicle veParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Position - 0xF20A (61962)
{
	float entityCoords;
	float num;
...
BOOL func_240(Vehicle veParam0, float fParam1) // Position - 0xF316 (62230)
{
	var outProjectile;
	var outCoords;
...
BOOL func_241(Vehicle veParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Position - 0xF3AB (62379)
{
	var unk;
	var entityForwardVector;
	float num;
...
BOOL func_242(Vehicle veParam0, BOOL bParam1, float fParam2, float fParam3) // Position - 0xF439 (62521)
{
	if (bParam1)
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
BOOL func_243(int iParam0) // Position - 0xF481 (62593)
{
...
void func_244(Vehicle veParam0) // Position - 0xF4CB (62667)
{
	int taskSequenceId;
...
BOOL func_245(int iParam0) // Position - 0xF568 (62824)
{
	if (iParam0 == -1)
		iParam0 = func_179();
...
BOOL func_246(int iParam0) // Position - 0xF5FD (62973)
{
...
BOOL func_247() // Position - 0xF63C (63036)
{
	if (MISC::IS_PC_VERSION())
...
BOOL func_248() // Position - 0xF659 (63065)
{
	if (Global_99326 != -1)
...
BOOL func_249(int iParam0) // Position - 0xF67C (63100)
{
...
BOOL func_250() // Position - 0xF6B0 (63152)
{
...
BOOL func_251(int iParam0) // Position - 0xF6EE (63214)
{
	if (func_119(false))
...
BOOL func_254(var uParam0) // Position - 0xF7E8 (63464)
{
	int num;
	char* animDict;
	int i;
...
void func_255(Object* pobParam0, Hash hParam1, float fParam2, float fParam3, float fParam4, float fParam5) // Position - 0xFDAD (64941)
{
	func_220(pobParam0);
...
void func_256(Vehicle* pveParam0, Hash hParam1, float fParam2, float fParam3, float fParam4, float fParam5) // Position - 0xFDD4 (64980)
{
	func_257(pveParam0);
...
void func_257(Vehicle* pveParam0) // Position - 0xFE17 (65047)
{
	if (ENTITY::DOES_ENTITY_EXIST(*pveParam0))
	{
...
void func_258(Ped* ppedParam0, Hash hParam1, float fParam2, float fParam3, float fParam4, float fParam5, ePedType eptParam6) // Position - 0xFEB3 (65203)
{
	func_259(ppedParam0);
...
void func_259(Ped* ppedParam0) // Position - 0xFED4 (65236)
{
...
BOOL func_260(Ped* ppedParam0, eCharacter echParam1, float fParam2, float fParam3, float fParam4, float fParam5, char* sParam6, int iParam7) // Position - 0xFF15 (65301)
{
...
BOOL func_261(Ped* ppedParam0, eCharacter echParam1, Vector3 vParam2, var uParam3, var uParam4, float fParam5, BOOL bParam6) // Position - 0xFF71 (65393)
{
	Hash model;
...
int func_262(Ped pedParam0, eCharacter echParam1) // Position - 0xFFFF (65535)
{
	int num;
...
BOOL func_263(var uParam0) // Position - 0x10046 (65606)
{
	int i;
...
BOOL func_264(var uParam0) // Position - 0x10077 (65655)
{
	uParam0->f_16 = 3;
...
BOOL func_265(var uParam0) // Position - 0x100AB (65707)
{
	int num;
	int i;
...
BOOL func_266(var uParam0) // Position - 0x10196 (65942)
{
	int num;
	var unk6;
	var unk10;
...
BOOL func_267(var uParam0) // Position - 0x106D9 (67289)
{
	int num;
	int i;
	BOOL flag;
...
BOOL func_268(var uParam0) // Position - 0x10A1B (68123)
{
	int num;
	int i;
	BOOL flag;
...
void func_269(int iParam0, BOOL bParam1) // Position - 0x10D3F (68927)
{
	switch (iParam0)
	{
		case 46:
...
BOOL func_270(int iParam0) // Position - 0x10DCA (69066)
{
	var unk;
	eCharacter character;
...
BOOL func_271(int iParam0) // Position - 0x10E1B (69147)
{
	const char* string2;
...
BOOL func_272(int iParam0) // Position - 0x10ED4 (69332)
{
	var unk;
...
BOOL func_273(int iParam0) // Position - 0x10F95 (69525)
{
	int i;
	var interiorType;
	Interior interiorAtCoordsWithType;
...
BOOL func_274(int iParam0, char* sParam1) // Position - 0x1101A (69658)
{
...
BOOL func_275(int iParam0) // Position - 0x110FC (69884)
{
...
BOOL func_276(int iParam0) // Position - 0x11127 (69927)
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_277(int iParam0) // Position - 0x11152 (69970)
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_278(int iParam0) // Position - 0x1117D (70013)
{
	if (func_246(iParam0))
		return false;
	else if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
...
void func_279() // Position - 0x111B2 (70066)
{
...
BOOL func_280(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, float fParam5) // Position - 0x111CC (70092)
{
	int i;
...
BOOL func_281(int iParam0, var uParam1, var uParam2, var uParam3, float fParam4, var uParam5) // Position - 0x11231 (70193)
{
	int num;
	char* str;
...
BOOL func_282(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, BOOL bParam7) // Position - 0x112A9 (70313)
{
	if (fParam6 < 0f)
		fParam6 = 0f;
...
void func_283(var uParam0, BOOL bParam1) // Position - 0x11324 (70436)
{
	if (bParam1)
	{
...
int func_284(var uParam0) // Position - 0x11492 (70802)
{
	if (func_218(uParam0))
	{
...
void func_285(var uParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0x114C8 (70856)
{
...
void func_286(var uParam0, BOOL bParam1) // Position - 0x114E8 (70888)
{
	func_287(&(uParam0->f_41), bParam1);
	return;
}

void func_287(var uParam0, BOOL bParam1) // Position - 0x114FA (70906)
{
	int i;
...
void func_288(Object* pobParam0, BOOL bParam1) // Position - 0x11538 (70968)
{
	if (ENTITY::DOES_ENTITY_EXIST(*pobParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*pobParam0))
...
void func_289(var uParam0, BOOL bParam1) // Position - 0x11573 (71027)
{
	func_290(&(uParam0->f_35), bParam1);
	return;
}

void func_290(var uParam0, BOOL bParam1) // Position - 0x11585 (71045)
{
	int i;
...
void func_291(Vehicle* pveParam0) // Position - 0x115C2 (71106)
{
	if (ENTITY::DOES_ENTITY_EXIST(*pveParam0))
	{
...
void func_292(var uParam0, int iParam1) // Position - 0x115FA (71162)
{
	func_293(&(uParam0->f_28), iParam1);
	return;
}

void func_293(var uParam0, int iParam1) // Position - 0x1160C (71180)
{
	int i;
...
void func_294(Ped* ppedParam0, BOOL bParam1, int iParam2, int iParam3) // Position - 0x1164D (71245)
{
	if (ENTITY::DOES_ENTITY_EXIST(*ppedParam0))
	{
...
void func_295(int iParam0) // Position - 0x1169D (71325)
{
	if (*iParam0 == -1)
		return;
...
void func_296(char* sParam0) // Position - 0x116DA (71386)
{
	!MISC::IS_STRING_NULL_OR_EMPTY(sParam0);
	return;
}

void func_297(var uParam0) // Position - 0x116EC (71404)
{
	*uParam0 = -1;
...
void func_298() // Position - 0x1171F (71455)
{
...
Hash func_299(eCharacter echParam0) // Position - 0x11739 (71481)
{
	if (!func_36(echParam0))
