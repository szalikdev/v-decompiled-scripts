...
BOOL IS_GAMER_HANDLE_VALID(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12) // Position - 0x20FE (8446)
{
	return NETWORK::NETWORK_IS_HANDLE_VALID(&uParam0, 13);
}

BOOL func_79(Hash hParam0) // Position - 0x210E (8462)
{
	switch (hParam0)
	{
		case -1321131184:
...
BOOL func_80(Hash hParam0) // Position - 0x213C (8508)
{
	switch (hParam0)
	{
		case joaat("coureur"):
...
BOOL func_81(Hash hParam0) // Position - 0x2171 (8561)
{
	switch (hParam0)
	{
		case joaat("deity"):
...
BOOL func_82(Hash hParam0) // Position - 0x2200 (8704)
{
	switch (hParam0)
	{
		case joaat("pounder2"):
...
void func_83(Vehicle veParam0) // Position - 0x2307 (8967)
{
	Hash entityModel;
...
void func_84(var uParam0, var uParam1, var uParam2) // Position - 0x2392 (9106)
{
	Hash eventData;
...
int func_85(BOOL bParam0, BOOL bParam1) // Position - 0x23D3 (9171)
{
	int address;
	int i;
	Player player;
...
BOOL func_86(int iParam0) // Position - 0x2438 (9272)
{
	int i;
...
BOOL func_87(int iParam0) // Position - 0x2473 (9331)
{
	return func_88(iParam0, 6, true);
}

BOOL func_88(int iParam0, int iParam1, BOOL bParam2) // Position - 0x2483 (9347)
{
	if (iParam0 == -1)
		return false;
...
int func_89(int iParam0, int iParam1) // Position - 0x24E3 (9443)
{
	Hash statHash;
	int outValue;
...
Hash func_90(int iParam0, int iParam1) // Position - 0x2512 (9490)
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(0, iParam0, func_91(iParam1));
}

int func_91(int iParam0) // Position - 0x2527 (9511)
{
	int num;
	int num2;
...
int func_92(int iParam0) // Position - 0x255B (9563)
{
	switch (iParam0)
	{
		case 0:
...
int func_93() // Position - 0x293F (10559)
{
	return Global_33775;
}

int func_94(int iParam0) // Position - 0x294A (10570)
{
	switch (iParam0)
	{
		case -1:
...
BOOL func_95() // Position - 0x2CB4 (11444)
{
	return Global_102481.f_418 > 0;
}

int func_96(Vehicle veParam0, Any* panParam1) // Position - 0x2CC5 (11461)
{
...
BOOL func_97(Vehicle veParam0) // Position - 0x2D42 (11586)
{
	int vehicleCrewEmblemRequestState;
	int networkTime;
	int num;
...
void func_98(Vehicle veParam0) // Position - 0x2DCF (11727)
{
	int _int;
...
BOOL func_99(var uParam0, Player plParam1) // Position - 0x2E2B (11819)
{
	func_103();
...
BOOL func_100(var uParam0, Player plParam1, int iParam2, Vector3 vParam3, var uParam4, var uParam5, Vector3 vParam6, var uParam7, var uParam8, Vector3 vParam9, var uParam10, var uParam11, float fParam12, int iParam13, int iParam14) // Position - 0x30D6 (12502)
{
...
int func_101(Vehicle veParam0, int iParam1, var uParam2, var uParam3, var uParam4, float fParam5) // Position - 0x30FF (12543)
{
	if (!ENTITY::DOES_ENTITY_EXIST(veParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(veParam0, false))
		return 0;
...
BOOL func_102(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, BOOL bParam6) // Position - 0x9143 (37187)
{
	if (bParam6)
...
void func_103() // Position - 0x918A (37258)
{
	Global_1950086 = 0;
...
BOOL func_104(Vehicle veParam0) // Position - 0x9203 (37379)
{
	if (ENTITY::DOES_ENTITY_EXIST(veParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(veParam0, false))
...
BOOL func_105(Vehicle veParam0) // Position - 0x923B (37435)
{
	int _int;
...
BOOL func_106(Vehicle veParam0, Any* panParam1) // Position - 0x9283 (37507)
{
	Player playerFromGamerHandle;
	BOOL flag;
	int num;
...
BOOL func_107(Vehicle veParam0) // Position - 0x93E0 (37856)
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		return true;
...
int func_108(Vehicle veParam0) // Position - 0x973D (38717)
{
...
int func_109(Player plParam0) // Position - 0x9769 (38761)
{
...
int func_110(Player plParam0) // Position - 0x9786 (38790)
{
...
BOOL func_111(Player plParam0, BOOL bParam1) // Position - 0x97A9 (38825)
{
	if (func_11(plParam0))
...
int func_112(Player plParam0) // Position - 0x97ED (38893)
{
	if (func_11(plParam0))
		if (func_111(plParam0, false))
...
int func_113() // Position - 0x9819 (38937)
{
	int num;
...
BOOL func_114(BOOL bParam0) // Position - 0x9826 (38950)
{
	return func_115(PLAYER::PLAYER_ID(), bParam0);
}

BOOL func_115(Player plParam0, BOOL bParam1) // Position - 0x9838 (38968)
{
	return func_116(plParam0, bParam1, 1);
}

BOOL func_116(Player plParam0, BOOL bParam1, int iParam2) // Position - 0x9849 (38985)
{
	Player player;
...
BOOL func_117(Player plParam0, int iParam1) // Position - 0x98A5 (39077)
{
	if (func_11(plParam0))
...
BOOL func_118(int iParam0, BOOL bParam1) // Position - 0x98F4 (39156)
{
	int num;
	int num2;
...
int func_119(int iParam0) // Position - 0x9952 (39250)
{
	return iParam0 % 32;
}

int func_120(int iParam0) // Position - 0x995F (39263)
{
	int num;
...
int func_121(int iParam0) // Position - 0x9976 (39286)
{
	int num;
	int num2;
...
int func_122(int iParam0) // Position - 0x99A3 (39331)
{
	return iParam0 / 32;
}

BOOL func_123(Player plParam0) // Position - 0x99B0 (39344)
{
...
BOOL func_124(Player plParam0) // Position - 0x99E5 (39397)
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
...
int func_125(int iParam0) // Position - 0x9A2C (39468)
{
	switch (iParam0)
	{
		case 0:
...
void func_126(Vehicle veParam0, int iParam1) // Position - 0x9F7C (40828)
{
	int num;
	int num2;
...
BOOL func_127(int iParam0, var uParam1) // Position - 0x9F9D (40861)
{
	*uParam1 = -1;
...
int func_128(int iParam0) // Position - 0xA25F (41567)
{
	switch (iParam0)
	{
		case 0:
...
int func_129(int iParam0, int iParam1, int iParam2) // Position - 0xA2FD (41725)
{
...
BOOL func_130() // Position - 0xA4DF (42207)
{
	var gamerHandle;
...
struct<13> GET_LOCAL_GAMER_HANDLE() // Position - 0xA527 (42279)
{
	var gamerHandle;
...
BOOL func_132(Vehicle veParam0) // Position - 0xA53C (42300)
{
	switch (ENTITY::GET_ENTITY_MODEL(veParam0))
	{
		case joaat("deathbike2"):
...
BOOL func_133(int iParam0, var uParam1) // Position - 0xA55D (42333)
{
	*uParam1 = -1f;
...
void func_134(Vehicle veParam0, var uParam1) // Position - 0xA85E (43102)
{
...
void func_135(Vehicle veParam0) // Position - 0xA8D7 (43223)
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
...
void func_136(Vehicle veParam0) // Position - 0xA909 (43273)
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		if (DECORATOR::DECOR_IS_REGISTERED_AS_TYPE("MLJ", BOOL))
			if (!DECORATOR::DECOR_EXIST_ON(veParam0, "MLJ"))
...
BOOL func_137(Hash hParam0) // Position - 0xA93D (43325)
{
	switch (hParam0)
	{
		case 1484920335:
...
BOOL func_138(Hash hParam0) // Position - 0xA960 (43360)
{
...
void func_139(Vehicle veParam0, var uParam1, BOOL bParam2, BOOL bParam3) // Position - 0xB925 (47397)
{
	int num;
	int num2;
	int i;
...
BOOL func_140(Vehicle veParam0, float fParam1) // Position - 0xC045 (49221)
{
	float entityCoords;
	var groundZ;
...
Hash func_141(BOOL bParam0) // Position - 0xC0B6 (49334)
{
	if (bParam0)
...
BOOL func_142() // Position - 0xC0D0 (49360)
{
...
BOOL func_143(Player plParam0) // Position - 0xC15F (49503)
{
	Player player;
...
BOOL func_144(Player plParam0) // Position - 0xC184 (49540)
{
	Player player;
...
BOOL func_145(Player plParam0, int iParam1) // Position - 0xC1A2 (49570)
{
	return IS_BIT_SET(Global_1892653[plParam0 /*615*/].f_10.f_4, iParam1);
}

BOOL func_146(int iParam0) // Position - 0xC1BA (49594)
{
	return func_147(&(Global_2673271.f_194), iParam0);
}

BOOL func_147(var uParam0, int iParam1) // Position - 0xC1CE (49614)
{
	int num;
	int num2;
	int num3;
...
int func_148(var uParam0, var uParam1, var uParam2) // Position - 0xC1F1 (49649)
{
	int i;
	int modType;
...
BOOL func_149(Vehicle veParam0) // Position - 0xC3CA (50122)
{
	int i;
	int modType;
	Hash hashKey;
...
void func_150(var uParam0) // Position - 0xC4A4 (50340)
{
...
int func_151(Vehicle veParam0, int iParam1) // Position - 0xC4FB (50427)
{
	int value;
	int value2;
	float num;
...
int func_152(Vehicle veParam0, int iParam1) // Position - 0xC5E4 (50660)
{
	int i;
...
BOOL func_153(Hash hParam0) // Position - 0xC646 (50758)
{
...
BOOL func_154(Hash hParam0, int iParam1) // Position - 0xC671 (50801)
{
	switch (hParam0)
	{
		case joaat("faction2"):
...
BOOL func_155(Vehicle veParam0, int iParam1, int iParam2) // Position - 0xCA57 (51799)
{
...
BOOL func_156() // Position - 0xCA7B (51835)
{
	return false;
}

void func_157(Vehicle veParam0, int iParam1) // Position - 0xCA84 (51844)
{
	int vehicleMod;
...
BOOL func_158(int iParam0) // Position - 0xCAFC (51964)
{
	switch (iParam0)
	{
		case joaat("granger"):
...
BOOL func_159() // Position - 0xCB1C (51996)
{
	return DLC::IS_DLC_PRESENT(joaat("mpindependence"));
}

BOOL func_160(Vehicle veParam0) // Position - 0xCB2D (52013)
{
	int _int;
...
int func_161(var uParam0) // Position - 0xCB72 (52082)
{
...
BOOL func_162(int iParam0) // Position - 0xCB92 (52114)
{
	switch (iParam0)
	{
		case 161:
...
int func_163(int iParam0) // Position - 0xCBE5 (52197)
{
	switch (iParam0)
	{
		case 1:
...
BOOL func_164(Vehicle veParam0) // Position - 0xCC95 (52373)
{
...
BOOL _IS_PLAYER_IN_VEHICLE_SEAT(Player plParam0, int iParam1) // Position - 0xCD1C (52508)
{
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(Ped pedParam0) // Position - 0xCD69 (52585)
{
...
void func_167(var uParam0) // Position - 0xCD8A (52618)
{
...
void func_168(var uParam0) // Position - 0xCDD8 (52696)
{
...
Vector3 func_169(float fParam0, var uParam1, var uParam2) // Position - 0xCE92 (52882)
{
	return -BUILTIN::SIN(fParam0.f_2) * BUILTIN::COS(fParam0), BUILTIN::COS(fParam0.f_2) * BUILTIN::COS(fParam0), BUILTIN::SIN(fParam0);
}

BOOL func_170(var uParam0) // Position - 0xCEBF (52927)
{
	Player player;
...
void func_171(Ped pedParam0, var uParam1, BOOL bParam2, int iParam3) // Position - 0xCF97 (53143)
{
	var unk;
	int characterType;
	BOOL flag;
...
void func_172(Ped pedParam0, int iParam1, int iParam2) // Position - 0xD100 (53504)
{
	switch (iParam1)
	{
		case 1310977332:
...
BOOL func_173(Ped pedParam0, const char* sParam1, int iParam2, int iParam3, Hash hParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7, BOOL bParam8) // Position - 0xE3D7 (58327)
{
	Hash entityModel;
	int num;
...
BOOL func_174(int iParam0, int iParam1) // Position - 0xEBFD (60413)
{
	int num;
	int num2;
...
int func_175(int iParam0, int iParam1) // Position - 0xEC3C (60476)
{
	int num;
	int num2;
...
int func_176() // Position - 0xEC82 (60546)
{
	return Global_33776;
}

int func_177(int iParam0) // Position - 0xEC8D (60557)
{
	int num;
	int num2;
...
char* func_178(int iParam0) // Position - 0xF02E (61486)
{
	switch (iParam0)
	{
		case 0:
...
int func_179(Hash hParam0, const char* sParam1, int iParam2) // Position - 0xF66B (63083)
{
	switch (iParam2)
	{
		case joaat("crewLogo"):
...
void func_300() // Position - 0x362BE (221886)
{
	...
	if (randomIntInRange < 50)
		func_301(&uLocal_122, 4105.583f, -4644.602f, 4.1196f, 11.1032f, -0.012f, 107.968f, "HS4_ISD_TAKE_NIMB2", 0, 1, 1, 0);
	else
		func_301(&uLocal_122, 4105.583f, -4644.602f, 4.1196f, 11.1032f, -0.012f, 107.968f, "HS4_ISD_TAKE_NIMB2", 0, 1, 2, 0);

	return;
}

void func_301(var uParam0, float fParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6, char* sParam7, int iParam8, int iParam9, int iParam10, int iParam11) // Position - 0x36356 (222038)
{
...
void func_302(var uParam0, char* sParam1, int iParam2, int iParam3, int iParam4) // Position - 0x36386 (222086)
{
	uParam0->f_1 = sParam1;
	uParam0->f_2 = iParam3;
...
void func_303(var uParam0, int iParam1, char* sParam2) // Position - 0x363B3 (222131)
{
