...
void func_23(int iParam0) // Position - 0x121A (4634)
{
	...
	else if (IS_BIT_SET(Global_114904.f_20571.f_471, iParam0) || IS_BIT_SET(Global_2359296[func_25() /*5574*/].f_681.f_10, iParam0))
	{
		flag = true;
		MISC::CLEAR_BIT(&(Global_114904.f_20571.f_471), iParam0);
...
char* func_24(int iParam0) // Position - 0x1394 (5012)
{
	switch (iParam0)
	{
		case 0:
...
int func_25() // Position - 0x1497 (5271)
{
	int num;
...
void func_26(int iParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0x14A4 (5284)
{
	Hash statName;
...
Hash func_27(int iParam0, int iParam1) // Position - 0x14D2 (5330)
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(0, iParam0, func_28(iParam1));
}

int func_28(int iParam0) // Position - 0x14E7 (5351)
{
	int num;
	int num2;
...
int func_29() // Position - 0x151B (5403)
{
	return Global_1574927;
}

void _STAT_SET_PACKED_BOOL(int iParam0, BOOL bParam1, int iParam2) // Position - 0x1527 (5415)
{
	if (iParam2 == -1)
		iParam2 = func_29();
...
void func_31(int iParam0) // Position - 0x1545 (5445)
{
	func_52(93, iParam0);
	func_52(29, iParam0);
	func_52(30, iParam0);
...
BOOL func_32(int iParam0) // Position - 0x1565 (5477)
{
	int cloudTimeAsInt;
	int num;
	int cloudTimeAsInt2;
...
int func_33(int iParam0, int iParam1) // Position - 0x1705 (5893)
{
	Hash statHash;
	int outValue;
...
BOOL _STAT_GET_PACKED_BOOL(int iParam0, int iParam1) // Position - 0x1734 (5940)
{
	if (iParam1 == -1)
		iParam1 = func_29();
...
int func_35(BOOL bParam0) // Position - 0x1750 (5968)
{
	var outValue;
	int value;
	int outValue2;
...
int func_36(int iParam0, int iParam1) // Position - 0x1807 (6151)
{
	if (iParam0 >= 78)
		return 0;
...
int func_37(int iParam0, int iParam1) // Position - 0x1822 (6178)
{
...
BOOL func_38(var uParam0, int iParam1) // Position - 0x18BF (6335)
{
	int i;
	var unk;
...
int func_39(var uParam0, int iParam1) // Position - 0x1970 (6512)
{
	int i;
...
BOOL func_40(var uParam0, int iParam1) // Position - 0x19EB (6635)
{
	return uParam0->[iParam1] == 78;
}

void func_41(var uParam0) // Position - 0x19FC (6652)
{
	int i;
...
void func_42(var uParam0, int iParam1) // Position - 0x1A30 (6704)
{
	uParam0->[iParam1] = 78;
	return;
}

void func_43(var uParam0, int iParam1) // Position - 0x1A40 (6720)
{
	if (iParam1 == 0f)
		uParam0->f_80 = 0f;
	else
...
float func_44(var uParam0) // Position - 0x1A5D (6749)
{
	return uParam0->f_80;
}

BOOL func_45(var uParam0, int iParam1) // Position - 0x1A69 (6761)
{
	return func_46(uParam0, iParam1) != -1;
}

int func_46(var uParam0, int iParam1) // Position - 0x1A7B (6779)
{
	int i;
...
BOOL func_47(var uParam0) // Position - 0x1AA8 (6824)
{
	return uParam0->f_79 == 1;
}

BOOL func_48(int iParam0) // Position - 0x1AB6 (6838)
{
	switch (iParam0)
	{
		case 60:
...
BOOL func_49(int iParam0) // Position - 0x1B06 (6918)
{
	return Global_44869 == iParam0;
}

BOOL func_50(int iParam0, int iParam1) // Position - 0x1B14 (6932)
{
...
void func_51(Hash hParam0, int iParam1) // Position - 0x1B65 (7013)
{
	int outValue;
...
void func_52(int iParam0, int iParam1) // Position - 0x1B88 (7048)
{
	int outValue;
...
void func_53() // Position - 0x1BE5 (7141)
{
	int outValue;
...
int func_54(eCharacter echParam0) // Position - 0x1C5A (7258)
{
	return Global_2339[echParam0 /*29*/].f_17;
}

eCharacter _GET_CURRENT_PLAYER_CHARACTER() // Position - 0x1C6B (7275)
{
	func_56();
	return Global_114904.f_2370.f_539.f_4321;
}

void func_56() // Position - 0x1C84 (7300)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (_GET_CHARACTER_MODEL(Global_114904.f_2370.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_57(character) && !func_49(14) || Global_113852)
			{
...
BOOL func_57(eCharacter echParam0) // Position - 0x1D81 (7553)
{
	return echParam0 < CHAR_MULTIPLAYER;
}

eCharacter _GET_PLAYER_CHARACTER_FROM_PED(Ped pedParam0) // Position - 0x1D8D (7565)
{
	eCharacter i;
	Hash entityModel;
...
Hash _GET_CHARACTER_MODEL(eCharacter character) // Position - 0x1DCA (7626)
{
...
Hash func_60(eCharacter echParam0) // Position - 0x1DEF (7663)
{
	return Global_2339[echParam0 /*29*/];
}

BOOL func_61() // Position - 0x1DFE (7678)
{
	int num;
...
int func_62(var uParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4) // Position - 0x1E22 (7714)
{
	int i;
...
void func_63(var uParam0, int iParam1) // Position - 0x1F59 (8025)
{
	int i;
...
BOOL _CAN_ENTER_FREEROAM_STATE(int iParam0) // Position - 0x1FA8 (8104)
{
	return func_65(iParam0, Global_44869);
}

BOOL func_65(int iParam0, int iParam1) // Position - 0x1FB9 (8121)
{
	if (iParam1 == 15)
		return 1;
...
BOOL func_66(int iParam0) // Position - 0x219A (8602)
{
	if (Global_44869 == 15)
		return false;
...
BOOL func_67(Ped pedParam0) // Position - 0x21BC (8636)
{
...
void func_68() // Position - 0x21DC (8668)
{
	Player playerIndex;
...
void func_69(BOOL bParam0, int iParam1) // Position - 0x2270 (8816)
{
	int num;
	...
	if (bParam0)
	{
		func_70(&Global_24529.f_6263[num /*10*/]);
...
void func_70(int* piParam0) // Position - 0x2336 (9014)
{
	if (piParam0->f_9 != 0)
	{
...
BOOL func_71(var uParam0, BOOL bParam1, int iParam2) // Position - 0x2362 (9058)
{
	var unk;
	Hash hashKey;
	int i;
...
void func_72(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0x23FF (9215)
{
	if (bParam0)
	{
...
BOOL func_73() // Position - 0x254E (9550)
{
	return IS_BIT_SET(Global_1845250[PLAYER::PLAYER_ID() /*880*/].f_36.f_18, 14);
}

BOOL func_74(Player plParam0, int iParam1) // Position - 0x2568 (9576)
{
	BOOL flag;
...
int func_75(int iParam0, BOOL bParam1) // Position - 0x25C1 (9665)
{
	int num;
	int num2;
...
BOOL func_76(Player plParam0) // Position - 0x2602 (9730)
{
	Player player;
...
BOOL func_77(Player plParam0) // Position - 0x2624 (9764)
{
...
BOOL func_78() // Position - 0x2663 (9827)
{
	return IS_BIT_SET(Global_2621446, 3);
}

int func_79(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x2671 (9841)
{
	int num;
...
BOOL func_80() // Position - 0x26A4 (9892)
{
...
void func_81(int iParam0) // Position - 0x26CB (9931)
{
	if (iParam0 == 1)
...
BOOL func_82() // Position - 0x26EE (9966)
{
	int num;
	int num2;
	var unk;
	...
	func_134(&num, &num2, &unk, &unk2, false);
...
void func_83(BOOL bParam0, int iParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, int iParam5, BOOL bParam6, BOOL bParam7, int iParam8) // Position - 0x284A (10314)
{
	int num;
	int r;
	int g;
	...
	if (Global_24529)
		if (func_128(30, true, true, &num26, &num27, bParam7))
			num39 = num27 / num26;
		else
			Global_24529 = false;
	...
	num41 = 1f;
	func_126(bParam7, &unk3, &unk4, &num41);

	if (bParam3)
	{
		if (Global_24529.f_5821 <= PV_COMP_BERD)
		{
			func_122(Global_24529.f_5821 + 1, "DFLT_MNU_OPT" /*Exit*/, 0, true, false, false, false);
	...
	for (i = 0; i < 2; i = i + 1)
	{
		if (i == 1 && Global_24529.f_6331)
		{
			...
			else
			{
				if (Global_24529)
				{
					TEXT_LABEL_ASSIGN_STRING(&unk5, func_121(30), 64);
					TEXT_LABEL_ASSIGN_STRING(&unk21, func_118(30, true), 64);
				
					if (MISC::GET_HASH_KEY(&Global_24529.f_7744[30 /*16*/]) == joaat("CREW_LOGO"))
					{
						func_117(Global_24526, Global_24527, iParam5, num38, 0, 0, 0, 255);
						func_116(&unk5, &unk21, Global_24526 + (iParam5 * 0.5f), Global_24527 + (num38 * 0.5f), iParam5, num38, 0f, 255, 255, 255, 255, false, 0);
					}
					else
					{
						func_116(&unk5, &unk21, Global_24526 + (iParam5 * 0.5f), Global_24527 + (num38 * 0.5f), iParam5, num38, 0f, 255, 255, 255, 255, false, 0);
				...
				func_117(Global_24526, Global_24527 + num38, iParam5, 0.034722f, r, g, b, a);
				...
				if (MISC::GET_HASH_KEY(&(Global_24529.f_1)) != 0)
				{
					...
					func_114(Global_24526 + 0.00390625f, Global_24527 + num38 + 0.00416664f, 0);
				}
			
				if (Global_24529.f_6338)
				{
					func_115();
					func_112((Global_24526 + iParam5) - 0.00390625f - func_113("CM_ITEM_COUNT" /*~1~ / ~1~*/, Global_24529.f_6339, Global_24529.f_6340), Global_24527 + num38 + 0.00416664f, "CM_ITEM_COUNT" /*~1~ / ~1~*/, Global_24529.f_6339, Global_24529.f_6340);
				}
				else if (Global_24529.f_6334 > Global_24529.f_5828)
				{
					...
					{
						func_115();
						func_112((Global_24526 + iParam5) - 0.00390625f - func_113("CM_ITEM_COUNT" /*~1~ / ~1~*/, Global_24529.f_6337, Global_24529.f_6336), Global_24527 + num38 + 0.00416664f, "CM_ITEM_COUNT" /*~1~ / ~1~*/, Global_24529.f_6337, Global_24529.f_6336);
					}
				}
			}
			...
			func_116("CommonMenu", "Gradient_Bgd", Global_24526 + (iParam5 * 0.5f), (num42 + ((num36 - num42) * 0.5f)) - 0.00138888f, iParam5, num36 - num42, 0f, 255, 255, 255, 255, false, 0);
			...
			if (Global_24529.f_6334 > Global_24529.f_5828)
			{
				...
				func_117(Global_24526, num36 + 0f, iParam5, 0.034722f, r, g, b, a);
				...
				func_116("CommonMenu", "shop_arrows_upANDdown", Global_24526 + (iParam5 * 0.5f), num36 + 0f + (0.034722f * 0.5f), (textureResolution / 1280f) * num41, (textureResolution.f_1 / 720f) * num41, 0f, r, g, b, a, false, 0);
			...
			if (MISC::GET_HASH_KEY(&(Global_24529.f_5241)) != 0 && Global_24529.f_5323 != -1)
			{
				...
				{
					func_128(Global_24529.f_5325, true, true, &num26, &num27, bParam7);
				...
				func_117(Global_24526, num36 - 0.00277776f, iParam5, 0.00277776f, r, g, b, a);
				...
				func_114(x, num36 + 0.00277776f, 0);
			
				if (Global_24529.f_5325 != 0)
				{
					func_128(Global_24529.f_5325, true, true, &num26, &num27, bParam7);
					func_110(Global_24529.f_5325, true, &num32, &num33, &num34, &num35);
					func_116(func_121(Global_24529.f_5325), func_118(Global_24529.f_5325, true), Global_24526 + (num26 * 0.5f) + (0.00078125f * 2f), (num36 + (num27 * 0.5f)) - (0.00138888f * 4f), num26, num27, 0f, num32, num33, num34, num35, false, 0);
				}
			...
			if (MISC::GET_HASH_KEY(&(Global_4521195.f_21)) != 0 && Global_4521195.f_65 != -1)
			{
				...
				{
					func_128(Global_4521195.f_67, true, true, &num26, &num27, bParam7);
					x = (Global_24526 + num26 + (0.00078125f * 4f)) - (0.00078125f * 1f);
				}
				...
				{
					func_128(Global_4521195.f_67, true, true, &num26, &num27, bParam7);
					func_110(Global_4521195.f_67, true, &num32, &num33, &num34, &num35);
					func_116(func_121(Global_4521195.f_67), func_118(Global_4521195.f_67, true), Global_24526 + (num26 * 0.5f) + (0.00078125f * 2f), (num36 + (num27 * 0.5f)) - (0.00138888f * 4f), num26, num27, 0f, num32, num33, num34, num35, false, 0);
				}
			...
			func_105(unk3, iParam1, iParam8, false, false, false, bParam4, 1, false);
			GRAPHICS::SET_SCRIPT_GFX_ALIGN(76, 84);
			GRAPHICS::SET_SCRIPT_GFX_ALIGN_PARAMS(-0.05f, -0.05f, 0f, 0f);
		}
		...
		if (i == 1 || !Global_24529.f_6331)
		{
			...
			for (j = PV_COMP_HEAD; j <= type; j = j + 1)
			{
				...
				if (flag && i == 1 && flag2)
				{
					...
					func_116("CommonMenu", "Gradient_Nav", Global_24526 + (iParam5 * 0.5f), num40 + num44 + (0.00277776f * (float)num5) + (num37 * 0.5f), iParam5, num37, 0f, r2, g2, b2, a2, false, 0);
						...
						switch (Global_24529.f_5659[k])
						{
								...
								if (flag2)
								{
									if (!Global_24529.f_6332)
									{
										...
										if (MISC::GET_HASH_KEY(&Global_24529.f_79[num16 /*6*/]) != 0)
										{
											...
											func_102(flag, Global_24529.f_1616[num16], Global_24529.f_1873[num16], flag7, num45, flag5, flag4);
										...
										if (num20 > 0)
										{
											...
											{
												if (func_128(Global_24529.f_4984[num14 + l], flag, false, &num26, &num27, bParam7))
												{
													num29 = num29 + num26;
									...
									if (flag6)
									{
										if (func_128(27, true, false, &num26, &num27, bParam7))
										{
											if (Global_24529.f_5686[k] == 2)
												x = x - (num26 * 2f);
											...
											if (func_128(27, true, true, &num26, &num27, bParam7))
											{
												func_110(27, true, &num32, &num33, &num34, &num35);
											
												if (i == 1)
													func_116(func_121(27), func_118(27, true), num24 + x + num30, (num25 - 0.00277776f) + (num37 * 0.5f), num26, num27, 0f, num32, num33, num34, num35, false, 0);
											}
										}
									
										if (func_128(28, true, false, &num26, &num27, bParam7))
										{
											x = x + num26;
											num30 = num26 * 0.5f;
										
											if (func_128(28, true, true, &num26, &num27, bParam7))
											{
												func_110(28, true, &num32, &num33, &num34, &num35);
											
												if (i == 1)
													func_116(func_121(28), func_118(28, true), num24 + x + num30 + num28 + num29, (num25 - 0.00277776f) + (num37 * 0.5f), num26, num27, 0f, num32, num33, num34, num35, false, 0);
											}
										}
									}
									...
									if (MISC::GET_HASH_KEY(&Global_24529.f_79[num16 /*6*/]) != 0 && i == 1)
									{
										...
										func_102(flag, Global_24529.f_1616[num16], Global_24529.f_1873[num16], flag7, 0, flag5, flag4);
									...
									for (l = 0; l < 4; l = l + 1)
									{
										...
										else if (Global_24529.f_2387[num16 /*5*/][l] == 4)
										{
											...
											{
												if (func_128(Global_24529.f_4984[num14 + num20], flag, false, &num26, &num27, bParam7))
												{
													x = x + (num26 * 0.5f);
												
													if (func_128(Global_24529.f_4984[num14 + num20], flag, true, &num26, &num27, bParam7))
													{
														func_110(Global_24529.f_4984[num14 + num20], flag, &num32, &num33, &num34, &num35);
													
														if (i == 1)
															if (Global_24529.f_5686[k] == 2)
																func_116(func_121(Global_24529.f_4984[num14 + num20]), func_118(Global_24529.f_4984[num14 + num20], flag), ((num24 + x) - (0.00078125f * 8f)) + (0.00078125f * 4f), (num25 - 0.00277776f) + (num37 * 0.5f), num26, num27, 0f, num32, num33, num34, num35, false, 0);
															else
																func_116(func_121(Global_24529.f_4984[num14 + num20]), func_118(Global_24529.f_4984[num14 + num20], flag), (num24 + x) - (0.00078125f * 8f), (num25 - 0.00277776f) + (num37 * 0.5f), num26, num27, 0f, num32, num33, num34, num35, false, 0);
									...
									if (MISC::GET_HASH_KEY(&Global_24529.f_79[num16 /*6*/]) != 0 && i == 1)
									{
										...
										{
											func_114(num24 + x + (0.00078125f * 7f), num25, 0);
										}
										else
										{
											func_114(num24 + x, num25, 0);
											...
											if (IS_ROCKSTAR_DEV() && SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(joaat("fm_mission_creator")) > 0)
											{
												if (k == 0)
												{
													...
													func_102(false, Global_24529.f_1616[num16], Global_24529.f_1873[num16], flag7, 0, flag5, flag4);
													...
													func_114(num24 - num48, num25 + num47, 0);
													num22 = num22 + 1;
												}
											}
										}
										...
										for (l = 0; l < num20; l = l + 1)
										{
											if (Global_24529.f_4984[num14 + l] != 2 && Global_24529.f_4984[num14 + l] != 56 && Global_24529.f_4984[num14 + l] != 66)
											{
												if (func_128(Global_24529.f_4984[num14 + l], flag, false, &num26, &num27, bParam7))
												{
													...
													if (i == 1)
													{
														if (func_128(Global_24529.f_4984[num14 + l], flag, true, &num26, &num27, bParam7))
														{
															func_110(Global_24529.f_4984[num14 + l], flag, &num32, &num33, &num34, &num35);
														
															if (Global_24529.f_4984[num14 + l] == 31)
																func_116(func_121(Global_24529.f_4984[num14 + l]), func_118(Global_24529.f_4984[num14 + l], flag), Global_24526 + (num26 * 0.5f), (num25 + 0.00277776f + (num27 * 0.5f)) - (0.00078125f * 11f), num26, num27, 0f, num32, num33, num34, num35, false, 0);
															else if (Global_24529.f_5686[k] == 2)
																func_116(func_121(Global_24529.f_4984[num14 + l]), func_118(Global_24529.f_4984[num14 + l], flag), ((num24 + x + num28) - (0.00078125f * 8f)) + (0.00078125f * 4f), (num25 - 0.00277776f) + (num37 * 0.5f), num26, num27, 0f, num32, num33, num34, num35, false, 0);
															else
																func_116(func_121(Global_24529.f_4984[num14 + l]), func_118(Global_24529.f_4984[num14 + l], flag), (num24 + x + num28) - (0.00078125f * 12f), (num25 - 0.00277776f) + (num37 * 0.5f), num26, num27, 0f, num32, num33, num34, num35, false, 0);
														}
													}
							...
							case 2:
								if (flag2)
								{
									if (!Global_24529.f_6332)
									{
										func_102(flag, Global_24529.f_1616[num16], Global_24529.f_1873[num16], flag7, 0, false, false);
									...
									{
										func_102(flag, Global_24529.f_1616[num16], Global_24529.f_1873[num16], flag7, 0, false, false);
										func_96(num24 + x, num25, "NUMBER" /*~1~*/, Global_24529.f_4469[num12], 0);
									}
								}
							...
							case 3:
								if (flag2)
								{
									...
									if (flag6)
									{
										if (func_128(27, true, false, &num26, &num27, false))
										{
											if (Global_24529.f_5686[k] == 2)
												x = x - (num26 * 2f);
									...
									func_102(flag, Global_24529.f_1616[num16], Global_24529.f_1873[num16], flag7, 0, false, false);
									func_92(num24 + x, num25, "NUMBER" /*~1~*/, Global_24529.f_4726[num13], Global_24529.f_4855[num13]);
								}
							...
							case 4:
								if (flag2)
								{
									if (func_128(Global_24529.f_4984[num14], flag, false, &num26, &num27, bParam7))
									{
										if (!Global_24529.f_6332)
										{
											num29 = num26;
										...
										if (i == 1)
										{
											if (func_128(Global_24529.f_4984[num14], flag, true, &num26, &num27, bParam7))
											{
												func_110(Global_24529.f_4984[num14], flag, &num32, &num33, &num34, &num35);
												func_116(func_121(Global_24529.f_4984[num14]), func_118(Global_24529.f_4984[num14], flag), num24 + x + (num26 * 0.5f), (num25 - 0.00277776f) + (num37 * 0.5f), num26 * func_91(Global_24529.f_4984[num14]), num27 * func_91(Global_24529.f_4984[num14]), 0f, num32, num33, num34, num35, false, 0);
											}
										}
									}
								}
...
void func_84(int iParam0) // Position - 0x5A09 (23049)
{
	Global_1679103.f_1163 = iParam0;
	return;
}

void func_85(int iParam0) // Position - 0x5A1A (23066)
{
	if (func_90())
		return;
...
void func_86(int iParam0) // Position - 0x5A4D (23117)
{
	if (func_90())
		return;
...
void func_87(BOOL bParam0, BOOL bParam1) // Position - 0x5AD7 (23255)
{
	if (bParam0)
	{
		if (func_89(0))
...
BOOL func_88() // Position - 0x5B4B (23371)
{
	return IS_BIT_SET(Global_1964145, 5);
}

BOOL func_89(int iParam0) // Position - 0x5B59 (23385)
{
	if (iParam0 == 1)
...
BOOL func_90() // Position - 0x5BB0 (23472)
{
	return IS_BIT_SET(Global_1964145, 19);
}

float func_91(int iParam0) // Position - 0x5BBF (23487)
{
	switch (iParam0)
	{
		case 36:
...
void func_92(float fParam0, float fParam1, char* sParam2, float fParam3, int iParam4) // Position - 0x5C34 (23604)
{
...
float func_93(float fParam0) // Position - 0x5C57 (23639)
{
	fParam0 = fParam0 * func_94();
	return fParam0;
}

float func_94() // Position - 0x5C6A (23658)
{
	return 1.7777778f / func_95();
}

float func_95() // Position - 0x5C7C (23676)
{
	return Global_24529.f_9245;
}

void func_96(float fParam0, float fParam1, char* sParam2, ePedComponentType epctParam3, int iParam4) // Position - 0x5C8A (23690)
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_TEXT(sParam2);
...
BOOL IS_ROCKSTAR_DEV() // Position - 0x5CAC (23724)
{
	return DLC::IS_DLC_PRESENT(-1762644250);
}

void func_98(BOOL bParam0) // Position - 0x5CBD (23741)
{
	int r;
	int g;
	int b;
...
float func_99(BOOL bParam0) // Position - 0x5D03 (23811)
{
	return func_100(HUD::END_TEXT_COMMAND_GET_SCREEN_WIDTH_OF_DISPLAY_TEXT(bParam0));
}

float func_100(float fParam0) // Position - 0x5D15 (23829)
{
	fParam0 = fParam0 * func_101();
	return fParam0;
}

float func_101() // Position - 0x5D28 (23848)
{
	return func_95() / 1.7777778f;
}

void func_102(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, int iParam4, BOOL bParam5, BOOL bParam6) // Position - 0x5D3A (23866)
{
	int r;
	int g;
	int b;
	...
	if (bParam2)
	{
		if (bParam3)
		{
			func_104(Global_24529.f_6614[iParam4], &r, &g, &b);
...
void func_103(float fParam0, float fParam1) // Position - 0x5EE8 (24296)
{
	HUD::SET_TEXT_WRAP(func_93(fParam0), func_93(fParam1));
	return;
}

void func_104(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x5F00 (24320)
{
	switch (iParam0)
	{
		case 0:
...
void func_105(var uParam0, int iParam1, int iParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, int iParam7, BOOL bParam8) // Position - 0x618A (24970)
{
	int num;
	int i;
	int j;
	...
	if (bParam3 && !func_130(bParam4, bParam8))
		return;
	...
	if (Global_24529.f_5326 != 0)
	{
		...
		if (!Global_24529.f_5327)
		{
			...
			if (MISC::GET_HASH_KEY(&(Global_4521195.f_16)) != MISC::GET_HASH_KEY(""))
			{
				...
				func_107(&Global_4521195);
			
				if (Global_4521195.f_20 == -1)
				{
					func_106(&(Global_4521195.f_16));
				}
				else
				{
...
void func_106(char* sParam0) // Position - 0x668F (26255)
{
...
void func_107(char* sParam0) // Position - 0x66A1 (26273)
{
	GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_PLAYER_NAME_STRING(sParam0);
	return;
}

BOOL func_108() // Position - 0x66AF (26287)
{
	var position;
...
BOOL func_109() // Position - 0x671D (26397)
{
	if (SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(joaat("cellphone_flashhand")) > 0)
		return true;
...
void func_110(int iParam0, BOOL bParam1, int* piParam2, int* piParam3, int* piParam4, int* piParam5) // Position - 0x6737 (26423)
{
...
void func_111(float fParam0) // Position - 0x6879 (26745)
{
	int r;
	int g;
	int b;
	...
	HUD::SET_TEXT_COLOUR(r, g, b, a);
	func_103(fParam0, (Global_24526 + Global_24528) - 0.0046875f);
	HUD::SET_TEXT_CENTRE(false);
	HUD::SET_TEXT_DROPSHADOW(0, 0, 0, 0, 0);
	HUD::SET_TEXT_EDGE(0, 0, 0, 0, 0);
	return;
...
void func_112(float fParam0, float fParam1, char* sParam2, int iParam3, int iParam4) // Position - 0x68D8 (26840)
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_TEXT(sParam2);
...
float func_113(char* sParam0, int iParam1, int iParam2) // Position - 0x68FF (26879)
{
...
void func_114(float fParam0, float fParam1, int iParam2) // Position - 0x6941 (26945)
{
	HUD::END_TEXT_COMMAND_DISPLAY_TEXT(func_93(fParam0), fParam1, iParam2);
	return;
}

void func_115() // Position - 0x6957 (26967)
{
	int r;
	int g;
	int b;
	...
	HUD::SET_TEXT_SCALE(0f, 0.35f);
	HUD::SET_TEXT_COLOUR(r, g, b, a);
	func_103(Global_24526 + 0.0046875f, (Global_24526 + Global_24528) - 0.0046875f);
	HUD::SET_TEXT_CENTRE(false);
	HUD::SET_TEXT_DROPSHADOW(0, 0, 0, 0, 0);
	HUD::SET_TEXT_EDGE(0, 0, 0, 0, 0);
	return;
...
void func_116(char* sParam0, char* sParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6, int iParam7, int iParam8, int iParam9, int iParam10, BOOL bParam11, int iParam12) // Position - 0x69E1 (27105)
{
...
void func_117(float fParam0, float fParam1, int iParam2, float fParam3, int iParam4, int iParam5, int iParam6, int iParam7) // Position - 0x6A0F (27151)
{
	GRAPHICS::DRAW_RECT(func_93(fParam0 + (iParam2 * 0.5f)), fParam1 + (fParam3 * 0.5f), func_93(iParam2), fParam3, iParam4, iParam5, iParam6, iParam7, false);
	return;
}

char* func_118(int iParam0, BOOL bParam1) // Position - 0x6A46 (27206)
{
	var unk;
	var txdName;
	var netHandle;
	...
	if (!MISC::IS_STRING_NULL_OR_EMPTY(&Global_24529.f_7744[iParam0 /*16*/]))
	{
		...
		{
			return func_119(&Global_24529.f_7744[iParam0 /*16*/]);
		}
	}
...
char* func_119(char* sParam0) // Position - 0x6FAC (28588)
{
	return sParam0;
}

struct<13> GET_GAMER_HANDLE_PLAYER(Player plParam0) // Position - 0x6FB6 (28598)
{
	var gamerHandle;
...
char* func_121(int iParam0) // Position - 0x6FCD (28621)
{
	var txdName;
	var netHandle;
	...
	if (!MISC::IS_STRING_NULL_OR_EMPTY(&Global_24529.f_6623[iParam0 /*16*/]))
	{
		...
		{
			return func_119(&Global_24529.f_6623[iParam0 /*16*/]);
		}
	}
...
void func_122(ePedComponentType epctParam0, char* sParam1, int iParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0x7042 (28738)
{
	int num;
	float num2;
	float num3;
	...
	if (!bParam3)
		func_125(Global_24529.f_5821, true);
	else
		func_125(Global_24529.f_5821, false);

	if (iParam2 == 0)
	{
		num2 = func_124(&Global_24529.f_79[Global_24529.f_5823 /*6*/]);
	
		if (Global_24529.f_5678[Global_24529.f_5822])
		{
			func_128(27, true, false, &num3, &unk, false);
			num2 = num2 + (num3 * 2f);
		}
	...
	if (bParam5)
	{
		if (iParam2 == 0)
		{
			num4 = func_123(&Global_24529.f_79[Global_24529.f_5823 /*6*/]);
...
float func_123(char* sParam0) // Position - 0x725E (29278)
{
	!HUD::DOES_TEXT_LABEL_EXIST(sParam0);
	return HUD::GET_RENDERED_CHARACTER_HEIGHT(0.35f, 0);
}

float func_124(char* sParam0) // Position - 0x727A (29306)
{
	if (!MISC::IS_STRING_NULL(sParam0))
		if (MISC::GET_HASH_KEY(sParam0) == 0)
			return 0f;
	...
	func_102(false, true, false, false, 0, false, false);
	HUD::BEGIN_TEXT_COMMAND_GET_SCREEN_WIDTH_OF_DISPLAY_TEXT(sParam0);
	return func_99(true);
}

void func_125(ePedComponentType epctParam0, BOOL bParam1) // Position - 0x72B7 (29367)
{
	int num;
...
void func_126(BOOL bParam0, int* piParam1, int* piParam2, var uParam3) // Position - 0x7303 (29443)
{
	float num;
	float value;
	float aspectRatio;
...
BOOL func_127(int iParam0, int iParam1) // Position - 0x738B (29579)
{
	return BUILTIN::TO_FLOAT(iParam0) / BUILTIN::TO_FLOAT(iParam1) > 3.5f;
}

BOOL func_128(int iParam0, BOOL bParam1, BOOL bParam2, var uParam3, var uParam4, BOOL bParam5) // Position - 0x73A6 (29606)
{
	var textureDict;
	var textureName;
	int num;
...
float func_129(int iParam0) // Position - 0x74D2 (29906)
{
	switch (iParam0)
	{
		case 34:
...
BOOL func_130(BOOL bParam0, BOOL bParam1) // Position - 0x75B8 (30136)
{
	if (Global_2673271.f_1762.f_701 != 0)
		return true;

	if (!CAM::IS_SCREEN_FADED_IN() || func_132(8, -1) && func_131() != TRANSITION_STATE_WAITING_FOR_EXTERNAL_TERMINATION_CALL || HUD::GET_PAUSE_MENU_STATE() != 0 && !bParam1 || STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS() && !bParam0 || NETWORK::IS_COMMERCE_STORE_OPEN() || Global_80541 || Global_24529.f_9243 || HUD::IS_WARNING_MESSAGE_ACTIVE() || Global_102481.f_1514)
		return false;

	return true;
}

eTransitionState func_131() // Position - 0x7655 (30293)
{
	return Global_1575018;
}

BOOL func_132(int iParam0, int iParam1) // Position - 0x7661 (30305)
{
	switch (iParam0)
	{
		case 5:
...
void func_133(int iParam0, BOOL bParam1, int iParam2) // Position - 0x7699 (30361)
{
	ePedComponentType i;
	int num;
...
void func_134(var uParam0, var uParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x77EB (30699)
{
...
void func_135() // Position - 0x78C0 (30912)
{
	...
	if (iLocal_81.f_1 == 3)
		func_139("SEA_MENU" /*Sea Races*/);
	else
		func_139("STREET_MENU" /*Street Races*/);

	func_122(0, "RACES_OPT_SP" /*Standard Race*/, 0, 1, 0, false, 0);
	func_122(PV_COMP_BERD, "RACES_OPT_MP" /*Play Online*/, 0, true, false, false, false);
	func_138(INPUT_FRONTEND_ACCEPT, "ITEM_SELECT" /*Select*/, -1);
	func_138(INPUT_FRONTEND_CANCEL, "ITEM_EXIT" /*Exit*/, -1);
	func_137(11, "ITEM_SCROLL" /*Scroll*/, -1);
	func_136(0);
	func_133(0, true, 1);
	iLocal_95 = 0;
	return;
...
void func_136(int iParam0) // Position - 0x7947 (31047)
{
	Global_24529.f_6341 = iParam0;
	return;
}

void func_137(int iParam0, char* sParam1, int iParam2) // Position - 0x7957 (31063)
{
...
void func_138(eControlAction ecaParam0, char* sParam1, int iParam2) // Position - 0x7A07 (31239)
{
...
void func_139(char* sParam0) // Position - 0x7AB6 (31414)
{
	int i;
...
void func_140(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4) // Position - 0x7B01 (31489)
{
...
void func_141(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4) // Position - 0x7B40 (31552)
{
...
void func_142(BOOL bParam0, BOOL bParam1) // Position - 0x7BEA (31722)
{
	int i;
	int j;
	float aspectRatio;
	...
	Global_24529.f_9245 = func_143(false);
	Global_24526 = 0.05f;
	Global_24527 = 0.05f;
	Global_24528 = 0.225f;
	aspectRatio = GRAPHICS::GET_ASPECT_RATIO(false);
...
float func_143(BOOL bParam0) // Position - 0x80CD (32973)
{
	float aspectRatio;
...
BOOL func_144(char* sParam0, int iParam1, BOOL bParam2) // Position - 0x80F8 (33016)
{
	int num;
	BOOL flag;
	BOOL flag2;
	...
	flag2 = func_145(&Global_24529.f_6263[num /*10*/]);
	!flag || !flag2;
	return flag && flag2;
}

BOOL func_145(int* piParam0) // Position - 0x8206 (33286)
{
	switch (piParam0->f_9)
	{
		case 0:
...
void func_146() // Position - 0x82A8 (33448)
{
	int num;
...
void func_147() // Position - 0x8359 (33625)
{
...
void func_148(int iParam0) // Position - 0x837A (33658)
{
	int taskSequenceId;
		...
		switch (iLocal_193)
		{
			...
			case 2:
				if (TASK::GET_SCRIPT_TASK_STATUS(uLocal_101[iParam0], SCRIPT_TASK_PERFORM_SEQUENCE) != 1 || PED::IS_PED_FACING_PED(uLocal_101[iParam0], PLAYER::PLAYER_PED_ID(), 20f))
				{
					...
					if (!bLocal_195)
						func_155(uLocal_101[iParam0], "PRERACE_CHAT", "A_M_Y_RACER_01_WHITE_MINI_01", 11, false);
					else
						func_155(uLocal_101[iParam0], "PRERACE_TAUNT", "A_M_Y_RACER_01_WHITE_MINI_01", 11, false);
			...
			case 4:
				...
				if (func_149(&uLocal_196) >= 5f && !bLocal_194)
				{
					bLocal_194 = true;
					iLocal_193 = 1;
				}
				else if (func_149(&uLocal_196) >= 10f && !bLocal_195)
				{
					bLocal_195 = true;
					iLocal_193 = 1;
				}
...
float func_149(var uParam0) // Position - 0x8543 (34115)
{
	if (func_152(uParam0))
		if (func_151(uParam0))
			return uParam0->f_2;
		else
			return func_150(IS_BIT_SET(*uParam0, 4)) - uParam0->f_1;

	return uParam0->f_1;
}

float func_150(BOOL bParam0) // Position - 0x857F (34175)
{
	float num;
	float num2;
	int networkTime;
...
BOOL func_151(var uParam0) // Position - 0x85D7 (34263)
{
	return IS_BIT_SET(*uParam0, 2);
}

BOOL func_152(var uParam0) // Position - 0x85E4 (34276)
{
	return IS_BIT_SET(*uParam0, 1);
}

void func_153(int* piParam0) // Position - 0x85F1 (34289)
{
	func_154(piParam0, 0f);
	return;
}

void func_154(int* piParam0, float fParam1) // Position - 0x8600 (34304)
{
	piParam0->f_1 = func_150(IS_BIT_SET(*piParam0, 4)) - fParam1;
...
void func_155(Ped pedParam0, char* sParam1, char* sParam2, int iParam3, BOOL bParam4) // Position - 0x862B (34347)
{
	AUDIO::PLAY_PED_AMBIENT_SPEECH_WITH_VOICE_NATIVE(pedParam0, sParam1, sParam2, func_156(iParam3), bParam4);
	return;
}

char* func_156(int iParam0) // Position - 0x8645 (34373)
{
	char* str;
...
void func_157(int iParam0) // Position - 0x883A (34874)
{
...
BOOL func_158() // Position - 0x8897 (34967)
{
...
BOOL func_159() // Position - 0x88B0 (34992)
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
		...
		{
			if (iLocal_81.f_1 == 3)
				func_171("SEA_NA_CASH" /*Can't afford to enter this sea race. $~1~ needed to race.*/, iLocal_81.f_3);
			else
				func_171("STREET_NA_CASH" /*Can't afford to enter this street race. $~1~ needed to race.*/, iLocal_81.f_3);
		...
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
		{
			...
			else if (ENTITY::GET_ENTITY_HEALTH(veLocal_0) <= 200 || FIRE::IS_ENTITY_ON_FIRE(veLocal_0) || func_164())
			{
				func_163("RACE_VehDmg" /*This vehicle is too damaged to race. Get it fixed, or find a vehicle in better repair to race.*/);
				bLocal_90 = true;
				iLocal_93 = MISC::GET_GAME_TIMER() + 1000;
				return false;
			}
			...
			else
			{
				...
				{
					case 1:
						func_171("STREET_PLAY_B" /*Press ~INPUT_CONTEXT~ to enter a motorcycle street race. The entry fee is $~1~.*/, iLocal_81.f_3);
						break;
				
					case 2:
						func_171("STREET_PLAY_C" /*Press ~INPUT_CONTEXT~ to enter a street race. The entry fee is $~1~.*/, iLocal_81.f_3);
						break;
				
					case 3:
						func_163("SEA_PLAY" /*Press ~INPUT_CONTEXT~ to enter a sea race.*/);
						break;
				}
...
void func_160() // Position - 0x8A22 (35362)
{
	char* str;
	...
	else if (iLocal_81.f_1 == 1)
	{
		...
		{
			func_161("STREET_NA_BIKE" /*A motorcycle is needed to enter this street race.*/);
			bLocal_90 = true;
			iLocal_93 = MISC::GET_GAME_TIMER() + 1000;
		}
	}
	...
	{
		func_161("STREET_NA_CAR" /*A car is needed to enter this street race.*/);
		bLocal_90 = true;
		iLocal_93 = MISC::GET_GAME_TIMER() + 1000;
	}
...
void func_161(char* sParam0) // Position - 0x8AB4 (35508)
{
...
BOOL _IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(char* message) // Position - 0x8ACA (35530)
{
	HUD::BEGIN_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(message);
	return HUD::END_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(0);
}

void func_163(char* sParam0) // Position - 0x8ADD (35549)
{
...
BOOL func_164() // Position - 0x8AF5 (35573)
{
	Hash entityModel;
...
BOOL func_165() // Position - 0x8B71 (35697)
{
	int num;
	char* str;
	...
	switch (iLocal_81.f_1)
	{
		case 1:
			...
			if (num == 1)
			{
				func_163("STREET_NA_COP" /*Can't enter a street race in an emergency vehicle.*/);
				return false;
			}
			else if (num == 2)
			{
				func_163("STREET_NA_BIKE" /*A motorcycle is needed to enter this street race.*/);
				return false;
			}
			break;
		...
		case 2:
			...
			{
				func_163("STREET_NA_CAR" /*A car is needed to enter this street race.*/);
				return false;
			}
			break;
...
BOOL func_166() // Position - 0x8C22 (35874)
{
	Hash entityModel;
...
int func_167() // Position - 0x8C64 (35940)
{
	Hash entityModel;
	int i;
	int num;
...
BOOL func_168(Hash hParam0) // Position - 0x9107 (37127)
{
	switch (hParam0)
	{
		case joaat("police"):
...
int func_169() // Position - 0x91C1 (37313)
{
	Hash entityModel;
...
void func_170(Vehicle* pveParam0) // Position - 0x920D (37389)
{
...
void func_171(char* sParam0, int iParam1) // Position - 0x9245 (37445)
{
...
void func_172(char* sParam0, int iParam1) // Position - 0x9261 (37473)
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(sParam0);
	HUD::ADD_TEXT_COMPONENT_INTEGER(iParam1);
	HUD::END_TEXT_COMMAND_DISPLAY_HELP(0, true, true, -1);
...
BOOL func_173(char* sParam0, int iParam1) // Position - 0x927D (37501)
{
...
int _GET_PLAYER_CASH(eCharacter echParam0) // Position - 0x9296 (37526)
{
	int outValue;
...
BOOL func_175() // Position - 0x92EE (37614)
{
...
BOOL func_176() // Position - 0x934D (37709)
{
	int num;
...
void func_177() // Position - 0x939D (37789)
{
	int i;
	int j;
	int k;
				...
				if (STREAMING::HAS_ANIM_DICT_LOADED(sLocal_182))
				{
					if (bLocal_191)
					{
						for (i = 0; i <= iLocal_172 - 1; i = i + 1)
						{
							...
							{
								if (!ENTITY::IS_ENTITY_DEAD(uLocal_101[i], false) && !func_178(uLocal_101[i], SCRIPT_TASK_PLAY_ANIM))
								{
				...
				if (STREAMING::HAS_ANIM_DICT_LOADED(sLocal_182))
				{
					if (bLocal_191)
					{
						for (j = 0; j <= iLocal_172 - 3; j = j + 1)
						{
							...
							{
								if (!ENTITY::IS_ENTITY_DEAD(uLocal_101[j], false) && !func_178(uLocal_101[j], SCRIPT_TASK_PLAY_ANIM))
								{
...
BOOL func_178(Ped pedParam0, eScriptTaskHash esthParam1) // Position - 0x9AC2 (39618)
{
...
BOOL func_179() // Position - 0x9AF5 (39669)
{
	if (!func_181())
		return false;

	if (func_67(PLAYER::PLAYER_PED_ID()))
		if (!func_180(PLAYER::PLAYER_PED_ID(), uLocal_111, 100f, true) || CAM::IS_SCREEN_FADED_OUT())
			return true;

	return false;
}

BOOL func_180(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, BOOL bParam5) // Position - 0x9B39 (39737)
{
	return BUILTIN::VDIST2(ENTITY::GET_ENTITY_COORDS(pedParam0, bParam5), vParam1) <= fParam4 * fParam4;
}

BOOL func_181() // Position - 0x9B57 (39767)
{
	if (iLocal_81.f_1 == 3)
		return true;
...
BOOL func_182(var uParam0) // Position - 0x9BA5 (39845)
{
	int i;
...
BOOL func_183(var uParam0) // Position - 0x9C01 (39937)
{
	return func_184(*uParam0, &(uParam0->f_2), uParam0->f_1);
}

BOOL func_184(int iParam0, const char* sParam1, Hash hParam2) // Position - 0x9C18 (39960)
{
...
int func_185(int iParam0) // Position - 0x9D03 (40195)
{
	int i;
...
void func_186(var uParam0) // Position - 0x9D2C (40236)
{
	int i;
...
void func_187(int* piParam0) // Position - 0x9DAA (40362)
{
	func_188(piParam0, &(piParam0->f_2), piParam0->f_1);
	return;
}

void func_188(int* piParam0, const char* sParam1, Hash hParam2) // Position - 0x9DC0 (40384)
{
	if (IS_BIT_SET(*piParam0, 30))
	{
		switch (func_185(*piParam0))
		{
			case 0:
...
void func_189() // Position - 0x9E91 (40593)
{
	int i;
	...
	if (iLocal_81.f_1 == 1 || iLocal_81.f_1 == 2)
	{
		...
		func_194(iLocal_81, &uLocal_205, &uLocal_208, &fLocal_211);
		...
		else
		{
			...
			func_193(&uLocal_214, hLocal_181);
		}
	
		hLocal_180 = func_192(iLocal_81.f_1);
	
		for (i = 0; i <= iLocal_172 - 1; i = i + 1)
		{
			func_193(&uLocal_214, iLocal_172[i]);
		}
	
		func_193(&uLocal_214, hLocal_180);
		func_190(&uLocal_214, sLocal_182);
...
void func_190(var uParam0, char* sParam1) // Position - 0xA81C (43036)
{
	func_191(uParam0, 1, -1, sParam1, 0);
	return;
}

void func_191(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4) // Position - 0xA82F (43055)
{
	int i;
...
Hash func_192(int iParam0) // Position - 0xA90E (43278)
{
	int num;
...
void func_193(var uParam0, int iParam1) // Position - 0xA94F (43343)
{
	func_191(uParam0, 0, iParam1, "NULL", 0);
	return;
}

void func_194(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0xA963 (43363)
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_195() // Position - 0xAA85 (43653)
{
	Vehicle playersLastVehicle;
	int i;
	int taskSequenceId;
	...
	if (func_67(PLAYER::PLAYER_PED_ID()) && PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
	{
		...
		if (func_17(playersLastVehicle) && PED::IS_PED_SITTING_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), playersLastVehicle) && !func_217(PLAYER::PLAYER_PED_ID(), playersLastVehicle, -1) && ENTITY::GET_ENTITY_MODEL(playersLastVehicle) != joaat("taxi"))
			return false;
	}
	...
	if (func_197())
	{
		...
		{
			case 0:
				Global_114878[0] = true;
				Global_114884[0] = MISC::GET_GAME_TIMER();
				break;
		
			case 1:
				Global_114878[1] = true;
				Global_114884[1] = MISC::GET_GAME_TIMER();
				break;
		
			case 2:
				Global_114878[2] = true;
				Global_114884[2] = MISC::GET_GAME_TIMER();
				break;
		
			case 3:
				Global_114878[3] = true;
				Global_114884[3] = MISC::GET_GAME_TIMER();
				break;
		
			case 4:
				Global_114878[4] = true;
				Global_114884[4] = MISC::GET_GAME_TIMER();
				break;
		
			case 5:
				Global_114868[0] = true;
				Global_114873[0] = MISC::GET_GAME_TIMER();
				break;
		
			case 6:
				Global_114868[1] = true;
				Global_114873[1] = MISC::GET_GAME_TIMER();
				break;
		
			case 7:
				Global_114868[2] = true;
				Global_114873[2] = MISC::GET_GAME_TIMER();
				break;
		
			case 8:
				Global_114868[3] = true;
				Global_114873[3] = MISC::GET_GAME_TIMER();
				break;
		}
...
void func_196(Ped pedParam0, BOOL bParam1) // Position - 0xAFD9 (45017)
{
	char* str;
	int endRange;
	...
	if (func_67(pedParam0))
	{
		...
		if (PED::IS_PED_MALE(pedParam0))
			func_155(pedParam0, str, "WAVELOAD_PAIN_MALE", 24, false);
		else
			func_155(pedParam0, str, "WAVELOAD_PAIN_FEMALE", 24, false);
	}

	return;
}

BOOL func_197() // Position - 0xB04C (45132)
{
	int i;
		...
		for (i = 0; i <= iLocal_168 - 1; i = i + 1)
		{
			if (ENTITY::DOES_ENTITY_EXIST(iLocal_168[i]))
				if (PED::IS_PED_INJURED(iLocal_168[i]))
					return true;
				else if (func_198(iLocal_168[i], true, 1116471296, 1126825984, false, false, false, false) || PED::IS_PED_BEING_JACKED(iLocal_168[i]))
					return true;
	...
	if (func_180(PLAYER::PLAYER_PED_ID(), uLocal_87, 50f, true) && PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
		return true;
	...
	if (ENTITY::DOES_ENTITY_EXIST(pedLocal_110))
	{
		...
		else if (func_198(pedLocal_110, true, 1116471296, 1126825984, false, false, false, false))
		{
			return true;
		}
	...
	for (i = 0; i <= iLocal_172 - 1; i = i + 1)
	{
		if (ENTITY::DOES_ENTITY_EXIST(uLocal_101[i]))
			if (PED::IS_PED_INJURED(uLocal_101[i]))
				return true;
			else if (func_198(uLocal_101[i], true, 1116471296, 1126825984, false, false, false, false))
				return true;
	}
...
BOOL func_198(Ped pedParam0, BOOL bParam1, int iParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7) // Position - 0xB29F (45727)
{
	float num;
	...
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(PLAYER::PLAYER_PED_ID()) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(pedParam0))
	{
		...
		if (func_212(pedParam0, bParam1, bParam5, bParam6, bParam7))
			return true;
		...
		if (!WEAPON::IS_PED_ARMED(PLAYER::PLAYER_PED_ID(), 6))
		{
			if (PED::IS_PED_IN_MELEE_COMBAT(PLAYER::PLAYER_PED_ID()))
			{
				...
				if ((num * num) + (num.f_1 * num.f_1) + (num.f_2 * num.f_2) <= 5f)
					return func_211(PLAYER::PLAYER_PED_ID(), pedParam0, iParam2);
			}
		}
	
		if (bParam4)
			return false;
		else if (func_199(pedParam0, iParam3))
			return true;
	}
...
BOOL func_199(Vehicle veParam0, int iParam1) // Position - 0xB35A (45914)
{
	float xSize;

	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(PLAYER::PLAYER_PED_ID()) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(veParam0))
	{
		if (func_210(veParam0) || PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), veParam0))
		{
			if (WEAPON::IS_PED_ARMED(PLAYER::PLAYER_PED_ID(), 6))
				xSize = 40f;
			else
...
BOOL func_200(Vehicle veParam0, int iParam1) // Position - 0xB3D0 (46032)
{
	return func_201(veParam0, PLAYER::PLAYER_PED_ID(), iParam1, 1, 250, 7);
}

BOOL func_201(Vehicle veParam0, Ped pedParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xB3E8 (46056)
{
	BOOL flag;
	var pedBoneCoords;
	int num;

	num = func_209(veParam0, pedParam1);

	if (!_DOES_ENTITY_EXIST_AND_IS_ALIVE(veParam0) || !_DOES_ENTITY_EXIST_AND_IS_ALIVE(pedParam1))
	{
		if (num != -1)
			func_208(&iLocal_38[num /*4*/]);
	
		return false;
	}

	if (!func_205(veParam0, pedParam1, iParam2, iParam3))
		return false;
	...
	flag = func_202(&iLocal_38[num /*4*/], pedBoneCoords, pedParam1, &(iLocal_38[num /*4*/].f_3), veParam0, iParam5);
	return flag || MISC::GET_GAME_TIMER() - iLocal_38[num /*4*/].f_3 < iParam4;
}

BOOL func_202(var uParam0, Vector3 vParam1, var uParam2, var uParam3, Ped pedParam4, var uParam5, Vehicle veParam6, int iParam7) // Position - 0xB4A9 (46249)
{
	var hit;
	var endCoords;
	var surfaceNormal;
	...
	if (*uParam0 == 0)
	{
		endCoords = { func_203(pedParam4, iParam7) };
...
Vector3 func_203(Ped pedParam0, int iParam1) // Position - 0xB5D5 (46549)
{
	int randomIntInRange;
...
int func_204() // Position - 0xB69A (46746)
{
	int i;
...
BOOL func_205(Vehicle veParam0, Ped pedParam1, int iParam2, int iParam3) // Position - 0xB6E4 (46820)
{
	var unk;
	var entityForwardVector;
	float num;

	unk = { func_207(ENTITY::GET_ENTITY_COORDS(pedParam1, true) - ENTITY::GET_ENTITY_COORDS(veParam0, true)) };
	...
	if (iParam3 == 0)
		...
		entityForwardVector = { func_207(PED::GET_PED_BONE_COORDS(veParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(veParam0, 31086, 0f, 0f, 0f)) };

	num = func_206(entityForwardVector, unk);
...
float func_206(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) // Position - 0xB775 (46965)
{
	return (fParam0 * uParam3) + (fParam0.f_1 * uParam3.f_1) + (fParam0.f_2 * uParam3.f_2);
}

Vector3 func_207(float fParam0, var uParam1, var uParam2) // Position - 0xB796 (46998)
{
	float num;
	float num2;
...
void func_208(var uParam0) // Position - 0xB7D5 (47061)
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_209(Vehicle veParam0, Ped pedParam1) // Position - 0xB7F0 (47088)
{
	int i;
...
BOOL func_210(Vehicle veParam0) // Position - 0xB82F (47151)
{
...
BOOL func_211(Ped pedParam0, Vehicle veParam1, int iParam2) // Position - 0xB857 (47191)
{
...
BOOL func_212(Vehicle veParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0xB89E (47262)
{
	float radius;
	float num;
	int weaponHash;
	...
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(PLAYER::PLAYER_PED_ID()) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(veParam0))
	{
		...
		if (!bParam2)
		{
			if (func_216(veParam0, bParam1, radius, num))
				return true;
		
			if (func_213(veParam0, num, bParam3, bParam4))
				return true;
		}
		else
		{
...
BOOL func_213(Vehicle veParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Position - 0xB999 (47513)
{
	float entityCoords;
	float num;
...
BOOL func_214(Vehicle veParam0, float fParam1) // Position - 0xBAA5 (47781)
{
	var outProjectile;
	var outCoords;
	...
	if (MISC::GET_PROJECTILE_OF_PROJECTILE_TYPE_WITHIN_DISTANCE(veParam0, joaat("WEAPON_GRENADE"), fParam1, &outCoords, &outProjectile, false) || MISC::GET_PROJECTILE_OF_PROJECTILE_TYPE_WITHIN_DISTANCE(veParam0, joaat("WEAPON_SMOKEGRENADE"), fParam1, &outCoords, &outProjectile, false) || MISC::GET_PROJECTILE_OF_PROJECTILE_TYPE_WITHIN_DISTANCE(veParam0, joaat("WEAPON_BZGAS"), fParam1, &outCoords, &outProjectile, false) || MISC::GET_PROJECTILE_OF_PROJECTILE_TYPE_WITHIN_DISTANCE(veParam0, joaat("WEAPON_STICKYBOMB"), fParam1, &outCoords, &outProjectile, false) || MISC::GET_PROJECTILE_OF_PROJECTILE_TYPE_WITHIN_DISTANCE(veParam0, joaat("WEAPON_MOLOTOV"), fParam1, &outCoords, &outProjectile, false))
		if (func_215(veParam0, outCoords, 90f, 0))
			return true;

	return false;
}

BOOL func_215(Vehicle veParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Position - 0xBB3A (47930)
{
	var unk;
	var entityForwardVector;
	float num;

	unk = { func_207(uParam1 - ENTITY::GET_ENTITY_COORDS(veParam0, true)) };
...
BOOL func_216(Vehicle veParam0, BOOL bParam1, float fParam2, float fParam3) // Position - 0xBBC8 (48072)
{
	if (bParam1)
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
BOOL func_217(Ped pedParam0, Vehicle veParam1, int iParam2) // Position - 0xBC10 (48144)
{
...
BOOL func_218() // Position - 0xBC4E (48206)
{
	switch (iLocal_81)
	{
		case 5:
			return IS_BIT_SET(Global_114904.f_24983.f_2, 0);
	
		case 6:
			return IS_BIT_SET(Global_114904.f_24983.f_2, 1);
	
		case 7:
			return IS_BIT_SET(Global_114904.f_24983.f_2, 2);
	
		case 8:
			return IS_BIT_SET(Global_114904.f_24983.f_2, 3);
	
		case 0:
			return IS_BIT_SET(Global_114904.f_24986.f_3, 0);
	
		case 1:
			return IS_BIT_SET(Global_114904.f_24986.f_3, 1);
	
		case 2:
			return IS_BIT_SET(Global_114904.f_24986.f_3, 2);
	
		case 3:
			return IS_BIT_SET(Global_114904.f_24986.f_3, 3);
	
		case 4:
			return IS_BIT_SET(Global_114904.f_24986.f_3, 4);
	}

	return false;
}

void func_219() // Position - 0xBD2D (48429)
{
	iLocal_80 = 0;
	bLocal_90 = false;
	bLocal_97 = false;
	...
	if (iLocal_81 == 1)
	{
		iLocal_213 = func_220(374.00833f, 279.59192f, 102.330574f, 40f);
		MISC::CLEAR_AREA_OF_VEHICLES(374.00833f, 279.59192f, 102.330574f, 25f, false, false, false, false, false, false, 0);
	}

	if (iLocal_81.f_1 == 1 || iLocal_81.f_1 == 2)
		iLocal_212 = func_220(uLocal_87, 60f);

	return;
}

int func_220(float fParam0, float fParam1, float fParam2, float fParam3) // Position - 0xBDC4 (48580)
{
	var unk;
...
void func_221(BOOL bParam0) // Position - 0xBDF7 (48631)
{
	if (bParam0)
	{
		switch (iLocal_81)
...
void func_222(var uParam0) // Position - 0xBE95 (48789)
{
	int i;
...
void func_223(var uParam0) // Position - 0xBECB (48843)
{
	func_224(*uParam0, &(uParam0->f_2), uParam0->f_1);
	return;
}

void func_224(int iParam0, const char* sParam1, Hash hParam2) // Position - 0xBEE2 (48866)
{
	if (IS_BIT_SET(iParam0, 30))
	{
		switch (func_185(iParam0))
...
BOOL func_225(int iParam0) // Position - 0xBF9C (49052)
{
	switch (iParam0)
	{
		case 0:
			return IS_BIT_SET(Global_114904.f_24986.f_1, 0);
	
		case 1:
			return IS_BIT_SET(Global_114904.f_24986.f_1, 1);
	
		case 2:
			return IS_BIT_SET(Global_114904.f_24986.f_1, 2);
	
		case 3:
			return IS_BIT_SET(Global_114904.f_24986.f_1, 3);
	
		case 4:
			return IS_BIT_SET(Global_114904.f_24986.f_1, 4);
	}

	return false;
}

BOOL func_226(int iParam0, int iParam1) // Position - 0xC022 (49186)
{
	BOOL flag;
...
void func_227() // Position - 0xC06C (49260)
{
	if (func_228(func_229(86, 0), uLocal_87, 1f, false))
	{
		iLocal_81 = 0;
		iLocal_81.f_1 = 2;
		iLocal_81.f_3 = 100;
	...
	else if (func_228(func_229(87, 0), uLocal_87, 1f, false))
	{
		iLocal_81 = 1;
		iLocal_81.f_1 = 2;
		iLocal_81.f_3 = 500;
	...
	else if (func_228(func_229(88, 0), uLocal_87, 1f, false))
	{
		iLocal_81 = 2;
		iLocal_81.f_1 = 2;
		iLocal_81.f_3 = 1000;
	...
	else if (func_228(func_229(89, 0), uLocal_87, 1f, false))
	{
		iLocal_81 = 3;
		iLocal_81.f_1 = 2;
		iLocal_81.f_3 = 1250;
	...
	else if (func_228(func_229(90, 0), uLocal_87, 1f, false))
	{
		iLocal_81 = 4;
		iLocal_81.f_1 = 1;
		iLocal_81.f_3 = 1500;
	...
	else if (func_228(func_229(82, 0), uLocal_87, 1f, false))
	{
		iLocal_81 = 5;
		iLocal_81.f_1 = 3;
		iLocal_81.f_3 = 0;
	...
	else if (func_228(func_229(83, 0), uLocal_87, 1f, false))
	{
		iLocal_81 = 6;
		iLocal_81.f_1 = 3;
		iLocal_81.f_3 = 0;
	...
	else if (func_228(func_229(84, 0), uLocal_87, 1f, false))
	{
		iLocal_81 = 7;
		iLocal_81.f_1 = 3;
		iLocal_81.f_3 = 0;
	...
	else if (func_228(func_229(85, 0), uLocal_87, 1f, false))
	{
		iLocal_81 = 8;
		iLocal_81.f_1 = 3;
		iLocal_81.f_4 = 24;
...
BOOL func_228(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, BOOL bParam7) // Position - 0xC204 (49668)
{
	if (fParam6 < 0f)
		fParam6 = 0f;
...
Vector3 func_229(int iParam0, int iParam1) // Position - 0xC27F (49791)
{
	int num;
...
void func_230(BOOL bParam0) // Position - 0xC2BD (49853)
{
	int i;
	Player playerIndex;
	...
	func_231(&uLocal_214, false);
	SCRIPT::TERMINATE_THIS_THREAD();
	return;
}

void func_231(var uParam0, BOOL bParam1) // Position - 0xC604 (50692)
{
	int i;
...
void func_232(var uParam0) // Position - 0xC63F (50751)
{
	*uParam0 = 0;
	uParam0->f_1 = -1;
...
void func_233(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0xC658 (50776)
{
	int num;
	BOOL flag;
