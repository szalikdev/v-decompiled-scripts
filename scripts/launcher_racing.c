...
void func_23(int iParam0) // Position - 0x121A (4634)
{
	...
	else if (IS_BIT_SET(Global_114344.f_20568.f_471, iParam0) || IS_BIT_SET(Global_2359296[func_25() /*5571*/].f_681.f_10, iParam0))
	{
		flag = true;
		MISC::CLEAR_BIT(&(Global_114344.f_20568.f_471), iParam0);
...
void func_56() // Position - 0x1C84 (7300)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (_GET_CHARACTER_MODEL(Global_114344.f_2367.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_57(character) && !func_49(14) || Global_113292)
			{
...
void func_69(BOOL bParam0, int iParam1) // Position - 0x2270 (8816)
{
	...
	if (bParam0)
	{
		func_70(&Global_24131.f_6263[num /*10*/]);
...
void func_83(BOOL bParam0, int iParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, int iParam5, BOOL bParam6, BOOL bParam7, int iParam8) // Position - 0x284A (10314)
{
	...
	if (bParam3)
	{
		...
		{
			func_122(Global_24131.f_5821 + 1, "DFLT_MNU_OPT" /*Exit*/, 0, true, false, false, false);
		...
		if (i == 1 && Global_24131.f_6331)
		{
			...
			else
			{
				if (Global_24131)
				{
					...
					{
						func_117(Global_24128, Global_24129, iParam5, num38, 0, 0, 0, 255);
						func_116(&unk5, &unk21, Global_24128 + (iParam5 * 0.5f), Global_24129 + (num38 * 0.5f), iParam5, num38, 0f, 255, 255, 255, 255, false, 0);
					}
					else
					{
						func_116(&unk5, &unk21, Global_24128 + (iParam5 * 0.5f), Global_24129 + (num38 * 0.5f), iParam5, num38, 0f, 255, 255, 255, 255, false, 0);
				...
				func_117(Global_24128, Global_24129 + num38, iParam5, 0.034722f, r, g, b, a);
				...
				if (MISC::GET_HASH_KEY(&(Global_24131.f_1)) != 0)
				{
					...
					func_114(Global_24128 + 0.00390625f, Global_24129 + num38 + 0.00416664f, 0);
				}
			
				if (Global_24131.f_6338)
				{
					func_115();
					func_112((Global_24128 + iParam5) - 0.00390625f - func_113("CM_ITEM_COUNT" /*~1~ / ~1~*/, Global_24131.f_6339, Global_24131.f_6340), Global_24129 + num38 + 0.00416664f, "CM_ITEM_COUNT" /*~1~ / ~1~*/, Global_24131.f_6339, Global_24131.f_6340);
				}
				else if (Global_24131.f_6334 > Global_24131.f_5828)
				{
					...
					{
						func_115();
						func_112((Global_24128 + iParam5) - 0.00390625f - func_113("CM_ITEM_COUNT" /*~1~ / ~1~*/, Global_24131.f_6337, Global_24131.f_6336), Global_24129 + num38 + 0.00416664f, "CM_ITEM_COUNT" /*~1~ / ~1~*/, Global_24131.f_6337, Global_24131.f_6336);
					}
				}
			}
			...
			func_116("CommonMenu", "Gradient_Bgd", Global_24128 + (iParam5 * 0.5f), (num42 + ((num36 - num42) * 0.5f)) - 0.00138888f, iParam5, num36 - num42, 0f, 255, 255, 255, 255, false, 0);
			...
			if (Global_24131.f_6334 > Global_24131.f_5828)
			{
				...
				func_117(Global_24128, num36 + 0f, iParam5, 0.034722f, r, g, b, a);
				...
				func_116("CommonMenu", "shop_arrows_upANDdown", Global_24128 + (iParam5 * 0.5f), num36 + 0f + (0.034722f * 0.5f), (textureResolution / 1280f) * num41, (textureResolution.f_1 / 720f) * num41, 0f, r, g, b, a, false, 0);
			...
			if (MISC::GET_HASH_KEY(&(Global_24131.f_5241)) != 0 && Global_24131.f_5323 != -1)
			{
				...
				{
					func_128(Global_24131.f_5325, true, true, &num26, &num27, bParam7);
				...
				func_117(Global_24128, num36 - 0.00277776f, iParam5, 0.00277776f, r, g, b, a);
				...
				{
					func_128(Global_24131.f_5325, true, true, &num26, &num27, bParam7);
					func_110(Global_24131.f_5325, true, &num32, &num33, &num34, &num35);
					func_116(func_121(Global_24131.f_5325), func_118(Global_24131.f_5325, true), Global_24128 + (num26 * 0.5f) + (0.00078125f * 2f), (num36 + (num27 * 0.5f)) - (0.00138888f * 4f), num26, num27, 0f, num32, num33, num34, num35, false, 0);
				}
			...
			if (MISC::GET_HASH_KEY(&(Global_4542961.f_21)) != 0 && Global_4542961.f_65 != -1)
			{
				...
				{
					func_128(Global_4542961.f_67, true, true, &num26, &num27, bParam7);
					x = (Global_24128 + num26 + (0.00078125f * 4f)) - (0.00078125f * 1f);
				}
				...
				{
					func_128(Global_4542961.f_67, true, true, &num26, &num27, bParam7);
					func_110(Global_4542961.f_67, true, &num32, &num33, &num34, &num35);
					func_116(func_121(Global_4542961.f_67), func_118(Global_4542961.f_67, true), Global_24128 + (num26 * 0.5f) + (0.00078125f * 2f), (num36 + (num27 * 0.5f)) - (0.00138888f * 4f), num26, num27, 0f, num32, num33, num34, num35, false, 0);
				}
		...
		if (i == 1 || !Global_24131.f_6331)
		{
			...
			for (j = 0; j <= num43; j = j + 1)
			{
				...
				if (flag && i == 1 && flag2)
				{
					...
					func_116("CommonMenu", "Gradient_Nav", Global_24128 + (iParam5 * 0.5f), num40 + num45 + (0.00277776f * (float)num5) + (num37 * 0.5f), iParam5, num37, 0f, r2, g2, b2, a2, false, 0);
						...
						switch (Global_24131.f_5659[k])
						{
								...
								if (flag2)
								{
									if (!Global_24131.f_6332)
									{
										...
										if (MISC::GET_HASH_KEY(&Global_24131.f_79[num16 /*6*/]) != 0)
										{
											...
											func_102(flag, Global_24131.f_1616[num16], Global_24131.f_1873[num16], flag7, num46, flag5, flag4);
										...
										if (num20 > 0)
										{
											...
											{
												if (func_128(Global_24131.f_4984[num14 + l], flag, false, &num26, &num27, bParam7))
												{
													num29 = num29 + num26;
									...
									if (MISC::GET_HASH_KEY(&Global_24131.f_79[num16 /*6*/]) != 0 && i == 1)
									{
										...
										func_102(flag, Global_24131.f_1616[num16], Global_24131.f_1873[num16], flag7, 0, flag5, flag4);
									...
									for (l = 0; l < 4; l = l + 1)
									{
										...
										else if (Global_24131.f_2387[num16 /*5*/][l] == 4)
										{
											...
											{
												if (func_128(Global_24131.f_4984[num14 + num20], flag, false, &num26, &num27, bParam7))
												{
													x = x + (num26 * 0.5f);
												
													if (func_128(Global_24131.f_4984[num14 + num20], flag, true, &num26, &num27, bParam7))
													{
														func_110(Global_24131.f_4984[num14 + num20], flag, &num32, &num33, &num34, &num35);
													
														if (i == 1)
															if (Global_24131.f_5686[k] == 2)
																func_116(func_121(Global_24131.f_4984[num14 + num20]), func_118(Global_24131.f_4984[num14 + num20], flag), ((num24 + x) - (0.00078125f * 8f)) + (0.00078125f * 4f), (num25 - 0.00277776f) + (num37 * 0.5f), num26, num27, 0f, num32, num33, num34, num35, false, 0);
															else
																func_116(func_121(Global_24131.f_4984[num14 + num20]), func_118(Global_24131.f_4984[num14 + num20], flag), (num24 + x) - (0.00078125f * 8f), (num25 - 0.00277776f) + (num37 * 0.5f), num26, num27, 0f, num32, num33, num34, num35, false, 0);
										...
										else
										{
											...
											if (IS_ROCKSTAR_DEV() && SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(joaat("fm_mission_creator")) > 0)
											{
												if (k == 0)
												{
													...
													func_102(false, Global_24131.f_1616[num16], Global_24131.f_1873[num16], flag7, 0, flag5, flag4);
													...
													func_114(num24 - num49, num25 + num48, 0);
													num22 = num22 + 1;
												}
											}
										}
										...
										for (l = 0; l < num20; l = l + 1)
										{
											if (Global_24131.f_4984[num14 + l] != 2 && Global_24131.f_4984[num14 + l] != 55 && Global_24131.f_4984[num14 + l] != 65)
											{
												if (func_128(Global_24131.f_4984[num14 + l], flag, false, &num26, &num27, bParam7))
												{
													...
													if (i == 1)
													{
														if (func_128(Global_24131.f_4984[num14 + l], flag, true, &num26, &num27, bParam7))
														{
															func_110(Global_24131.f_4984[num14 + l], flag, &num32, &num33, &num34, &num35);
														
															if (Global_24131.f_4984[num14 + l] == 31)
																func_116(func_121(Global_24131.f_4984[num14 + l]), func_118(Global_24131.f_4984[num14 + l], flag), Global_24128 + (num26 * 0.5f), (num25 + 0.00277776f + (num27 * 0.5f)) - (0.00078125f * 11f), num26, num27, 0f, num32, num33, num34, num35, false, 0);
															else if (Global_24131.f_5686[k] == 2)
																func_116(func_121(Global_24131.f_4984[num14 + l]), func_118(Global_24131.f_4984[num14 + l], flag), ((num24 + x + num28) - (0.00078125f * 8f)) + (0.00078125f * 4f), (num25 - 0.00277776f) + (num37 * 0.5f), num26, num27, 0f, num32, num33, num34, num35, false, 0);
															else
																func_116(func_121(Global_24131.f_4984[num14 + l]), func_118(Global_24131.f_4984[num14 + l], flag), (num24 + x + num28) - (0.00078125f * 12f), (num25 - 0.00277776f) + (num37 * 0.5f), num26, num27, 0f, num32, num33, num34, num35, false, 0);
														}
													}
							...
							case 2:
								if (flag2)
								{
									if (!Global_24131.f_6332)
									{
										func_102(flag, Global_24131.f_1616[num16], Global_24131.f_1873[num16], flag7, 0, false, false);
									...
									{
										func_102(flag, Global_24131.f_1616[num16], Global_24131.f_1873[num16], flag7, 0, false, false);
										func_96(num24 + x, num25, "NUMBER" /*~1~*/, Global_24131.f_4469[num12], 0);
									}
								}
							...
							case 3:
								if (flag2)
								{
									...
									func_102(flag, Global_24131.f_1616[num16], Global_24131.f_1873[num16], flag7, 0, false, false);
									func_92(num24 + x, num25, "NUMBER" /*~1~*/, Global_24131.f_4726[num13], Global_24131.f_4855[num13]);
								}
							...
							case 4:
								if (flag2)
								{
									if (func_128(Global_24131.f_4984[num14], flag, false, &num26, &num27, bParam7))
									{
										if (!Global_24131.f_6332)
										{
											num29 = num26;
										...
										if (i == 1)
										{
											if (func_128(Global_24131.f_4984[num14], flag, true, &num26, &num27, bParam7))
											{
												func_110(Global_24131.f_4984[num14], flag, &num32, &num33, &num34, &num35);
												func_116(func_121(Global_24131.f_4984[num14]), func_118(Global_24131.f_4984[num14], flag), num24 + x + (num26 * 0.5f), (num25 - 0.00277776f) + (num37 * 0.5f), num26 * func_91(Global_24131.f_4984[num14]), num27 * func_91(Global_24131.f_4984[num14]), 0f, num32, num33, num34, num35, false, 0);
											}
										}
									}
								}
...
void func_92(float fParam0, float fParam1, char* sParam2, float fParam3, int iParam4) // Position - 0x5C2E (23598)
{
...
float func_93(float fParam0) // Position - 0x5C51 (23633)
{
	fParam0 = fParam0 * func_94();
	return fParam0;
}

float func_94() // Position - 0x5C64 (23652)
{
	return 1.7777778f / func_95();
}

float func_95() // Position - 0x5C76 (23670)
{
	return Global_24131.f_9149;
}

void func_96(float fParam0, float fParam1, char* sParam2, BOOL bParam3, int iParam4) // Position - 0x5C84 (23684)
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_TEXT(sParam2);
...
BOOL IS_ROCKSTAR_DEV() // Position - 0x5CA6 (23718)
{
	return DLC::IS_DLC_PRESENT(-1762644250);
}

void func_98(BOOL bParam0) // Position - 0x5CB7 (23735)
{
	int r;
	int g;
	int b;
...
float func_99(BOOL bParam0) // Position - 0x5CFD (23805)
{
	return func_100(HUD::END_TEXT_COMMAND_GET_SCREEN_WIDTH_OF_DISPLAY_TEXT(bParam0));
}

float func_100(float fParam0) // Position - 0x5D0F (23823)
{
	fParam0 = fParam0 * func_101();
	return fParam0;
}

float func_101() // Position - 0x5D22 (23842)
{
	return func_95() / 1.7777778f;
}

void func_102(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, int iParam4, BOOL bParam5, BOOL bParam6) // Position - 0x5D34 (23860)
{
	int r;
	int g;
	int b;
	...
	if (bParam2)
	{
		if (bParam3)
		{
			func_104(Global_24131.f_6614[iParam4], &r, &g, &b);
...
void func_103(float fParam0, float fParam1) // Position - 0x5EE2 (24290)
{
	HUD::SET_TEXT_WRAP(func_93(fParam0), func_93(fParam1));
	return;
}

void func_104(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x5EFA (24314)
{
	switch (iParam0)
	{
		case 0:
...
void func_105(var uParam0, int iParam1, int iParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, int iParam7, BOOL bParam8) // Position - 0x6184 (24964)
{
	int num;
	int i;
	int j;
...
void func_106(char* sParam0) // Position - 0x6689 (26249)
{
...
void func_107(char* sParam0) // Position - 0x669B (26267)
{
	GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_PLAYER_NAME_STRING(sParam0);
	return;
}

BOOL func_108() // Position - 0x66A9 (26281)
{
	var position;
...
BOOL func_109() // Position - 0x6717 (26391)
{
	if (SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(joaat("cellphone_flashhand")) > 0)
		return true;
...
void func_110(int iParam0, BOOL bParam1, int* piParam2, int* piParam3, int* piParam4, int* piParam5) // Position - 0x6731 (26417)
{
...
void func_111(float fParam0) // Position - 0x686D (26733)
{
	int r;
	int g;
	int b;
...
void func_112(float fParam0, float fParam1, char* sParam2, int iParam3, int iParam4) // Position - 0x68CC (26828)
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_TEXT(sParam2);
...
float func_113(char* sParam0, int iParam1, int iParam2) // Position - 0x68F3 (26867)
{
...
void func_114(float fParam0, float fParam1, int iParam2) // Position - 0x6935 (26933)
{
	HUD::END_TEXT_COMMAND_DISPLAY_TEXT(func_93(fParam0), fParam1, iParam2);
	return;
}

void func_115() // Position - 0x694B (26955)
{
	int r;
	int g;
	int b;
...
void func_116(char* sParam0, char* sParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6, int iParam7, int iParam8, int iParam9, int iParam10, BOOL bParam11, int iParam12) // Position - 0x69D5 (27093)
{
...
void func_117(float fParam0, float fParam1, int iParam2, float fParam3, int iParam4, int iParam5, int iParam6, int iParam7) // Position - 0x6A03 (27139)
{
...
char* func_118(int iParam0, BOOL bParam1) // Position - 0x6A3A (27194)
{
	var unk;
	var txdName;
	var netHandle;
...
char* func_119(char* sParam0) // Position - 0x6F6A (28522)
{
	return sParam0;
}

struct<13> GET_GAMER_HANDLE_PLAYER(Player plParam0) // Position - 0x6F74 (28532)
{
	var gamerHandle;
...
char* func_121(int iParam0) // Position - 0x6F8B (28555)
{
	var txdName;
	var netHandle;
...
void func_122(int iParam0, char* sParam1, int iParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0x7000 (28672)
{
	int num;
	float num2;
	float num3;
	...
	if (!bParam3)
		func_125(Global_24131.f_5821, true);
	else
		func_125(Global_24131.f_5821, false);

	if (iParam2 == 0)
	{
		num2 = func_124(&Global_24131.f_79[Global_24131.f_5823 /*6*/]);
	...
	if (bParam5)
	{
		if (iParam2 == 0)
		{
			num4 = func_123(&Global_24131.f_79[Global_24131.f_5823 /*6*/]);
...
float func_123(char* sParam0) // Position - 0x721C (29212)
{
	!HUD::DOES_TEXT_LABEL_EXIST(sParam0);
	return HUD::GET_RENDERED_CHARACTER_HEIGHT(0.35f, 0);
}

float func_124(char* sParam0) // Position - 0x7238 (29240)
{
	if (!MISC::IS_STRING_NULL(sParam0))
		if (MISC::GET_HASH_KEY(sParam0) == 0)
			return 0f;
...
void func_125(int iParam0, BOOL bParam1) // Position - 0x7275 (29301)
{
	int num;
...
void func_126(BOOL bParam0, int* piParam1, int* piParam2, var uParam3) // Position - 0x72C1 (29377)
{
	float num;
	float value;
	float aspectRatio;
...
BOOL func_127(int iParam0, int iParam1) // Position - 0x7349 (29513)
{
	return BUILTIN::TO_FLOAT(iParam0) / BUILTIN::TO_FLOAT(iParam1) > 3.5f;
}

BOOL func_128(int iParam0, BOOL bParam1, BOOL bParam2, var uParam3, var uParam4, BOOL bParam5) // Position - 0x7364 (29540)
{
	var textureDict;
	var textureName;
	int num;
...
float func_129(int iParam0) // Position - 0x7490 (29840)
{
	switch (iParam0)
	{
		case 34:
...
BOOL func_130(BOOL bParam0, BOOL bParam1) // Position - 0x756A (30058)
{
	if (Global_2672964.f_1761.f_701 != 0)
		return true;

	if (!CAM::IS_SCREEN_FADED_IN() || func_132(8, -1) && func_131() != TRANSITION_STATE_WAITING_FOR_EXTERNAL_TERMINATION_CALL || HUD::GET_PAUSE_MENU_STATE() != 0 && !bParam1 || STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS() && !bParam0 || NETWORK::IS_COMMERCE_STORE_OPEN() || Global_80005 || Global_24131.f_9147 || HUD::IS_WARNING_MESSAGE_ACTIVE() || Global_101945.f_1490)
		return false;

	return true;
}

eTransitionState func_131() // Position - 0x7607 (30215)
{
	return Global_1575014;
}

BOOL func_132(int iParam0, int iParam1) // Position - 0x7613 (30227)
{
	switch (iParam0)
	{
		case 5:
...
void func_133(int iParam0, BOOL bParam1, int iParam2) // Position - 0x764B (30283)
{
	int i;
	int num;
...
void func_134(var uParam0, var uParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x779D (30621)
{
...
void func_135() // Position - 0x7872 (30834)
{
	...
	func_122(1, "RACES_OPT_MP" /*Play Online*/, 0, true, false, false, false);
...
void func_136(int iParam0) // Position - 0x78F9 (30969)
{
	Global_24131.f_6341 = iParam0;
	return;
}

void func_137(int iParam0, char* sParam1, int iParam2) // Position - 0x7909 (30985)
{
...
void func_138(eControlAction ecaParam0, char* sParam1, int iParam2) // Position - 0x79B9 (31161)
{
...
void func_139(char* sParam0) // Position - 0x7A68 (31336)
{
	int i;
...
void func_140(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4) // Position - 0x7AB3 (31411)
{
...
void func_141(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4) // Position - 0x7AF2 (31474)
{
...
void func_142(BOOL bParam0, BOOL bParam1) // Position - 0x7B9C (31644)
{
	int i;
	int j;
	float aspectRatio;
	...
	Global_24131.f_9149 = func_143(false);
	Global_24128 = 0.05f;
	Global_24129 = 0.05f;
	Global_24130 = 0.225f;
	aspectRatio = GRAPHICS::GET_ASPECT_RATIO(false);
...
float func_143(BOOL bParam0) // Position - 0x8081 (32897)
{
	float aspectRatio;
...
BOOL func_144(char* sParam0, int iParam1, BOOL bParam2) // Position - 0x80AC (32940)
{
	int num;
	BOOL flag;
	BOOL flag2;
	...
	flag2 = func_145(&Global_24131.f_6263[num /*10*/]);
	!flag || !flag2;
	return flag && flag2;
}

BOOL func_145(int* piParam0) // Position - 0x81BA (33210)
{
	switch (piParam0->f_9)
	{
		case 0:
...
void func_146() // Position - 0x825C (33372)
{
	int num;
...
void func_147() // Position - 0x830D (33549)
{
...
void func_148(int iParam0) // Position - 0x832E (33582)
{
	int taskSequenceId;
...
float func_149(var uParam0) // Position - 0x84F7 (34039)
{
	if (func_152(uParam0))
		if (func_151(uParam0))
			return uParam0->f_2;
...
float func_150(BOOL bParam0) // Position - 0x8533 (34099)
{
	float num;
	float num2;
	int networkTime;
...
BOOL func_151(var uParam0) // Position - 0x858B (34187)
{
	return IS_BIT_SET(*uParam0, 2);
}

BOOL func_152(var uParam0) // Position - 0x8598 (34200)
{
	return IS_BIT_SET(*uParam0, 1);
}

void func_153(int* piParam0) // Position - 0x85A5 (34213)
{
	func_154(piParam0, 0f);
	return;
}

void func_154(int* piParam0, float fParam1) // Position - 0x85B4 (34228)
{
...
void func_155(Ped pedParam0, char* sParam1, char* sParam2, int iParam3, BOOL bParam4) // Position - 0x85DF (34271)
{
	AUDIO::PLAY_PED_AMBIENT_SPEECH_WITH_VOICE_NATIVE(pedParam0, sParam1, sParam2, func_156(iParam3), bParam4);
	return;
}

char* func_156(int iParam0) // Position - 0x85F9 (34297)
{
	char* str;
...
void func_157(int iParam0) // Position - 0x87EE (34798)
{
...
BOOL func_158() // Position - 0x884B (34891)
{
...
BOOL func_159() // Position - 0x8864 (34916)
{
...
void func_160() // Position - 0x89D6 (35286)
{
	char* str;
...
void func_161(char* sParam0) // Position - 0x8A68 (35432)
{
...
BOOL _IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(char* message) // Position - 0x8A7E (35454)
{
	HUD::BEGIN_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(message);
	return HUD::END_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(0);
}

void func_163(char* sParam0) // Position - 0x8A91 (35473)
{
...
BOOL func_164() // Position - 0x8AA9 (35497)
{
	Hash entityModel;
...
BOOL func_165() // Position - 0x8B25 (35621)
{
	int num;
	char* str;
...
BOOL func_166() // Position - 0x8BD6 (35798)
{
	Hash entityModel;
...
int func_167() // Position - 0x8C18 (35864)
{
	Hash entityModel;
	int i;
	int num;
...
BOOL func_168(Hash hParam0) // Position - 0x90BB (37051)
{
	switch (hParam0)
	{
		case joaat("police"):
...
int func_169() // Position - 0x9169 (37225)
{
	Hash entityModel;
...
void func_170(Vehicle* pveParam0) // Position - 0x91B5 (37301)
{
...
void func_171(char* sParam0, int iParam1) // Position - 0x91ED (37357)
{
...
void func_172(char* sParam0, int iParam1) // Position - 0x9209 (37385)
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(sParam0);
	HUD::ADD_TEXT_COMPONENT_INTEGER(iParam1);
	HUD::END_TEXT_COMMAND_DISPLAY_HELP(0, true, true, -1);
...
BOOL func_173(char* sParam0, int iParam1) // Position - 0x9225 (37413)
{
...
int _GET_PLAYER_CASH(eCharacter echParam0) // Position - 0x923E (37438)
{
	int outValue;
...
BOOL func_175() // Position - 0x9296 (37526)
{
...
BOOL func_176() // Position - 0x92F5 (37621)
{
	int num;
...
void func_177() // Position - 0x9345 (37701)
{
	int i;
	int j;
	int k;
...
BOOL func_178(Ped pedParam0, eScriptTaskHash esthParam1) // Position - 0x9A6A (39530)
{
...
BOOL func_179() // Position - 0x9A9D (39581)
{
	if (!func_181())
		return false;
...
BOOL func_180(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, BOOL bParam5) // Position - 0x9AE1 (39649)
{
	return BUILTIN::VDIST2(ENTITY::GET_ENTITY_COORDS(pedParam0, bParam5), vParam1) <= fParam4 * fParam4;
}

BOOL func_181() // Position - 0x9AFF (39679)
{
	if (iLocal_81.f_1 == 3)
		return true;
...
BOOL func_182(var uParam0) // Position - 0x9B4D (39757)
{
	int i;
...
BOOL func_183(var uParam0) // Position - 0x9BA9 (39849)
{
	return func_184(*uParam0, &(uParam0->f_2), uParam0->f_1);
}

BOOL func_184(int iParam0, const char* sParam1, Hash hParam2) // Position - 0x9BC0 (39872)
{
...
int func_185(int iParam0) // Position - 0x9CAB (40107)
{
	int i;
...
void func_186(var uParam0) // Position - 0x9CD4 (40148)
{
	int i;
...
void func_187(int* piParam0) // Position - 0x9D52 (40274)
{
	func_188(piParam0, &(piParam0->f_2), piParam0->f_1);
	return;
}

void func_188(int* piParam0, const char* sParam1, Hash hParam2) // Position - 0x9D68 (40296)
{
...
void func_189() // Position - 0x9E39 (40505)
{
	int i;
...
void func_190(var uParam0, char* sParam1) // Position - 0xA7C4 (42948)
{
	func_191(uParam0, 1, -1, sParam1, 0);
	return;
}

void func_191(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4) // Position - 0xA7D7 (42967)
{
	int i;
...
Hash func_192(int iParam0) // Position - 0xA8B6 (43190)
{
	int num;
...
void func_193(var uParam0, int iParam1) // Position - 0xA8F7 (43255)
{
	func_191(uParam0, 0, iParam1, "NULL", 0);
	return;
}

void func_194(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0xA90B (43275)
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_195() // Position - 0xAA2D (43565)
{
	Vehicle playersLastVehicle;
	int i;
	int taskSequenceId;
...
void func_196(Ped pedParam0, BOOL bParam1) // Position - 0xAF81 (44929)
{
	char* str;
	int endRange;
...
BOOL func_197() // Position - 0xAFF4 (45044)
{
	int i;
...
BOOL func_198(Ped pedParam0, BOOL bParam1, int iParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7) // Position - 0xB247 (45639)
{
	float num;
...
BOOL func_199(Vehicle veParam0, int iParam1) // Position - 0xB302 (45826)
{
	float xSize;
...
BOOL func_200(Vehicle veParam0, int iParam1) // Position - 0xB378 (45944)
{
	return func_201(veParam0, PLAYER::PLAYER_PED_ID(), iParam1, 1, 250, 7);
}

BOOL func_201(Vehicle veParam0, Ped pedParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xB390 (45968)
{
	BOOL flag;
	var pedBoneCoords;
	int num;
...
BOOL func_202(var uParam0, Vector3 vParam1, var uParam2, var uParam3, Ped pedParam4, var uParam5, Vehicle veParam6, int iParam7) // Position - 0xB451 (46161)
{
	var hit;
	var endCoords;
	var surfaceNormal;
...
Vector3 func_203(Ped pedParam0, int iParam1) // Position - 0xB57D (46461)
{
	int randomIntInRange;
...
int func_204() // Position - 0xB642 (46658)
{
	int i;
...
BOOL func_205(Vehicle veParam0, Ped pedParam1, int iParam2, int iParam3) // Position - 0xB68C (46732)
{
	var unk;
...
float func_206(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) // Position - 0xB71D (46877)
{
	return (fParam0 * uParam3) + (fParam0.f_1 * uParam3.f_1) + (fParam0.f_2 * uParam3.f_2);
}

Vector3 func_207(float fParam0, var uParam1, var uParam2) // Position - 0xB73E (46910)
{
	float num;
	float num2;
...
void func_208(var uParam0) // Position - 0xB77D (46973)
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_209(Vehicle veParam0, Ped pedParam1) // Position - 0xB798 (47000)
{
	int i;
...
BOOL func_210(Vehicle veParam0) // Position - 0xB7D7 (47063)
{
...
BOOL func_211(Ped pedParam0, Vehicle veParam1, int iParam2) // Position - 0xB7FF (47103)
{
...
BOOL func_212(Vehicle veParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0xB846 (47174)
{
	float radius;
	float num;
	int weaponHash;
...
BOOL func_213(Vehicle veParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Position - 0xB941 (47425)
{
	float entityCoords;
	float num;
...
BOOL func_214(Vehicle veParam0, float fParam1) // Position - 0xBA4D (47693)
{
	var outProjectile;
	var outCoords;
...
BOOL func_215(Vehicle veParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Position - 0xBAE2 (47842)
{
	var unk;
	var entityForwardVector;
	float num;
...
BOOL func_216(Vehicle veParam0, BOOL bParam1, float fParam2, float fParam3) // Position - 0xBB70 (47984)
{
	if (bParam1)
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
BOOL func_217(Ped pedParam0, Vehicle veParam1, int iParam2) // Position - 0xBBB8 (48056)
{
...
BOOL func_218() // Position - 0xBBF6 (48118)
{
	switch (iLocal_81)
	{
		case 5:
			return IS_BIT_SET(Global_114344.f_24980.f_2, 0);
	
		case 6:
			return IS_BIT_SET(Global_114344.f_24980.f_2, 1);
	
		case 7:
			return IS_BIT_SET(Global_114344.f_24980.f_2, 2);
	
		case 8:
			return IS_BIT_SET(Global_114344.f_24980.f_2, 3);
	
		case 0:
			return IS_BIT_SET(Global_114344.f_24983.f_3, 0);
	
		case 1:
			return IS_BIT_SET(Global_114344.f_24983.f_3, 1);
	
		case 2:
			return IS_BIT_SET(Global_114344.f_24983.f_3, 2);
	
		case 3:
			return IS_BIT_SET(Global_114344.f_24983.f_3, 3);
	
		case 4:
			return IS_BIT_SET(Global_114344.f_24983.f_3, 4);
	}

	return false;
}

void func_219() // Position - 0xBCD5 (48341)
{
	iLocal_80 = 0;
	bLocal_90 = false;
	bLocal_97 = false;
...
int func_220(float fParam0, float fParam1, float fParam2, float fParam3) // Position - 0xBD6C (48492)
{
	var unk;
...
void func_221(BOOL bParam0) // Position - 0xBD9F (48543)
{
	if (bParam0)
	{
		switch (iLocal_81)
...
void func_222(var uParam0) // Position - 0xBE3D (48701)
{
	int i;
...
void func_223(var uParam0) // Position - 0xBE73 (48755)
{
	func_224(*uParam0, &(uParam0->f_2), uParam0->f_1);
	return;
}

void func_224(int iParam0, const char* sParam1, Hash hParam2) // Position - 0xBE8A (48778)
{
	if (IS_BIT_SET(iParam0, 30))
	{
		switch (func_185(iParam0))
...
BOOL func_225(int iParam0) // Position - 0xBF44 (48964)
{
	switch (iParam0)
	{
		case 0:
			return IS_BIT_SET(Global_114344.f_24983.f_1, 0);
	
		case 1:
			return IS_BIT_SET(Global_114344.f_24983.f_1, 1);
	
		case 2:
			return IS_BIT_SET(Global_114344.f_24983.f_1, 2);
	
		case 3:
			return IS_BIT_SET(Global_114344.f_24983.f_1, 3);
	
		case 4:
			return IS_BIT_SET(Global_114344.f_24983.f_1, 4);
	}

	return false;
}

BOOL func_226(int iParam0, int iParam1) // Position - 0xBFC7 (49095)
{
	BOOL flag;
...
void func_227() // Position - 0xC013 (49171)
{
...
BOOL func_228(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, BOOL bParam7) // Position - 0xC1AB (49579)
{
	if (fParam6 < 0f)
		fParam6 = 0f;
...
Vector3 func_229(int iParam0, int iParam1) // Position - 0xC226 (49702)
{
	int num;
...
void func_230(BOOL bParam0) // Position - 0xC264 (49764)
{
	int i;
	Player playerIndex;
...
void func_231(var uParam0, BOOL bParam1) // Position - 0xC5AB (50603)
{
	int i;
...
void func_232(var uParam0) // Position - 0xC5E6 (50662)
{
	*uParam0 = 0;
	uParam0->f_1 = -1;
...
void func_233(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0xC5FF (50687)
{
	int num;
	BOOL flag;
