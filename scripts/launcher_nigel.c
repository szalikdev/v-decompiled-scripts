	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (num != -1)
		{
			if (Global_113991[num /*10*/].f_9 != -1)
			{
				...
				func_329(&(Global_113991[num /*10*/].f_9));
			}
		}
...
ePedComponentType func_83() // Position - 0x784E (30798)
{
...
Vector3 func_97(ePedComponentType epctParam0, int iParam1) // Position - 0x8A8F (35471)
{
	switch (iParam1)
	{
		case 0:
...
int func_98() // Position - 0x8C1F (35871)
{
	return func_99(PLAYER::PLAYER_ID());
}

int func_99(Player plParam0) // Position - 0x8C2F (35887)
{
	return MISC::GET_BITS_IN_RANGE(Global_2658291[plParam0 /*468*/].f_325.f_3, 28, 31);
}

BOOL func_100(int iParam0) // Position - 0x8C4C (35916)
{
	return func_74(iParam0, 0, false);
}

int func_101(int iParam0) // Position - 0x8C5C (35932)
{
	switch (iParam0)
	{
		case -1:
...
BOOL func_102() // Position - 0x8FC6 (36806)
{
	return Global_102481.f_417 > 0;
}

var func_103() // Position - 0x8FD7 (36823)
{
	var unk;
...
void func_104(var uParam0, int iParam1) // Position - 0x901D (36893)
{
	if (iParam1 <= 0)
		return;
...
void func_105(var uParam0, int iParam1) // Position - 0x90A3 (37027)
{
...
void func_106(var uParam0, int iParam1) // Position - 0x90D6 (37078)
{
	int num;
	int num2;
...
int func_107(int iParam0, int iParam1) // Position - 0x9127 (37159)
{
	if (iParam1 < 0)
		iParam1 = 0;
...
int func_108(int iParam0) // Position - 0x91C9 (37321)
{
	return (BUILTIN::SHIFT_RIGHT(iParam0, 26) & 31 * IS_BIT_SET(iParam0, 31) ? -1 : 1) + 2011;
}

var func_109(BOOL bParam0, var uParam1, var uParam2) // Position - 0x91EB (37355)
{
	if (bParam0)
		return uParam1;
...
int func_110(int iParam0) // Position - 0x9202 (37378)
{
	return iParam0 & 15;
}

void func_111(var uParam0, int iParam1) // Position - 0x920F (37391)
{
...
void func_112(var uParam0, int iParam1) // Position - 0x9249 (37449)
{
...
void func_113(var uParam0, int iParam1) // Position - 0x9284 (37508)
{
	if (iParam1 < 0 || iParam1 >= 60)
		return;
...
eCharacter _GET_CURRENT_PLAYER_CHARACTER_0() // Position - 0x92C0 (37568)
{
	func_58();
	return Global_114904.f_2370.f_539.f_4321;
}

void func_115(int iParam0) // Position - 0x92D9 (37593)
{
	int num;
	var textLabel;
...
BOOL func_116() // Position - 0x933C (37692)
{
	return MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION();
}

BOOL func_117() // Position - 0x9352 (37714)
{
	return MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION();
}

void func_118(char* sParam0, Any anParam1, int iParam2) // Position - 0x9368 (37736)
{
...
BOOL func_119(BOOL bParam0) // Position - 0x93AA (37802)
{
...
struct<2> func_120(int iParam0) // Position - 0x93D2 (37842)
{
	var unk;
...
void func_121(int iParam0, var uParam1) // Position - 0x981F (38943)
{
	switch (iParam0)
	{
		case 0:
...
int func_123(int iParam0) // Position - 0xAAF7 (43767)
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_124(Any* panParam0) // Position - 0xAE3D (44605)
{
	int threadId;
...
void func_125(int iParam0) // Position - 0xAEE2 (44770)
{
	var name;
...
void func_126(int iParam0) // Position - 0xAF7D (44925)
{
	if (iParam0 < 63)
	{
		func_127();
...
void func_127() // Position - 0xAFA3 (44963)
{
	Global_80535 != 6;
...
void func_128(Ped pedParam0) // Position - 0xAFDB (45019)
{
	int num;
	int num2;
	int num3;
...
void func_129(int iParam0) // Position - 0xB034 (45108)
{
...
int func_130(Ped pedParam0) // Position - 0xB0B7 (45239)
{
	int i;
...
void func_131(int iParam0, int iParam1, int iParam2) // Position - 0xB0E8 (45288)
{
	func_132(iParam0, iParam1, iParam2, 0, 0, 1);
	return;
}

void func_132(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xB0FD (45309)
{
	int num;
...
int func_133() // Position - 0xB17F (45439)
{
	int i;
...
BOOL func_134(int iParam0, int iParam1, int iParam2) // Position - 0xB1B0 (45488)
{
...
int func_135(int iParam0, int iParam1, int iParam2) // Position - 0xB1CB (45515)
{
	int i;
...
int func_136(Ped pedParam0) // Position - 0xB217 (45591)
{
	int i;
...
BOOL func_137(Ped pedParam0) // Position - 0xB260 (45664)
{
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(Ped pedParam0) // Position - 0xB280 (45696)
{
	if (ENTITY::DOES_ENTITY_EXIST(pedParam0))
...
BOOL func_139(int iParam0) // Position - 0xB2A1 (45729)
{
	switch (iParam0)
	{
		case 5:
...
void func_140() // Position - 0xB2F4 (45812)
{
...
BOOL func_141(int iParam0) // Position - 0xB371 (45937)
{
	switch (iParam0)
	{
		case 5:
...
void func_142(Any* panParam0, BOOL bParam1, BOOL bParam2) // Position - 0xB3C4 (46020)
{
	int i;
...
BOOL func_143(int iParam0) // Position - 0xB4BA (46266)
{
	switch (iParam0)
	{
		case 5:
...
void func_144(BOOL bParam0) // Position - 0xB525 (46373)
{
	Player playerIndex;
...
void func_145(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB564 (46436)
{
	if (bParam0)
	{
...
BOOL func_146() // Position - 0xB6B3 (46771)
{
	return IS_BIT_SET(Global_1845250[PLAYER::PLAYER_ID() /*880*/].f_36.f_18, 14);
}

BOOL func_147(Player plParam0, int iParam1) // Position - 0xB6CD (46797)
{
	BOOL flag;
...
int func_148(int iParam0, BOOL bParam1) // Position - 0xB726 (46886)
{
	int num;
	int num2;
...
BOOL func_150(Player plParam0) // Position - 0xB789 (46985)
{
...
BOOL func_151() // Position - 0xB7C8 (47048)
{
	return IS_BIT_SET(Global_2621446, 3);
}

BOOL func_152() // Position - 0xB7D6 (47062)
{
...
void func_153(int iParam0) // Position - 0xB7FD (47101)
{
	if (iParam0 == 1)
...
BOOL func_154(const char* sParam0) // Position - 0xB820 (47136)
{
...
void func_155() // Position - 0xB85D (47197)
{
	Global_21849 = 0;
	func_156();
	return;
...
void func_156() // Position - 0xB86D (47213)
{
...
BOOL func_157() // Position - 0xB8C4 (47300)
{
...
void func_158() // Position - 0xB8E6 (47334)
{
	func_164(0);
	func_163();
	func_159();
...
void func_159() // Position - 0xB8FB (47355)
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
...
BOOL func_160(Vehicle veParam0, float fParam1, int iParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB953 (47443)
{
...
void func_161(Vehicle veParam0) // Position - 0xB9AA (47530)
{
	if (!ENTITY::IS_ENTITY_DEAD(veParam0, false))
...
void func_162(BOOL bParam0, BOOL bParam1) // Position - 0xB9D6 (47574)
{
...
void func_163() // Position - 0xBB27 (47911)
{
...
void func_164(int iParam0) // Position - 0xBB78 (47992)
{
	if (func_169())
		return;
...
void func_165(int iParam0) // Position - 0xBBAB (48043)
{
	if (func_169())
		return;
...
void func_166(BOOL bParam0, BOOL bParam1) // Position - 0xBC35 (48181)
{
	if (bParam0)
	{
		if (func_168(0))
...
BOOL func_167() // Position - 0xBCA9 (48297)
{
	return IS_BIT_SET(Global_1964145, 5);
}

BOOL func_168(int iParam0) // Position - 0xBCB7 (48311)
{
	if (iParam0 == 1)
...
BOOL func_169() // Position - 0xBD0E (48398)
{
	return IS_BIT_SET(Global_1964145, 19);
}

BOOL func_170(int iParam0) // Position - 0xBD1D (48413)
{
...
BOOL func_171(int iParam0) // Position - 0xBD5E (48478)
{
	int num;
...
void func_172(int iParam0) // Position - 0xBDA3 (48547)
{
...
int func_173(int iParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4) // Position - 0xBDD5 (48597)
{
	int i;
...
void func_174(int iParam0, int iParam1) // Position - 0xBF0C (48908)
{
	int i;
...
BOOL _CAN_ENTER_FREEROAM_STATE(int iParam0) // Position - 0xBF5B (48987)
{
	return func_176(iParam0, Global_44869);
}

BOOL func_176(int iParam0, int iParam1) // Position - 0xBF6C (49004)
{
	if (iParam1 == 15)
		return 1;
...
int func_185(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0xC738 (51000)
{
	int num;
...
BOOL func_186(var uParam0, int iParam1) // Position - 0xC76B (51051)
{
	switch (uParam0->f_16)
	{
		case 0:
...
void func_187() // Position - 0xCF4E (53070)
{
	func_27(&(Global_105463.f_2890), &Global_105463, 0, 1, 1, 0);
	return;
}

BOOL func_188(var uParam0) // Position - 0xCF69 (53097)
{
	float num;
...
void func_189(int iParam0, var uParam1) // Position - 0xCFF7 (53239)
{
	if (iParam0 == 1)
	{
		if (!func_141(uParam1))
...
BOOL func_190(BOOL bParam0) // Position - 0xD05B (53339)
{
...
BOOL func_191(Vehicle veParam0) // Position - 0xD0F2 (53490)
{
...
BOOL func_192(int iParam0) // Position - 0xD11C (53532)
{
	eCharacter character;
...
BOOL func_193() // Position - 0xD839 (55353)
{
	return Global_102468.f_1;
}

BOOL func_194() // Position - 0xD847 (55367)
{
	if (Global_99326 != -1)
...
BOOL func_195() // Position - 0xD86A (55402)
{
...
BOOL func_196() // Position - 0xD884 (55428)
{
	if (Global_80541)
		return true;
...
BOOL func_197() // Position - 0xD8AE (55470)
{
	return Global_102481.f_418 > 0;
}

BOOL func_198(int iParam0, int iParam1) // Position - 0xD8BF (55487)
{
	switch (iParam0)
	{
		case 5:
...
BOOL func_199() // Position - 0xD8F7 (55543)
{
	return Global_1575090;
}

BOOL func_200() // Position - 0xD903 (55555)
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
...
int func_201(var uParam0) // Position - 0xD91F (55583)
{
	int i;
...
int func_202(var uParam0, var uParam1) // Position - 0xD9E3 (55779)
{
...
BOOL func_203(var uParam0, float fParam1, var uParam2, var uParam3) // Position - 0xDA20 (55840)
{
	BOOL flag;
	int num;
	int num2;
...
void func_204(var uParam0, var uParam1, var uParam2) // Position - 0xDADC (56028)
{
...
char* func_205(int iParam0) // Position - 0xDC47 (56391)
{
	char* str;
...
int func_206(var uParam0, float fParam1, float fParam2, float fParam3, char* sParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, int iParam9) // Position - 0xDE3C (56892)
{
	var unk;
...
void _CONVERSATION_ADD_LINE_NO_SUBTITLE(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xDEC4 (57028)
{
...
void func_208(var uParam0, eCharacter echParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xDEFF (57087)
{
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, Ped pedParam2, char* sParam3, int iParam4, int iParam5) // Position - 0xDF55 (57173)
{
...
float func_210(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0xDFF0 (57328)
{
...
int func_211(var uParam0, var uParam1, var uParam2, var uParam3, char* sParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, char* sParam9, var uParam10) // Position - 0xE02A (57386)
{
	var unk;
...
void func_212(int iParam0) // Position - 0xE175 (57717)
{
	Global_23994 = iParam0;
	return;
}

BOOL func_213(char* sParam0) // Position - 0xE182 (57730)
{
	var string1;
...
struct<6> func_214() // Position - 0xE1A2 (57762)
{
	var unk;
...
void func_215(Ped pedParam0, var uParam1, int iParam2) // Position - 0xE1C6 (57798)
{
	int taskSequenceId;
	int taskSequenceId2;
...
BOOL func_216(int iParam0) // Position - 0xE51E (58654)
{
...
BOOL func_217(var uParam0) // Position - 0xE53E (58686)
{
...
BOOL func_218(var uParam0) // Position - 0xE556 (58710)
{
...
Hash func_219() // Position - 0xE57B (58747)
{
	return joaat("U_M_M_Aldinapoli");
}

char* func_220() // Position - 0xE588 (58760)
{
	return "Al_DiNapoli";
}

void func_221(var uParam0, const char* sParam1, var uParam2, var uParam3, var uParam4) // Position - 0xE594 (58772)
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
...
void func_222(int iParam0, BOOL bParam1) // Position - 0xE685 (59013)
{
	if (iParam0 == -1)
		return;
...
int func_223(int iParam0) // Position - 0xE6C1 (59073)
{
	if (Global_80276 == iParam0)
		if (Global_80277 == -1)
...
void func_224(var uParam0, int iParam1) // Position - 0xE6FA (59130)
{
	BOOL flag;
	int i;
...
BOOL func_225() // Position - 0xE798 (59288)
{
	return Global_99713;
}

void func_226(var uParam0) // Position - 0xE7A4 (59300)
{
	CUTSCENE::STOP_CUTSCENE(false);
	CUTSCENE::REMOVE_CUTSCENE();
	func_227(uParam0);
...
void func_227(var uParam0) // Position - 0xE7BB (59323)
{
	BOOL flag;
	int num;
	int i;
...
void func_228(int iParam0) // Position - 0xE8A3 (59555)
{
	if (iParam0 == -1)
		iParam0 = func_178();
...
BOOL func_229(Any* panParam0, BOOL bParam1) // Position - 0xE8CB (59595)
{
	var unk;
	...
	if (func_262(*panParam0) || func_260(*panParam0) || Global_80526 == true)
		return true;
...
void func_230(var uParam0) // Position - 0xEB3B (60219)
{
	int i;
	int taskSequenceId;
...
void func_231(Object* pobParam0) // Position - 0xEE3F (60991)
{
...
void func_232(var uParam0) // Position - 0xEE6A (61034)
{
	int i;
...
BOOL CHECK_VEHICLES_OK(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0xEEEA (61162)
{
	int i;
	int num;
	Vehicle playersLastVehicle;
...
BOOL func_234(Ped pedParam0, Vehicle veParam1) // Position - 0xF0A8 (61608)
{
...
BOOL func_235(var uParam0, BOOL bParam1, int iParam2) // Position - 0xF0D8 (61656)
{
	int i;
	int num;
...
BOOL func_236(int iParam0) // Position - 0xF394 (62356)
{
...
BOOL func_237(Ped pedParam0, int iParam1) // Position - 0xF3C8 (62408)
{
	float xSize;
...
BOOL func_238(Ped pedParam0, int iParam1) // Position - 0xF43E (62526)
{
	return func_239(pedParam0, PLAYER::PLAYER_PED_ID(), iParam1, 1, 250, 7);
}

BOOL func_239(Ped pedParam0, Ped pedParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xF456 (62550)
{
	BOOL flag;
	var pedBoneCoords;
	int num;
...
BOOL func_240(var uParam0, Vector3 vParam1, var uParam2, var uParam3, Ped pedParam4, var uParam5, Ped pedParam6, int iParam7) // Position - 0xF517 (62743)
{
	var hit;
	var endCoords;
	var surfaceNormal;
...
Vector3 func_241(Ped pedParam0, int iParam1) // Position - 0xF643 (63043)
{
...
int func_242() // Position - 0xF708 (63240)
{
	int i;
...
BOOL func_243(Ped pedParam0, Ped pedParam1, int iParam2, int iParam3) // Position - 0xF752 (63314)
{
	var unk;
...
float func_244(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) // Position - 0xF7E3 (63459)
{
	return (fParam0 * uParam3) + (fParam0.f_1 * uParam3.f_1) + (fParam0.f_2 * uParam3.f_2);
}

Vector3 func_245(float fParam0, var uParam1, var uParam2) // Position - 0xF804 (63492)
{
	float num;
	float num2;
...
void func_246(var uParam0) // Position - 0xF843 (63555)
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_247(Ped pedParam0, Ped pedParam1) // Position - 0xF85E (63582)
{
	int i;
...
BOOL func_248(Ped pedParam0) // Position - 0xF89D (63645)
{
...
BOOL func_249(Ped pedParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0xF8C5 (63685)
{
	float radius;
	float num;
	int weaponHash;
...
BOOL func_250(Ped pedParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Position - 0xF9C0 (63936)
{
	float entityCoords;
	float num;
...
BOOL func_251(Ped pedParam0, float fParam1) // Position - 0xFACC (64204)
{
	var outProjectile;
	var outCoords;
...
BOOL func_252(Ped pedParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Position - 0xFB61 (64353)
{
	var unk;
	var entityForwardVector;
	float num;
...
BOOL func_253(Ped pedParam0, BOOL bParam1, float fParam2, float fParam3) // Position - 0xFBEF (64495)
{
	if (bParam1)
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
BOOL func_254(int iParam0) // Position - 0xFC37 (64567)
{
...
void func_255(Ped pedParam0) // Position - 0xFC81 (64641)
{
	int taskSequenceId;
...
BOOL func_256(int iParam0) // Position - 0xFD1E (64798)
{
	if (iParam0 == -1)
		iParam0 = func_178();
...
BOOL func_257(int iParam0) // Position - 0xFDB3 (64947)
{
...
BOOL func_258() // Position - 0xFDF2 (65010)
{
	if (MISC::IS_PC_VERSION())
...
BOOL func_259() // Position - 0xFE0F (65039)
{
	if (Global_99326 != -1)
...
BOOL func_260(int iParam0) // Position - 0xFE32 (65074)
{
	if (func_261() && Global_102429.f_11 == 6 && iParam0 == func_179(&(Global_102429.f_3), 0))
		return true;

	return false;
}

BOOL func_261() // Position - 0xFE66 (65126)
{
...
BOOL func_262(int iParam0) // Position - 0xFEA4 (65188)
{
	if (func_119(false))
...
BOOL func_263(var uParam0, var uParam1) // Position - 0xFECC (65228)
{
	switch (*uParam0)
	{
		case 37:
...
BOOL func_264(var uParam0) // Position - 0xFF88 (65416)
{
	int num;
	int i;
	BOOL flag;
...
BOOL func_265(var uParam0, var uParam1) // Position - 0x10171 (65905)
{
...
void func_266(Vehicle* pveParam0, Hash hParam1, float fParam2, float fParam3, float fParam4, float fParam5) // Position - 0x10246 (66118)
{
	func_267(pveParam0);
...
void func_267(Vehicle* pveParam0) // Position - 0x10289 (66185)
{
	if (ENTITY::DOES_ENTITY_EXIST(*pveParam0))
	{
...
BOOL func_268(Ped* ppedParam0, eCharacter echParam1, float fParam2, float fParam3, float fParam4, float fParam5, char* sParam6, int iParam7) // Position - 0x10325 (66341)
{
...
BOOL func_269(Ped* ppedParam0, eCharacter echParam1, Vector3 vParam2, var uParam3, var uParam4, float fParam5, BOOL bParam6) // Position - 0x10381 (66433)
{
	Hash model;
...
int func_270(Ped pedParam0, eCharacter echParam1) // Position - 0x1040F (66575)
{
	int num;
...
BOOL func_271(var uParam0) // Position - 0x10455 (66645)
{
	if (func_218(uParam0))
	{
...
BOOL func_272(var uParam0) // Position - 0x1047F (66687)
{
	int i;
...
void func_273(var uParam0, char* sParam1, char* sParam2, char* sParam3) // Position - 0x104B0 (66736)
{
	*uParam0 = sParam1;
	uParam0->f_1 = sParam2;
	uParam0->f_2 = sParam3;
...
BOOL func_274(var uParam0) // Position - 0x104EC (66796)
{
	int num;
	int i;
	BOOL flag;
...
void func_275(int iParam0, BOOL bParam1) // Position - 0x10707 (67335)
{
	switch (iParam0)
	{
		case 37:
...
void func_276(BOOL bParam0) // Position - 0x10B21 (68385)
{
	Vector3 vector;
	Vector3 vector2;
	Vector3 vector3;
...
void func_280(var uParam0) // Position - 0x111FF (70143)
{
	int i;
	float num;
...
void func_281(var uParam0, float fParam1, float fParam2, float fParam3) // Position - 0x1129F (70303)
{
	uParam0->f_51 == 0;
	uParam0->f_46 >= 15;
...
void func_282(var uParam0) // Position - 0x112D0 (70352)
{
	uParam0->f_51;
	uParam0->f_46 = 0;
...
BOOL func_283(var uParam0) // Position - 0x112F7 (70391)
{
	int num;
	int i;
	char* animDict;
...
BOOL func_284(var uParam0) // Position - 0x11625 (71205)
{
	int num;
	int i;
	char* animDict;
...
void func_285(Object* pobParam0, Hash hParam1, float fParam2, float fParam3, float fParam4, float fParam5) // Position - 0x11B89 (72585)
{
	func_231(pobParam0);
...
void func_286(Ped* ppedParam0, Hash hParam1, float fParam2, float fParam3, float fParam4, float fParam5, ePedType eptParam6) // Position - 0x11BB0 (72624)
{
	func_287(ppedParam0);
...
void func_287(Ped* ppedParam0) // Position - 0x11BD1 (72657)
{
	if (ENTITY::DOES_ENTITY_EXIST(*ppedParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(*ppedParam0, false))
...
BOOL func_288(var uParam0) // Position - 0x11C12 (72722)
{
	int num;
	int i;
	Interior interiorAtCoordsWithType;
...
void func_289(int iParam0, BOOL bParam1) // Position - 0x12160 (74080)
{
	char* string2;
	Interior interior;
...
BOOL func_290(int iParam0) // Position - 0x12227 (74279)
{
	int num;
...
struct<2> func_291(int iParam0) // Position - 0x12258 (74328)
{
	int num;
...
void func_292(int iParam0, BOOL bParam1) // Position - 0x12285 (74373)
{
	int offset;
...
char* func_293(int iParam0, var uParam1) // Position - 0x122C8 (74440)
{
	Vector3 vector;
...
struct<5> func_294(int iParam0) // Position - 0x122ED (74477)
{
	var unk;
	var unk6;
	...
	switch (iParam0)
	{
		...
		case 243:
			...
			unk.f_3 = func_295(&Global_4718592.f_231597[0 /*160*/]);
			unk.f_4 = unk.f_3;
			break;
	
		case 244:
			unk = { Global_4718592.f_231597[1 /*160*/].f_16 };
			unk.f_3 = func_295(&Global_4718592.f_231597[1 /*160*/]);
			unk.f_4 = unk.f_3;
			break;
	
		case 245:
			unk = { Global_4718592.f_231597[2 /*160*/].f_16 };
			unk.f_3 = func_295(&Global_4718592.f_231597[2 /*160*/]);
			unk.f_4 = unk.f_3;
			break;
	
		case 246:
			unk = { Global_4718592.f_231597[3 /*160*/].f_16 };
			unk.f_3 = func_295(&Global_4718592.f_231597[3 /*160*/]);
			unk.f_4 = unk.f_3;
			break;
	
		case 247:
			unk = { Global_4718592.f_231597[4 /*160*/].f_16 };
			unk.f_3 = func_295(&Global_4718592.f_231597[4 /*160*/]);
			unk.f_4 = unk.f_3;
			break;
...
char* func_295(char* sParam0) // Position - 0x14FAB (85931)
{
	return sParam0;
}

struct<6> func_296(int iParam0, BOOL bParam1) // Position - 0x14FB5 (85941)
{
	var unk;
...
BOOL func_297(var uParam0) // Position - 0x15B6B (88939)
{
	int num;
	int i;
	int num2;
...
BOOL func_298(int iParam0) // Position - 0x15E0C (89612)
{
	var unk;
	eCharacter character;
...
BOOL func_299(int iParam0) // Position - 0x15E5D (89693)
{
	const char* string2;
...
BOOL func_300(int iParam0) // Position - 0x15F16 (89878)
{
	var unk;
...
BOOL func_301(int iParam0) // Position - 0x15FD7 (90071)
{
	int i;
	var interiorType;
	Interior interiorAtCoordsWithType;
...
BOOL func_302(int iParam0, char* sParam1) // Position - 0x1605C (90204)
{
...
BOOL func_303(int iParam0) // Position - 0x1613E (90430)
{
...
BOOL func_304(int iParam0) // Position - 0x16169 (90473)
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_305(int iParam0) // Position - 0x16194 (90516)
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_306(int iParam0) // Position - 0x161BF (90559)
{
	if (func_257(iParam0))
		return false;
	else if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
...
void func_307() // Position - 0x161F4 (90612)
{
...
BOOL func_308(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, float fParam5) // Position - 0x1620E (90638)
{
	int i;
...
BOOL func_309(int iParam0, var uParam1, var uParam2, var uParam3, float fParam4, var uParam5) // Position - 0x16273 (90739)
{
	int num;
	char* str;
...
BOOL func_310(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, BOOL bParam7) // Position - 0x162EB (90859)
{
	if (fParam6 < 0f)
		fParam6 = 0f;
...
void func_311(var uParam0, var uParam1, BOOL bParam2) // Position - 0x16366 (90982)
{
	char* str;
...
void func_312(char* sParam0) // Position - 0x16450 (91216)
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam0))
		if (func_213(sParam0))
			func_313();
...
void func_313() // Position - 0x1646F (91247)
{
	Global_21849 = 0;
	func_314();
	return;
...
void func_314() // Position - 0x1647F (91263)
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_23994 = 0;
...
int func_315(var uParam0) // Position - 0x164A0 (91296)
{
	if (func_218(uParam0))
	{
		if (STREAMING::HAS_ANIM_DICT_LOADED(*uParam0))
...
void func_316(var uParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0x164D6 (91350)
{
...
void func_317(var uParam0, BOOL bParam1) // Position - 0x164F6 (91382)
{
	func_318(&(uParam0->f_41), bParam1);
	return;
}

void func_318(var uParam0, BOOL bParam1) // Position - 0x16508 (91400)
{
	int i;
...
void func_319(Object* pobParam0, BOOL bParam1) // Position - 0x16546 (91462)
{
	if (ENTITY::DOES_ENTITY_EXIST(*pobParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*pobParam0))
...
void func_320(var uParam0, BOOL bParam1) // Position - 0x16581 (91521)
{
	func_321(&(uParam0->f_35), bParam1);
	return;
}

void func_321(var uParam0, BOOL bParam1) // Position - 0x16593 (91539)
{
	int i;
...
void func_322(Vehicle* pveParam0) // Position - 0x165D0 (91600)
{
	if (ENTITY::DOES_ENTITY_EXIST(*pveParam0))
	{
...
void func_323(var uParam0, int iParam1) // Position - 0x16608 (91656)
{
	func_324(&(uParam0->f_28), iParam1);
	return;
}

void func_324(var uParam0, int iParam1) // Position - 0x1661A (91674)
{
	int i;
...
void func_325(Ped* ppedParam0, BOOL bParam1, int iParam2, int iParam3) // Position - 0x1665B (91739)
{
	if (ENTITY::DOES_ENTITY_EXIST(*ppedParam0))
	{
...
void func_326(var uParam0) // Position - 0x166AB (91819)
{
...
BOOL func_327(Ped pedParam0, eScriptTaskHash esthParam1) // Position - 0x166FC (91900)
{
...
void func_328(var uParam0) // Position - 0x1672F (91951)
{
	if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(uParam0->f_59))
	{
		if (func_137(uParam0->f_28[0]))
...
void func_329(int iParam0) // Position - 0x167BE (92094)
{
	if (*iParam0 == -1)
		return;
...
void func_330(char* sParam0) // Position - 0x167FB (92155)
{
	!MISC::IS_STRING_NULL_OR_EMPTY(sParam0);
	return;
}

void func_331(var uParam0) // Position - 0x1680D (92173)
{
	*uParam0 = -1;
...
void func_332() // Position - 0x16840 (92224)
{
...
Hash func_333(eCharacter echParam0) // Position - 0x1685A (92250)
{
	if (!func_36(echParam0))
