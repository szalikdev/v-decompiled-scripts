...
{
	switch (Global_114904.f_10056.f_134)
	{
		case 0:
			Global_114904.f_10056.f_134 = 1;
			break;
	
		case 1:
			Global_114904.f_10056.f_134 = 2;
			GRAPHICS::SET_EXTRA_TCMODIFIER(func_4());
			AUDIO::PLAY_SOUND_FRONTEND(-1, "ON", "NOIR_FILTER_SOUNDS", true);
			break;
	
		case 2:
			Global_114904.f_10056.f_134 = 0;
			break;
	}
...
{
	return Global_114904.f_10056.f_133 == 127;
}
...
BOOL func_22(int iParam0) // Position - 0xA8A (2698)
{
	...
	bitsInRange = MISC::GET_BITS_IN_RANGE(Global_114904.f_10056.f_133, 0, num - 1);
...
struct<5> func_40(int iParam0) // Position - 0x1875 (6261)
{
	...
	switch (iParam0)
	{
		...
		case 243:
			...
			unk.f_3 = func_41(&Global_4718592.f_231597[0 /*160*/]);
			unk.f_4 = unk.f_3;
			break;
	
		case 244:
			unk = { Global_4718592.f_231597[1 /*160*/].f_16 };
			unk.f_3 = func_41(&Global_4718592.f_231597[1 /*160*/]);
			unk.f_4 = unk.f_3;
			break;
	
		case 245:
			unk = { Global_4718592.f_231597[2 /*160*/].f_16 };
			unk.f_3 = func_41(&Global_4718592.f_231597[2 /*160*/]);
			unk.f_4 = unk.f_3;
			break;
	
		case 246:
			unk = { Global_4718592.f_231597[3 /*160*/].f_16 };
			unk.f_3 = func_41(&Global_4718592.f_231597[3 /*160*/]);
			unk.f_4 = unk.f_3;
			break;
	
		case 247:
			unk = { Global_4718592.f_231597[4 /*160*/].f_16 };
			unk.f_3 = func_41(&Global_4718592.f_231597[4 /*160*/]);
			unk.f_4 = unk.f_3;
			break;
...
void func_69(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x5819 (22553)
{
	if (bParam1)
	{
		MISC::SET_BIT(&(Global_114904.f_10056.f_133), iParam0);
	...
	{
		MISC::CLEAR_BIT(&(Global_114904.f_10056.f_133), iParam0);
	}
...
{
	return IS_BIT_SET(Global_114904.f_10056.f_133, iParam0);
}
