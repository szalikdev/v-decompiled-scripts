...
BOOL func_13(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9) // Position - 0x7C1 (1985)
{
	...
	else
	{
		...
		num2 = 0;
		func_19(&num2);
		num3 = func_18(unk10, Global_114904.f_7695.f_765[num2 /*10*/]);
	
		if (num3 == 2)
		{
			func_16(Global_114904.f_7695.f_765[num2 /*10*/]);
		...
		else if (num3 == 1)
		{
			...
			{
				if (!func_14(Global_114904.f_7695.f_765[num2 /*10*/]))
				{
					Global_114904.f_7695.f_765[num2 /*10*/] = { unk10 };
					func_15(&unk10);
					return true;
...
void func_19(var uParam0) // Position - 0xA95 (2709)
{
	...
	*uParam0 = 0;
	...
	{
		if (func_18(Global_114904.f_7695.f_765[i /*10*/], Global_114904.f_7695.f_765[*uParam0 /*10*/]) == 0)
			*uParam0 = i;
	}
...
{
	Global_80063[1 /*14*/] = { func_102(hParam0, iParam1, epctParam2, -1) };
	...
	if (Global_80535 != 6)
	{
		...
		else
		{
			...
			if (value < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				text = { func_359(Global_80536, Global_80538, iParam10) };
				y == -0.014f;
...
int func_430() // Position - 0x31EC2 (204482)
{
	...
	num = func_431(&(Global_102429.f_3), false);
	num2 = 0;
