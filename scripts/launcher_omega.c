	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (num != -1)
		{
			if (Global_113991[num /*10*/].f_9 != -1)
			{
				...
				func_296(&(Global_113991[num /*10*/].f_9));
			}
		}
...
ePedComponentType func_83() // Position - 0x772F (30511)
{
...
Vector3 func_97(ePedComponentType epctParam0, int iParam1) // Position - 0x896E (35182)
{
	switch (iParam1)
	{
		case 0:
...
int func_98() // Position - 0x8AFE (35582)
{
	return func_99(PLAYER::PLAYER_ID());
}

int func_99(Player plParam0) // Position - 0x8B0E (35598)
{
	return MISC::GET_BITS_IN_RANGE(Global_2658291[plParam0 /*468*/].f_325.f_3, 28, 31);
}

BOOL func_100(int iParam0) // Position - 0x8B2B (35627)
{
	return func_74(iParam0, 0, false);
}

int func_101(int iParam0) // Position - 0x8B3B (35643)
{
	switch (iParam0)
	{
		case -1:
...
BOOL func_102() // Position - 0x8EA5 (36517)
{
	return Global_102481.f_417 > 0;
}

var func_103() // Position - 0x8EB6 (36534)
{
	var unk;
...
void func_104(var uParam0, int iParam1) // Position - 0x8EFC (36604)
{
	if (iParam1 <= 0)
		return;
...
void func_105(var uParam0, int iParam1) // Position - 0x8F82 (36738)
{
...
void func_106(var uParam0, int iParam1) // Position - 0x8FB5 (36789)
{
	int num;
	int num2;
...
int func_107(int iParam0, int iParam1) // Position - 0x9006 (36870)
{
	if (iParam1 < 0)
		iParam1 = 0;
...
int func_108(int iParam0) // Position - 0x90A8 (37032)
{
	return (BUILTIN::SHIFT_RIGHT(iParam0, 26) & 31 * IS_BIT_SET(iParam0, 31) ? -1 : 1) + 2011;
}

var func_109(BOOL bParam0, var uParam1, var uParam2) // Position - 0x90CA (37066)
{
	if (bParam0)
		return uParam1;
...
int func_110(int iParam0) // Position - 0x90E1 (37089)
{
	return iParam0 & 15;
}

void func_111(var uParam0, int iParam1) // Position - 0x90EE (37102)
{
...
void func_112(var uParam0, int iParam1) // Position - 0x9128 (37160)
{
...
void func_113(var uParam0, int iParam1) // Position - 0x9163 (37219)
{
	if (iParam1 < 0 || iParam1 >= 60)
		return;
...
eCharacter _GET_CURRENT_PLAYER_CHARACTER_0() // Position - 0x919F (37279)
{
	func_58();
	return Global_114904.f_2370.f_539.f_4321;
}

void func_115(int iParam0) // Position - 0x91B8 (37304)
{
	int num;
	var textLabel;
...
BOOL func_116() // Position - 0x921B (37403)
{
	return MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION();
}

BOOL func_117() // Position - 0x9231 (37425)
{
	return MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION();
}

void func_118(char* sParam0, Any anParam1, int iParam2) // Position - 0x9247 (37447)
{
...
BOOL func_119(BOOL bParam0) // Position - 0x9289 (37513)
{
...
struct<2> func_120(int iParam0) // Position - 0x92B1 (37553)
{
	var unk;
...
void func_121(int iParam0, var uParam1) // Position - 0x96FE (38654)
{
	switch (iParam0)
	{
		case 0:
...
int func_123(int iParam0) // Position - 0xA9D6 (43478)
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_124(Any* panParam0) // Position - 0xAD1C (44316)
{
	int threadId;
...
void func_125(int iParam0) // Position - 0xADC1 (44481)
{
	var name;
...
void func_126(int iParam0) // Position - 0xAE5C (44636)
{
	if (iParam0 < 63)
	{
		func_127();
...
void func_127() // Position - 0xAE82 (44674)
{
	Global_80535 != 6;
...
void func_128(Ped pedParam0) // Position - 0xAEBA (44730)
{
	int num;
	int num2;
	int num3;
...
void func_129(int iParam0) // Position - 0xAF13 (44819)
{
...
int func_130(Ped pedParam0) // Position - 0xAF96 (44950)
{
	int i;
...
void func_131(int iParam0, int iParam1, int iParam2) // Position - 0xAFC7 (44999)
{
	func_132(iParam0, iParam1, iParam2, 0, 0, 1);
	return;
}

void func_132(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xAFDC (45020)
{
	int num;
...
int func_133() // Position - 0xB05E (45150)
{
	int i;
...
BOOL func_134(int iParam0, int iParam1, int iParam2) // Position - 0xB08F (45199)
{
...
int func_135(int iParam0, int iParam1, int iParam2) // Position - 0xB0AA (45226)
{
	int i;
...
int func_136(Ped pedParam0) // Position - 0xB0F6 (45302)
{
	int i;
...
BOOL func_137(Ped pedParam0) // Position - 0xB13F (45375)
{
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(Ped pedParam0) // Position - 0xB15F (45407)
{
	if (ENTITY::DOES_ENTITY_EXIST(pedParam0))
...
BOOL func_139(int iParam0) // Position - 0xB180 (45440)
{
	switch (iParam0)
	{
		case 5:
...
void func_140() // Position - 0xB1D3 (45523)
{
...
BOOL func_141(int iParam0) // Position - 0xB250 (45648)
{
	switch (iParam0)
	{
		case 5:
...
void func_142(Any* panParam0, BOOL bParam1, BOOL bParam2) // Position - 0xB2A3 (45731)
{
	int i;
...
BOOL func_143(int iParam0) // Position - 0xB399 (45977)
{
	switch (iParam0)
	{
		case 5:
...
void func_144(BOOL bParam0) // Position - 0xB404 (46084)
{
	Player playerIndex;
...
void func_145(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB443 (46147)
{
	if (bParam0)
	{
...
BOOL func_146() // Position - 0xB592 (46482)
{
	return IS_BIT_SET(Global_1845250[PLAYER::PLAYER_ID() /*880*/].f_36.f_18, 14);
}

BOOL func_147(Player plParam0, int iParam1) // Position - 0xB5AC (46508)
{
	BOOL flag;
...
int func_148(int iParam0, BOOL bParam1) // Position - 0xB605 (46597)
{
	int num;
	int num2;
...
BOOL func_149(Player plParam0) // Position - 0xB646 (46662)
{
	Player player;
...
BOOL func_150(Player plParam0) // Position - 0xB668 (46696)
{
...
BOOL func_151() // Position - 0xB6A7 (46759)
{
	return IS_BIT_SET(Global_2621446, 3);
}

int func_152(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0xB6B5 (46773)
{
	int num;
...
BOOL func_153() // Position - 0xB6E8 (46824)
{
...
void func_154(int iParam0) // Position - 0xB70F (46863)
{
	if (iParam0 == 1)
...
BOOL func_155(const char* sParam0) // Position - 0xB732 (46898)
{
...
void func_156() // Position - 0xB76F (46959)
{
	Global_21849 = 0;
	func_157();
	return;
...
void func_157() // Position - 0xB77F (46975)
{
...
BOOL func_158() // Position - 0xB7D6 (47062)
{
...
void func_159() // Position - 0xB7F8 (47096)
{
	func_165(0);
	func_164();
	func_160();
...
void func_160() // Position - 0xB80D (47117)
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
...
BOOL func_161(Vehicle veParam0, float fParam1, int iParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB865 (47205)
{
...
void func_162(Vehicle veParam0) // Position - 0xB8BC (47292)
{
	if (!ENTITY::IS_ENTITY_DEAD(veParam0, false))
...
void func_163(BOOL bParam0, BOOL bParam1) // Position - 0xB8E8 (47336)
{
...
void func_164() // Position - 0xBA39 (47673)
{
...
void func_165(int iParam0) // Position - 0xBA8A (47754)
{
	if (func_170())
		return;
...
void func_166(int iParam0) // Position - 0xBABD (47805)
{
	if (func_170())
		return;
...
void func_167(BOOL bParam0, BOOL bParam1) // Position - 0xBB47 (47943)
{
	if (bParam0)
	{
		if (func_169(0))
...
BOOL func_168() // Position - 0xBBBB (48059)
{
	return IS_BIT_SET(Global_1964145, 5);
}

BOOL func_169(int iParam0) // Position - 0xBBC9 (48073)
{
	if (iParam0 == 1)
...
BOOL func_170() // Position - 0xBC20 (48160)
{
	return IS_BIT_SET(Global_1964145, 19);
}

BOOL func_171(int iParam0) // Position - 0xBC2F (48175)
{
...
BOOL func_172(int iParam0) // Position - 0xBC70 (48240)
{
	int num;
...
void func_173(int iParam0) // Position - 0xBCB5 (48309)
{
...
int func_174(int iParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4) // Position - 0xBCE7 (48359)
{
	int i;
...
void func_175(int iParam0, int iParam1) // Position - 0xBE1E (48670)
{
	int i;
...
BOOL _CAN_ENTER_FREEROAM_STATE(int iParam0) // Position - 0xBE6D (48749)
{
	return func_177(iParam0, Global_44869);
}

BOOL func_177(int iParam0, int iParam1) // Position - 0xBE7E (48766)
{
	if (iParam1 == 15)
		return 1;
...
BOOL func_178(int iParam0) // Position - 0xC05F (49247)
{
	if (Global_44869 == 15)
		return false;
...
int func_179() // Position - 0xC081 (49281)
{
	return func_180(SCRIPT::GET_THIS_SCRIPT_NAME(), 0);
}

int func_180(const char* sParam0, int iParam1) // Position - 0xC092 (49298)
{
	int num;
	const char* str;
	Hash hashKey;
...
BOOL func_181() // Position - 0xC0DB (49371)
{
	if (Global_102429 == 10 || Global_102429 == 9)
		return true;
...
BOOL func_182(var uParam0, int iParam1) // Position - 0xC0FF (49407)
{
	switch (uParam0->f_16)
	{
		case 0:
...
void func_183() // Position - 0xC8E2 (51426)
{
	func_27(&(Global_105463.f_2890), &Global_105463, 0, 1, 1, 0);
	return;
}

BOOL func_184(var uParam0) // Position - 0xC8FD (51453)
{
	float num;
...
void func_185(int iParam0, var uParam1) // Position - 0xC98B (51595)
{
	if (iParam0 == 1)
	{
		if (!func_141(uParam1))
...
BOOL func_186(BOOL bParam0) // Position - 0xC9EF (51695)
{
...
BOOL func_187(Vehicle veParam0) // Position - 0xCA86 (51846)
{
...
BOOL func_188(int iParam0) // Position - 0xCAB0 (51888)
{
	eCharacter character;
...
BOOL func_189() // Position - 0xD1CD (53709)
{
	return Global_102468.f_1;
}

BOOL func_190() // Position - 0xD1DB (53723)
{
	if (Global_99326 != -1)
...
BOOL func_191() // Position - 0xD1FE (53758)
{
...
BOOL func_192() // Position - 0xD218 (53784)
{
	if (Global_80541)
		return true;
...
BOOL func_193() // Position - 0xD242 (53826)
{
	return Global_102481.f_418 > 0;
}

BOOL func_194(int iParam0, int iParam1) // Position - 0xD253 (53843)
{
	switch (iParam0)
	{
		case 5:
...
BOOL func_195() // Position - 0xD28B (53899)
{
	return Global_1575090;
}

BOOL func_196() // Position - 0xD297 (53911)
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
...
void func_197(var uParam0) // Position - 0xD2B3 (53939)
{
	var entityCoords;
	float entityCoords2;
	float heading;
...
BOOL func_198(Ped pedParam0, Entity eParam1, float fParam2, BOOL bParam3) // Position - 0xD39C (54172)
{
...
void func_199() // Position - 0xD3BE (54206)
{
	float x;
	float y;
	float width;
...
int func_200(var uParam0, var uParam1, var uParam2, var uParam3, char* sParam4, char* sParam5, int iParam6, char* sParam7, var uParam8) // Position - 0xD4B0 (54448)
{
	var unk;
...
void func_201(int iParam0) // Position - 0xD5D2 (54738)
{
	Global_23994 = iParam0;
	return;
}

BOOL func_202(char* sParam0) // Position - 0xD5DF (54751)
{
	var string1;
...
struct<6> func_203() // Position - 0xD5FF (54783)
{
	var unk;
...
void _CONVERSATION_ADD_LINE_NO_SUBTITLE(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xD623 (54819)
{
...
void func_205(var uParam0, eCharacter echParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xD65E (54878)
{
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, Ped pedParam2, char* sParam3, int iParam4, int iParam5) // Position - 0xD6B4 (54964)
{
...
float func_207(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0xD74F (55119)
{
...
void func_208(var uParam0, const char* sParam1, var uParam2, var uParam3, var uParam4) // Position - 0xD789 (55177)
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
...
void func_209(int iParam0, BOOL bParam1) // Position - 0xD87A (55418)
{
	if (iParam0 == -1)
		return;
...
int func_210(int iParam0) // Position - 0xD8B6 (55478)
{
	if (Global_80276 == iParam0)
		if (Global_80277 == -1)
...
void func_211(var uParam0, int iParam1) // Position - 0xD8EF (55535)
{
	BOOL flag;
	int i;
...
BOOL func_212() // Position - 0xD98D (55693)
{
	return Global_99713;
}

void func_213(var uParam0) // Position - 0xD999 (55705)
{
	CUTSCENE::STOP_CUTSCENE(false);
	CUTSCENE::REMOVE_CUTSCENE();
	func_214(uParam0);
...
void func_214(var uParam0) // Position - 0xD9B0 (55728)
{
	BOOL flag;
	int num;
	int i;
...
void func_215(int iParam0) // Position - 0xDA98 (55960)
{
	if (iParam0 == -1)
		iParam0 = func_179();
...
BOOL func_216(Any* panParam0, BOOL bParam1) // Position - 0xDAC0 (56000)
{
	var unk;
	...
	if (func_253(*panParam0) || func_251(*panParam0) || Global_80526 == true)
		return true;
...
void func_217(Ped pedParam0, var uParam1, int iParam2) // Position - 0xDD30 (56624)
{
	int taskSequenceId;
	int taskSequenceId2;
...
BOOL func_218(int iParam0) // Position - 0xE088 (57480)
{
...
BOOL func_219(var uParam0) // Position - 0xE0A8 (57512)
{
...
BOOL func_220(var uParam0) // Position - 0xE0C0 (57536)
{
...
void func_221(var uParam0) // Position - 0xE0E5 (57573)
{
	int i;
	int taskSequenceId;
...
void func_222(Object* pobParam0) // Position - 0xE3E9 (58345)
{
...
void func_223(var uParam0) // Position - 0xE414 (58388)
{
	int i;
...
BOOL CHECK_VEHICLES_OK(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0xE494 (58516)
{
	int i;
	int num;
	Vehicle playersLastVehicle;
...
BOOL func_225(Ped pedParam0, Vehicle veParam1) // Position - 0xE652 (58962)
{
...
BOOL func_226(var uParam0, BOOL bParam1, int iParam2) // Position - 0xE682 (59010)
{
	int i;
	int num;
...
BOOL func_227(int iParam0) // Position - 0xE93E (59710)
{
...
BOOL func_228(Ped pedParam0, int iParam1) // Position - 0xE972 (59762)
{
	float xSize;
...
BOOL func_229(Ped pedParam0, int iParam1) // Position - 0xE9E8 (59880)
{
	return func_230(pedParam0, PLAYER::PLAYER_PED_ID(), iParam1, 1, 250, 7);
}

BOOL func_230(Ped pedParam0, Ped pedParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xEA00 (59904)
{
	BOOL flag;
	var pedBoneCoords;
	int num;
...
BOOL func_231(var uParam0, Vector3 vParam1, var uParam2, var uParam3, Ped pedParam4, var uParam5, Ped pedParam6, int iParam7) // Position - 0xEAC1 (60097)
{
	var hit;
	var endCoords;
	var surfaceNormal;
...
Vector3 func_232(Ped pedParam0, int iParam1) // Position - 0xEBED (60397)
{
...
int func_233() // Position - 0xECB2 (60594)
{
	int i;
...
BOOL func_234(Ped pedParam0, Ped pedParam1, int iParam2, int iParam3) // Position - 0xECFC (60668)
{
	var unk;
...
float func_235(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) // Position - 0xED8D (60813)
{
	return (fParam0 * uParam3) + (fParam0.f_1 * uParam3.f_1) + (fParam0.f_2 * uParam3.f_2);
}

Vector3 func_236(float fParam0, var uParam1, var uParam2) // Position - 0xEDAE (60846)
{
	float num;
	float num2;
...
void func_237(var uParam0) // Position - 0xEDED (60909)
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_238(Ped pedParam0, Ped pedParam1) // Position - 0xEE08 (60936)
{
	int i;
...
BOOL func_239(Ped pedParam0) // Position - 0xEE47 (60999)
{
...
BOOL func_240(Ped pedParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0xEE6F (61039)
{
	float radius;
	float num;
	int weaponHash;
...
BOOL func_241(Ped pedParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Position - 0xEF6A (61290)
{
	float entityCoords;
	float num;
...
BOOL func_242(Ped pedParam0, float fParam1) // Position - 0xF076 (61558)
{
	var outProjectile;
	var outCoords;
...
BOOL func_243(Ped pedParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Position - 0xF10B (61707)
{
	var unk;
	var entityForwardVector;
	float num;
...
BOOL func_244(Ped pedParam0, BOOL bParam1, float fParam2, float fParam3) // Position - 0xF199 (61849)
{
	if (bParam1)
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
BOOL func_245(int iParam0) // Position - 0xF1E1 (61921)
{
...
void func_246(Vehicle veParam0) // Position - 0xF22B (61995)
{
	int taskSequenceId;
...
BOOL func_247(int iParam0) // Position - 0xF2C8 (62152)
{
	if (iParam0 == -1)
		iParam0 = func_179();
...
BOOL func_248(int iParam0) // Position - 0xF35D (62301)
{
...
BOOL func_249() // Position - 0xF39C (62364)
{
	if (MISC::IS_PC_VERSION())
...
BOOL func_250() // Position - 0xF3B9 (62393)
{
	if (Global_99326 != -1)
...
BOOL func_251(int iParam0) // Position - 0xF3DC (62428)
{
	if (func_252() && Global_102429.f_11 == 6 && iParam0 == func_180(&(Global_102429.f_3), 0))
		return true;

	return false;
}

BOOL func_252() // Position - 0xF410 (62480)
{
...
BOOL func_253(int iParam0) // Position - 0xF44E (62542)
{
	if (func_119(false))
...
void func_254() // Position - 0xF476 (62582)
{
	iLocal_96 = MISC::GET_GAME_TIMER();
	return;
}

void func_255() // Position - 0xF484 (62596)
{
...
BOOL func_256(var uParam0) // Position - 0xF4EC (62700)
{
	switch (*uParam0)
	{
		case 44:
...
BOOL func_257(var uParam0) // Position - 0xF533 (62771)
{
	int num;
	int i;
	BOOL flag;
...
void func_258(Vehicle* pveParam0, Hash hParam1, float fParam2, float fParam3, float fParam4, float fParam5) // Position - 0xF702 (63234)
{
	func_259(pveParam0);
...
void func_259(Vehicle* pveParam0) // Position - 0xF745 (63301)
{
	if (ENTITY::DOES_ENTITY_EXIST(*pveParam0))
	{
...
BOOL func_260(Ped* ppedParam0, eCharacter echParam1, float fParam2, float fParam3, float fParam4, float fParam5, char* sParam6, int iParam7) // Position - 0xF7E1 (63457)
{
...
BOOL func_261(Ped* ppedParam0, eCharacter echParam1, Vector3 vParam2, var uParam3, var uParam4, float fParam5, BOOL bParam6) // Position - 0xF83D (63549)
{
	Hash model;
...
int func_262(Ped pedParam0, eCharacter echParam1) // Position - 0xF8CB (63691)
{
	int num;
...
BOOL func_263(var uParam0) // Position - 0xF911 (63761)
{
	if (func_220(uParam0))
	{
...
BOOL func_264(var uParam0) // Position - 0xF93B (63803)
{
	int i;
...
void func_265(var uParam0, char* sParam1, char* sParam2, int iParam3) // Position - 0xF96C (63852)
{
	*uParam0 = sParam1;
	uParam0->f_1 = sParam2;
	uParam0->f_2 = iParam3;
...
BOOL func_266(var uParam0) // Position - 0xF9A8 (63912)
{
	int num;
	int i;
	BOOL flag;
...
BOOL func_267(int iParam0) // Position - 0xFC2C (64556)
{
	var unk;
	eCharacter character;
...
BOOL func_268(int iParam0) // Position - 0xFC7D (64637)
{
	const char* string2;
...
BOOL func_269(int iParam0) // Position - 0xFD36 (64822)
{
	var unk;
...
BOOL func_270(int iParam0) // Position - 0xFDF7 (65015)
{
	int i;
	var interiorType;
	Interior interiorAtCoordsWithType;
...
BOOL func_271(int iParam0, char* sParam1) // Position - 0xFE7C (65148)
{
...
BOOL func_272(int iParam0) // Position - 0xFF5E (65374)
{
...
BOOL func_273(int iParam0) // Position - 0xFF89 (65417)
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_274(int iParam0) // Position - 0xFFB4 (65460)
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_275(int iParam0) // Position - 0xFFDF (65503)
{
	if (func_248(iParam0))
		return false;
	else if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
...
void func_276() // Position - 0x10014 (65556)
{
...
BOOL func_277(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, float fParam5) // Position - 0x1002E (65582)
{
	int i;
...
BOOL func_278(int iParam0, var uParam1, var uParam2, var uParam3, float fParam4, var uParam5) // Position - 0x10093 (65683)
{
	int num;
	char* str;
...
BOOL func_279(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, BOOL bParam7) // Position - 0x1010B (65803)
{
	if (fParam6 < 0f)
		fParam6 = 0f;
...
void func_280(var uParam0, BOOL bParam1) // Position - 0x10186 (65926)
{
	char* str;
...
void func_281(char* sParam0) // Position - 0x10256 (66134)
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam0))
		if (func_202(sParam0))
			func_282();
...
void func_282() // Position - 0x10275 (66165)
{
	Global_21849 = 0;
	func_283();
	return;
...
void func_283() // Position - 0x10285 (66181)
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_23994 = 0;
...
int func_284(var uParam0) // Position - 0x102A6 (66214)
{
	if (func_220(uParam0))
	{
		if (STREAMING::HAS_ANIM_DICT_LOADED(*uParam0))
...
void func_285(var uParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0x102DC (66268)
{
...
void func_286(var uParam0, BOOL bParam1) // Position - 0x102FC (66300)
{
	func_287(&(uParam0->f_41), bParam1);
	return;
}

void func_287(var uParam0, BOOL bParam1) // Position - 0x1030E (66318)
{
	int i;
...
void func_288(Object* pobParam0, BOOL bParam1) // Position - 0x1034C (66380)
{
	if (ENTITY::DOES_ENTITY_EXIST(*pobParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*pobParam0))
...
void func_289(var uParam0, BOOL bParam1) // Position - 0x10387 (66439)
{
	func_290(&(uParam0->f_35), bParam1);
	return;
}

void func_290(var uParam0, BOOL bParam1) // Position - 0x10399 (66457)
{
	int i;
...
void func_291(Vehicle* pveParam0) // Position - 0x103D6 (66518)
{
	if (ENTITY::DOES_ENTITY_EXIST(*pveParam0))
	{
...
void func_292(var uParam0, int iParam1) // Position - 0x1040E (66574)
{
	func_293(&(uParam0->f_28), iParam1);
	return;
}

void func_293(var uParam0, int iParam1) // Position - 0x10420 (66592)
{
	int i;
...
void func_294(Ped* ppedParam0, BOOL bParam1, int iParam2, int iParam3) // Position - 0x10461 (66657)
{
	if (ENTITY::DOES_ENTITY_EXIST(*ppedParam0))
	{
...
void func_295(Ped* ppedParam0) // Position - 0x104B1 (66737)
{
	if (ENTITY::DOES_ENTITY_EXIST(*ppedParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(*ppedParam0, false))
...
void func_296(int iParam0) // Position - 0x104F2 (66802)
{
	if (*iParam0 == -1)
		return;
...
void func_297(char* sParam0) // Position - 0x1052F (66863)
{
	!MISC::IS_STRING_NULL_OR_EMPTY(sParam0);
	return;
}

void func_298(var uParam0) // Position - 0x10541 (66881)
{
	*uParam0 = -1;
...
void func_299() // Position - 0x10574 (66932)
{
...
Hash func_300(eCharacter echParam0) // Position - 0x1058E (66958)
{
	if (!func_36(echParam0))
