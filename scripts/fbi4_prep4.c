...
void main() // Position - 0x0 (0)
{
	...
	if (func_300())
		func_299(-1339.7863f, -1277.5099f, 3.8874f, 261.2839f, 1, 0);

	if (func_298(false))
	{
		Global_114904.f_2370.f_539.f_2395[0] = -99;
		Global_114904.f_2370.f_539.f_2395[1] = -99;
		Global_114904.f_2370.f_539.f_2395[2] = -99;
		func_267();
	}
...
void func_4(int iParam0) // Position - 0x28C (652)
{
	...
	if (Global_114904.f_9092 || func_298(false))
	{
		num = func_18();
...
BOOL func_5(int iParam0) // Position - 0x2D1 (721)
{
	...
	func_6(&(Global_114904.f_2370.f_539), num2);
...
void func_6(var uParam0, int iParam1) // Position - 0x3E1 (993)
{
	...
	for (i = 0; i < 3; i = i + 1)
	{
		...
		else
		{
			...
			if (!func_8(Global_114904.f_18540[i], &unk, &num2))
			{
...
void func_12() // Position - 0x1062 (4194)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (_GET_CHARACTER_MODEL(Global_114904.f_2370.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_14(character) && !func_13(14) || Global_113852)
			{
...
void func_23() // Position - 0x129C (4764)
{
	switch (iLocal_79)
	{
		...
		case 2:
			if (MISC::GET_GAME_TIMER() - iLocal_202 > 2000)
			{
				...
				if (func_44(&uLocal_380, &uLocal_376, &uLocal_211))
				{
					...
					if (Global_114904.f_2370.f_539.f_2395[0] == 38 && Global_114904.f_2370.f_539.f_2395[1] == 33 && Global_114904.f_2370.f_539.f_2395[2] == 54)
						func_42(821);
		...
		case 3:
			Global_114904.f_2370.f_539.f_2395[0] = 38;
			Global_114904.f_2370.f_539.f_2395[1] = 33;
			Global_114904.f_2370.f_539.f_2395[2] = 54;
			func_24(1, 1, 1);
			iLocal_79 = 2;
			break;
	}
...
void func_40(BOOL bParam0, BOOL bParam1) // Position - 0x18E8 (6376)
{
	...
	if (bParam0)
	{
		if (func_298(false) && Global_80527.f_1 == 1 && func_41(Global_80527))
		{
		}
		else
		{
...
Ped func_58(eCharacter echParam0) // Position - 0x21E2 (8674)
{
	...
	return Global_99882[func_59(echParam0)];
}
...
void func_117(var uParam0, float fParam1, float fParam2, float fParam3, float fParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, Hash hParam10, int iParam11, eCharacter echParam12, int iParam13) // Position - 0x39FE (14846)
{
	...
	if (!func_300() || !func_250())
		num = 0;

	if (num == 1)
		if (!func_247(iParam6, iParam7, iParam8, iParam13))
			num = 0;
	...
	if (num == 1)
	{
		...
		*uParam0 = func_218(fParam1, fParam4);
	}
	else if (iParam9 == 1)
	{
		...
		func_208(fParam1, 5f, false);
	
		if (func_14(echParam12))
		{
			func_206(echParam12, 0);
...
BOOL func_118(var uParam0, eCharacter echParam1, Vector3 vParam2, var uParam3, var uParam4, float fParam5, BOOL bParam6, int iParam7) // Position - 0x3B92 (15250)
{
	...
	if (func_14(echParam1))
	{
		...
		model.f_31 = 49;
		model.f_81 = 2;
		func_205(echParam1, &model, iParam7);
		...
		if (Global_114904.f_2370.f_539.f_2407[0 /*295*/][echParam1 /*98*/] == model)
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Global_114904.f_2370.f_539.f_2407[0 /*295*/][echParam1 /*98*/]))
			{
				*uParam0 = VEHICLE::CREATE_VEHICLE(Global_114904.f_2370.f_539.f_2407[0 /*295*/][echParam1 /*98*/], vParam2, fParam5, false, false, false);
				...
				if (func_204(&plateText, &plateIndex))
				{
				...
				func_196(uParam0, &(Global_114904.f_2370.f_539.f_2407[0 /*295*/][echParam1 /*98*/].f_31), &(Global_114904.f_2370.f_539.f_2407[0 /*295*/][echParam1 /*98*/].f_81));
		...
		else if (Global_114904.f_2370.f_539.f_2407[1 /*295*/][echParam1 /*98*/] == model)
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Global_114904.f_2370.f_539.f_2407[1 /*295*/][echParam1 /*98*/]))
			{
				*uParam0 = VEHICLE::CREATE_VEHICLE(Global_114904.f_2370.f_539.f_2407[1 /*295*/][echParam1 /*98*/], vParam2, fParam5, false, false, false);
				...
				func_196(uParam0, &(Global_114904.f_2370.f_539.f_2407[1 /*295*/][echParam1 /*98*/].f_31), &(Global_114904.f_2370.f_539.f_2407[1 /*295*/][echParam1 /*98*/].f_81));
				VEHICLE::SET_VEHICLE_ENVEFF_SCALE(*uParam0, model.f_96);
...
void func_119(eCharacter echParam0, var uParam1, int iParam2, BOOL bParam3) // Position - 0x49B8 (18872)
{
	...
	if (func_14(echParam0) && ENTITY::DOES_ENTITY_EXIST(*uParam1) && VEHICLE::IS_VEHICLE_DRIVEABLE(*uParam1, false))
	{
		...
		{
			func_123(uParam1, &(Global_114904.f_2370.f_539.f_2407[iParam2 /*295*/][echParam0 /*98*/].f_31), &(Global_114904.f_2370.f_539.f_2407[iParam2 /*295*/][echParam0 /*98*/].f_81));
			...
			if (bParam3)
			{
				...
				Global_114904.f_20125[echParam0 /*43*/].f_31 = func_122(*uParam1);
				...
				func_120(Global_114904.f_2370.f_539.f_2407[iParam2 /*295*/][echParam0 /*98*/].f_5, Global_114904.f_2370.f_539.f_2407[iParam2 /*295*/][echParam0 /*98*/].f_7, num, true, &(Global_114904.f_20125[echParam0 /*43*/].f_1));
				...
				func_120(Global_114904.f_2370.f_539.f_2407[iParam2 /*295*/][echParam0 /*98*/].f_6, -1, num, false, &(Global_114904.f_20125[echParam0 /*43*/].f_2));
			}
		}
	}
	...
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2658291[plParam0 /*468*/].f_325.f_8 != -1)
				return func_127(Global_2658291[plParam0 /*468*/].f_325.f_8) == 30;

	return false;
}

int func_127(Hash hParam0) // Position - 0x6FE1 (28641)
{
	switch (hParam0)
	{
		case 0:
...
BOOL _NETWORK_IS_PLAYER_VALID(Player player, BOOL bIsPlaying, BOOL bUnk) // Position - 0x7531 (30001)
{
	Player player;
...
BOOL func_129(Hash hParam0) // Position - 0x7591 (30097)
{
...
BOOL func_130(Player plParam0) // Position - 0x75A8 (30120)
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2658291[plParam0 /*468*/].f_325.f_8 != -1)
				return func_127(Global_2658291[plParam0 /*468*/].f_325.f_8) == 11;

	return false;
}

BOOL func_131(Hash hParam0) // Position - 0x75EF (30191)
{
...
BOOL func_132(Vehicle veParam0) // Position - 0x7631 (30257)
{
	switch (ENTITY::GET_ENTITY_MODEL(veParam0))
	{
...
BOOL func_133(Player plParam0) // Position - 0x76F9 (30457)
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2658291[plParam0 /*468*/].f_325.f_8 != -1)
				return func_127(Global_2658291[plParam0 /*468*/].f_325.f_8) == 26;

	return false;
}

BOOL func_134(Player plParam0) // Position - 0x7740 (30528)
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2658291[plParam0 /*468*/].f_325.f_8 != -1)
				return func_127(Global_2658291[plParam0 /*468*/].f_325.f_8) == 13;

	return false;
}

BOOL func_135(Player plParam0) // Position - 0x7787 (30599)
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2658291[plParam0 /*468*/].f_325.f_8 != -1)
				return func_127(Global_2658291[plParam0 /*468*/].f_325.f_8) == 7;

	return false;
}

BOOL func_136(Hash hParam0) // Position - 0x77CD (30669)
{
	BOOL flag;
...
Hash func_137(BOOL bParam0) // Position - 0x785E (30814)
{
	if (bParam0)
...
BOOL func_138(Player plParam0) // Position - 0x7878 (30840)
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
...
BOOL func_139(Vehicle veParam0) // Position - 0x789E (30878)
{
...
BOOL func_140(Vehicle veParam0) // Position - 0x78CD (30925)
{
...
BOOL func_141(Vehicle veParam0) // Position - 0x7A35 (31285)
{
	Hash entityModel;
...
BOOL func_142(Hash hParam0) // Position - 0x7AB2 (31410)
{
	switch (hParam0)
	{
		case joaat("mule"):
...
BOOL func_143(Player plParam0) // Position - 0x7B0E (31502)
{
	if (plParam0 == _INVALID_PLAYER_INDEX())
		return false;

	if (func_166(plParam0) && Global_2658291[plParam0 /*468*/].f_325.f_11 == plParam0)
		return true;

	return false;
}

BOOL func_144(Vehicle veParam0, BOOL bParam1) // Position - 0x7B47 (31559)
{
	switch (ENTITY::GET_ENTITY_MODEL(veParam0))
	{
...
int func_145(Vehicle veParam0) // Position - 0x7BA2 (31650)
{
	int i;
...
BOOL func_146(Hash hParam0, int iParam1) // Position - 0x7BDB (31707)
{
	if (iParam1 == 0)
...
BOOL func_156(Vehicle veParam0) // Position - 0x84BE (33982)
{
	if (PLAYER::PLAYER_ID() != _INVALID_PLAYER_INDEX())
	{
		...
		if (func_160(PLAYER::PLAYER_ID(), true, false) && Global_1845250[PLAYER::PLAYER_ID() /*880*/].f_260.f_39 > PV_COMP_HEAD || IS_BIT_SET(Global_1845250[PLAYER::PLAYER_ID() /*880*/].f_260.f_37, 14) || IS_BIT_SET(Global_1845250[PLAYER::PLAYER_ID() /*880*/].f_260.f_37, 11))
			return false;
			...
			if (DECORATOR::DECOR_EXIST_ON(veParam0, "Player_Vehicle"))
				if (DECORATOR::DECOR_GET_INT(veParam0, "Player_Vehicle") == NETWORK::NETWORK_HASH_FROM_PLAYER_HANDLE(PLAYER::PLAYER_ID()))
					if (func_158() != PV_COMP_INVALID && func_158() < 607)
						if (!func_157(veParam0) || ENTITY::GET_ENTITY_MODEL(veParam0) != Global_1583765[func_158() /*143*/].f_66)
							return true;
...
BOOL func_157(Vehicle veParam0) // Position - 0x85CC (34252)
{
...
ePedComponentType func_158() // Position - 0x85E5 (34277)
{
	return Global_2359296[func_159() /*5574*/].f_681.f_2;
}

int func_159() // Position - 0x85FD (34301)
{
	int num;
...
BOOL func_160(Player plParam0, BOOL bParam1, BOOL bParam2) // Position - 0x860A (34314)
{
	if (plParam0 == _INVALID_PLAYER_INDEX())
		return false;
...
BOOL func_161(Player plParam0) // Position - 0x866E (34414)
{
...
BOOL func_162() // Position - 0x869F (34463)
{
	return func_163() != -1;
}

Hash func_163() // Position - 0x86AD (34477)
{
	return Global_2658291[PLAYER::PLAYER_ID() /*468*/].f_325.f_8;
}

BOOL func_164(Player plParam0) // Position - 0x86C5 (34501)
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2658291[plParam0 /*468*/].f_325.f_8 != -1 && Global_2658291[plParam0 /*468*/].f_325.f_11 != _INVALID_PLAYER_INDEX())
				return func_127(Global_2658291[plParam0 /*468*/].f_325.f_8) == 5;

	return false;
}

BOOL func_165(Player plParam0) // Position - 0x8724 (34596)
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2658291[plParam0 /*468*/].f_325.f_8 != -1 && Global_2658291[plParam0 /*468*/].f_325.f_11 != _INVALID_PLAYER_INDEX())
				return func_127(Global_2658291[plParam0 /*468*/].f_325.f_8) == 8;

	return false;
}

BOOL func_166(Player plParam0) // Position - 0x8784 (34692)
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2658291[plParam0 /*468*/].f_325.f_8 != -1)
				return func_127(Global_2658291[plParam0 /*468*/].f_325.f_8) == 9;

	return false;
}

BOOL func_167(Hash hParam0, BOOL bParam1, var uParam2) // Position - 0x87CB (34763)
{
	BOOL flag;
...
BOOL func_168(Hash hParam0) // Position - 0x8BB4 (35764)
{
	switch (hParam0)
	{
		case joaat("towtruck"):
...
void func_169(Vehicle veParam0, eCharacter echParam1) // Position - 0x8BE9 (35817)
{
	...
	func_170(veParam0, &(Global_114904.f_32757.f_5510));
	return;
}

void func_170(Vehicle veParam0, var uParam1) // Position - 0x8DEB (36331)
{
	int i;
...
int func_171(int iParam0) // Position - 0x9096 (37014)
{
	switch (iParam0)
	{
		case 1:
...
BOOL func_172(int iParam0) // Position - 0x9146 (37190)
{
	switch (iParam0)
	{
		case joaat("granger"):
...
void func_173(var uParam0) // Position - 0x9166 (37222)
{
	int i;
...
BOOL func_174(Vehicle veParam0) // Position - 0x9216 (37398)
{
...
BOOL func_175(ePedComponentType epctParam0) // Position - 0x92F3 (37619)
{
...
BOOL func_176(ePedComponentType epctParam0, BOOL bParam1, int iParam2) // Position - 0x94B1 (38065)
{
	int i;
	Hash outData;
...
BOOL func_177(Hash hParam0) // Position - 0x9636 (38454)
{
	int num;
	var unk;
	var name;
...
BOOL _NETSHOPPING_SHOULD_USE_TRANSACTION_SYSTEM() // Position - 0x9702 (38658)
{
	if (MISC::IS_PC_VERSION())
...
BOOL func_179(Hash hParam0, int iParam1) // Position - 0x9719 (38681)
{
	int cloudTimeAsInt;
	int num;
...
BOOL func_180() // Position - 0x98DD (39133)
{
	return MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION();
}

BOOL func_181() // Position - 0x98F3 (39155)
{
	return MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION();
}

BOOL func_182() // Position - 0x9909 (39177)
{
	return false;
}

BOOL func_183() // Position - 0x9912 (39186)
{
	return true;
}

BOOL func_184() // Position - 0x991B (39195)
{
	return true;
}

BOOL func_185() // Position - 0x9924 (39204)
{
...
BOOL _IS_EXCLUSIVE_CONTENT_UNLOCKED() // Position - 0x993D (39229)
{
	int profileSetting;
...
BOOL func_187(Vehicle veParam0) // Position - 0x99F5 (39413)
{
...
BOOL func_188(Vehicle veParam0) // Position - 0x9A3C (39484)
{
	int i;
...
BOOL func_189(Vehicle veParam0) // Position - 0x9AB8 (39608)
{
	int i;
...
eCharacter func_190(Vehicle veParam0) // Position - 0x9BA0 (39840)
{
	int i;
...
BOOL func_191(Vehicle veParam0, int iParam1, BOOL bParam2) // Position - 0x9C03 (39939)
{
	int i;
	var garageName;
	int num;
...
BOOL func_192(int iParam0, int iParam1, char* sParam2, var uParam3) // Position - 0x9C71 (40049)
{
...
void func_193(Vehicle veParam0, eCharacter echParam1) // Position - 0x9D49 (40265)
{
	int i;
...
void func_194(var uParam0) // Position - 0x9DCB (40395)
{
	if (!func_195(*uParam0))
...
BOOL func_195(Vehicle veParam0) // Position - 0x9DF6 (40438)
{
	return VEHICLE::IS_VEHICLE_EXTRA_TURNED_ON(veParam0, 5);
}

int func_196(var uParam0, var uParam1, var uParam2) // Position - 0x9E05 (40453)
{
	int i;
	int modType;
	...
	for (i = 0; i < *uParam1; i = i + 1)
	{
		...
		else if (VEHICLE::GET_VEHICLE_MOD(*uParam0, modType) != uParam1->[i] - 1)
		{
			...
			if (uParam1->[i] > 0)
			{
				...
				else if (func_202(*uParam0, modType, uParam1->[i] - 1))
				{
				}
				else
				{
...
BOOL func_197(Vehicle veParam0) // Position - 0x9FDE (40926)
{
	int i;
	int modType;
	Hash hashKey;
...
void func_198(var uParam0) // Position - 0xA0BA (41146)
{
...
int func_199(Vehicle veParam0, int iParam1) // Position - 0xA111 (41233)
{
	int value;
	int value2;
	float num;
...
int func_200(Vehicle veParam0, int iParam1) // Position - 0xA1FA (41466)
{
	int i;
	...
	for (i = VEHICLE::GET_NUM_VEHICLE_MODS(veParam0, iParam1) - 1; i >= 0 && func_202(veParam0, iParam1, i); i = i - 1)
	{
	}
...
BOOL func_201(Hash hParam0) // Position - 0xA25C (41564)
{
...
BOOL func_202(Vehicle veParam0, int iParam1, int iParam2) // Position - 0xA287 (41607)
{
	if (!func_203() && VEHICLE::IS_VEHICLE_MOD_GEN9_EXCLUSIVE(veParam0, iParam1, iParam2))
		return true;

	return false;
}

BOOL func_203() // Position - 0xA2AB (41643)
{
	return false;
}

BOOL func_204(var uParam0, var uParam1) // Position - 0xA2B4 (41652)
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
	}
...
void func_205(eCharacter echParam0, var uParam1, int iParam2) // Position - 0xA2F5 (41717)
{
	int num;
...
void func_206(eCharacter echParam0, int iParam1) // Position - 0xA551 (42321)
{
	int i;
	...
	for (i = 0; i < 9; i = i + 1)
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_99735[i]))
		{
			...
			{
				if (iParam1 == 0 || ENTITY::GET_ENTITY_MODEL(Global_99735[i]) == func_207(echParam0, iParam1))
				{
...
Hash func_207(eCharacter echParam0, int iParam1) // Position - 0xA5EF (42479)
{
	int num;
	...
	if (func_14(echParam0))
	{
		...
		num.f_31 = 49;
		num.f_81 = 2;
		func_205(echParam0, &num, iParam1);
		return num;
	}
	else
	{
...
void func_208(Vector3 vParam0, var uParam1, var uParam2, float fParam3, BOOL bParam4) // Position - 0xA631 (42545)
{
	int i;

	for (i = 0; i < 68; i = i + 1)
	{
		if (func_216(&Global_79070.f_555[0 /*21*/], i))
...
void func_209(int iParam0) // Position - 0xA681 (42625)
{
	BOOL flag;
	...
	if (func_216(&Global_79070.f_555[0 /*21*/], iParam0))
	{
		...
		{
			if (iParam0 == 24 && func_215(iParam0, 0) && Global_79979.f_66 == 0 && Global_114904.f_32757.f_1958[Global_79070.f_555[0 /*21*/].f_14] != 0 && Global_114904.f_32757.f_1958[Global_79070.f_555[0 /*21*/].f_14] > 3 && !func_213(0, Global_79070.f_555[0 /*21*/].f_12) || !func_213(1, Global_79070.f_555[0 /*21*/].f_12))
			{
				func_212(&Global_114904.f_32757.f_69[Global_79070.f_555[0 /*21*/].f_14 /*78*/], &Global_79979);
...
void func_210(int iParam0, BOOL bParam1) // Position - 0xA7F0 (42992)
{
	if (iParam0 == -1)
		return;
	...
	if (bParam1)
	{
		...
		{
			func_211(iParam0, 1, false);
			func_211(iParam0, 2, false);
			func_211(iParam0, 3, false);
			func_211(iParam0, 4, false);
			func_211(iParam0, 0, true);
			Global_79070[iParam0] = 1;
		}
	}
	else
	{
		func_211(iParam0, 0, false);
	}

	return;
}

void func_211(int iParam0, int iParam1, BOOL bParam2) // Position - 0xA84D (43085)
{
	if (iParam0 == -1)
		return;
...
void func_212(var uParam0, var uParam1) // Position - 0xA888 (43144)
{
...
BOOL func_213(int iParam0, int iParam1) // Position - 0xA954 (43348)
{
	int num;
	...
	if (iParam0 < 0 || iParam0 >= func_214(&Global_114904.f_32757.f_5038[num /*157*/]))
		return false;

	return func_176(Global_114904.f_32757.f_5038[num /*157*/][iParam0 /*78*/].f_66, false, -1);
}

int func_214(var uParam0) // Position - 0xA9C7 (43463)
{
	return *uParam0;
}

BOOL func_215(int iParam0, int iParam1) // Position - 0xA9D2 (43474)
{
	if (iParam0 == -1)
		return false;
...
BOOL func_216(var uParam0, int iParam1) // Position - 0xA9F2 (43506)
{
	BOOL num;
	int num2;
	...
	*uParam0 = { 0f, 0f, 0f };
	...
	switch (iParam1)
	{
		case 0:
			*uParam0 = { -831.8538f, 172.1154f, 69.9058f };
			...
			uParam0->f_4 = func_207(CHAR_MICHAEL, 1);
			uParam0->f_12 = 0;
		...
		case 2:
			*uParam0 = { -22.6297f, -1439.1368f, 29.6549f };
			...
			uParam0->f_4 = func_207(CHAR_FRANKLIN, 1);
			uParam0->f_12 = 1;
			MISC::SET_BIT(&(uParam0->f_9), 20);
			MISC::SET_BIT(&(uParam0->f_9), 7);
			num = 1;
		...
		case 3:
			*uParam0 = { -22.5229f, -1434.6986f, 29.6552f };
			...
			uParam0->f_4 = func_207(CHAR_FRANKLIN, 2);
			uParam0->f_12 = 1;
		...
		case 6:
			*uParam0 = { 1981.4163f, 3808.1313f, 31.1384f };
			...
			uParam0->f_4 = func_207(CHAR_TREVOR, 1);
			uParam0->f_12 = 2;
			MISC::SET_BIT(&(uParam0->f_9), 20);
			MISC::SET_BIT(&(uParam0->f_9), 7);
			num = 1;
	...
	if (IS_BIT_SET(uParam0->f_9, 10))
	{
		...
		if (!func_217(Global_114904.f_32757.f_1864[uParam0->f_14 /*3*/], 0f, 0f, 0f, false))
	...
	{
		if (!func_217(Global_114904.f_2370.f_539.f_3588[1 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, false))
		{
	...
	{
		if (!func_217(Global_114904.f_2370.f_539.f_3588[0 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, false))
		{
...
BOOL func_217(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, BOOL bParam6) // Position - 0xC0E2 (49378)
{
	if (bParam6)
...
Vehicle func_218(var uParam0, var uParam1, var uParam2, float fParam3) // Position - 0xC129 (49449)
{
	return func_219(&(Global_108447.f_2890), uParam0, fParam3, false);
}

Vehicle func_219(var uParam0, float fParam1, var uParam2, var uParam3, float fParam4, BOOL bParam5) // Position - 0xC143 (49475)
{
	Vehicle vehicle;
	...
	if (func_243(uParam0))
	{
		...
		if (func_242(uParam0))
		{
			...
			if (ENTITY::DOES_ENTITY_EXIST(vehicle))
			{
				...
				func_223(vehicle, &(uParam0->f_12), false, true);
				flag = true;
				...
				else if (!func_221(vehicle, uParam0->f_3, uParam0->f_8) && uParam0->f_10 && MISC::ARE_STRINGS_EQUAL(SCRIPT::GET_THIS_SCRIPT_NAME(), "startup_positioning"))
				{
					num = func_220(vehicle);
...
int func_220(Vehicle veParam0) // Position - 0xC3F5 (50165)
{
	int i;
	var colorPrimary;
	var colorSecondary;
...
BOOL func_221(Vehicle veParam0, var uParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0xC4B8 (50360)
{
	Hash entityModel;
	var sizeAndVehs;
	...
	{
		case joaat("cargobob"):
			if (func_222(veParam0, Global_79070.f_139[38], false))
			{
				func_209(38);
				return true;
			}
		...
		case joaat("firetruk"):
			if (func_222(veParam0, Global_79070.f_139[43], true))
			{
				func_209(43);
				return true;
			}
		...
		case joaat("cuban800"):
			...
			{
				if (func_222(veParam0, sizeAndVehs[i], true) && func_101(ENTITY::GET_ENTITY_COORDS(sizeAndVehs[i], true), 2136.133f, 4780.5635f, 39.9702f, 5f, false))
				{
...
BOOL func_222(Vehicle veParam0, Vehicle veParam1, BOOL bParam2) // Position - 0xC6C0 (50880)
{
	var colorPrimary;
	var colorSecondary;
	var colorPrimary2;
...
void func_223(Vehicle veParam0, var uParam1, BOOL bParam2, BOOL bParam3) // Position - 0xC721 (50977)
{
	int num;
	int num2;
	int i;
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(veParam0, false))
	{
		...
		{
			if (func_233(uParam1->f_5) || func_233(uParam1->f_6))
			{
			}
			else
			{
		...
		if (IS_BIT_SET(uParam1->f_77, 15) || func_232(veParam0) || uParam1->f_62 == 0 && uParam1->f_63 == 0 && uParam1->f_64 == 0 && uParam1->f_9[20] > 0 && func_231())
		{
			uParam1->f_62 = 0;
			uParam1->f_63 = 0;
			uParam1->f_64 = 0;
		...
		if (uParam1->f_69 > -1 && uParam1->f_69 < 255)
			if (!VEHICLE::IS_THIS_MODEL_A_BICYCLE(ENTITY::GET_ENTITY_MODEL(veParam0)))
				if (VEHICLE::IS_THIS_MODEL_A_BIKE(ENTITY::GET_ENTITY_MODEL(veParam0)))
					if (uParam1->f_69 == 6)
						func_230(veParam0, uParam1->f_69);
				else
					func_230(veParam0, uParam1->f_69);
		...
		if (func_225() && VEHICLE::IS_THIS_MODEL_A_PLANE(uParam1->f_66) && VEHICLE::GET_VEHICLE_HAS_LANDING_GEAR(veParam0) && !VEHICLE::IS_VEHICLE_MODEL(veParam0, joaat("avenger")) && !VEHICLE::IS_VEHICLE_MODEL(veParam0, func_137(true)))
			if (!IS_BIT_SET(uParam1->f_77, 23))
				if (!IS_BIT_SET(uParam1->f_77, 22) && func_224(veParam0, 5f))
...
BOOL func_224(Vehicle veParam0, float fParam1) // Position - 0xCE42 (52802)
{
	float entityCoords;
	var groundZ;
...
BOOL func_225() // Position - 0xCEB3 (52915)
{
	...
	if (func_228(7))
		if (func_227(Global_2673271.f_4.f_16) || func_226(Global_2673271.f_4.f_16))
			return false;

	return true;
}

BOOL func_226(Player plParam0) // Position - 0xCF42 (53058)
{
	Player player;
...
BOOL func_227(Player plParam0) // Position - 0xCF67 (53095)
{
	Player player;
...
BOOL func_228(int iParam0) // Position - 0xCF85 (53125)
{
	return func_229(&(Global_2673271.f_194), iParam0);
}

BOOL func_229(var uParam0, int iParam1) // Position - 0xCF99 (53145)
{
	int num;
	int num2;
	int num3;
...
void func_230(Vehicle veParam0, int iParam1) // Position - 0xCFBC (53180)
{
	int vehicleMod;
...
BOOL func_231() // Position - 0xD034 (53300)
{
	return DLC::IS_DLC_PRESENT(joaat("mpindependence"));
}

BOOL func_232(Vehicle veParam0) // Position - 0xD045 (53317)
{
	int _int;
...
int func_233(var uParam0) // Position - 0xD08D (53389)
{
	if (!func_203() && func_234(uParam0))
		return 1;

	return 0;
}

BOOL func_234(int iParam0) // Position - 0xD0AD (53421)
{
	switch (iParam0)
	{
		case 161:
...
BOOL func_235(Vehicle veParam0) // Position - 0xD100 (53504)
{
	...
	if (func_237(PLAYER::PLAYER_ID()) == 3)
		if (ENTITY::DOES_ENTITY_EXIST(veParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(veParam0, false))
			if (func_236(veParam0) != -1)
				return true;

	return false;
}

int func_236(Vehicle veParam0) // Position - 0xD187 (53639)
{
...
int func_237(Player plParam0) // Position - 0xD1B6 (53686)
{
	if (func_240(plParam0) == 233)
		return func_238(plParam0);

	return -1;
}

int func_238(Player plParam0) // Position - 0xD1D3 (53715)
{
...
BOOL func_239(Player plParam0, BOOL bParam1) // Position - 0xD1F6 (53750)
{
	if (func_33(plParam0))
...
int func_240(Player plParam0) // Position - 0xD23A (53818)
{
	if (func_33(plParam0))
		if (func_239(plParam0, false))
...
BOOL _IS_PLAYER_IN_VEHICLE_SEAT(Player plParam0, int iParam1) // Position - 0xD266 (53862)
{
...
BOOL func_242(var uParam0) // Position - 0xD2B3 (53939)
{
	if (func_243(uParam0))
	{
...
BOOL func_243(var uParam0) // Position - 0xD2E8 (53992)
{
...
BOOL func_244() // Position - 0xD348 (54088)
{
	return func_242(&(Global_108447.f_2890));
}

void func_245() // Position - 0xD35B (54107)
{
	func_246(&(Global_108447.f_2890));
	return;
}

void func_246(var uParam0) // Position - 0xD36E (54126)
{
	if (func_243(uParam0))
...
BOOL func_247(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0xD38C (54156)
{
	...
	if (iParam2 == 0 && func_249(Global_108447.f_2890.f_12.f_66))
		return false;
...
BOOL func_248() // Position - 0xD41A (54298)
{
...
BOOL func_249(Hash hParam0) // Position - 0xD48F (54415)
{
	switch (hParam0)
	{
		case joaat("police"):
...
BOOL func_250() // Position - 0xD549 (54601)
{
	return func_243(&(Global_108447.f_2890));
}

void func_251(int iParam0) // Position - 0xD55C (54620)
{
	Global_98259 = 0;
...
void func_252(int iParam0) // Position - 0xD5EA (54762)
{
	MISC::SET_BIT(&Global_98259, iParam0);
	return;
}

void func_253() // Position - 0xD5FC (54780)
{
...
BOOL func_254() // Position - 0xD6B9 (54969)
{
	int num;
	...
	if (!func_255(bLocal_188, num) && !bLocal_188)
		return false;

	return true;
}

BOOL func_255(BOOL bParam0, int iParam1) // Position - 0xD6F5 (55029)
{
	int num;
...
int func_256(int iParam0, int iParam1) // Position - 0xD741 (55105)
{
	int num;
...
int func_257(int iParam0) // Position - 0xD756 (55126)
{
	return Global_62184[iParam0];
}

BOOL func_258(int iParam0) // Position - 0xD765 (55141)
{
	return func_90(iParam0, 1, true);
}

void func_259(int iParam0) // Position - 0xD775 (55157)
{
	HUD::CLEAR_PRINTS();
	func_260();
...
void func_260() // Position - 0xD7D7 (55255)
{
	Global_21849 = 0;
	func_75();
	return;
...
BOOL func_261() // Position - 0xD7E7 (55271)
{
	func_262();
...
void func_262() // Position - 0xD82C (55340)
{
	if (func_264())
	{
		switch (_GET_CURRENT_PLAYER_CHARACTER())
		{
			case CHAR_MICHAEL:
				if (Global_114904.f_2370.f_539.f_2395[0] == -99)
					func_263(uLocal_206[0], uLocal_206[1], uLocal_206[2]);
				else if (Global_114904.f_2370.f_539.f_2395[1] == -99)
					func_263(uLocal_206[1], uLocal_206[0], uLocal_206[2]);
				else if (Global_114904.f_2370.f_539.f_2395[2] == -99)
					func_263(uLocal_206[2], uLocal_206[1], uLocal_206[0]);
				break;
		
			case CHAR_FRANKLIN:
				if (Global_114904.f_2370.f_539.f_2395[1] == -99)
					func_263(uLocal_206[1], uLocal_206[0], uLocal_206[2]);
				else if (Global_114904.f_2370.f_539.f_2395[0] == -99)
					func_263(uLocal_206[0], uLocal_206[1], uLocal_206[2]);
				else if (Global_114904.f_2370.f_539.f_2395[2] == -99)
					func_263(uLocal_206[2], uLocal_206[1], uLocal_206[0]);
				break;
			...
			case CHAR_TREVOR:
				if (Global_114904.f_2370.f_539.f_2395[2] == -99)
					func_263(uLocal_206[2], uLocal_206[1], uLocal_206[0]);
				else if (Global_114904.f_2370.f_539.f_2395[0] == -99)
					func_263(uLocal_206[0], uLocal_206[1], uLocal_206[2]);
				else if (Global_114904.f_2370.f_539.f_2395[1] == -99)
...
void func_263(const char* sParam0, const char* sParam1, const char* sParam2) // Position - 0xD9E2 (55778)
{
...
BOOL func_264() // Position - 0xDA1E (55838)
{
	return MISC::GET_GAME_TIMER() <= Global_24529.f_6481 + 100;
}

int func_265() // Position - 0xDA33 (55859)
{
	int num;
	int i;
	...
	for (i = 0; i <= 2; i = i + 1)
	{
		if (Global_114904.f_2370.f_539.f_2395[i] != -99)
			num = num + 1;
	}
...
BOOL func_266(Ped pedParam0) // Position - 0xDA6F (55919)
{
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(pedParam0))
...
void func_267() // Position - 0xDA8F (55951)
{
	int num;
	...
	if (func_257(num) < 1500)
		func_268(_GET_CURRENT_PLAYER_CHARACTER(), 96, 1500, false, false);

	return;
}

void func_268(eCharacter echParam0, int iParam1, int iParam2, BOOL bParam3, BOOL bParam4) // Position - 0xDADF (56031)
{
	int outValue;
	Hash statHash;

	if (func_297(echParam0) == 3)
		return;

	if (func_297(echParam0) == 4)
		return;

	func_269(func_297(echParam0), 1, iParam1, iParam2, false);
...
int func_269(int iParam0, int iParam1, int iParam2, int iParam3, BOOL bParam4) // Position - 0xDBB1 (56241)
{
	float num;
	int num2;
	int num3;
	...
	switch (iParam1)
	{
		case 0:
			switch (iParam0)
			{
				case 0:
					func_295(99, 1);
					func_294(joaat("SP0_MONEY_TOTAL_SPENT"), iParam3);
					break;
			
				case 1:
					func_294(joaat("SP1_MONEY_TOTAL_SPENT"), iParam3);
					break;
			
				case 2:
					func_294(joaat("SP2_MONEY_TOTAL_SPENT"), iParam3);
					break;
			}
			...
			switch (iParam2)
			{
				...
				case 68:
					...
					{
						case 0:
							func_294(joaat("SP0_MONEY_SPENT_ON_TATTOOS"), iParam3);
							break;
					
						case 1:
							func_294(joaat("SP1_MONEY_SPENT_ON_TATTOOS"), iParam3);
							break;
					
						case 2:
							func_294(joaat("SP2_MONEY_SPENT_ON_TATTOOS"), iParam3);
							break;
					}
				...
				case 21:
					...
					{
						case 0:
							func_294(joaat("SP0_MONEY_SPENT_ON_TAXIS"), iParam3);
							break;
					
						case 1:
							func_294(joaat("SP1_MONEY_SPENT_ON_TAXIS"), iParam3);
							break;
					
						case 2:
							func_294(joaat("SP2_MONEY_SPENT_ON_TAXIS"), iParam3);
							break;
					}
					break;
				...
				case 25:
					...
					{
						case 0:
							func_294(joaat("SP0_MONEY_SPENT_IN_STRIP_CLUBS"), iParam3);
							break;
					
						case 1:
							func_294(joaat("SP1_MONEY_SPENT_IN_STRIP_CLUBS"), iParam3);
							break;
					
						case 2:
							func_294(joaat("SP2_MONEY_SPENT_IN_STRIP_CLUBS"), iParam3);
							break;
					}
					break;
				...
				case 113:
					...
					{
						case 0:
							func_294(joaat("SP0_MONEY_SPENT_PROPERTY"), iParam3);
							break;
					
						case 1:
							func_294(joaat("SP1_MONEY_SPENT_PROPERTY"), iParam3);
							break;
					
						case 2:
							func_294(joaat("SP2_MONEY_SPENT_PROPERTY"), iParam3);
							break;
					}
					break;
				...
				default:
					switch (SCRIPT::GET_HASH_OF_THIS_SCRIPT_NAME())
					{
						case joaat("clothes_shop_sp"):
							...
							{
								case 0:
									func_294(joaat("SP0_MONEY_SPENT_IN_CLOTHES"), iParam3);
									break;
							
								case 1:
									func_294(joaat("SP1_MONEY_SPENT_IN_CLOTHES"), iParam3);
									break;
							
								case 2:
									func_294(joaat("SP2_MONEY_SPENT_IN_CLOTHES"), iParam3);
									break;
							}
							break;
						...
						case joaat("hairdo_shop_sp"):
							...
							{
								case 0:
									func_294(joaat("SP0_MONEY_SPENT_ON_HAIRDOS"), iParam3);
									break;
							
								case 1:
									func_294(joaat("SP1_MONEY_SPENT_ON_HAIRDOS"), iParam3);
									break;
							
								case 2:
									func_294(joaat("SP2_MONEY_SPENT_ON_HAIRDOS"), iParam3);
									break;
							}
						...
						case joaat("gunclub_shop"):
							...
							{
								case 0:
									func_294(joaat("SP0_MONEY_SPENT_IN_BUYING_GUNS"), iParam3);
									break;
							
								case 1:
									func_294(joaat("SP1_MONEY_SPENT_IN_BUYING_GUNS"), iParam3);
									break;
							
								case 2:
									func_294(joaat("SP2_MONEY_SPENT_IN_BUYING_GUNS"), iParam3);
									break;
							}
							break;
						...
						case joaat("carmod_shop"):
							...
							{
								case 0:
									func_294(joaat("SP0_MONEY_SPENT_CAR_MODS"), iParam3);
									break;
							
								case 1:
									func_294(joaat("SP1_MONEY_SPENT_CAR_MODS"), iParam3);
									break;
							
								case 2:
									func_294(joaat("SP2_MONEY_SPENT_CAR_MODS"), iParam3);
									break;
							}
	...
	switch (iParam1)
	{
		case 1:
			...
			{
				case 0:
					func_294(joaat("SP0_TOTAL_CASH_EARNED"), iParam3);
					break;
			
				case 1:
					func_294(joaat("SP1_TOTAL_CASH_EARNED"), iParam3);
					break;
			
				case 2:
					func_294(joaat("SP2_TOTAL_CASH_EARNED"), iParam3);
					break;
			}
			break;
...
void func_270(BOOL bParam0) // Position - 0xE1B0 (57776)
{
	int i;
	int j;
...
void func_271(int iParam0) // Position - 0xE432 (58418)
{
	int value;
...
void func_272(int iParam0) // Position - 0xE48C (58508)
{
	BOOL flag;
	var txdName;
	...
	if (iParam0 == 12)
	{
		func_274(8272, 0, -1, true);
		return;
	}

	if (iParam0 == 13)
	{
		func_274(8273, 0, -1, true);
		return;
	}

	if (iParam0 == 14)
	{
		func_274(8274, 0, -1, true);
		return;
	}

	if (iParam0 == 15)
	{
		func_274(8275, 0, -1, true);
		return;
	}

	if (iParam0 == 16)
	{
		func_274(8276, 0, -1, true);
		return;
	}

	if (iParam0 == 17)
	{
		func_274(8277, 0, -1, true);
		return;
	}
	...
	else if (IS_BIT_SET(Global_114904.f_20571.f_471, iParam0) || IS_BIT_SET(Global_2359296[func_159() /*5574*/].f_681.f_10, iParam0))
	{
		flag = true;
		MISC::CLEAR_BIT(&(Global_114904.f_20571.f_471), iParam0);
	...
	if (flag)
	{
		...
		HUD::ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(func_273(iParam0));
...
char* func_273(int iParam0) // Position - 0xE605 (58885)
{
	switch (iParam0)
	{
		case 0:
...
void func_274(int iParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0xE707 (59143)
{
	Hash statName;
...
void _STAT_SET_PACKED_BOOL(int iParam0, BOOL bParam1, int iParam2) // Position - 0xE735 (59189)
{
	if (iParam2 == -1)
		iParam2 = func_32();
...
void func_276(int iParam0) // Position - 0xE753 (59219)
{
	func_295(93, iParam0);
	func_295(29, iParam0);
	func_295(30, iParam0);
...
BOOL func_277(int iParam0) // Position - 0xE773 (59251)
{
	int cloudTimeAsInt;
	int num;
	int cloudTimeAsInt2;
...
BOOL _STAT_GET_PACKED_BOOL(int iParam0, int iParam1) // Position - 0xE913 (59667)
{
	if (iParam1 == -1)
		iParam1 = func_32();
...
int func_279(BOOL bParam0) // Position - 0xE92F (59695)
{
	var outValue;
	int value;
	int outValue2;
...
int func_280(int iParam0, int iParam1) // Position - 0xE9E6 (59878)
{
	if (iParam0 >= 78)
		return 0;
...
int func_281(int iParam0, int iParam1) // Position - 0xEA01 (59905)
{
	if (func_13(14) && !func_292(iParam0))
		return 0;
	...
	if (func_291(&Global_4525144))
	{
		if (func_289(&Global_4525144, iParam0))
			return 0;
	
		if (func_282(&Global_4525144, iParam0))
			return 1;
	}
	else
	{
...
BOOL func_282(var uParam0, int iParam1) // Position - 0xEA9E (60062)
{
	int i;
	var unk;
	...
	if (func_13(14) && !func_292(iParam1))
		return false;

	if (func_289(uParam0, iParam1))
		return false;

	if (func_288(uParam0) < 0f)
		func_287(uParam0, 0);
...
int func_283(var uParam0, int iParam1) // Position - 0xEB4F (60239)
{
	int i;
...
BOOL func_284(var uParam0, int iParam1) // Position - 0xEBCA (60362)
{
	return uParam0->[iParam1] == 78;
}

void func_285(var uParam0) // Position - 0xEBDB (60379)
{
	int i;
	...
	func_287(uParam0, Global_4525143 - 0.5f);
	return;
}

void func_286(var uParam0, int iParam1) // Position - 0xEC0F (60431)
{
	uParam0->[iParam1] = 78;
	return;
}

void func_287(var uParam0, int iParam1) // Position - 0xEC1F (60447)
{
	if (iParam1 == 0f)
		uParam0->f_80 = 0f;
	else
...
float func_288(var uParam0) // Position - 0xEC3C (60476)
{
	return uParam0->f_80;
}

BOOL func_289(var uParam0, int iParam1) // Position - 0xEC48 (60488)
{
	return func_290(uParam0, iParam1) != -1;
}

int func_290(var uParam0, int iParam1) // Position - 0xEC5A (60506)
{
	int i;
...
BOOL func_291(var uParam0) // Position - 0xEC87 (60551)
{
	return uParam0->f_79 == 1;
}

BOOL func_292(int iParam0) // Position - 0xEC95 (60565)
{
	switch (iParam0)
	{
		case 60:
...
BOOL func_293(int iParam0, int iParam1) // Position - 0xECE5 (60645)
{
...
void func_294(Hash hParam0, int iParam1) // Position - 0xED36 (60726)
{
	int outValue;
...
void func_295(int iParam0, int iParam1) // Position - 0xED59 (60761)
{
	int outValue;
...
void func_296() // Position - 0xEDB6 (60854)
{
	int outValue;
...
int func_297(eCharacter echParam0) // Position - 0xEE2B (60971)
{
	return Global_2339[echParam0 /*29*/].f_17;
}

BOOL func_298(BOOL bParam0) // Position - 0xEE3C (60988)
{
...
void func_299(float fParam0, float fParam1, float fParam2, float fParam3, int iParam4, int iParam5) // Position - 0xEE64 (61028)
{
	if (func_300())
	{
...
BOOL func_300() // Position - 0xEEF9 (61177)
{
...
void func_301() // Position - 0xEF1D (61213)
{
	func_302(joaat("Player_Zero"), 14, 31, true);
	func_302(joaat("Player_Zero"), 14, 32, true);
	func_302(joaat("Player_Zero"), 14, 33, true);
	func_302(joaat("Player_Zero"), 14, 34, true);
	func_302(joaat("Player_Zero"), 14, 35, true);
	func_302(joaat("Player_Zero"), 14, 36, true);
	func_302(joaat("Player_Zero"), 14, 37, true);
	func_302(joaat("Player_Zero"), 14, 38, true);
	func_302(joaat("Player_Zero"), 14, 39, true);
	func_302(joaat("Player_Zero"), 14, 40, true);
	func_302(joaat("Player_Zero"), 14, 41, true);
	func_302(joaat("Player_Zero"), 14, 42, true);
	func_302(joaat("Player_Zero"), 14, 43, true);
	func_302(joaat("Player_Zero"), 14, 44, true);
	func_302(joaat("Player_Zero"), 9, 9, true);
	func_302(joaat("Player_Zero"), 9, 10, true);
	func_302(joaat("Player_Zero"), 9, 11, true);
	func_302(joaat("Player_Zero"), 9, 12, true);
	func_302(joaat("Player_Zero"), 9, 13, true);
	func_302(joaat("Player_Zero"), 9, 14, true);
	func_302(joaat("Player_One"), 14, 26, true);
	func_302(joaat("Player_One"), 14, 27, true);
	func_302(joaat("Player_One"), 14, 28, true);
	func_302(joaat("Player_One"), 14, 29, true);
	func_302(joaat("Player_One"), 14, 30, true);
	func_302(joaat("Player_One"), 14, 31, true);
	func_302(joaat("Player_One"), 14, 32, true);
	func_302(joaat("Player_One"), 14, 33, true);
	func_302(joaat("Player_One"), 14, 34, true);
	func_302(joaat("Player_One"), 14, 35, true);
	func_302(joaat("Player_One"), 14, 36, true);
	func_302(joaat("Player_One"), 14, 37, true);
	func_302(joaat("Player_One"), 14, 38, true);
	func_302(joaat("Player_One"), 14, 39, true);
	func_302(joaat("Player_One"), 9, 5, true);
	func_302(joaat("Player_One"), 9, 6, true);
	func_302(joaat("Player_One"), 9, 7, true);
	func_302(joaat("Player_One"), 9, 8, true);
	func_302(joaat("Player_One"), 9, 9, true);
	func_302(joaat("Player_One"), 9, 10, true);
	func_302(joaat("Player_Two"), 14, 49, true);
	func_302(joaat("Player_Two"), 14, 50, true);
	func_302(joaat("Player_Two"), 14, 51, true);
	func_302(joaat("Player_Two"), 14, 52, true);
	func_302(joaat("Player_Two"), 14, 53, true);
	func_302(joaat("Player_Two"), 14, 54, true);
	func_302(joaat("Player_Two"), 14, 55, true);
	func_302(joaat("Player_Two"), 14, 56, true);
	func_302(joaat("Player_Two"), 14, 57, true);
	func_302(joaat("Player_Two"), 14, 58, true);
	func_302(joaat("Player_Two"), 14, 59, true);
	func_302(joaat("Player_Two"), 14, 60, true);
	func_302(joaat("Player_Two"), 9, 9, true);
	func_302(joaat("Player_Two"), 9, 10, true);
	func_302(joaat("Player_Two"), 9, 11, true);
	func_302(joaat("Player_Two"), 9, 12, true);
	func_302(joaat("Player_Two"), 9, 13, true);
	func_302(joaat("Player_Two"), 9, 14, true);
	func_302(joaat("Player_Two"), 9, 15, true);
	func_302(joaat("Player_Two"), 9, 16, true);
	return;
}

int func_302(int iParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0xF26D (62061)
{
	Global_80063[1 /*14*/] = { func_304(iParam0, iParam1, iParam2, -1) };

	if (IS_BIT_SET(Global_80063[1 /*14*/].f_6, 0) && !IS_BIT_SET(Global_80063[1 /*14*/].f_6, 6))
	{
		if (bParam3)
			func_303(iParam1, Global_80063[1 /*14*/].f_5, Global_80063[1 /*14*/].f_2, 0, Global_80063[1 /*14*/].f_1, 1, 0);
		else
			func_303(iParam1, Global_80063[1 /*14*/].f_5, Global_80063[1 /*14*/].f_2, 0, Global_80063[1 /*14*/].f_1, 0, 1);
...
BOOL func_303(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0xF303 (62211)
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
struct<14> func_304(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x101A8 (65960)
{
	func_369();
...
void func_305(int iParam0, int iParam1) // Position - 0x101FA (66042)
{
	switch (iParam0)
	{
		case 0:
...
void func_306(int iParam0) // Position - 0x102EA (66282)
{
	BOOL flag;
	int num;
	var unk;
	...
	switch (iParam0)
	{
		...
		default:
			func_314(num6, iParam0, 155, -1);
			return;
	}

	func_307(&Global_80063[0 /*14*/], num6, iParam0, &unk, num2, num3, num, flag, num4, num5, false);
	return;
}

void func_307(int iParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, BOOL bParam7, int iParam8, int iParam9, BOOL bParam10) // Position - 0x11561 (71009)
{
	int num;
	int num2;
	...
	*iParam0 = iParam9;
	...
	if (bParam10)
	{
		...
		if (iParam1 == 12)
		{
			if (!func_311(Global_2883588, 1, true, true, -1))
				MISC::CLEAR_BIT(&(iParam0->f_6), 2);
		
			if (!func_311(Global_2883588, 2, true, true, -1))
	...
	else if (iParam0->f_5 >= 0 && iParam0->f_5 < 3)
	{
		...
		if (func_303(iParam1, iParam0->f_5, iParam0->f_2, 0, iParam0->f_1, 0, 0))
			MISC::SET_BIT(&(iParam0->f_6), 1);
	
		if (func_303(iParam1, iParam0->f_5, iParam0->f_2, 1, iParam0->f_1, 0, 0))
			MISC::SET_BIT(&(iParam0->f_6), 2);
	
		if (!func_303(iParam1, iParam0->f_5, iParam0->f_2, 2, iParam0->f_1, 0, 0))
			MISC::SET_BIT(&(iParam0->f_6), 4);
	}
	else
	{
		...
		if (iParam1 == 11 || iParam1 == 4 || iParam1 == 6 || iParam1 == 1 || iParam1 == 14 || iParam1 == 2 || iParam1 == 8 || iParam1 == 9 || iParam1 == 10 || iParam1 == 7 || iParam1 == 12)
		{
			...
			num = func_91(func_310(iParam1, iParam0->f_2), Global_80060);
		
			if (IS_BIT_SET(num, iParam0->f_1))
				MISC::SET_BIT(&(iParam0->f_6), 1);
		
			num = func_91(func_309(iParam1, iParam0->f_2), Global_80060);
		
			if (IS_BIT_SET(num, iParam0->f_1))
				MISC::SET_BIT(&(iParam0->f_6), 2);
		
			if (func_308(iParam1, iParam0->f_2, &num2))
			{
...
BOOL func_308(int iParam0, int iParam1, var uParam2) // Position - 0x11903 (71939)
{
	*uParam2 = 979;
...
int func_309(int iParam0, int iParam1) // Position - 0x11D08 (72968)
{
	switch (iParam1)
	{
		case 0:
...
int func_310(int iParam0, int iParam1) // Position - 0x12103 (73987)
{
	switch (iParam1)
	{
		case 0:
...
BOOL func_311(Hash hParam0, int iParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x124FE (75006)
{
	int num;
	int num2;
	int num3;
	...
	if (func_312(hParam0, iParam1, &num3, &num2, bParam2, bParam3))
	{
...
BOOL func_312(Hash hParam0, int iParam1, var uParam2, var uParam3, BOOL bParam4, BOOL bParam5) // Position - 0x1253C (75068)
{
...
int func_313(int iParam0) // Position - 0x1535E (86878)
{
	switch (iParam0)
	{
		case -1:
...
void func_314(int iParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0x15432 (87090)
{
	int num;
	int num2;
	Hash outfit;
	...
	if (iParam0 == 12)
	{
		...
		if (outfitIndex >= 0)
		{
			...
			if (num3 > outfitIndex)
			{
				...
				func_307(&Global_80063[0 /*14*/], iParam0, iParam1, &(outfit.f_7), 0, 0, outfit.f_2, false, -1, 2, true);
				return;
			}
		}
	}
	...
	{
		func_307(&Global_80063[0 /*14*/], iParam0, iParam1, "NO_LABEL", 0, 0, 0, true, -1, 2, true);
	}
	else if (iParam0 == 14)
	{
		...
		if (componentId >= 0)
		{
			...
			if (num5 > componentId)
			{
				...
				func_307(&Global_80063[0 /*14*/], iParam0, iParam1, &(outProp.f_9), outProp.f_3, outProp.f_4, outProp.f_5, EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(outProp.f_1, joaat("OUTFIT_ONLY"), 0), num4, 2, outProp.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (hParam3 != -1 && Global_80261)
		{
			...
			func_307(&Global_80063[0 /*14*/], iParam0, iParam1, &(outComponent.f_9), outComponent.f_3, outComponent.f_4, outComponent.f_5, EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(outComponent.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, outComponent.f_1 != 0);
			return;
		}
		...
		if (componentId2 >= 0)
		{
			num6 = EXTRAMETADATA::SETUP_SHOP_PED_APPAREL_QUERY_TU(num2, 11, -1, false, -1, func_315(iParam0));
...
int func_315(int iParam0) // Position - 0x156B9 (87737)
{
	switch (iParam0)
	{
		case 0:
...
void func_316(int iParam0) // Position - 0x15769 (87913)
{
	BOOL flag;
	int num;
	var unk;
...
void func_317(int iParam0) // Position - 0x158C0 (88256)
{
	BOOL flag;
	int num;
	var unk;
...
void func_318(int iParam0) // Position - 0x15DCE (89550)
{
	BOOL flag;
	int num;
	var unk;
...
void func_319(int iParam0) // Position - 0x15E43 (89667)
{
	BOOL flag;
	int num;
	var unk;
...
void func_320(int iParam0) // Position - 0x15EB7 (89783)
{
	BOOL flag;
	int num;
	var unk;
...
void func_321(int iParam0) // Position - 0x15F9E (90014)
{
	BOOL flag;
	int num;
	var unk;
...
void func_322(int iParam0) // Position - 0x16301 (90881)
{
	BOOL flag;
	int num;
	var unk;
...
void func_323(int iParam0) // Position - 0x16512 (91410)
{
	BOOL flag;
	int num;
	var unk;
...
void func_324(int iParam0) // Position - 0x16742 (91970)
{
	BOOL flag;
	int num;
	var unk;
...
void func_325(int iParam0) // Position - 0x16852 (92242)
{
	BOOL flag;
	int num;
	var unk;
...
void func_326(int iParam0) // Position - 0x171F1 (94705)
{
	BOOL flag;
	int num;
	var unk;
...
void func_327(int iParam0) // Position - 0x17D64 (97636)
{
	if (iParam0 < 136)
		func_329(iParam0);
	else
	...
	if (Global_80063[0 /*14*/].f_2 == -1)
		func_314(3, iParam0, 242, -1);

	return;
}

void func_328(int iParam0) // Position - 0x17D99 (97689)
{
	BOOL flag;
	int num;
	var unk;
...
void func_329(int iParam0) // Position - 0x18BDD (101341)
{
	BOOL flag;
	int num;
	var unk;
...
void func_330(int iParam0) // Position - 0x19AEB (105195)
{
	BOOL flag;
	int num;
	var unk;
...
void func_331(int iParam0) // Position - 0x19C18 (105496)
{
	BOOL flag;
	int num;
	var unk;
...
void func_332(int iParam0, int iParam1) // Position - 0x19D16 (105750)
{
	switch (iParam0)
	{
		case 0:
...
void func_333(int iParam0) // Position - 0x19E06 (105990)
{
	BOOL flag;
	int num;
	var unk;
...
void func_334(int iParam0) // Position - 0x1B2F7 (111351)
{
	BOOL flag;
	int num;
	var unk;
...
void func_335(int iParam0) // Position - 0x1B448 (111688)
{
	BOOL flag;
	int num;
	var unk;
...
void func_336(int iParam0) // Position - 0x1B953 (112979)
{
	BOOL flag;
	int num;
	var unk;
...
void func_337(int iParam0) // Position - 0x1BFC1 (114625)
{
	BOOL flag;
	int num;
	var unk;
...
void func_338(int iParam0) // Position - 0x1C036 (114742)
{
	BOOL flag;
	int num;
	var unk;
...
void func_339(int iParam0) // Position - 0x1C106 (114950)
{
	BOOL flag;
	int num;
	var unk;
...
void func_340(int iParam0) // Position - 0x1C636 (116278)
{
	BOOL flag;
	int num;
	var unk;
...
void func_341(int iParam0) // Position - 0x1C7CD (116685)
{
	BOOL flag;
	int num;
	var unk;
...
void func_342(int iParam0) // Position - 0x1CFCB (118731)
{
	BOOL flag;
	int num;
	var unk;
...
void func_343(int iParam0) // Position - 0x1D0DB (119003)
{
	BOOL flag;
	int num;
	var unk;
...
void func_344(int iParam0) // Position - 0x1E006 (122886)
{
	BOOL flag;
	int num;
	var unk;
...
void func_345(int iParam0) // Position - 0x1ECC3 (126147)
{
	if (iParam0 < 107)
		func_348(iParam0);
	else if (iParam0 < 227)
	...
	if (Global_80063[0 /*14*/].f_2 == -1)
		func_314(3, iParam0, 318, -1);

	return;
}

void func_346(int iParam0) // Position - 0x1ED09 (126217)
{
	BOOL flag;
	int num;
	var unk;
...
void func_347(int iParam0) // Position - 0x1F7AE (128942)
{
	BOOL flag;
	int num;
	var unk;
...
void func_348(int iParam0) // Position - 0x2059F (132511)
{
	BOOL flag;
	int num;
	var unk;
...
void func_349(int iParam0) // Position - 0x211E8 (135656)
{
	BOOL flag;
	int num;
	var unk;
...
void func_350(int iParam0) // Position - 0x21461 (136289)
{
	BOOL flag;
	int num;
	var unk;
...
void func_351(int iParam0, int iParam1) // Position - 0x215A7 (136615)
{
	switch (iParam0)
	{
		case 0:
...
void func_352(int iParam0) // Position - 0x21697 (136855)
{
	BOOL flag;
	int num;
	var unk;
...
void func_353(int iParam0) // Position - 0x22421 (140321)
{
	BOOL flag;
	int num;
	var unk;
...
void func_354(int iParam0) // Position - 0x2259B (140699)
{
	BOOL flag;
	int num;
	var unk;
...
void func_355(int iParam0) // Position - 0x22B12 (142098)
{
	BOOL flag;
	int num;
	var unk;
...
void func_356(int iParam0) // Position - 0x2303C (143420)
{
	BOOL flag;
	int num;
	var unk;
...
void func_357(int iParam0) // Position - 0x230B0 (143536)
{
	BOOL flag;
	int num;
	var unk;
...
void func_358(int iParam0) // Position - 0x23180 (143744)
{
	BOOL flag;
	int num;
	var unk;
...
void func_359(int iParam0) // Position - 0x23658 (144984)
{
	BOOL flag;
	int num;
	var unk;
...
void func_360(int iParam0) // Position - 0x238C1 (145601)
{
	BOOL flag;
	int num;
	var unk;
...
void func_361(int iParam0) // Position - 0x23B97 (146327)
{
	BOOL flag;
	int num;
	var unk;
...
void func_362(int iParam0) // Position - 0x23D60 (146784)
{
	BOOL flag;
	int num;
	var unk;
...
void func_363(int iParam0) // Position - 0x248B7 (149687)
{
	BOOL flag;
	int num;
	var unk;
...
void func_364(int iParam0) // Position - 0x25501 (152833)
{
	if (iParam0 < 60)
		func_366(iParam0);
	else
	...
	if (Global_80063[0 /*14*/].f_2 == -1)
		func_314(3, iParam0, 181, -1);

	return;
}

void func_365(int iParam0) // Position - 0x25536 (152886)
{
	BOOL flag;
	int num;
	var unk;
...
void func_366(int iParam0) // Position - 0x262D6 (156374)
{
	BOOL flag;
	int num;
	var unk;
...
void func_367(int iParam0) // Position - 0x26962 (158050)
{
	BOOL flag;
	int num;
	var unk;
...
void func_368(int iParam0) // Position - 0x26A49 (158281)
{
	BOOL flag;
	int num;
	var unk;
...
void func_369() // Position - 0x26B47 (158535)
{
...
void func_370() // Position - 0x26BC0 (158656)
{
	func_379();
	func_378();
	func_371();
...
void func_371() // Position - 0x26BD4 (158676)
{
	var unk;
...
void func_372(var uParam0, int iParam1) // Position - 0x26C41 (158785)
{
	int i;
	...
	{
		func_376(&uLocal_80, uParam0->[i /*3*/]);
	}

	func_375(&uLocal_80);
	func_373(&uLocal_132, &uLocal_80, 50f);
	return;
}

void func_373(var uParam0, var uParam1, float fParam2) // Position - 0x26C85 (158853)
{
	int num;
	int num2;
	int num3;
	...
	while (num2 < uParam1->f_46)
	{
		...
		if (func_374(uParam1, uParam1->[num2 /*3*/] + num6))
			num6 = { -num6 };
...
BOOL func_374(var uParam0, float fParam1, var uParam2, var uParam3) // Position - 0x26D92 (159122)
{
	BOOL flag;
	int num;
	int num2;
...
void func_375(var uParam0) // Position - 0x26E4E (159310)
{
	int i;
	float num;
...
void func_376(var uParam0, var uParam1, var uParam2, var uParam3) // Position - 0x26EEE (159470)
{
	uParam0->f_51 == 0;
	uParam0->f_46 >= 15;
...
void func_377(var uParam0) // Position - 0x26F1F (159519)
{
	uParam0->f_51;
	uParam0->f_46 = 0;
...
void func_378() // Position - 0x26F46 (159558)
{
...
void func_379() // Position - 0x26F66 (159590)
{
	return;
}

void func_380() // Position - 0x26F6E (159598)
{
	func_391(true);
	func_390();
	func_381(false);
...
void func_381(BOOL bParam0) // Position - 0x26F88 (159624)
{
	bParam0;
	func_389(true, 1, 1);
	PLAYER::SET_PLAYER_CONTROL(PLAYER::PLAYER_ID(), true, 0);
...
void func_382() // Position - 0x26FF3 (159731)
{
	return;
}

void func_383() // Position - 0x26FFB (159739)
{
	Global_21849 = 0;
	func_384();
	return;
...
void func_384() // Position - 0x2700B (159755)
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_23994 = 0;
...
void func_385() // Position - 0x2702C (159788)
{
	return;
}

void func_386() // Position - 0x27034 (159796)
{
	return;
}

void func_387() // Position - 0x2703C (159804)
{
	return;
}

void func_388() // Position - 0x27044 (159812)
{
	return;
}

void func_389(BOOL bParam0, int iParam1, int iParam2) // Position - 0x2704C (159820)
{
...
void func_390() // Position - 0x270AB (159915)
{
	Global_98259 = 0;
	return;
}

void func_391(BOOL bParam0) // Position - 0x270B8 (159928)
{
...
void func_392() // Position - 0x270FF (159999)
{
	int num;
...
BOOL func_393() // Position - 0x27170 (160112)
{
	if (Global_102429 == 13 || Global_102429 == 10 || Global_102429 == 11 || Global_102429 == 12)
		return false;
...
void func_394() // Position - 0x271AE (160174)
{
	Global_114904.f_2370.f_539.f_2395[0] = -99;
	Global_114904.f_2370.f_539.f_2395[1] = -99;
	Global_114904.f_2370.f_539.f_2395[2] = -99;
