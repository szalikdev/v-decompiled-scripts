...
BOOL IS_GAMER_HANDLE_VALID(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12) // Position - 0x2275 (8821)
{
	return NETWORK::NETWORK_IS_HANDLE_VALID(&uParam0, 13);
}

BOOL func_83(Hash hParam0) // Position - 0x2285 (8837)
{
	switch (hParam0)
	{
		case -1321131184:
...
BOOL func_84(Hash hParam0) // Position - 0x22B3 (8883)
{
	switch (hParam0)
	{
		case joaat("coureur"):
...
BOOL func_85(Hash hParam0) // Position - 0x22E8 (8936)
{
	switch (hParam0)
	{
		case joaat("deity"):
...
BOOL func_86(Hash hParam0) // Position - 0x2377 (9079)
{
	switch (hParam0)
	{
		case joaat("pounder2"):
...
void func_87(Vehicle veParam0) // Position - 0x247E (9342)
{
	Hash entityModel;
...
void func_88(var uParam0, var uParam1, var uParam2) // Position - 0x2509 (9481)
{
	Hash eventData;
...
int func_89(BOOL bParam0, BOOL bParam1) // Position - 0x254A (9546)
{
	int address;
	int i;
	Player player;
...
BOOL func_90(int iParam0) // Position - 0x25AF (9647)
{
	int i;
...
BOOL func_91(int iParam0) // Position - 0x25EA (9706)
{
	return func_92(iParam0, 6, true);
}

BOOL func_92(int iParam0, int iParam1, BOOL bParam2) // Position - 0x25FA (9722)
{
	if (iParam0 == -1)
		return false;
...
int func_93(int iParam0, int iParam1) // Position - 0x265A (9818)
{
	Hash statHash;
	int outValue;
...
Hash func_94(int iParam0, int iParam1) // Position - 0x2689 (9865)
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(0, iParam0, func_95(iParam1));
}

int func_95(int iParam0) // Position - 0x269E (9886)
{
	int num;
	int num2;
...
int func_96(int iParam0) // Position - 0x26D2 (9938)
{
	switch (iParam0)
	{
		case 0:
...
int func_97() // Position - 0x2AB6 (10934)
{
	return Global_33775;
}

int func_98(int iParam0) // Position - 0x2AC1 (10945)
{
	switch (iParam0)
	{
		case -1:
...
BOOL func_99() // Position - 0x2E2B (11819)
{
	return Global_102481.f_418 > 0;
}

int func_100(Vehicle veParam0, Any* panParam1) // Position - 0x2E3C (11836)
{
...
BOOL func_101(Vehicle veParam0) // Position - 0x2EB9 (11961)
{
	int vehicleCrewEmblemRequestState;
	int networkTime;
	int num;
...
void func_102(Vehicle veParam0) // Position - 0x2F46 (12102)
{
	int _int;
...
BOOL func_103(var uParam0, Player plParam1) // Position - 0x2FA2 (12194)
{
	func_107();
	...
	func_105(*uParam0, &Global_1950086, &(Global_1950086.f_1), &(Global_1950086.f_4), &(Global_1950086.f_7), &(Global_1950086.f_10));
	...
	{
		if (func_104(uParam0, plParam1, Global_1950086, Global_1950086.f_1, Global_1950086.f_4, Global_1950086.f_7, Global_1950086.f_10, 0, Global_1950086.f_13))
		{
			if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	...
	else
	{
		...
		if (Global_1950086.f_23 == 0 && func_104(uParam0, plParam1, Global_1950086, Global_1950086.f_1, Global_1950086.f_4, Global_1950086.f_7, Global_1950086.f_10, 0, Global_1950086.f_13) || Global_1950086.f_23 != 0 && Global_1950086.f_24 == 0 && func_104(uParam0, plParam1, Global_1950086, Global_1950086.f_14, Global_1950086.f_17, Global_1950086.f_20, Global_1950086.f_10, 1, Global_1950086.f_13) || Global_1950086.f_24 != 0)
		{
			if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
				Global_1576399 = NETWORK::GET_NETWORK_TIME();
			else
...
BOOL func_104(var uParam0, Player plParam1, int iParam2, Vector3 vParam3, var uParam4, var uParam5, Vector3 vParam6, var uParam7, var uParam8, Vector3 vParam9, var uParam10, var uParam11, float fParam12, int iParam13, int iParam14) // Position - 0x324D (12877)
{
...
int func_105(Vehicle veParam0, int iParam1, var uParam2, var uParam3, var uParam4, float fParam5) // Position - 0x3276 (12918)
{
	if (!ENTITY::DOES_ENTITY_EXIST(veParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(veParam0, false))
		return 0;
	...
	*iParam1 = ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(veParam0, "chassis_dummy");
	...
	if (!func_106(Global_1950112, 0f, 0f, 0f, false) && !func_106(Global_1950115, 0f, 0f, 0f, false) && !func_106(Global_1950118, 0f, 0f, 0f, false) && !(Global_1950121 == 0f))
	{
...
BOOL func_106(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, BOOL bParam6) // Position - 0x92BB (37563)
{
	if (bParam6)
...
void func_107() // Position - 0x9302 (37634)
{
	Global_1950086 = 0;
...
BOOL func_108(Vehicle veParam0) // Position - 0x937B (37755)
{
	if (ENTITY::DOES_ENTITY_EXIST(veParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(veParam0, false))
...
BOOL func_109(Vehicle veParam0) // Position - 0x93B3 (37811)
{
	int _int;
...
BOOL func_110(Vehicle veParam0, Any* panParam1) // Position - 0x93FB (37883)
{
	Player playerFromGamerHandle;
	BOOL flag;
	int num;
...
BOOL func_111(Vehicle veParam0) // Position - 0x9558 (38232)
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		return true;
...
int func_112(Vehicle veParam0) // Position - 0x98B5 (39093)
{
...
int func_113(Player plParam0) // Position - 0x98E1 (39137)
{
...
int func_114(Player plParam0) // Position - 0x98FE (39166)
{
...
BOOL func_115(Player plParam0, BOOL bParam1) // Position - 0x9921 (39201)
{
	if (func_11(plParam0))
...
int func_116(Player plParam0) // Position - 0x9965 (39269)
{
	if (func_11(plParam0))
		if (func_115(plParam0, false))
...
int func_117() // Position - 0x9991 (39313)
{
	int num;
...
BOOL func_118(BOOL bParam0) // Position - 0x999E (39326)
{
	return func_119(PLAYER::PLAYER_ID(), bParam0);
}

BOOL func_119(Player plParam0, BOOL bParam1) // Position - 0x99B0 (39344)
{
	return func_120(plParam0, bParam1, 1);
}

BOOL func_120(Player plParam0, BOOL bParam1, int iParam2) // Position - 0x99C1 (39361)
{
	Player player;
...
BOOL func_121(Player plParam0, int iParam1) // Position - 0x9A1D (39453)
{
	if (func_11(plParam0))
...
BOOL func_122(int iParam0, BOOL bParam1) // Position - 0x9A6C (39532)
{
	int num;
	int num2;
...
int func_123(int iParam0) // Position - 0x9ACA (39626)
{
	return iParam0 % 32;
}

int func_124(int iParam0) // Position - 0x9AD7 (39639)
{
	int num;
...
int func_125(int iParam0) // Position - 0x9AEE (39662)
{
	int num;
	int num2;
...
int func_126(int iParam0) // Position - 0x9B1B (39707)
{
	return iParam0 / 32;
}

BOOL func_127(Player plParam0) // Position - 0x9B28 (39720)
{
...
BOOL func_128(Player plParam0) // Position - 0x9B5D (39773)
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2658291[plParam0 /*468*/].f_325.f_8 != -1)
				return func_129(Global_2658291[plParam0 /*468*/].f_325.f_8) == 22;

	return false;
}

int func_129(int iParam0) // Position - 0x9BA4 (39844)
{
	switch (iParam0)
	{
		case 0:
...
void func_130(Vehicle veParam0, int iParam1) // Position - 0xA0F4 (41204)
{
	int num;
	int num2;
...
BOOL func_131(int iParam0, var uParam1) // Position - 0xA115 (41237)
{
	*uParam1 = -1;
...
int func_132(int iParam0) // Position - 0xA3D7 (41943)
{
	switch (iParam0)
	{
		case 0:
...
int func_133(int iParam0, int iParam1, int iParam2) // Position - 0xA475 (42101)
{
...
BOOL func_134() // Position - 0xA657 (42583)
{
	var gamerHandle;
...
struct<13> GET_LOCAL_GAMER_HANDLE() // Position - 0xA69F (42655)
{
	var gamerHandle;
...
BOOL func_136(Vehicle veParam0) // Position - 0xA6B4 (42676)
{
	switch (ENTITY::GET_ENTITY_MODEL(veParam0))
	{
		case joaat("deathbike2"):
...
BOOL func_137(int iParam0, var uParam1) // Position - 0xA6D5 (42709)
{
	*uParam1 = -1f;
...
void func_138(Vehicle veParam0, var uParam1) // Position - 0xA9D6 (43478)
{
...
void func_139(Vehicle veParam0) // Position - 0xAA4F (43599)
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
...
void func_140(Vehicle veParam0) // Position - 0xAA81 (43649)
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		if (DECORATOR::DECOR_IS_REGISTERED_AS_TYPE("MLJ", BOOL))
			if (!DECORATOR::DECOR_EXIST_ON(veParam0, "MLJ"))
...
BOOL func_141(Hash hParam0) // Position - 0xAAB5 (43701)
{
	switch (hParam0)
	{
		case 1484920335:
...
BOOL func_142(Hash hParam0) // Position - 0xAAD8 (43736)
{
...
void func_143(Vehicle veParam0, var uParam1, BOOL bParam2, BOOL bParam3) // Position - 0xBA9D (47773)
{
	int num;
	int num2;
	int i;
...
BOOL func_144(Vehicle veParam0, float fParam1) // Position - 0xC1BE (49598)
{
	float entityCoords;
	var groundZ;
...
Hash func_145(BOOL bParam0) // Position - 0xC22F (49711)
{
	if (bParam0)
...
BOOL func_146() // Position - 0xC249 (49737)
{
...
BOOL func_147(Player plParam0) // Position - 0xC2D8 (49880)
{
	Player player;
...
BOOL func_148(Player plParam0) // Position - 0xC2FD (49917)
{
	Player player;
...
BOOL func_149(Player plParam0, int iParam1) // Position - 0xC31B (49947)
{
	return IS_BIT_SET(Global_1892653[plParam0 /*615*/].f_10.f_4, iParam1);
}

BOOL func_150(int iParam0) // Position - 0xC333 (49971)
{
	return func_151(&(Global_2673271.f_194), iParam0);
}

BOOL func_151(var uParam0, int iParam1) // Position - 0xC347 (49991)
{
	int num;
	int num2;
	int num3;
...
int func_152(var uParam0, var uParam1, var uParam2) // Position - 0xC36A (50026)
{
	int i;
	int modType;
...
BOOL func_153(Vehicle veParam0) // Position - 0xC543 (50499)
{
	int i;
	int modType;
	Hash hashKey;
...
void func_154(var uParam0) // Position - 0xC61D (50717)
{
...
int func_155(Vehicle veParam0, int iParam1) // Position - 0xC674 (50804)
{
	int value;
	int value2;
	float num;
...
int func_156(Vehicle veParam0, int iParam1) // Position - 0xC75D (51037)
{
	int i;
...
BOOL func_157(Hash hParam0) // Position - 0xC7BF (51135)
{
...
BOOL func_158(Hash hParam0, int iParam1) // Position - 0xC7EA (51178)
{
	switch (hParam0)
	{
		case joaat("faction2"):
...
BOOL func_159(Vehicle veParam0, int iParam1, int iParam2) // Position - 0xCBD0 (52176)
{
...
BOOL func_160() // Position - 0xCBF4 (52212)
{
	return false;
}

void func_161(Vehicle veParam0, int iParam1) // Position - 0xCBFD (52221)
{
	int vehicleMod;
...
BOOL func_162(int iParam0) // Position - 0xCC75 (52341)
{
	switch (iParam0)
	{
		case joaat("granger"):
...
BOOL func_163() // Position - 0xCC95 (52373)
{
	return DLC::IS_DLC_PRESENT(joaat("mpindependence"));
}

BOOL func_164(Vehicle veParam0) // Position - 0xCCA6 (52390)
{
	int _int;
...
int func_165(var uParam0) // Position - 0xCCEB (52459)
{
...
BOOL func_166(int iParam0) // Position - 0xCD0B (52491)
{
	switch (iParam0)
	{
		case 161:
...
int func_167(int iParam0) // Position - 0xCD5E (52574)
{
	switch (iParam0)
	{
		case 1:
...
BOOL func_168(Vehicle veParam0) // Position - 0xCE0E (52750)
{
...
BOOL _IS_PLAYER_IN_VEHICLE_SEAT(Player plParam0, int iParam1) // Position - 0xCE95 (52885)
{
...
void func_170(var uParam0) // Position - 0xCEE2 (52962)
{
...
void func_171(var uParam0) // Position - 0xCF30 (53040)
{
...
Vector3 func_172(float fParam0, var uParam1, var uParam2) // Position - 0xCFEA (53226)
{
	return -BUILTIN::SIN(fParam0.f_2) * BUILTIN::COS(fParam0), BUILTIN::COS(fParam0.f_2) * BUILTIN::COS(fParam0), BUILTIN::SIN(fParam0);
}

BOOL func_173(var uParam0) // Position - 0xD017 (53271)
{
	Player player;
	...
	else
	{
		...
		func_174(uParam0->f_23, &Global_1879623[player /*55*/], false, -1);
	}
...
void func_174(Ped pedParam0, var uParam1, BOOL bParam2, int iParam3) // Position - 0xD0EF (53487)
{
	var unk;
	int characterType;
	BOOL flag;
...
void func_175(Ped pedParam0, int iParam1, int iParam2) // Position - 0xD258 (53848)
{
	switch (iParam1)
	{
		case 1310977332:
...
BOOL func_176(Ped pedParam0, const char* sParam1, int iParam2, int iParam3, Hash hParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7, BOOL bParam8) // Position - 0xE52F (58671)
{
	Hash entityModel;
	int num;
...
BOOL func_177(int iParam0, int iParam1) // Position - 0xED55 (60757)
{
	int num;
	int num2;
...
int func_178(int iParam0, int iParam1) // Position - 0xED94 (60820)
{
	int num;
	int num2;
...
int func_179() // Position - 0xEDDA (60890)
{
	return Global_33776;
}

int func_180(int iParam0) // Position - 0xEDE5 (60901)
{
	int num;
	int num2;
...
char* func_181(int iParam0) // Position - 0xF186 (61830)
{
	switch (iParam0)
	{
		case 0:
...
int func_182(Hash hParam0, const char* sParam1, int iParam2) // Position - 0xF7C7 (63431)
{
	switch (iParam2)
	{
		case joaat("crewLogo"):
...
BOOL func_206(Ped pedParam0, int iParam1, int iParam2) // Position - 0x14E3E (85566)
{
	...
	if (iParam1 == 12)
	{
		...
		{
			if (func_93(1759, Global_80060) != unk[10])
			{
				Global_2883588 = hash;
				Global_2883589 = hash2;
				return false;
	...
	*iParam0 = iParam9;
	...
	else
	{
		...
		if (iParam1 == 11 || iParam1 == 4 || iParam1 == 6 || iParam1 == 1 || iParam1 == 14 || iParam1 == 2 || iParam1 == 8 || iParam1 == 9 || iParam1 == 10 || iParam1 == 7 || iParam1 == 12)
		{
			...
			num = func_93(func_228(iParam1, iParam0->f_2), Global_80060);
		
			if (IS_BIT_SET(num, iParam0->f_1))
				MISC::SET_BIT(&(iParam0->f_6), 1);
		
			num = func_93(func_227(iParam1, iParam0->f_2), Global_80060);
...
BOOL func_230(Hash hParam0, int iParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x1B1AC (111020)
{
	int num;
	int num2;
	int num3;
...
BOOL func_231(Hash hParam0, int iParam1, var uParam2, var uParam3, BOOL bParam4, BOOL bParam5) // Position - 0x1B1EA (111082)
{
...
int func_248(int iParam0, int iParam1) // Position - 0x2661C (157212)
{
	...
	num = func_93(func_249(iParam0), iParam1);
	return num;
}
			...
			switch (pedDrawableVariation)
			{
				...
				case 5:
					if (!bParam1)
					{
						...
						else if (func_119(PLAYER::PLAYER_ID(), true) && Global_1892653[PLAYER::PLAYER_ID() /*615*/].f_10.f_77.f_21 != 0)
						{
							return 1;
						}
					}
...
void func_303() // Position - 0x362BE (221886)
{
	...
	func_309(&uLocal_122, -1640.5961f, -3127.1133f, 14.5828f, -2.3352f, 0.0001f, 145.7214f, "HS4_NIMB_LSA_ISD", 0, 1, 1023, 0);
...
void func_304() // Position - 0x36346 (222022)
{
...
void func_305() // Position - 0x36385 (222085)
{
	Global_80252 = false;
	Global_80253 = -1;
	Global_80254 = -1;
...
BOOL func_306() // Position - 0x363AB (222123)
{
	return func_307(PLAYER::PLAYER_PED_ID());
}

BOOL func_307(Ped pedParam0) // Position - 0x363BB (222139)
{
	int pedDrawableVariation;
...
void func_309(var uParam0, float fParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6, char* sParam7, int iParam8, int iParam9, int iParam10, int iParam11) // Position - 0x364A9 (222377)
{
...
void func_310(var uParam0, char* sParam1, int iParam2, int iParam3, int iParam4) // Position - 0x364D9 (222425)
{
	uParam0->f_1 = sParam1;
	uParam0->f_2 = iParam3;
...
void func_311(var uParam0, int iParam1, char* sParam2) // Position - 0x36506 (222470)
{
