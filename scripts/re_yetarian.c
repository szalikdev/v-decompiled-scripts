...
int func_68(BOOL bParam0) // Position - 0x2C36 (11318)
{
	if (func_72())
	{
		...
		if (bParam0 && func_17(Global_114893))
...
{
	switch (func_73(&Global_33835, 0, 5, false, SCRIPT::GET_ID_OF_THIS_THREAD()))
	{
		case 1:
			return true;
...
void func_102(int iParam0) // Position - 0x5C2E (23598)
{
	...
	if (func_130())
	{
		...
		func_105(30000);
		TEXT_LABEL_ASSIGN_STRING(&name, func_104(Global_114893, true), 64);
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					...
					case 1:
						if (PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_165() || Global_33778 || func_164() || func_53(8, -1) || func_161() || func_163() || func_162() || func_160() || Global_114904.f_7695.f_919[character] == 5)
							return false;
						break;
					...
					case 3:
						if (PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_165() || Global_113951 || Global_33778 || func_164() || func_53(8, -1) || func_163() || func_162() || func_160() || Global_114904.f_7695.f_919[character] == 5)
							return false;
						break;
				
					case 4:
						if (func_165() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0 || func_53(8, -1) || func_160() || func_159() || Global_114904.f_7695.f_919[character] == 5)
							return false;
						break;
