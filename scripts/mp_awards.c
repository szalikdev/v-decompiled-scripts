				...
				case 3:
					switch (uParam0->f_6)
					{
						...
						case 22:
							...
							func_65("CLO_S1M_DEC_25", "CLO_S1M_D_24_25" /*Complete all the Lowriders Lamar missions.*/, "BennyTshirt01", "MPTShirtAwards4", PV_COMP_ACCS, type, -1, 1, &uLocal_111, 235, 189);
							break;
					}
					break;
					...
					switch (uParam0->f_6)
					{
						...
						case 22:
							if (!uLocal_111.f_1[0])
							{
								...
								func_65("CLO_S1M_DEC_24", "CLO_S1M_D_24_25" /*Complete all the Lowriders Lamar missions.*/, "BennyTshirt02", "MPTShirtAwards4", PV_COMP_ACCS, type, -1, 1, &uLocal_111, 235, 189);
							}
							break;
					}
					break;
...
void func_45(int iParam0, ePedComponentType epctParam1, int iParam2, BOOL bParam3) // Position - 0x542E (21550)
{
	Hash statName;
...
Hash func_46(int iParam0, int iParam1) // Position - 0x545C (21596)
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(0, iParam0, func_47(iParam1));
}

int func_47(int iParam0) // Position - 0x5471 (21617)
{
	int num;
	int num2;
...
int func_49(int iParam0, int iParam1) // Position - 0x54C3 (21699)
{
	Hash statHash;
	int outValue;
...
ePedComponentType func_50(int iParam0, int iParam1) // Position - 0x54F2 (21746)
{
	Hash statHash;
...
Hash func_51(int iParam0, int iParam1) // Position - 0x5516 (21782)
{
...
BOOL func_54(int iParam0, int iParam1) // Position - 0x8E41 (36417)
{
	int num;
	int num2;
...
int func_56(int iParam0, int iParam1) // Position - 0x8E7D (36477)
{
	int num;
...
int _STAT_GET_PACKED_INT(int iParam0, int iParam1) // Position - 0x96F2 (38642)
{
	if (iParam1 == -1)
		iParam1 = func_7();
...
BOOL _STAT_GET_PACKED_BOOL(int iParam0, int iParam1) // Position - 0xA009 (40969)
{
	if (iParam1 == -1)
		iParam1 = func_7();
