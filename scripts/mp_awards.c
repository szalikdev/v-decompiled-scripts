					...
					switch (uParam0->f_6)
					{
						...
						case 21:
							if (!Global_1672160.f_1[0])
							{
								...
								func_65("CLO_LTS_T_0", "CLO_LTS_TD_0", "Elitas_Tshirt", "MPTshirtAwardLTS", 1, hash, -1, 1, &Global_1672160, 218, 182);
								func_62(0);
								func_62(1);
								func_62(2);
								hash = 0;
								...
								func_65("CLO_HST_A_4", "CLO_HST_AD_5", "CantTouchThis", "MPTShirtAwards2", 1, hash, -1, 1, &Global_1672160, 218, 182);
								func_62(5);
								func_62(7);
								func_62(6);
							}
				...
				case 3:
					switch (uParam0->f_6)
					{
						...
						case 21:
							...
							func_65("CLO_HST_A_9", "CLO_HST_AD_9", "Showroom", "MPTShirtAwards2", 1, hash, -1, 1, &Global_1672160, 218, 182);
							...
							func_62(34);
							func_65("CLO_S1M_DEC_25", "CLO_S1M_D_24_25" /*Complete all the Lowriders Lamar missions.*/, "BennyTshirt01", "MPTShirtAwards4", 8, hash, -1, 1, &Global_1672160, 218, 182);
							break;
					}
					break;
					...
					switch (uParam0->f_6)
					{
						...
						case 21:
							if (!Global_1672160.f_1[0])
							{
								...
								func_65("CLO_S1M_DEC_24", "CLO_S1M_D_24_25" /*Complete all the Lowriders Lamar missions.*/, "BennyTshirt02", "MPTShirtAwards4", 8, hash, -1, 1, &Global_1672160, 218, 182);
							}
							break;
					}
					break;
...
Hash func_42(int iParam0) // Position - 0x57B6 (22454)
{
	Hash hash;

	if (Global_1940840[iParam0 /*8*/] == -1)
	{
		hash = func_49(func_48(iParam0), -1);
		...
		Global_1940840[iParam0 /*8*/] = hash;
	}

	return Global_1940840[iParam0 /*8*/];
}

void func_43(int iParam0, Hash hParam1) // Position - 0x57F9 (22521)
{
	Global_1940840[iParam0 /*8*/] = hParam1;
	func_44(func_48(iParam0), hParam1, -1);
	return;
}

void func_44(int iParam0, Hash hParam1, int iParam2) // Position - 0x5818 (22552)
{
	func_45(iParam0, hParam1, iParam2, true);
	return;
}

void func_45(int iParam0, Hash hParam1, int iParam2, BOOL bParam3) // Position - 0x582B (22571)
{
	Hash statName;
...
int func_50(int iParam0, int iParam1) // Position - 0x58EF (22767)
{
	Hash statHash;
	int outValue;
...
int func_52(int iParam0, int iParam1, int iParam2) // Position - 0x5929 (22825)
{
	iParam2 == 0;
...
void func_62(int iParam0) // Position - 0x98D0 (39120)
{
	...
	func_65(str, str2, str3, str4, num4, num5, -1, num2, &Global_1672160, 218, 182);
	return;
}

int func_63() // Position - 0x9A4F (39503)
{
	int num;
...
void func_65(char* sParam0, char* sParam1, char* sParam2, char* sParam3, int iParam4, Hash hParam5, int iParam6, int iParam7, var uParam8, int iParam9, int iParam10) // Position - 0xA07B (41083)
{
	int i;
	...
	for (i = 0; i <= 11; i = i + 1)
	{
		if (uParam8->f_1[i] == 0)
		{
			...
			func_66(i, sParam0, sParam1, iParam4, hParam5, uParam8);
			uParam8->f_1[i] = 1;
...
void func_66(int iParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, var uParam5) // Position - 0xA0E5 (41189)
{
...
void func_70(int iParam0, int iParam1, int iParam2, var uParam3) // Position - 0xA1BF (41407)
{
	...
	func_65(str, str2, str3, str4, num2, num3, num6, iParam1, uParam3, 218, 182);
	return;
}
...
int func_72(int iParam0) // Position - 0xA354 (41812)
{
	Hash hash;
	Hash statHash;
	int outValue;
...
int func_73(int iParam0, int iParam1, int iParam2) // Position - 0xA37C (41852)
{
	iParam2 == 0;
...
BOOL func_80(int iParam0, int iParam1) // Position - 0xA6D2 (42706)
{
	if (iParam1 <= iParam0)
		return true;
...
void func_82(int iParam0, int iParam1, int iParam2, var uParam3) // Position - 0xA75B (42843)
{
	...
	iParam1 = 1;
	func_65(str, str2, str3, str4, num3, num4, num5, iParam1, uParam3, 218, 182);
	return;
}
...
int func_91(int iParam0, int iParam1, int iParam2) // Position - 0xBCFD (48381)
{
	iParam1 == 5;
	iParam2 == 0;
	func_90(iParam0);
...
void func_104(int iParam0, int iParam1, int iParam2, var uParam3) // Position - 0xC528 (50472)
{
	...
	func_65(str, str2, str3, str4, num2, num3, num7, iParam1, uParam3, iParam0, 182);
	return;
}

int func_105() // Position - 0xC87E (51326)
{
	int num;
...
int func_106() // Position - 0xC8E3 (51427)
{
	int i;
	int num;
...
void func_118(int iParam0, int iParam1, int iParam2, var uParam3) // Position - 0xFDD0 (64976)
{
	...
	value2 = num3 - num5;
	num6 = BUILTIN::FLOOR((BUILTIN::TO_FLOAT(value2) / BUILTIN::TO_FLOAT(value)) * 100f);
	func_65(str, str2, str3, str4, num2, num3, num6, iParam1, uParam3, 218, iParam0);
	return;
}
