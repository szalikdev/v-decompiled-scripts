	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (num != -1)
		{
			if (Global_113991[num /*10*/].f_9 != -1)
			{
				...
				func_282(&(Global_113991[num /*10*/].f_9));
			}
		}
...
ePedComponentType func_83() // Position - 0x76B8 (30392)
{
...
Vector3 func_97(ePedComponentType epctParam0, int iParam1) // Position - 0x88F7 (35063)
{
	switch (iParam1)
	{
		case 0:
...
int func_98() // Position - 0x8A87 (35463)
{
	return func_99(PLAYER::PLAYER_ID());
}

int func_99(Player plParam0) // Position - 0x8A97 (35479)
{
	return MISC::GET_BITS_IN_RANGE(Global_2658291[plParam0 /*468*/].f_325.f_3, 28, 31);
}

BOOL func_100(int iParam0) // Position - 0x8AB4 (35508)
{
	return func_74(iParam0, 0, false);
}

int func_101(int iParam0) // Position - 0x8AC4 (35524)
{
	switch (iParam0)
	{
		case -1:
...
BOOL func_102() // Position - 0x8E2E (36398)
{
	return Global_102481.f_417 > 0;
}

var func_103() // Position - 0x8E3F (36415)
{
	var unk;
...
void func_104(var uParam0, int iParam1) // Position - 0x8E85 (36485)
{
	if (iParam1 <= 0)
		return;
...
void func_105(var uParam0, int iParam1) // Position - 0x8F0B (36619)
{
...
void func_106(var uParam0, int iParam1) // Position - 0x8F3E (36670)
{
	int num;
	int num2;
...
int func_107(int iParam0, int iParam1) // Position - 0x8F8F (36751)
{
	if (iParam1 < 0)
		iParam1 = 0;
...
int func_108(int iParam0) // Position - 0x9031 (36913)
{
	return (BUILTIN::SHIFT_RIGHT(iParam0, 26) & 31 * IS_BIT_SET(iParam0, 31) ? -1 : 1) + 2011;
}

var func_109(BOOL bParam0, var uParam1, var uParam2) // Position - 0x9053 (36947)
{
	if (bParam0)
		return uParam1;
...
int func_110(int iParam0) // Position - 0x906A (36970)
{
	return iParam0 & 15;
}

void func_111(var uParam0, int iParam1) // Position - 0x9077 (36983)
{
...
void func_112(var uParam0, int iParam1) // Position - 0x90B1 (37041)
{
...
void func_113(var uParam0, int iParam1) // Position - 0x90EC (37100)
{
	if (iParam1 < 0 || iParam1 >= 60)
		return;
...
eCharacter _GET_CURRENT_PLAYER_CHARACTER_0() // Position - 0x9128 (37160)
{
	func_58();
	return Global_114904.f_2370.f_539.f_4321;
}

void func_115(int iParam0) // Position - 0x9141 (37185)
{
	int num;
	var textLabel;
...
BOOL func_116() // Position - 0x91A4 (37284)
{
	return MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION();
}

BOOL func_117() // Position - 0x91BA (37306)
{
	return MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION();
}

void func_118(char* sParam0, Any anParam1, int iParam2) // Position - 0x91D0 (37328)
{
...
BOOL func_119(BOOL bParam0) // Position - 0x9212 (37394)
{
...
struct<2> func_120(int iParam0) // Position - 0x923A (37434)
{
	var unk;
...
void func_121(int iParam0, var uParam1) // Position - 0x9687 (38535)
{
	switch (iParam0)
	{
		case 0:
...
int func_123(int iParam0) // Position - 0xA95F (43359)
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_124(Any* panParam0) // Position - 0xACA5 (44197)
{
	int threadId;
...
void func_125(int iParam0) // Position - 0xAD4A (44362)
{
	var name;
...
void func_126(int iParam0) // Position - 0xADE5 (44517)
{
	if (iParam0 < 63)
	{
		func_127();
...
void func_127() // Position - 0xAE0B (44555)
{
	Global_80535 != 6;
...
void func_128(Ped pedParam0) // Position - 0xAE43 (44611)
{
	int num;
	int num2;
	int num3;
...
void func_129(int iParam0) // Position - 0xAE9C (44700)
{
...
int func_130(Ped pedParam0) // Position - 0xAF1F (44831)
{
	int i;
...
void func_131(int iParam0, int iParam1, int iParam2) // Position - 0xAF50 (44880)
{
	func_132(iParam0, iParam1, iParam2, 0, 0, 1);
	return;
}

void func_132(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xAF65 (44901)
{
	int num;
...
int func_133() // Position - 0xAFE7 (45031)
{
	int i;
...
BOOL func_134(int iParam0, int iParam1, int iParam2) // Position - 0xB018 (45080)
{
...
int func_135(int iParam0, int iParam1, int iParam2) // Position - 0xB033 (45107)
{
	int i;
...
int func_136(Ped pedParam0) // Position - 0xB07F (45183)
{
	int i;
...
BOOL func_137(Ped pedParam0) // Position - 0xB0C8 (45256)
{
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(Ped pedParam0) // Position - 0xB0E8 (45288)
{
	if (ENTITY::DOES_ENTITY_EXIST(pedParam0))
...
BOOL func_139(int iParam0) // Position - 0xB109 (45321)
{
	switch (iParam0)
	{
		case 5:
...
void func_140() // Position - 0xB15C (45404)
{
...
BOOL func_141(int iParam0) // Position - 0xB1D9 (45529)
{
	switch (iParam0)
	{
		case 5:
...
void func_142(Any* panParam0, BOOL bParam1, BOOL bParam2) // Position - 0xB22C (45612)
{
	int i;
...
BOOL func_143(int iParam0) // Position - 0xB322 (45858)
{
	switch (iParam0)
	{
		case 5:
...
void func_144(BOOL bParam0) // Position - 0xB38D (45965)
{
	Player playerIndex;
...
void func_145(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB3CC (46028)
{
	if (bParam0)
	{
...
BOOL func_146() // Position - 0xB51B (46363)
{
	return IS_BIT_SET(Global_1845250[PLAYER::PLAYER_ID() /*880*/].f_36.f_18, 14);
}

BOOL func_147(Player plParam0, int iParam1) // Position - 0xB535 (46389)
{
	BOOL flag;
...
int func_148(int iParam0, BOOL bParam1) // Position - 0xB58E (46478)
{
	int num;
	int num2;
...
BOOL func_149(Player plParam0) // Position - 0xB5CF (46543)
{
	Player player;
...
BOOL func_150(Player plParam0) // Position - 0xB5F1 (46577)
{
...
BOOL func_151() // Position - 0xB630 (46640)
{
	return IS_BIT_SET(Global_2621446, 3);
}

int func_152(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0xB63E (46654)
{
	int num;
...
BOOL func_153() // Position - 0xB671 (46705)
{
...
void func_154(int iParam0) // Position - 0xB698 (46744)
{
	if (iParam0 == 1)
...
BOOL func_155(const char* sParam0) // Position - 0xB6BB (46779)
{
...
void func_156() // Position - 0xB6F8 (46840)
{
	Global_21849 = 0;
	func_157();
	return;
...
void func_157() // Position - 0xB708 (46856)
{
...
BOOL func_158() // Position - 0xB75F (46943)
{
...
void func_159() // Position - 0xB781 (46977)
{
	func_165(0);
	func_164();
	func_160();
...
void func_160() // Position - 0xB796 (46998)
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
...
BOOL func_161(Vehicle veParam0, float fParam1, int iParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB7EE (47086)
{
...
void func_162(Vehicle veParam0) // Position - 0xB845 (47173)
{
	if (!ENTITY::IS_ENTITY_DEAD(veParam0, false))
...
void func_163(BOOL bParam0, BOOL bParam1) // Position - 0xB871 (47217)
{
...
void func_164() // Position - 0xB9C2 (47554)
{
...
void func_165(int iParam0) // Position - 0xBA13 (47635)
{
	if (func_170())
		return;
...
void func_166(int iParam0) // Position - 0xBA46 (47686)
{
	if (func_170())
		return;
...
void func_167(BOOL bParam0, BOOL bParam1) // Position - 0xBAD0 (47824)
{
	if (bParam0)
	{
		if (func_169(0))
...
BOOL func_168() // Position - 0xBB44 (47940)
{
	return IS_BIT_SET(Global_1964145, 5);
}

BOOL func_169(int iParam0) // Position - 0xBB52 (47954)
{
	if (iParam0 == 1)
...
BOOL func_170() // Position - 0xBBA9 (48041)
{
	return IS_BIT_SET(Global_1964145, 19);
}

BOOL func_171(int iParam0) // Position - 0xBBB8 (48056)
{
...
BOOL func_172(int iParam0) // Position - 0xBBF9 (48121)
{
	int num;
...
void func_173(int iParam0) // Position - 0xBC3E (48190)
{
...
int func_174(int iParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4) // Position - 0xBC70 (48240)
{
	int i;
...
void func_175(int iParam0, int iParam1) // Position - 0xBDA7 (48551)
{
	int i;
...
BOOL _CAN_ENTER_FREEROAM_STATE(int iParam0) // Position - 0xBDF6 (48630)
{
	return func_177(iParam0, Global_44869);
}

BOOL func_177(int iParam0, int iParam1) // Position - 0xBE07 (48647)
{
	if (iParam1 == 15)
		return 1;
...
BOOL func_178(int iParam0) // Position - 0xBFE8 (49128)
{
	if (Global_44869 == 15)
		return false;
...
int func_179() // Position - 0xC00B (49163)
{
	return func_180(SCRIPT::GET_THIS_SCRIPT_NAME(), 0);
}

int func_180(const char* sParam0, int iParam1) // Position - 0xC01C (49180)
{
	int num;
	const char* str;
	Hash hashKey;
...
BOOL func_181() // Position - 0xC065 (49253)
{
	if (Global_102429 == 10 || Global_102429 == 9)
		return true;
...
BOOL func_182(var uParam0, int iParam1) // Position - 0xC089 (49289)
{
	switch (uParam0->f_16)
	{
		case 0:
...
void func_183() // Position - 0xC86C (51308)
{
	func_27(&(Global_105463.f_2890), &Global_105463, 0, 1, 1, 0);
	return;
}

BOOL func_184(var uParam0) // Position - 0xC887 (51335)
{
	float num;
...
void func_185(int iParam0, var uParam1) // Position - 0xC915 (51477)
{
	if (iParam0 == 1)
	{
		if (!func_141(uParam1))
...
BOOL func_186(BOOL bParam0) // Position - 0xC979 (51577)
{
...
BOOL func_187(Vehicle veParam0) // Position - 0xCA10 (51728)
{
...
BOOL func_188(int iParam0) // Position - 0xCA3A (51770)
{
	eCharacter character;
...
BOOL func_189() // Position - 0xD157 (53591)
{
	return Global_102468.f_1;
}

BOOL func_190() // Position - 0xD165 (53605)
{
	if (Global_99326 != -1)
...
BOOL func_191() // Position - 0xD188 (53640)
{
...
BOOL func_192() // Position - 0xD1A2 (53666)
{
	if (Global_80541)
		return true;
...
BOOL func_193() // Position - 0xD1CC (53708)
{
	return Global_102481.f_418 > 0;
}

BOOL func_194(int iParam0, int iParam1) // Position - 0xD1DD (53725)
{
	switch (iParam0)
	{
		case 5:
...
BOOL func_195() // Position - 0xD215 (53781)
{
	return Global_1575090;
}

BOOL func_196() // Position - 0xD221 (53793)
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
...
void func_197(var uParam0, const char* sParam1, var uParam2, var uParam3, var uParam4) // Position - 0xD23D (53821)
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
...
void func_198(int iParam0, BOOL bParam1) // Position - 0xD32E (54062)
{
	if (iParam0 == -1)
		return;
...
int func_199(int iParam0) // Position - 0xD36A (54122)
{
	if (Global_80276 == iParam0)
		if (Global_80277 == -1)
...
void func_200(var uParam0, int iParam1) // Position - 0xD3A3 (54179)
{
	BOOL flag;
	int i;
...
float func_201(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0xD441 (54337)
{
...
BOOL func_202() // Position - 0xD47B (54395)
{
	return Global_99713;
}

void func_203(var uParam0) // Position - 0xD487 (54407)
{
	CUTSCENE::STOP_CUTSCENE(false);
	CUTSCENE::REMOVE_CUTSCENE();
	func_204(uParam0);
...
void func_204(var uParam0) // Position - 0xD49E (54430)
{
	BOOL flag;
	int num;
	int i;
...
void func_205(int iParam0) // Position - 0xD586 (54662)
{
	if (iParam0 == -1)
		iParam0 = func_179();
...
BOOL func_206(Any* panParam0, BOOL bParam1) // Position - 0xD5AE (54702)
{
	var unk;
...
void func_207(Ped pedParam0, var uParam1, int iParam2) // Position - 0xD81E (55326)
{
	int taskSequenceId;
	int taskSequenceId2;
...
BOOL func_208(int iParam0) // Position - 0xDB76 (56182)
{
...
BOOL func_209(var uParam0) // Position - 0xDB96 (56214)
{
...
BOOL func_210(var uParam0) // Position - 0xDBAE (56238)
{
...
void func_211(var uParam0) // Position - 0xDBD3 (56275)
{
	int i;
	int taskSequenceId;
...
void func_212(Object* pobParam0) // Position - 0xDED7 (57047)
{
...
void func_213(var uParam0) // Position - 0xDF02 (57090)
{
	int i;
...
BOOL CHECK_VEHICLES_OK(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0xDF82 (57218)
{
	int i;
	int num;
	Vehicle playersLastVehicle;
...
BOOL func_215(Ped pedParam0, Vehicle veParam1) // Position - 0xE140 (57664)
{
...
BOOL func_216(var uParam0, BOOL bParam1, int iParam2) // Position - 0xE170 (57712)
{
	int i;
	int num;
...
BOOL func_217(int iParam0) // Position - 0xE42C (58412)
{
...
BOOL func_218(Ped pedParam0, int iParam1) // Position - 0xE460 (58464)
{
	float xSize;
...
BOOL func_219(Ped pedParam0, int iParam1) // Position - 0xE4D6 (58582)
{
	return func_220(pedParam0, PLAYER::PLAYER_PED_ID(), iParam1, 1, 250, 7);
}

BOOL func_220(Ped pedParam0, Ped pedParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xE4EE (58606)
{
	BOOL flag;
	var pedBoneCoords;
	int num;
...
BOOL func_221(var uParam0, Vector3 vParam1, var uParam2, var uParam3, Ped pedParam4, var uParam5, Ped pedParam6, int iParam7) // Position - 0xE5AF (58799)
{
	var hit;
	var endCoords;
	var surfaceNormal;
...
Vector3 func_222(Ped pedParam0, int iParam1) // Position - 0xE6DB (59099)
{
...
int func_223() // Position - 0xE7A0 (59296)
{
	int i;
...
BOOL func_224(Ped pedParam0, Ped pedParam1, int iParam2, int iParam3) // Position - 0xE7EA (59370)
{
	var unk;
...
float func_225(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) // Position - 0xE87B (59515)
{
	return (fParam0 * uParam3) + (fParam0.f_1 * uParam3.f_1) + (fParam0.f_2 * uParam3.f_2);
}

Vector3 func_226(float fParam0, var uParam1, var uParam2) // Position - 0xE89C (59548)
{
	float num;
	float num2;
...
void func_227(var uParam0) // Position - 0xE8DB (59611)
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_228(Ped pedParam0, Ped pedParam1) // Position - 0xE8F6 (59638)
{
	int i;
...
BOOL func_229(Ped pedParam0) // Position - 0xE935 (59701)
{
...
BOOL func_230(Ped pedParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0xE95D (59741)
{
	float radius;
	float num;
	int weaponHash;
...
BOOL func_231(Ped pedParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Position - 0xEA58 (59992)
{
	float entityCoords;
	float num;
...
BOOL func_232(Ped pedParam0, float fParam1) // Position - 0xEB64 (60260)
{
	var outProjectile;
	var outCoords;
...
BOOL func_233(Ped pedParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Position - 0xEBF9 (60409)
{
	var unk;
	var entityForwardVector;
	float num;
...
BOOL func_234(Ped pedParam0, BOOL bParam1, float fParam2, float fParam3) // Position - 0xEC87 (60551)
{
	if (bParam1)
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
BOOL func_235(int iParam0) // Position - 0xECCF (60623)
{
...
void func_236(Ped pedParam0) // Position - 0xED19 (60697)
{
	int taskSequenceId;
...
BOOL func_237(int iParam0) // Position - 0xEDB6 (60854)
{
	if (iParam0 == -1)
		iParam0 = func_179();
...
BOOL func_238(int iParam0) // Position - 0xEE4B (61003)
{
...
BOOL func_239() // Position - 0xEE8A (61066)
{
	if (MISC::IS_PC_VERSION())
...
BOOL func_240() // Position - 0xEEA7 (61095)
{
	if (Global_99326 != -1)
...
BOOL func_241(int iParam0) // Position - 0xEECA (61130)
{
...
BOOL func_242() // Position - 0xEEFE (61182)
{
...
BOOL func_243(int iParam0) // Position - 0xEF3C (61244)
{
	if (func_119(false))
...
BOOL func_244(var uParam0) // Position - 0xEF64 (61284)
{
	if (!func_245(uParam0))
		return false;
...
BOOL func_245(var uParam0) // Position - 0xEF83 (61315)
{
	int num;
	int i;
	BOOL flag;
...
BOOL func_246(Ped* ppedParam0, eCharacter echParam1, float fParam2, float fParam3, float fParam4, float fParam5, char* sParam6, int iParam7) // Position - 0xF21B (61979)
{
...
BOOL func_247(Ped* ppedParam0, eCharacter echParam1, Vector3 vParam2, var uParam3, var uParam4, float fParam5, BOOL bParam6) // Position - 0xF277 (62071)
{
	Hash model;
...
int func_248(Ped pedParam0, eCharacter echParam1) // Position - 0xF305 (62213)
{
	int num;
...
void func_249(Object* pobParam0, Hash hParam1, float fParam2, float fParam3, float fParam4, float fParam5) // Position - 0xF34B (62283)
{
	func_212(pobParam0);
...
BOOL func_250(var uParam0) // Position - 0xF372 (62322)
{
	int i;
...
void func_251(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0xF3A3 (62371)
{
	Vector3 vector;
	Vector3 vector2;
...
Hash func_252(eCharacter echParam0) // Position - 0xF4A4 (62628)
{
	if (!func_36(echParam0))
...
BOOL func_253(int iParam0) // Position - 0xF4CA (62666)
{
	var unk;
	eCharacter character;
...
BOOL func_254(int iParam0) // Position - 0xF51B (62747)
{
	const char* string2;
...
BOOL func_255(int iParam0) // Position - 0xF5D4 (62932)
{
	var unk;
...
BOOL func_256(int iParam0) // Position - 0xF695 (63125)
{
	int i;
	var interiorType;
	Interior interiorAtCoordsWithType;
...
BOOL func_257(int iParam0, char* sParam1) // Position - 0xF71A (63258)
{
...
BOOL func_258(int iParam0) // Position - 0xF7FC (63484)
{
...
BOOL func_259(int iParam0) // Position - 0xF827 (63527)
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_260(int iParam0) // Position - 0xF852 (63570)
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_261(int iParam0) // Position - 0xF87D (63613)
{
	if (func_238(iParam0))
		return false;
	else if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
...
void func_262() // Position - 0xF8B2 (63666)
{
...
BOOL func_263(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, float fParam5) // Position - 0xF8CC (63692)
{
	int i;
...
BOOL func_264(int iParam0, var uParam1, var uParam2, var uParam3, float fParam4, var uParam5) // Position - 0xF931 (63793)
{
	int num;
	char* str;
...
BOOL func_265(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, BOOL bParam7) // Position - 0xF9A9 (63913)
{
	if (fParam6 < 0f)
		fParam6 = 0f;
...
void func_266(var uParam0, BOOL bParam1) // Position - 0xFA24 (64036)
{
	if (bParam1)
	{
...
int func_267(var uParam0) // Position - 0xFA89 (64137)
{
	if (func_210(uParam0))
	{
...
void func_268(var uParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0xFABF (64191)
{
...
void func_269(var uParam0, BOOL bParam1) // Position - 0xFADF (64223)
{
	func_270(&(uParam0->f_41), bParam1);
	return;
}

void func_270(var uParam0, BOOL bParam1) // Position - 0xFAF1 (64241)
{
	int i;
...
void func_271(Object* pobParam0, BOOL bParam1) // Position - 0xFB2F (64303)
{
	if (ENTITY::DOES_ENTITY_EXIST(*pobParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*pobParam0))
...
void func_272(var uParam0, BOOL bParam1) // Position - 0xFB6A (64362)
{
	func_273(&(uParam0->f_35), bParam1);
	return;
}

void func_273(var uParam0, BOOL bParam1) // Position - 0xFB7C (64380)
{
	int i;
...
void func_274(Vehicle* pveParam0) // Position - 0xFBB9 (64441)
{
...
void func_275(Vehicle* pveParam0) // Position - 0xFBF1 (64497)
{
	if (ENTITY::DOES_ENTITY_EXIST(*pveParam0))
	{
...
void func_276(var uParam0, int iParam1) // Position - 0xFC8D (64653)
{
	func_277(&(uParam0->f_28), iParam1);
	return;
}

void func_277(var uParam0, int iParam1) // Position - 0xFC9F (64671)
{
	int i;
...
void func_278(Ped* ppedParam0, BOOL bParam1, int iParam2, int iParam3) // Position - 0xFCE0 (64736)
{
	if (ENTITY::DOES_ENTITY_EXIST(*ppedParam0))
	{
...
void func_279(Ped* ppedParam0) // Position - 0xFD30 (64816)
{
	if (ENTITY::DOES_ENTITY_EXIST(*ppedParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(*ppedParam0, false))
...
void func_280(var uParam0) // Position - 0xFD71 (64881)
{
...
BOOL func_281(Ped pedParam0, eScriptTaskHash esthParam1) // Position - 0xFDE2 (64994)
{
...
void func_282(int iParam0) // Position - 0xFE15 (65045)
{
	if (*iParam0 == -1)
		return;
...
void func_283(char* sParam0) // Position - 0xFE52 (65106)
{
	!MISC::IS_STRING_NULL_OR_EMPTY(sParam0);
	return;
}

void func_284(var uParam0) // Position - 0xFE64 (65124)
{
	*uParam0 = -1;
...
void func_285() // Position - 0xFE97 (65175)
{
