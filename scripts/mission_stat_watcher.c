...
{
	Global_65029 = false;
	Global_65033 = func_7(joaat("SP0_SHOTS"));
	Global_65032 = func_7(joaat("SP0_HITS"));
	Global_65035 = func_7(joaat("SP1_SHOTS"));
	Global_65034 = func_7(joaat("SP1_HITS"));
	Global_65037 = func_7(joaat("SP2_SHOTS"));
	Global_65036 = func_7(joaat("SP2_HITS"));
	return;
}
...
void func_98(int iParam0) // Position - 0xD8D0 (55504)
{
	...
	{
		case 0:
			STATS::STAT_SET_INT(joaat("JEWEL_HEIST_RAW_TAKE"), Global_114904.f_1.f_126[iParam0 /*23*/], true);
			break;
	}
...
void func_103() // Position - 0xE502 (58626)
{
	...
	value = 0;
	value2 = 0;
	value = func_7(joaat("SP0_SHOTS")) - Global_65033;
	value2 = func_7(joaat("SP0_HITS")) - Global_65032;
	value = value + (func_7(joaat("SP1_SHOTS")) - Global_65035);
	value2 = value2 + (func_7(joaat("SP1_HITS")) - Global_65034);
	value = value + (func_7(joaat("SP2_SHOTS")) - Global_65037);
	value2 = value2 + (func_7(joaat("SP2_HITS")) - Global_65036);
	BUILTIN::WAIT(0);
	num = 100f;
