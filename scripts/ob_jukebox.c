...
void main() // Position - 0x0 (0)
{
	...
	hLocal_142 = Global_1845225[PLAYER::PLAYER_ID() /*874*/].f_260.f_36;
	...
	if (hLocal_142 == 126)
	{
		plLocal_138 = func_229(PLAYER::PLAYER_ID());
	...
	if (NETWORK::NETWORK_IS_HOST_OF_THIS_SCRIPT())
	{
		if (hLocal_142 == 126)
		{
			if (Global_1845225[plLocal_138 /*874*/].f_260.f_389 > iLocal_151)
				Global_1845225[plLocal_138 /*874*/].f_260.f_389 = iLocal_151;
		
			if (Global_1845225[plLocal_138 /*874*/].f_260.f_389 != iLocal_151 && func_225(plLocal_138))
			{
				func_221(Global_1845225[plLocal_138 /*874*/].f_260.f_389);
				func_216(true);
				iLocal_171.f_1 = 0.5f;
				iLocal_171 = 1;
		...
		{
			if (Global_1845225[plLocal_138 /*874*/].f_260.f_390 > iLocal_151)
				Global_1845225[plLocal_138 /*874*/].f_260.f_390 = iLocal_151;
		
			if (Global_1845225[plLocal_138 /*874*/].f_260.f_390 != iLocal_151)
			{
				func_221(Global_1845225[plLocal_138 /*874*/].f_260.f_390);
				func_216(true);
				iLocal_171.f_1 = 0.5f;
				iLocal_171 = 1;
				iLocal_171.f_3 = iLocal_139;
		...
		{
			if (Global_1845225[plLocal_138 /*874*/].f_260.f_386 > iLocal_151)
				Global_1845225[plLocal_138 /*874*/].f_260.f_386 = iLocal_151;
		
			if (Global_1845225[plLocal_138 /*874*/].f_260.f_386 != iLocal_151)
			{
				func_221(Global_1845225[plLocal_138 /*874*/].f_260.f_386);
				func_216(true);
				iLocal_171 = 1;
				iLocal_171.f_3 = iLocal_139;
				func_215();
	...
	while (true)
	{
		...
		if (obLocal_137 != 0 && !func_213(uLocal_168, 0f, 0f, 0f, false))
		{
			if (NETWORK::NETWORK_IS_HOST_OF_THIS_SCRIPT())
				func_212();
		...
		else if (hLocal_142 != -1 && hLocal_142 <= 131)
		{
			uLocal_161 = { func_1() };
...
{
	if (func_6(hLocal_142, -1))
		return func_4(hLocal_142);
	else if (hLocal_142 == 126)
		return func_3();
	else if (hLocal_142 == 130)
		return func_2();
...
Vector3 func_4(Hash hParam0) // Position - 0x4A7 (1191)
{
	if (func_5(hParam0) == 97)
		return 1001.0933f, -3171.0508f, -35.0421f;
	else if (func_5(hParam0) == 91)
		return 1122.5051f, -3152.9944f, -38.0211f;

	return 0f, 0f, 0f;
}

int func_5(Hash hParam0) // Position - 0x4EF (1263)
{
	switch (hParam0)
	{
		case 1:
...
BOOL func_6(Hash hParam0, int iParam1) // Position - 0x72C (1836)
{
	if (iParam1 == -1)
	{
		switch (hParam0)
...
{
	if (plLocal_138 == PLAYER::PLAYER_ID() && func_214())
	{
...
{
	Global_1845225[PLAYER::PLAYER_ID() /*874*/].f_260.f_387 = iParam0;
	return;
}
	...
	if (iLocal_171.f_3 != iLocal_139)
	{
		...
		if (plLocal_138 == PLAYER::PLAYER_ID() && iLocal_171.f_4)
		{
			if (hLocal_142 == 126)
			{
				...
				Global_1845225[plLocal_138 /*874*/].f_260.f_389 = iLocal_139;
			}
			else if (hLocal_142 == 130)
			{
				func_26(41216, iLocal_139, -1);
				Global_1845225[plLocal_138 /*874*/].f_260.f_390 = iLocal_139;
			}
			else
			{
				func_26(9355, iLocal_139, -1);
				Global_1845225[plLocal_138 /*874*/].f_260.f_386 = iLocal_139;
			}
		}
	}
	...
	switch (iLocal_154)
	{
		case 0:
			if (func_203() && func_202())
			{
				...
				else if (iLocal_144 != -1 && func_197(iLocal_144, true) && !TASK::IS_PED_RUNNING(PLAYER::PLAYER_PED_ID()))
				{
					func_196(2);
					func_194(&iLocal_144);
		...
		case 2:
			if (iLocal_171.f_2 == PLAYER::PLAYER_ID() && func_179())
			{
				iLocal_145 = 0;
				func_196(1);
			...
			else if (iLocal_171.f_2 != -1 || !func_179())
			{
				func_196(0);
				MISC::CLEAR_BIT(&uLocal_176[PLAYER::PLAYER_ID() /*3*/], 0);
		...
		case 4:
			...
			else if (PED::GET_SYNCHRONIZED_SCENE_PHASE(localSceneFromNetworkId) >= 0.96f)
			{
				...
				if (hLocal_142 == 126)
					iLocal_150 = Global_1845225[plLocal_138 /*874*/].f_260.f_389;
				else if (hLocal_142 == 130)
					iLocal_150 = Global_1845225[plLocal_138 /*874*/].f_260.f_390;
				else
					iLocal_150 = Global_1845225[plLocal_138 /*874*/].f_260.f_386;
...
{
	return func_40(&(Global_2658016[plParam0 /*467*/].f_446), 0);
}
...
char* func_42(Hash hParam0) // Position - 0x1A03 (6659)
{
	switch (hParam0)
	{
		case 1:
...
int func_44(Player plParam0) // Position - 0x29A6 (10662)
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
...
BOOL func_45() // Position - 0x2A15 (10773)
{
	return func_46() != -1;
}

int func_46() // Position - 0x2A23 (10787)
{
	return Global_2658016[PLAYER::PLAYER_ID() /*467*/].f_324.f_8;
}

int func_47() // Position - 0x2A3B (10811)
{
...
int func_48() // Position - 0x2A57 (10839)
{
...
int func_49(Player plParam0) // Position - 0x2A73 (10867)
{
	if (plParam0 == _INVALID_PLAYER_INDEX())
		return -1;
...
int func_50(Player plParam0) // Position - 0x2A98 (10904)
{
	if (plParam0 == _INVALID_PLAYER_INDEX())
		return -1;
...
Player _GET_BOSS_OF_LOCAL_PLAYER() // Position - 0x2ABD (10941)
{
	return Global_1888737[PLAYER::PLAYER_ID() /*611*/].f_10;
}

void func_52(int iParam0) // Position - 0x2AD2 (10962)
{
...
int func_53(BOOL bParam0) // Position - 0x2AF3 (10995)
{
	if (!bParam0)
		iLocal_145 = 1;
...
void func_54(int iParam0) // Position - 0x2B5B (11099)
{
	if (func_60())
		return;
...
void func_55(int iParam0) // Position - 0x2B8E (11150)
{
	if (func_60())
		return;
...
BOOL func_56() // Position - 0x2C18 (11288)
{
...
void func_57(BOOL bParam0, BOOL bParam1) // Position - 0x2C3F (11327)
{
	if (bParam0)
	{
		if (func_59(0))
...
BOOL func_58() // Position - 0x2CB3 (11443)
{
	return IS_BIT_SET(Global_1959772, 5);
}

BOOL func_59(int iParam0) // Position - 0x2CC1 (11457)
{
	if (iParam0 == 1)
...
BOOL func_60() // Position - 0x2D18 (11544)
{
	return IS_BIT_SET(Global_1959772, 19);
}

BOOL func_61(char* sParam0, BOOL bParam1, BOOL bParam2) // Position - 0x2D27 (11559)
{
	int localSceneFromNetworkId;
...
void func_62(BOOL bParam0, int iParam1) // Position - 0x2DBF (11711)
{
	int num;
	...
	if (bParam0)
	{
		func_63(&Global_24131.f_6263[num /*10*/]);
...
void func_63(int* piParam0) // Position - 0x2E85 (11909)
{
	if (piParam0->f_9 != 0)
	{
...
BOOL func_64(var uParam0, BOOL bParam1, int iParam2) // Position - 0x2EB1 (11953)
{
	var unk;
	Hash hashKey;
	int i;
...
void func_65() // Position - 0x2F4E (12110)
{
...
void func_66() // Position - 0x2FB6 (12214)
{
...
void func_67(BOOL bParam0, int iParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, int iParam5, BOOL bParam6, BOOL bParam7, int iParam8) // Position - 0x2FC8 (12232)
{
	int num;
	int r;
	int g;
	...
	if (bParam3)
	{
		...
		{
			func_103(Global_24131.f_5821 + 1, "DFLT_MNU_OPT" /*Exit*/, 0, true, false, false, false);
		...
		if (i == 1 && Global_24131.f_6331)
		{
			...
			else
			{
				if (Global_24131)
				{
					...
					{
						func_98(Global_24128, Global_24129, iParam5, num38, 0, 0, 0, 255);
						func_97(&unk5, &unk21, Global_24128 + (iParam5 * 0.5f), Global_24129 + (num38 * 0.5f), iParam5, num38, 0f, 255, 255, 255, 255, false, 0);
					}
					else
					{
						func_97(&unk5, &unk21, Global_24128 + (iParam5 * 0.5f), Global_24129 + (num38 * 0.5f), iParam5, num38, 0f, 255, 255, 255, 255, false, 0);
				...
				func_98(Global_24128, Global_24129 + num38, iParam5, 0.034722f, r, g, b, a);
				...
				if (MISC::GET_HASH_KEY(&(Global_24131.f_1)) != 0)
				{
					...
					func_95(Global_24128 + 0.00390625f, Global_24129 + num38 + 0.00416664f, 0);
				}
			
				if (Global_24131.f_6338)
				{
					func_96();
					func_93((Global_24128 + iParam5) - 0.00390625f - func_94("CM_ITEM_COUNT" /*~1~ / ~1~*/, Global_24131.f_6339, Global_24131.f_6340), Global_24129 + num38 + 0.00416664f, "CM_ITEM_COUNT" /*~1~ / ~1~*/, Global_24131.f_6339, Global_24131.f_6340);
				}
				else if (Global_24131.f_6334 > Global_24131.f_5828)
				{
					...
					{
						func_96();
						func_93((Global_24128 + iParam5) - 0.00390625f - func_94("CM_ITEM_COUNT" /*~1~ / ~1~*/, Global_24131.f_6337, Global_24131.f_6336), Global_24129 + num38 + 0.00416664f, "CM_ITEM_COUNT" /*~1~ / ~1~*/, Global_24131.f_6337, Global_24131.f_6336);
					}
				}
			}
			...
			func_97("CommonMenu", "Gradient_Bgd", Global_24128 + (iParam5 * 0.5f), (num42 + ((num36 - num42) * 0.5f)) - 0.00138888f, iParam5, num36 - num42, 0f, 255, 255, 255, 255, false, 0);
			...
			if (Global_24131.f_6334 > Global_24131.f_5828)
			{
				...
				func_98(Global_24128, num36 + 0f, iParam5, 0.034722f, r, g, b, a);
				...
				func_97("CommonMenu", "shop_arrows_upANDdown", Global_24128 + (iParam5 * 0.5f), num36 + 0f + (0.034722f * 0.5f), (textureResolution / 1280f) * num41, (textureResolution.f_1 / 720f) * num41, 0f, r, g, b, a, false, 0);
			...
			if (MISC::GET_HASH_KEY(&(Global_24131.f_5241)) != 0 && Global_24131.f_5323 != -1)
			{
				...
				{
					func_109(Global_24131.f_5325, true, true, &num26, &num27, bParam7);
				...
				func_98(Global_24128, num36 - 0.00277776f, iParam5, 0.00277776f, r, g, b, a);
				...
				{
					func_109(Global_24131.f_5325, true, true, &num26, &num27, bParam7);
					func_91(Global_24131.f_5325, true, &num32, &num33, &num34, &num35);
					func_97(func_102(Global_24131.f_5325), func_99(Global_24131.f_5325, true), Global_24128 + (num26 * 0.5f) + (0.00078125f * 2f), (num36 + (num27 * 0.5f)) - (0.00138888f * 4f), num26, num27, 0f, num32, num33, num34, num35, false, 0);
				}
			...
			if (MISC::GET_HASH_KEY(&(Global_4542961.f_21)) != 0 && Global_4542961.f_65 != -1)
			{
				...
				if (Global_4542961.f_67 != 0)
				{
					...
					func_97(func_102(Global_4542961.f_67), func_99(Global_4542961.f_67, true), Global_24128 + (num26 * 0.5f) + (0.00078125f * 2f), (num36 + (num27 * 0.5f)) - (0.00138888f * 4f), num26, num27, 0f, num32, num33, num34, num35, false, 0);
				}
		...
		if (i == 1 || !Global_24131.f_6331)
		{
			...
			for (j = 0; j <= num43; j = j + 1)
			{
				...
				if (flag && i == 1 && flag2)
				{
					...
					func_97("CommonMenu", "Gradient_Nav", Global_24128 + (iParam5 * 0.5f), num40 + num45 + (0.00277776f * (float)num5) + (num37 * 0.5f), iParam5, num37, 0f, r2, g2, b2, a2, false, 0);
						...
						switch (Global_24131.f_5659[k])
						{
								...
								if (flag2)
								{
									if (!Global_24131.f_6332)
									{
										...
										if (MISC::GET_HASH_KEY(&Global_24131.f_79[num16 /*6*/]) != 0)
										{
											...
											func_80(flag, Global_24131.f_1616[num16], Global_24131.f_1873[num16], flag7, num46, flag5, flag4);
										...
										if (num20 > 0)
										{
											...
											{
												if (func_109(Global_24131.f_4984[num14 + l], flag, false, &num26, &num27, bParam7))
												{
													num29 = num29 + num26;
									...
									if (MISC::GET_HASH_KEY(&Global_24131.f_79[num16 /*6*/]) != 0 && i == 1)
									{
										...
										func_80(flag, Global_24131.f_1616[num16], Global_24131.f_1873[num16], flag7, 0, flag5, flag4);
									...
									for (l = 0; l < 4; l = l + 1)
									{
										...
										else if (Global_24131.f_2387[num16 /*5*/][l] == 4)
										{
											...
											{
												if (func_109(Global_24131.f_4984[num14 + num20], flag, false, &num26, &num27, bParam7))
												{
													x = x + (num26 * 0.5f);
												
													if (func_109(Global_24131.f_4984[num14 + num20], flag, true, &num26, &num27, bParam7))
													{
														func_91(Global_24131.f_4984[num14 + num20], flag, &num32, &num33, &num34, &num35);
													
														if (i == 1)
															if (Global_24131.f_5686[k] == 2)
																func_97(func_102(Global_24131.f_4984[num14 + num20]), func_99(Global_24131.f_4984[num14 + num20], flag), ((num24 + x) - (0.00078125f * 8f)) + (0.00078125f * 4f), (num25 - 0.00277776f) + (num37 * 0.5f), num26, num27, 0f, num32, num33, num34, num35, false, 0);
															else
																func_97(func_102(Global_24131.f_4984[num14 + num20]), func_99(Global_24131.f_4984[num14 + num20], flag), (num24 + x) - (0.00078125f * 8f), (num25 - 0.00277776f) + (num37 * 0.5f), num26, num27, 0f, num32, num33, num34, num35, false, 0);
										...
										else
										{
											...
											if (IS_ROCKSTAR_DEV() && SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(joaat("fm_mission_creator")) > 0)
											{
												if (k == 0)
												{
													...
													func_80(false, Global_24131.f_1616[num16], Global_24131.f_1873[num16], flag7, 0, flag5, flag4);
										...
										for (l = 0; l < num20; l = l + 1)
										{
											if (Global_24131.f_4984[num14 + l] != 2 && Global_24131.f_4984[num14 + l] != 55 && Global_24131.f_4984[num14 + l] != 65)
											{
												if (func_109(Global_24131.f_4984[num14 + l], flag, false, &num26, &num27, bParam7))
												{
													...
													if (i == 1)
													{
														if (func_109(Global_24131.f_4984[num14 + l], flag, true, &num26, &num27, bParam7))
														{
															func_91(Global_24131.f_4984[num14 + l], flag, &num32, &num33, &num34, &num35);
														
															if (Global_24131.f_4984[num14 + l] == 31)
																func_97(func_102(Global_24131.f_4984[num14 + l]), func_99(Global_24131.f_4984[num14 + l], flag), Global_24128 + (num26 * 0.5f), (num25 + 0.00277776f + (num27 * 0.5f)) - (0.00078125f * 11f), num26, num27, 0f, num32, num33, num34, num35, false, 0);
															else if (Global_24131.f_5686[k] == 2)
																func_97(func_102(Global_24131.f_4984[num14 + l]), func_99(Global_24131.f_4984[num14 + l], flag), ((num24 + x + num28) - (0.00078125f * 8f)) + (0.00078125f * 4f), (num25 - 0.00277776f) + (num37 * 0.5f), num26, num27, 0f, num32, num33, num34, num35, false, 0);
															else
																func_97(func_102(Global_24131.f_4984[num14 + l]), func_99(Global_24131.f_4984[num14 + l], flag), (num24 + x + num28) - (0.00078125f * 12f), (num25 - 0.00277776f) + (num37 * 0.5f), num26, num27, 0f, num32, num33, num34, num35, false, 0);
														}
													}
							...
							case 2:
								if (flag2)
								{
									if (!Global_24131.f_6332)
									{
										func_80(flag, Global_24131.f_1616[num16], Global_24131.f_1873[num16], flag7, 0, false, false);
									...
									{
										func_80(flag, Global_24131.f_1616[num16], Global_24131.f_1873[num16], flag7, 0, false, false);
										func_74(num24 + x, num25, "NUMBER" /*~1~*/, Global_24131.f_4469[num12], 0);
									}
								}
							...
							case 3:
								if (flag2)
								{
									...
									func_80(flag, Global_24131.f_1616[num16], Global_24131.f_1873[num16], flag7, 0, false, false);
									func_70(num24 + x, num25, "NUMBER" /*~1~*/, Global_24131.f_4726[num13], Global_24131.f_4855[num13]);
								}
							...
							case 4:
								if (flag2)
								{
									if (func_109(Global_24131.f_4984[num14], flag, false, &num26, &num27, bParam7))
									{
										if (!Global_24131.f_6332)
										{
											num29 = num26;
										...
										if (i == 1)
										{
											if (func_109(Global_24131.f_4984[num14], flag, true, &num26, &num27, bParam7))
											{
												func_91(Global_24131.f_4984[num14], flag, &num32, &num33, &num34, &num35);
												func_97(func_102(Global_24131.f_4984[num14]), func_99(Global_24131.f_4984[num14], flag), num24 + x + (num26 * 0.5f), (num25 - 0.00277776f) + (num37 * 0.5f), num26 * func_69(Global_24131.f_4984[num14]), num27 * func_69(Global_24131.f_4984[num14]), 0f, num32, num33, num34, num35, false, 0);
											}
										}
									}
								}
...
void func_68(int iParam0) // Position - 0x6187 (24967)
{
	Global_1675403.f_1163 = iParam0;
	return;
}

float func_69(int iParam0) // Position - 0x6198 (24984)
{
	switch (iParam0)
	{
		case 36:
...
void func_70(float fParam0, float fParam1, char* sParam2, float fParam3, int iParam4) // Position - 0x6207 (25095)
{
...
float func_71(float fParam0) // Position - 0x622A (25130)
{
	fParam0 = fParam0 * func_72();
	return fParam0;
}

float func_72() // Position - 0x623D (25149)
{
	return 1.7777778f / func_73();
}

float func_73() // Position - 0x624F (25167)
{
	return Global_24131.f_9149;
}

void func_74(float fParam0, float fParam1, char* sParam2, BOOL bParam3, int iParam4) // Position - 0x625D (25181)
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_TEXT(sParam2);
...
BOOL IS_ROCKSTAR_DEV() // Position - 0x627F (25215)
{
	return DLC::IS_DLC_PRESENT(-1762644250);
}

void func_76(BOOL bParam0) // Position - 0x6290 (25232)
{
	int r;
	int g;
	int b;
...
float func_77(BOOL bParam0) // Position - 0x62D6 (25302)
{
	return func_78(HUD::END_TEXT_COMMAND_GET_SCREEN_WIDTH_OF_DISPLAY_TEXT(bParam0));
}

float func_78(float fParam0) // Position - 0x62E8 (25320)
{
	fParam0 = fParam0 * func_79();
	return fParam0;
}

float func_79() // Position - 0x62FB (25339)
{
	return func_73() / 1.7777778f;
}

void func_80(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, int iParam4, BOOL bParam5, BOOL bParam6) // Position - 0x630D (25357)
{
	int r;
	int g;
	int b;
	...
	if (bParam2)
	{
		if (bParam3)
		{
			func_82(Global_24131.f_6614[iParam4], &r, &g, &b);
...
void func_81(float fParam0, float fParam1) // Position - 0x64BB (25787)
{
	HUD::SET_TEXT_WRAP(func_71(fParam0), func_71(fParam1));
	return;
}

void func_82(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x64D3 (25811)
{
	switch (iParam0)
	{
		case 0:
...
void func_83(var uParam0, int iParam1, int iParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, int iParam7, BOOL bParam8) // Position - 0x675D (26461)
{
	int num;
	int i;
	int j;
...
void func_84(char* sParam0) // Position - 0x6C62 (27746)
{
...
void func_85(char* sParam0) // Position - 0x6C74 (27764)
{
	GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_PLAYER_NAME_STRING(sParam0);
	return;
}

BOOL func_86(Player plParam0, int iParam1) // Position - 0x6C82 (27778)
{
	BOOL flag;
...
eCharacter func_87(int iParam0, BOOL bParam1) // Position - 0x6CDB (27867)
{
...
BOOL func_88(Player plParam0) // Position - 0x6D1C (27932)
{
	Player player;
...
BOOL func_89() // Position - 0x6D3E (27966)
{
	var position;
...
BOOL func_90() // Position - 0x6DAC (28076)
{
	if (SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(joaat("cellphone_flashhand")) > 0)
		return true;
...
void func_91(int iParam0, BOOL bParam1, int* piParam2, int* piParam3, int* piParam4, int* piParam5) // Position - 0x6DC6 (28102)
{
...
void func_92(float fParam0) // Position - 0x6F02 (28418)
{
	int r;
	int g;
	int b;
...
void func_93(float fParam0, float fParam1, char* sParam2, int iParam3, int iParam4) // Position - 0x6F61 (28513)
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_TEXT(sParam2);
...
float func_94(char* sParam0, int iParam1, int iParam2) // Position - 0x6F88 (28552)
{
...
void func_95(float fParam0, float fParam1, int iParam2) // Position - 0x6FCA (28618)
{
	HUD::END_TEXT_COMMAND_DISPLAY_TEXT(func_71(fParam0), fParam1, iParam2);
	return;
}

void func_96() // Position - 0x6FE0 (28640)
{
	int r;
	int g;
	int b;
...
void func_97(char* sParam0, char* sParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6, int iParam7, int iParam8, int iParam9, int iParam10, BOOL bParam11, int iParam12) // Position - 0x706A (28778)
{
...
void func_98(float fParam0, float fParam1, int iParam2, float fParam3, int iParam4, int iParam5, int iParam6, int iParam7) // Position - 0x7098 (28824)
{
...
char* func_99(int iParam0, BOOL bParam1) // Position - 0x70CF (28879)
{
	var unk;
	var txdName;
	var netHandle;
...
char* func_100(char* sParam0) // Position - 0x75FF (30207)
{
	return sParam0;
}

struct<13> GET_GAMER_HANDLE_PLAYER(Player plParam0) // Position - 0x7609 (30217)
{
	var gamerHandle;
...
char* func_102(int iParam0) // Position - 0x7620 (30240)
{
	var txdName;
	var netHandle;
...
void func_103(int iParam0, char* sParam1, int iParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0x7695 (30357)
{
	int num;
	float num2;
	float num3;
	...
	if (!bParam3)
		func_106(Global_24131.f_5821, true);
	else
		func_106(Global_24131.f_5821, false);

	if (iParam2 == 0)
	{
		num2 = func_105(&Global_24131.f_79[Global_24131.f_5823 /*6*/]);
	...
	if (bParam5)
	{
		if (iParam2 == 0)
		{
			num4 = func_104(&Global_24131.f_79[Global_24131.f_5823 /*6*/]);
...
float func_104(char* sParam0) // Position - 0x78B1 (30897)
{
	!HUD::DOES_TEXT_LABEL_EXIST(sParam0);
	return HUD::GET_RENDERED_CHARACTER_HEIGHT(0.35f, 0);
}

float func_105(char* sParam0) // Position - 0x78CD (30925)
{
	if (!MISC::IS_STRING_NULL(sParam0))
		if (MISC::GET_HASH_KEY(sParam0) == 0)
			return 0f;
...
void func_106(int iParam0, BOOL bParam1) // Position - 0x790A (30986)
{
	int num;
...
void func_107(BOOL bParam0, int* piParam1, int* piParam2, var uParam3) // Position - 0x7956 (31062)
{
	float num;
	float value;
	float aspectRatio;
...
BOOL func_108(int iParam0, int iParam1) // Position - 0x79DE (31198)
{
	return BUILTIN::TO_FLOAT(iParam0) / BUILTIN::TO_FLOAT(iParam1) > 3.5f;
}

BOOL func_109(int iParam0, BOOL bParam1, BOOL bParam2, var uParam3, var uParam4, BOOL bParam5) // Position - 0x79F9 (31225)
{
	var textureDict;
	var textureName;
	int num;
...
float func_110(int iParam0) // Position - 0x7B25 (31525)
{
	switch (iParam0)
	{
		case 34:
...
BOOL func_111(BOOL bParam0, BOOL bParam1) // Position - 0x7BFF (31743)
{
	if (Global_2672964.f_1761.f_701 != 0)
		return true;

	if (!CAM::IS_SCREEN_FADED_IN() || func_113(8, -1) && func_112() != TRANSITION_STATE_WAITING_FOR_EXTERNAL_TERMINATION_CALL || HUD::GET_PAUSE_MENU_STATE() != 0 && !bParam1 || STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS() && !bParam0 || NETWORK::IS_COMMERCE_STORE_OPEN() || Global_80005 || Global_24131.f_9147 || HUD::IS_WARNING_MESSAGE_ACTIVE() || Global_101945.f_1490)
		return false;

	return true;
}

eTransitionState func_112() // Position - 0x7C9C (31900)
{
	return Global_1575014;
}

BOOL func_113(int iParam0, int iParam1) // Position - 0x7CA8 (31912)
{
	switch (iParam0)
	{
		case 5:
...
void func_114() // Position - 0x7CE0 (31968)
{
	switch (iLocal_153)
	{
		case 1:
...
void func_115() // Position - 0x7D16 (32022)
{
	if (!func_214())
		if (iLocal_141 == 0)
...
void func_116(char* sParam0, int iParam1, int iParam2) // Position - 0x7D8A (32138)
{
	int i;
...
void func_117() // Position - 0x7DEF (32239)
{
	var unk;
	...
	else if (iLocal_141 == iLocal_171.f_3 && func_214())
	{
	...
	else
	{
		...
		if (hLocal_142 != 126 && hLocal_142 != 130 && iLocal_141 >= 4)
...
BOOL func_118() // Position - 0x7E94 (32404)
{
...
BOOL _STAT_GET_PACKED_BOOL(int iParam0, int iParam1) // Position - 0x7F2B (32555)
{
	if (iParam1 == -1)
		iParam1 = func_19();
...
void func_120() // Position - 0x7F47 (32583)
{
	func_116("JBOX_TOFF_NM" /*You need $1 in cash to use the jukebox.*/, 0, 0);
	return;
}

void func_121(int iParam0, BOOL bParam1, int iParam2) // Position - 0x7F59 (32601)
{
	int i;
	int num;
...
void func_122() // Position - 0x80AC (32940)
{
	switch (iLocal_153)
	{
		case 1:
...
void func_123() // Position - 0x80E2 (32994)
{
...
void func_124(eControlAction ecaParam0, char* sParam1, int iParam2, BOOL bParam3) // Position - 0x812E (33070)
{
...
void func_125(char* sParam0) // Position - 0x81E3 (33251)
{
...
void func_126(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4) // Position - 0x8209 (33289)
{
...
void func_127(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4) // Position - 0x82B3 (33459)
{
...
void func_128(char* sParam0) // Position - 0x82F2 (33522)
{
	int i;
...
void func_129(BOOL bParam0, BOOL bParam1) // Position - 0x833D (33597)
{
	int i;
	int j;
	float aspectRatio;
	...
	Global_24131.f_9149 = func_130(false);
	Global_24128 = 0.05f;
	Global_24129 = 0.05f;
	Global_24130 = 0.225f;
	aspectRatio = GRAPHICS::GET_ASPECT_RATIO(false);
...
float func_130(BOOL bParam0) // Position - 0x881F (34847)
{
	float aspectRatio;
...
void func_131() // Position - 0x884A (34890)
{
	int num;
	int i;
	var unk;
	...
	for (i = 0; i < num; i = i + 1)
	{
		...
		if (hLocal_142 != 126 && hLocal_142 != 130 && i >= 4)
	...
	if (hLocal_142 == 126 && func_214())
		func_132(8, "HUD_INPUT77" /*Change Volume*/, -1);

	return;
}

void func_132(int iParam0, char* sParam1, int iParam2) // Position - 0x893C (35132)
{
...
BOOL func_133(int iParam0) // Position - 0x89EC (35308)
{
...
int func_134() // Position - 0x8A1A (35354)
{
	if (hLocal_142 == 126 || hLocal_142 == 130)
		return 20;

	return 15;
}

void func_135() // Position - 0x8A3C (35388)
{
	func_125("JBOX_MENU_T" /*JUKEBOX*/);
...
BOOL func_136(char* sParam0, int iParam1, BOOL bParam2) // Position - 0x8A7A (35450)
{
	int num;
	BOOL flag;
	BOOL flag2;
	...
	flag2 = func_137(&Global_24131.f_6263[num /*10*/]);
	!flag || !flag2;
	return flag && flag2;
}

BOOL func_137(int* piParam0) // Position - 0x8B88 (35720)
{
	switch (piParam0->f_9)
	{
		case 0:
...
void func_138() // Position - 0x8C2A (35882)
{
	int controlValue;
	int num;
	BOOL flag;
	...
	if (isControlJustPressed)
	{
		...
		switch (iLocal_153)
		{
			...
			case 0:
				if (iLocal_141 != iLocal_171.f_3 || !func_214() && !func_133(iLocal_141))
				{
...
void func_139(int iParam0) // Position - 0x8F02 (36610)
{
	Hash hashKey;
	int num;
...
void _NETSHOPPING_PROCESS_TRANSACTION(Hash hParam0, int iParam1, var uParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5) // Position - 0x8F85 (36741)
{
	int num;
...
int func_141(var uParam0, int iParam1, Hash hParam2, Hash hParam3, Hash hParam4, int iParam5, int iParam6, int iParam7) // Position - 0x9910 (39184)
{
	BOOL flag;
	BOOL flag2;
	int i;
...
void func_142(int iParam0, Hash hParam1, int iParam2, int iParam3, int iParam4) // Position - 0x9ABD (39613)
{
	switch (hParam1)
	{
		case joaat("SERVICE_SPEND_BETTING"):
...
void func_143(int iParam0) // Position - 0x9AF5 (39669)
{
	BOOL flag;
...
void func_144(Hash hParam0) // Position - 0x9B49 (39753)
{
	hParam0->f_65 = 0;
...
void func_145(var uParam0) // Position - 0x9C54 (40020)
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
BOOL func_146(int iParam0) // Position - 0x9C9C (40092)
{
...
void func_147(BOOL bParam0, Hash hParam1) // Position - 0x9CC7 (40135)
{
...
int func_148(int iParam0, int iParam1, Hash hParam2, Hash hParam3, Hash hParam4, int iParam5, BOOL bParam6, int iParam7, int iParam8, int iParam9, BOOL bParam10) // Position - 0x9CDB (40155)
{
	int i;
...
int func_150(Player plParam0) // Position - 0x9E9B (40603)
{
	var address;
...
char* func_152(int iParam0) // Position - 0x9ECD (40653)
{
	switch (iParam0)
	{
		case 0:
...
char* func_153(int iParam0) // Position - 0x9FE4 (40932)
{
	switch (iParam0)
	{
		case 0:
...
char* func_154(int iParam0) // Position - 0xA0FB (41211)
{
	switch (iParam0)
	{
		case 0:
...
void func_155(float fParam0) // Position - 0xA1D1 (41425)
{
...
int func_156() // Position - 0xA1F2 (41458)
{
	int num;
...
void func_157(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) // Position - 0xA23B (41531)
{
...
BOOL func_158(BOOL bParam0, BOOL bParam1, int iParam2) // Position - 0xA368 (41832)
{
...
BOOL func_159(BOOL bParam0, BOOL bParam1, int iParam2) // Position - 0xA3CD (41933)
{
	if (PAD::IS_USING_KEYBOARD_AND_MOUSE(FRONTEND_CONTROL))
	{
		if (Global_4543037 == -2)
...
BOOL func_160() // Position - 0xA432 (42034)
{
	if (PAD::IS_USING_KEYBOARD_AND_MOUSE(FRONTEND_CONTROL))
...
BOOL func_161() // Position - 0xA451 (42065)
{
	if (PAD::IS_USING_KEYBOARD_AND_MOUSE(FRONTEND_CONTROL))
		if (Global_4543037 > -1)
...
int func_162(BOOL bParam0, int iParam1, BOOL bParam2) // Position - 0xA478 (42104)
{
	if (!PAD::IS_USING_KEYBOARD_AND_MOUSE(FRONTEND_CONTROL))
		return 0;
...
void func_163(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0xA558 (42328)
{
	float x;
	float y;
	float x2;
	...
	if (num4 >= x && num4 <= x2 && num5 >= y && num5 <= y2)
	{
		...
		if (bParam3)
		{
			if (!bParam1 || num10 != 0)
			{
				GRAPHICS::SET_SCRIPT_GFX_ALIGN(76, 84);
				GRAPHICS::SET_SCRIPT_GFX_ALIGN_PARAMS(-0.05f, -0.05f, 0f, 0f);
				func_98(num, num2 + ((float)num10 * 0.034722f), Global_24130, 0.034722f - 0.0015f, 255, 255, 255, num7);
				GRAPHICS::RESET_SCRIPT_GFX_ALIGN();
			}
		}
...
void func_164(BOOL bParam0) // Position - 0xA804 (43012)
{
	float num;
	float num2;
	float num3;
	...
	if (Global_4543037 == -2)
		func_98(num, num2, Global_24130, num3, 255, 255, 255, num4);
	else if (Global_4543037 == -3)
		func_98(num, num2 + num3, Global_24130, num3, 255, 255, 255, num4);

	GRAPHICS::RESET_SCRIPT_GFX_ALIGN();
	return;
}

void func_165() // Position - 0xA88D (43149)
{
...
void func_166() // Position - 0xA8D5 (43221)
{
	func_167(true);
	func_55(1);
...
void func_167(BOOL bParam0) // Position - 0xA90B (43275)
{
	if (bParam0)
		if (func_168())
...
BOOL func_168() // Position - 0xA930 (43312)
{
	return IS_BIT_SET(Global_2684745.f_2, 11);
}

BOOL func_169() // Position - 0xA941 (43329)
{
	return HUD::GET_PAUSE_MENU_STATE() != 0;
}

BOOL func_170() // Position - 0xA94F (43343)
{
	if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false))
	{
		switch (iLocal_145)
...
BOOL func_171() // Position - 0xA9AA (43434)
{
	var unk;
	float num;
	int num2;
...
void func_172(char* sParam0, int iParam1, float fParam2, float fParam3, float fParam4, int iParam5, float fParam6) // Position - 0xAA65 (43621)
{
	Vector3 vector;
...
BOOL func_173() // Position - 0xAAB5 (43701)
{
	var unk;
	float num;
...
BOOL func_174(float fParam0, float fParam1, float fParam2) // Position - 0xAB11 (43793)
{
	float num;
	float num2;
...
BOOL func_175(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, BOOL bParam7) // Position - 0xAB86 (43910)
{
	if (fParam6 < 0f)
		fParam6 = 0f;
...
void func_176(Vector3 vParam0, var uParam1, var uParam2, float fParam3) // Position - 0xAC01 (44033)
{
...
void func_177(var uParam0, var uParam1) // Position - 0xAC61 (44129)
{
...
void _STOPWATCH_DESTROY(var uParam0) // Position - 0xACB5 (44213)
{
	uParam0->f_1 = 0;
	return;
}

BOOL func_179() // Position - 0xACC2 (44226)
{
	if (func_180() == 0)
		return true;
...
int func_180() // Position - 0xACD7 (44247)
{
	return Global_1574634.f_18;
}

void func_181() // Position - 0xACE5 (44261)
{
...
void func_182(char* sParam0) // Position - 0xAD0D (44301)
{
...
void _SET_PLAYER_CONTROL_EX(Player plParam0, BOOL bParam1, eSetPlayerControlFlags espcfParam2, BOOL bParam3) // Position - 0xAD23 (44323)
{
...
BOOL func_184(int iParam0) // Position - 0xB1D7 (45527)
{
	return iParam0 == 17;
}

void func_185() // Position - 0xB1E4 (45540)
{
	var unk;
...
void func_186() // Position - 0xB231 (45617)
{
...
BOOL func_187(Ped pedParam0) // Position - 0xB26F (45679)
{
...
void func_188(BOOL bParam0, Ped pedParam1, int iParam2) // Position - 0xB2A0 (45728)
{
	int num;
	eViewModeContext i;
...
void _MPPLY_STAT_SET_BOOL(Hash hParam0, BOOL bParam1) // Position - 0xB370 (45936)
{
	Hash statName;
...
void func_190() // Position - 0xB38C (45964)
{
	eViewModeContext i;
...
BOOL func_191(Player plParam0) // Position - 0xB3E4 (46052)
{
...
BOOL func_192() // Position - 0xB423 (46115)
{
	return IS_BIT_SET(Global_2621446, 3);
}

BOOL func_193() // Position - 0xB431 (46129)
{
...
void func_194(var uParam0) // Position - 0xB462 (46178)
{
	int num;
...
int func_195(int iParam0) // Position - 0xB4B9 (46265)
{
	int i;
...
void func_196(int iParam0) // Position - 0xB4F4 (46324)
{
	iLocal_154 = iParam0;
	return;
}

BOOL func_197(int iParam0, BOOL bParam1) // Position - 0xB500 (46336)
{
	int num;
...
void func_198() // Position - 0xB5B8 (46520)
{
...
void _CONTEXT_ADD_HELP_TEXT(var uParam0, int iParam1, char* sParam2, int iParam3, const char* sParam4, int iParam5, int iParam6) // Position - 0xB5DF (46559)
{
	int i;
...
void func_200() // Position - 0xB70A (46858)
{
...
BOOL _IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(char* message) // Position - 0xB72A (46890)
{
	HUD::BEGIN_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(message);
	return HUD::END_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(0);
}

BOOL func_202() // Position - 0xB73D (46909)
{
...
BOOL func_203() // Position - 0xB761 (46945)
{
	BOOL flag;

	flag = true;

	if (func_252(PLAYER::PLAYER_ID()) && !func_225(plLocal_138))
		flag = false;

	if (!IS_BIT_SET(Global_2708069, 5) && !func_210() && !func_59(0) && !func_209() && !PED::IS_PED_IN_COVER(PLAYER::PLAYER_PED_ID(), false) && INTERIOR::GET_ROOM_KEY_FROM_ENTITY(PLAYER::PLAYER_PED_ID()) == INTERIOR::GET_ROOM_KEY_FROM_ENTITY(obLocal_137) && func_174(ENTITY::GET_ENTITY_HEADING(PLAYER::PLAYER_PED_ID()), fLocal_164, 75f) && ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), uLocal_165, 0.55f, 0.8f, 1.5f, false, true, 1) && !ENTITY::IS_ENTITY_PLAYING_ANIM(PLAYER::PLAYER_PED_ID(), sLocal_152, "EXIT", 3) && !func_208(PLAYER::PLAYER_ID()) && !func_207() && flag && !IS_BIT_SET(Global_1945923.f_4, 2) && func_204(PLAYER::PLAYER_PED_ID()) <= 9 && !Global_2635523.f_2982 && !PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) && !Global_1922322)
		return true;

	return false;
}

int func_204(Ped pedParam0) // Position - 0xB888 (47240)
{
	int num;
	int num2;
...
int func_205(int iParam0) // Position - 0xB8CB (47307)
{
	int i;
...
int func_206(Ped pedParam0) // Position - 0xB8FB (47355)
{
	int i;
...
BOOL func_207() // Position - 0xB93C (47420)
{
	if (iLocal_171.f_2 != -1)
		return true;
...
BOOL func_208(Player plParam0) // Position - 0xB951 (47441)
{
...
BOOL func_209() // Position - 0xB98A (47498)
{
	return Global_76838;
}

BOOL func_210() // Position - 0xB996 (47510)
{
	if (func_211() != -1)
		return true;
	else
...
int func_211() // Position - 0xB9B2 (47538)
{
	return Global_2696568;
}

void func_212() // Position - 0xB9BE (47550)
{
	if (func_207())
	{
	...
	if (!func_207())
		if (hLocal_142 == 126)
			if (Global_1845225[plLocal_138 /*874*/].f_260.f_389 == iLocal_171.f_3 && !func_214() && Global_1845225[plLocal_138 /*874*/].f_260.f_389 == iLocal_151)
				iLocal_171.f_4 = 0;
		else if (hLocal_142 == 130)
			if (Global_1845225[plLocal_138 /*874*/].f_260.f_390 == iLocal_171.f_3 && !func_214() && Global_1845225[plLocal_138 /*874*/].f_260.f_390 == iLocal_151)
				iLocal_171.f_4 = 0;
		else if (Global_1845225[plLocal_138 /*874*/].f_260.f_386 == iLocal_171.f_3 && !func_214() && Global_1845225[plLocal_138 /*874*/].f_260.f_386 == iLocal_151)
			iLocal_171.f_4 = 0;
...
BOOL func_213(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, BOOL bParam6) // Position - 0xBB89 (48009)
{
	if (bParam6)
...
BOOL func_214() // Position - 0xBBD0 (48080)
{
	return iLocal_171 == 1;
}

void func_215() // Position - 0xBBDC (48092)
{
	int num;
	int num2;
	int num3;
...
void func_216(BOOL bParam0) // Position - 0xBC43 (48195)
{
	if (bParam0)
...
void func_217(BOOL bParam0) // Position - 0xBC96 (48278)
{
...
void _STAT_SET_PACKED_BOOL(int iParam0, BOOL bParam1, int iParam2) // Position - 0xBCF1 (48369)
{
	if (iParam2 == -1)
		iParam2 = func_19();
...
void func_219(BOOL bParam0) // Position - 0xBD0F (48399)
{
...
void func_220(Hash hParam0, BOOL bParam1) // Position - 0xBD2B (48427)
{
	if (func_5(hParam0) == 97)
	{
...
void func_221(int iParam0) // Position - 0xBD84 (48516)
{
	if (func_6(hLocal_142, -1))
	{
		if (iParam0 != iLocal_151 && iParam0 != -1)
		{
			...
			func_224(hLocal_142, iParam0);
		}
	
		if (iParam0 != -1)
			iLocal_139 = iParam0;
	}
	else if (hLocal_142 == 126 || hLocal_142 == 130)
	{
		if (iParam0 != iLocal_151 && iParam0 != -1)
		{
			if (plLocal_138 == PLAYER::PLAYER_ID() && iLocal_148 != 0)
...
void func_222(int iParam0) // Position - 0xBE3C (48700)
{
	char* radioStation;
...
void func_223(int iParam0) // Position - 0xBE77 (48759)
{
	char* radioStation;
...
void func_224(Hash hParam0, int iParam1) // Position - 0xBEB2 (48818)
{
	char* radioStation;
...
BOOL func_225(Player plParam0) // Position - 0xBF2D (48941)
{
	return func_227(plParam0) && func_226(plParam0);
}

BOOL func_226(Player plParam0) // Position - 0xBF46 (48966)
{
	if (plParam0 == PLAYER::PLAYER_ID())
...
BOOL func_227(Player plParam0) // Position - 0xBF7A (49018)
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		return IS_BIT_SET(Global_1845225[plParam0 /*874*/].f_260.f_433.f_1, 2);

	return false;
}

Player _INVALID_PLAYER_INDEX() // Position - 0xBFA2 (49058)
{
	return -1;
}

Player func_229(Player plParam0) // Position - 0xBFAB (49067)
{
	int num;
...
Player func_230(Player plParam0) // Position - 0xC03D (49213)
{
	if (func_88(plParam0))
...
BOOL func_231(Player plParam0, BOOL bParam1) // Position - 0xC060 (49248)
{
	if (!func_88(plParam0))
		return false;
	...
	return func_88(Global_1888737[plParam0 /*611*/].f_10);
}

BOOL func_232(Player plParam0) // Position - 0xC098 (49304)
{
	if (func_88(plParam0))
		if (func_88(Global_1888737[plParam0 /*611*/].f_10))
			return Global_1888737[plParam0 /*611*/].f_10 == plParam0;

	return false;
}

int func_233(int iParam0) // Position - 0xC0CD (49357)
{
	switch (iParam0)
	{
		case 0:
...
BOOL IS_GAMER_HANDLE_VALID(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12) // Position - 0xC603 (50691)
{
	return NETWORK::NETWORK_IS_HANDLE_VALID(&uParam0, 13);
}

void func_235(Player plParam0, var uParam1) // Position - 0xC613 (50707)
{
	*uParam1 = { Global_1845225[plParam0 /*874*/].f_260.f_73 };
	return;
}

void func_236() // Position - 0xC631 (50737)
{
	int instanceId;
...
BOOL _NETWORK_WAIT_FOR_HOST_BROADCAST_DATA() // Position - 0xC6A5 (50853)
{
	int num;
...
BOOL _DOES_EVENT_OF_TYPE_EXIST(int iParam0) // Position - 0xC6FE (50942)
{
...
BOOL func_239() // Position - 0xC715 (50965)
{
	return Global_2684745.f_695;
}

int func_240(int iParam0, int iParam1, BOOL bParam2) // Position - 0xC724 (50980)
{
	int i;
...
BOOL func_241(BOOL bParam0) // Position - 0xC83A (51258)
{
	bParam0;
	return Global_1575058;
}

void func_242() // Position - 0xC84B (51275)
{
	SCRIPT::TERMINATE_THIS_THREAD();
	return;
}

Player func_243() // Position - 0xC857 (51287)
{
	Player player;
...
BOOL func_244(Player plParam0) // Position - 0xC877 (51319)
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
...
void func_245() // Position - 0xC8DD (51421)
{
	if (hLocal_142 == 126)
	{
		...
		else if (IS_BIT_SET(Global_2708069, 1))
		{
			MISC::CLEAR_BIT(&Global_2708069, 1);
			func_253(false);
		}
		else if (IS_BIT_SET(Global_1945923.f_6, 10))
		{
			if (iLocal_154 != 0)
			{
				if (IS_BIT_SET(iLocal_147, 3))
	...
	else if (hLocal_142 != Global_1845225[PLAYER::PLAYER_ID() /*874*/].f_260.f_36)
	{
		func_253(false);
	}
...
BOOL func_246() // Position - 0xCB26 (52006)
{
	return Global_4196257;
}

BOOL func_247(Player plParam0) // Position - 0xCB32 (52018)
{
...
BOOL func_248(Player plParam0) // Position - 0xCB6B (52075)
{
	if (plParam0 != _INVALID_PLAYER_INDEX() && _NETWORK_IS_PLAYER_VALID(plParam0, true, true))
...
BOOL func_249(Player plParam0) // Position - 0xCB9C (52124)
{
	if (plParam0 != _INVALID_PLAYER_INDEX() && _NETWORK_IS_PLAYER_VALID(plParam0, true, true))
...
int func_250() // Position - 0xCBCD (52173)
{
	return func_134();
}

BOOL func_251(Player plParam0) // Position - 0xCBD9 (52185)
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2658016[plParam0 /*467*/].f_324.f_8 != -1)
				return func_233(Global_2658016[plParam0 /*467*/].f_324.f_8) == 26;

	return false;
}

BOOL func_252(Player plParam0) // Position - 0xCC20 (52256)
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2658016[plParam0 /*467*/].f_324.f_8 != -1)
				return func_233(Global_2658016[plParam0 /*467*/].f_324.f_8) == 17;

	return false;
}

void func_253(BOOL bParam0) // Position - 0xCC67 (52327)
{
	func_255(false);
...
void func_254() // Position - 0xCCEB (52459)
{
...
void func_255(BOOL bParam0) // Position - 0xCD64 (52580)
{
	if (bParam0)
	{
		func_256();
...
void func_256() // Position - 0xCDC7 (52679)
{
