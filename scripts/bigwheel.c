...
BOOL func_188(Ped pedParam0, ePedComponentType epctParam1, Hash hParam2) // Position - 0x25663 (153187)
{
	Hash entityModel;
	Hash hash;
	int i;
	...
	entityModel = ENTITY::GET_ENTITY_MODEL(pedParam0);
	Global_80063[1 /*14*/] = { func_124(entityModel, epctParam1, hParam2, -1) };
