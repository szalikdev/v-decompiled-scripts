...
int func_117(var uParam0, int iParam1, Hash hParam2, Hash hParam3, Hash hParam4, ePedComponentType epctParam5, int iParam6, int iParam7) // Position - 0x9905 (39173)
{
	BOOL flag;
	BOOL flag2;
	int i;
...
void func_118(int iParam0, Hash hParam1, int iParam2, ePedComponentType epctParam3, int iParam4) // Position - 0x9AB2 (39602)
{
	switch (hParam1)
	{
		case joaat("SERVICE_SPEND_BETTING"):
...
ePedComponentType func_128(int iParam0) // Position - 0x9EC2 (40642)
{
	if (iParam0 == 1)
...
void func_222(Hash hParam0, int iParam1, ePedComponentType epctParam2) // Position - 0xD8A0 (55456)
{
	Hash hash;
	int num;
...
void func_255(var uParam0, int iParam1, int iParam2, ePedComponentType epctParam3, ePedComponentType epctParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0x13421 (78881)
{
	uParam0->[0] = iParam1;
	uParam0->[2] = iParam2;
...
void func_399(var uParam0, int iParam1, char* sParam2, var uParam3, var uParam4, var uParam5, ePedComponentType epctParam6, char* sParam7, int iParam8, float fParam9) // Position - 0x2DECD (188109)
{
	uParam0->f_5 = sParam2;
	uParam0->f_1 = { uParam3 };
	uParam0->f_4 = sParam7;
